import{i as c,b as u,a as p,r as i,t as m}from"./index-Cp-RiFG9.js";import{e as h}from"./query-BTNVwIEl.js";import"./ia-audio-element-DDjvhEqc.js";import"./story-template-C6hfRotf.js";const g=""+new URL("arrow-Mvsiq3dP.ogg",import.meta.url).href,y=""+new URL("arrow-DBfEM-Y0.mp3",import.meta.url).href,v=""+new URL("spring-DUrlU9jj.ogg",import.meta.url).href,b=""+new URL("spring-gwRd3wbj.mp3",import.meta.url).href;var w=Object.defineProperty,f=Object.getOwnPropertyDescriptor,a=(e,r,n,s)=>{for(var o=s>1?void 0:s?f(r,n):r,l=e.length-1,d;l>=0;l--)(d=e[l])&&(o=(s?d(r,n,o):d(o))||o);return s&&o&&w(r,n,o),o};const k={arrow:[{url:g,mimetype:"audio/ogg"},{url:y,mimetype:"audio/mpeg"}],spring:[{url:v,mimetype:"audio/ogg"},{url:b,mimetype:"audio/mpeg"}]},$=[{label:"Show native controls",propertyName:"showControls",defaultValue:!0,inputType:"radio",radioOptions:[!0,!1]}];let t=class extends c{constructor(){super(...arguments),this.trackName="arrow",this.currentTime=0,this.duration=0,this.playing=!1,this.playbackRate=1,this.volume=1}render(){return u`
      <story-template
