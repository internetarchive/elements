...
`,appliedProps:t}}))}static get styles(){return[V,T`
      ...
      `]}};Tt([p({type:Object})],nt.prototype,"propInputData",2);Tt([te(".prop-input")],nt.prototype,"propInputs",2);nt=Tt([O("story-props-settings")],nt);var Fe=Object.defineProperty,He=Object.getOwnPropertyDescriptor,A=(e,t,i,s)=>{for(var o=s>1?void 0:s?He(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(s?a(t,i,o):a(o))||o);return s&&o&&Fe(t,i,o),o};let S=class extends w{constructor(){super(...arguments),this.elementTag="",this.elementClassName="",this.labs=!1,this.detailsVisible=!1,this.shouldShowPropertySettings=!1,this.copiedKey=null}render(){return h`
      <div id="container">
        <h2>
        ...
        <div class="two-col">
          <div class="left-col">
            ...
            ${N(!!this.propInputData,()=>h`
                ...
                ></story-props-settings>
              `)}
            ${N(!this.propInputData&&!this.shouldShowPropertySettings,()=>h`<p class="section-placeholder">No settings to adjust</p>`)}
            <div
...
${this.elementTag} {
 ${this.stringifiedStyles}
    ...
    `:""}get modulePath(){return this.labs?`@internetarchive/elements/labs/${this.elementTag}/${this.elementTag}`:`@internetarchive/elements/${this.elementTag}/${this.elementTag}`}handleSettingsSlotChange(e){const t=e.target.assignedElements();this.shouldShowPropertySettings=t.length>0}handleDemoComponentSlotted(e){const t=e.target.assignedElements()[0];t&&(this.slottedDemoComponent=t)}handleStylesApplied(e){const t=e.detail.styles;t&&(this.stringifiedStyles=t)}handlePropsApplied(e){const t=e.detail.stringifiedProps,i=e.detail.appliedProps;!t||!i||(this.stringifiedProps=t,i.forEach(s=>{this.slottedDemoComponent[s.propName]=s.value}))}static get styles(){return[V,T`
      ...
      `]}};A([p({type:String})],S.prototype,"elementTag",2);A([p({type:String})],S.prototype,"elementClassName",2);A([p({type:String})],S.prototype,"customExampleUsage",2);A([p({type:String})],S.prototype,"defaultUsageProps",2);A([p({type:Object})],S.prototype,"styleInputData",2);A([p({type:Object})],S.prototype,"propInputData",2);A([p({type:Boolean})],S.prototype,"labs",2);A([m()],S.prototype,"detailsVisible",2);A([m()],S.prototype,"stringifiedStyles",2);A([m()],S.prototype,"stringifiedProps",2);A([m()],S.prototype,"shouldShowPropertySettings",2);A([m()],S.prototype,"slottedDemoComponent",2);A([m()],S.prototype,"copiedKey",2);S=A([O("story-template")],S);var ze=Object.getOwnPropertyDescriptor,Ke=(e,t,i,s)=>{for(var o=s>1?void 0:s?ze(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=a(o)||o);return o};const qe=[{label:"Text Color (Primary)",cssVariable:"--ia-theme-primary-cta-text-color",defaultValue:"#ffffff",inputType:"color"},{label:"Background Color (Primary)",cssVariable:"--ia-theme-primary-cta-fill",defaultValue:"#194880",inputType:"color"}];let bt=class extends w{render(){return h`
      <story-template
    ...
    `;return[V,e]}};f.formAssociated=!0;f.shadowRootOptions={...w.shadowRootOptions,delegatesFocus:!0};v([p({type:Array})],f.prototype,"options",2);v([p({type:String})],f.prototype,"placeholder",2);v([p({type:String})],f.prototype,"behavior",2);v([p({type:Number,attribute:"max-autocomplete-entries"})],f.prototype,"maxAutocompleteEntries",2);v([p({type:String})],f.prototype,"filter",2);v([p({type:Boolean,reflect:!0,attribute:"case-sensitive"})],f.prototype,"caseSensitive",2);v([p({type:Boolean,reflect:!0})],f.prototype,"sort",2);v([p({type:Boolean,reflect:!0,attribute:"wrap-arrow-keys"})],f.prototype,"wrapArrowKeys",2);v([p({type:Boolean,reflect:!0,attribute:"stay-open"})],f.prototype,"stayOpen",2);v([p({type:Boolean,reflect:!0})],f.prototype,"clearable",2);v([p({type:Boolean,reflect:!0})],f.prototype,"open",2);v([p({type:Boolean,reflect:!0})],f.prototype,"disabled",2);v([p({type:Boolean,reflect:!0})],f.prototype,"required",2);v([p({type:String})],f.prototype,"value",2);v([m()],f.prototype,"hasFocus",2);v([m()],f.prototype,"highlightedOption",2);v([m()],f.prototype,"enteredText",2);v([m()],f.prototype,"filterText",2);v([$("#main-widget-row")],f.prototype,"mainWidgetRow",2);v([$("#text-input")],f.prototype,"textInput",2);v([$("#options-list")],f.prototype,"optionsList",2);f=v([O("ia-combo-box")],f);var fi=Object.defineProperty,mi=Object.getOwnPropertyDescriptor,b=(e,t,i,s)=>{for(var o=s>1?void 0:s?mi(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(s?a(t,i,o):a(o))||o);return s&&o&&fi(t,i,o),o};const bi=[{label:"Width",cssVariable:"--ia-theme-combo-box-width",defaultValue:"250px",inputType:"text"},{label:"Padding",cssVariable:"--ia-theme-padding-sm",defaultValue:"5px",inputType:"text"},{label:"Dropdown width",cssVariable:"--combo-box-list-width",defaultValue:"",inputType:"text"},{label:"Dropdown max height",cssVariable:"--combo-box-list-max-height",defaultValue:"250px",inputType:"text"}],se=[{id:"red",text:"Red"},{id:"orange",text:"Orange"},{id:"yellow",text:"Yellow"},{id:"green",text:"Green"},{id:"blue",text:"Blue"},{id:"indigo",text:"Indigo"},{id:"violet",text:"Violet"}],yi=se.map(e=>({...e,content:h` <span style="display: flex; align-items: center">
...
`)}applySettings(e){e.preventDefault(),this.updateOptions(),this.behavior=this.behaviorSelect.value,this.label=this.labelInput.value,this.placeholder=this.placeholderInput.value,this.maxAutocompleteEntries=Number(this.maxAutocompleteInput.value),this.filterFn=this.filterFnSelect.value,this.caseSensitive=this.caseSensitiveCheck.checked,this.shouldSort=this.sortCheck.checked,this.wrapArrowKeys=this.wrapArrowKeysCheck.checked,this.clearable=this.clearableCheck.checked,this.disabled=this.disabledCheck.checked}updateOptions(){switch(this.optionSetSelect.value){case"colors":this.options=this.customContentCheck.checked?yi:se;break;case"countries":this.options=this.customContentCheck.checked?vi:Ft;break;default:this.options=[]}}handleComboBoxChange(e){this.announcerText=`New value is: ${e.detail}`}static get styles(){return T`
    ...
    `}};Et([p({type:Object})],at.prototype,"snowConfig",2);Et([m()],at.prototype,"snowing",2);at=Et([O("ia-snow")],at);var Bi=Object.defineProperty,Di=Object.getOwnPropertyDescriptor,H=(e,t,i,s)=>{for(var o=s>1?void 0:s?Di(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(s?a(t,i,o):a(o))||o);return s&&o&&Bi(t,i,o),o};let k=class extends w{render(){return h`
      <story-template
        elementTag="ia-snow"
