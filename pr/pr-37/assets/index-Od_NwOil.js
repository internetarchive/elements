(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))s(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const a of n.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function i(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(o){if(o.ep)return;o.ep=!0;const n=i(o);fetch(o.href,n)}})();const X=globalThis,wt=X.ShadowRoot&&(X.ShadyCSS===void 0||X.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,xt=Symbol(),Pt=new WeakMap;let Gt=class{constructor(t,i,s){if(this._$cssResult$=!0,s!==xt)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=i}get styleSheet(){let t=this.o;const i=this.t;if(wt&&t===void 0){const s=i!==void 0&&i.length===1;s&&(t=Pt.get(i)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),s&&Pt.set(i,t))}return t}toString(){return this.cssText}};const ne=e=>new Gt(typeof e=="string"?e:e+"",void 0,xt),T=(e,...t)=>{const i=e.length===1?e[0]:t.reduce(((s,o,n)=>s+(a=>{if(a._$cssResult$===!0)return a.cssText;if(typeof a=="number")return a;throw Error("Value passed to 'css' function must be a 'css' function result: "+a+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(o)+e[n+1]),e[0]);return new Gt(i,e,xt)},ae=(e,t)=>{if(wt)e.adoptedStyleSheets=t.map((i=>i instanceof CSSStyleSheet?i:i.styleSheet));else for(const i of t){const s=document.createElement("style"),o=X.litNonce;o!==void 0&&s.setAttribute("nonce",o),s.textContent=i.cssText,e.appendChild(s)}},It=wt?e=>e:e=>e instanceof CSSStyleSheet?(t=>{let i="";for(const s of t.cssRules)i+=s.cssText;return ne(i)})(e):e;const{is:re,defineProperty:le,getOwnPropertyDescriptor:he,getOwnPropertyNames:ce,getOwnPropertySymbols:pe,getPrototypeOf:de}=Object,rt=globalThis,kt=rt.trustedTypes,ue=kt?kt.emptyScript:"",ge=rt.reactiveElementPolyfillSupport,K=(e,t)=>e,tt={toAttribute(e,t){switch(t){case Boolean:e=e?ue:null;break;case Object:case Array:e=e==null?e:JSON.stringify(e)}return e},fromAttribute(e,t){let i=e;switch(t){case Boolean:i=e!==null;break;case Number:i=e===null?null:Number(e);break;case Object:case Array:try{i=JSON.parse(e)}catch{i=null}}return i}},_t=(e,t)=>!re(e,t),Lt={attribute:!0,type:String,converter:tt,reflect:!1,useDefault:!1,hasChanged:_t};Symbol.metadata??=Symbol("metadata"),rt.litPropertyMetadata??=new WeakMap;let R=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,i=Lt){if(i.state&&(i.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((i=Object.create(i)).wrapped=!0),this.elementProperties.set(t,i),!i.noAccessor){const s=Symbol(),o=this.getPropertyDescriptor(t,s,i);o!==void 0&&le(this.prototype,t,o)}}static getPropertyDescriptor(t,i,s){const{get:o,set:n}=he(this.prototype,t)??{get(){return this[i]},set(a){this[i]=a}};return{get:o,set(a){const r=o?.call(this);n?.call(this,a),this.requestUpdate(t,r,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??Lt}static _$Ei(){if(this.hasOwnProperty(K("elementProperties")))return;const t=de(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(K("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(K("properties"))){const i=this.properties,s=[...ce(i),...pe(i)];for(const o of s)this.createProperty(o,i[o])}const t=this[Symbol.metadata];if(t!==null){const i=litPropertyMetadata.get(t);if(i!==void 0)for(const[s,o]of i)this.elementProperties.set(s,o)}this._$Eh=new Map;for(const[i,s]of this.elementProperties){const o=this._$Eu(i,s);o!==void 0&&this._$Eh.set(o,i)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const i=[];if(Array.isArray(t)){const s=new Set(t.flat(1/0).reverse());for(const o of s)i.unshift(It(o))}else t!==void 0&&i.push(It(t));return i}static _$Eu(t,i){const s=i.attribute;return s===!1?void 0:typeof s=="string"?s:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise((t=>this.enableUpdating=t)),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach((t=>t(this)))}addController(t){(this._$EO??=new Set).add(t),this.renderRoot!==void 0&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){const t=new Map,i=this.constructor.elementProperties;for(const s of i.keys())this.hasOwnProperty(s)&&(t.set(s,this[s]),delete this[s]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return ae(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach((t=>t.hostConnected?.()))}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach((t=>t.hostDisconnected?.()))}attributeChangedCallback(t,i,s){this._$AK(t,s)}_$ET(t,i){const s=this.constructor.elementProperties.get(t),o=this.constructor._$Eu(t,s);if(o!==void 0&&s.reflect===!0){const n=(s.converter?.toAttribute!==void 0?s.converter:tt).toAttribute(i,s.type);this._$Em=t,n==null?this.removeAttribute(o):this.setAttribute(o,n),this._$Em=null}}_$AK(t,i){const s=this.constructor,o=s._$Eh.get(t);if(o!==void 0&&this._$Em!==o){const n=s.getPropertyOptions(o),a=typeof n.converter=="function"?{fromAttribute:n.converter}:n.converter?.fromAttribute!==void 0?n.converter:tt;this._$Em=o;const r=a.fromAttribute(i,n.type);this[o]=r??this._$Ej?.get(o)??r,this._$Em=null}}requestUpdate(t,i,s){if(t!==void 0){const o=this.constructor,n=this[t];if(s??=o.getPropertyOptions(t),!((s.hasChanged??_t)(n,i)||s.useDefault&&s.reflect&&n===this._$Ej?.get(t)&&!this.hasAttribute(o._$Eu(t,s))))return;this.C(t,i,s)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,i,{useDefault:s,reflect:o,wrapped:n},a){s&&!(this._$Ej??=new Map).has(t)&&(this._$Ej.set(t,a??i??this[t]),n!==!0||a!==void 0)||(this._$AL.has(t)||(this.hasUpdated||s||(i=void 0),this._$AL.set(t,i)),o===!0&&this._$Em!==t&&(this._$Eq??=new Set).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(i){Promise.reject(i)}const t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[o,n]of this._$Ep)this[o]=n;this._$Ep=void 0}const s=this.constructor.elementProperties;if(s.size>0)for(const[o,n]of s){const{wrapped:a}=n,r=this[o];a!==!0||this._$AL.has(o)||r===void 0||this.C(o,void 0,n,r)}}let t=!1;const i=this._$AL;try{t=this.shouldUpdate(i),t?(this.willUpdate(i),this._$EO?.forEach((s=>s.hostUpdate?.())),this.update(i)):this._$EM()}catch(s){throw t=!1,this._$EM(),s}t&&this._$AE(i)}willUpdate(t){}_$AE(t){this._$EO?.forEach((i=>i.hostUpdated?.())),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&=this._$Eq.forEach((i=>this._$ET(i,this[i]))),this._$EM()}updated(t){}firstUpdated(t){}};R.elementStyles=[],R.shadowRootOptions={mode:"open"},R[K("elementProperties")]=new Map,R[K("finalized")]=new Map,ge?.({ReactiveElement:R}),(rt.reactiveElementVersions??=[]).push("2.1.1");const St=globalThis,et=St.trustedTypes,jt=et?et.createPolicy("lit-html",{createHTML:e=>e}):void 0,Yt="$lit$",I=`lit$${Math.random().toFixed(9).slice(2)}$`,Zt="?"+I,fe=`<${Zt}>`,D=document,q=()=>D.createComment(""),W=e=>e===null||typeof e!="object"&&typeof e!="function",Ot=Array.isArray,me=e=>Ot(e)||typeof e?.[Symbol.iterator]=="function",dt=`[ 	
\f\r]`,z=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Bt=/-->/g,Dt=/>/g,L=RegExp(`>|${dt}(?:([^\\s"'>=/]+)(${dt}*=${dt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Mt=/'/g,Rt=/"/g,Jt=/^(?:script|style|textarea|title)$/i,be=e=>(t,...i)=>({_$litType$:e,strings:t,values:i}),h=be(1),C=Symbol.for("lit-noChange"),u=Symbol.for("lit-nothing"),Nt=new WeakMap,j=D.createTreeWalker(D,129);function Xt(e,t){if(!Ot(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return jt!==void 0?jt.createHTML(t):t}const ye=(e,t)=>{const i=e.length-1,s=[];let o,n=t===2?"<svg>":t===3?"<math>":"",a=z;for(let r=0;r<i;r++){const l=e[r];let y,d,c=-1,x=0;for(;x<l.length&&(a.lastIndex=x,d=a.exec(l),d!==null);)x=a.lastIndex,a===z?d[1]==="!--"?a=Bt:d[1]!==void 0?a=Dt:d[2]!==void 0?(Jt.test(d[2])&&(o=RegExp("</"+d[2],"g")),a=L):d[3]!==void 0&&(a=L):a===L?d[0]===">"?(a=o??z,c=-1):d[1]===void 0?c=-2:(c=a.lastIndex-d[2].length,y=d[1],a=d[3]===void 0?L:d[3]==='"'?Rt:Mt):a===Rt||a===Mt?a=L:a===Bt||a===Dt?a=z:(a=L,o=void 0);const _=a===L&&e[r+1].startsWith("/>")?" ":"";n+=a===z?l+fe:c>=0?(s.push(y),l.slice(0,c)+Yt+l.slice(c)+I+_):l+I+(c===-2?r:_)}return[Xt(e,n+(e[i]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),s]};class G{constructor({strings:t,_$litType$:i},s){let o;this.parts=[];let n=0,a=0;const r=t.length-1,l=this.parts,[y,d]=ye(t,i);if(this.el=G.createElement(y,s),j.currentNode=this.el.content,i===2||i===3){const c=this.el.content.firstChild;c.replaceWith(...c.childNodes)}for(;(o=j.nextNode())!==null&&l.length<r;){if(o.nodeType===1){if(o.hasAttributes())for(const c of o.getAttributeNames())if(c.endsWith(Yt)){const x=d[a++],_=o.getAttribute(c).split(I),E=/([.?@])?(.*)/.exec(x);l.push({type:1,index:n,name:E[2],strings:_,ctor:E[1]==="."?$e:E[1]==="?"?we:E[1]==="@"?xe:lt}),o.removeAttribute(c)}else c.startsWith(I)&&(l.push({type:6,index:n}),o.removeAttribute(c));if(Jt.test(o.tagName)){const c=o.textContent.split(I),x=c.length-1;if(x>0){o.textContent=et?et.emptyScript:"";for(let _=0;_<x;_++)o.append(c[_],q()),j.nextNode(),l.push({type:2,index:++n});o.append(c[x],q())}}}else if(o.nodeType===8)if(o.data===Zt)l.push({type:2,index:n});else{let c=-1;for(;(c=o.data.indexOf(I,c+1))!==-1;)l.push({type:7,index:n}),c+=I.length-1}n++}}static createElement(t,i){const s=D.createElement("template");return s.innerHTML=t,s}}function U(e,t,i=e,s){if(t===C)return t;let o=s!==void 0?i._$Co?.[s]:i._$Cl;const n=W(t)?void 0:t._$litDirective$;return o?.constructor!==n&&(o?._$AO?.(!1),n===void 0?o=void 0:(o=new n(e),o._$AT(e,i,s)),s!==void 0?(i._$Co??=[])[s]=o:i._$Cl=o),o!==void 0&&(t=U(e,o._$AS(e,t.values),o,s)),t}class ve{constructor(t,i){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=i}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:i},parts:s}=this._$AD,o=(t?.creationScope??D).importNode(i,!0);j.currentNode=o;let n=j.nextNode(),a=0,r=0,l=s[0];for(;l!==void 0;){if(a===l.index){let y;l.type===2?y=new Z(n,n.nextSibling,this,t):l.type===1?y=new l.ctor(n,l.name,l.strings,this,t):l.type===6&&(y=new _e(n,this,t)),this._$AV.push(y),l=s[++r]}a!==l?.index&&(n=j.nextNode(),a++)}return j.currentNode=D,o}p(t){let i=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(t,s,i),i+=s.strings.length-2):s._$AI(t[i])),i++}}class Z{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,i,s,o){this.type=2,this._$AH=u,this._$AN=void 0,this._$AA=t,this._$AB=i,this._$AM=s,this.options=o,this._$Cv=o?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const i=this._$AM;return i!==void 0&&t?.nodeType===11&&(t=i.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,i=this){t=U(this,t,i),W(t)?t===u||t==null||t===""?(this._$AH!==u&&this._$AR(),this._$AH=u):t!==this._$AH&&t!==C&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):me(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==u&&W(this._$AH)?this._$AA.nextSibling.data=t:this.T(D.createTextNode(t)),this._$AH=t}$(t){const{values:i,_$litType$:s}=t,o=typeof s=="number"?this._$AC(t):(s.el===void 0&&(s.el=G.createElement(Xt(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===o)this._$AH.p(i);else{const n=new ve(o,this),a=n.u(this.options);n.p(i),this.T(a),this._$AH=n}}_$AC(t){let i=Nt.get(t.strings);return i===void 0&&Nt.set(t.strings,i=new G(t)),i}k(t){Ot(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let s,o=0;for(const n of t)o===i.length?i.push(s=new Z(this.O(q()),this.O(q()),this,this.options)):s=i[o],s._$AI(n),o++;o<i.length&&(this._$AR(s&&s._$AB.nextSibling,o),i.length=o)}_$AR(t=this._$AA.nextSibling,i){for(this._$AP?.(!1,!0,i);t!==this._$AB;){const s=t.nextSibling;t.remove(),t=s}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}}class lt{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,i,s,o,n){this.type=1,this._$AH=u,this._$AN=void 0,this.element=t,this.name=i,this._$AM=o,this.options=n,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=u}_$AI(t,i=this,s,o){const n=this.strings;let a=!1;if(n===void 0)t=U(this,t,i,0),a=!W(t)||t!==this._$AH&&t!==C,a&&(this._$AH=t);else{const r=t;let l,y;for(t=n[0],l=0;l<n.length-1;l++)y=U(this,r[s+l],i,l),y===C&&(y=this._$AH[l]),a||=!W(y)||y!==this._$AH[l],y===u?t=u:t!==u&&(t+=(y??"")+n[l+1]),this._$AH[l]=y}a&&!o&&this.j(t)}j(t){t===u?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class $e extends lt{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===u?void 0:t}}class we extends lt{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==u)}}class xe extends lt{constructor(t,i,s,o,n){super(t,i,s,o,n),this.type=5}_$AI(t,i=this){if((t=U(this,t,i,0)??u)===C)return;const s=this._$AH,o=t===u&&s!==u||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,n=t!==u&&(s===u||o);o&&this.element.removeEventListener(this.name,this,s),n&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class _e{constructor(t,i,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=i,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){U(this,t)}}const Se=St.litHtmlPolyfillSupport;Se?.(G,Z),(St.litHtmlVersions??=[]).push("3.3.1");const Oe=(e,t,i)=>{const s=i?.renderBefore??t;let o=s._$litPart$;if(o===void 0){const n=i?.renderBefore??null;s._$litPart$=o=new Z(t.insertBefore(q(),n),n,void 0,i??{})}return o._$AI(e),o};const At=globalThis;let w=class extends R{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const i=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Oe(i,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return C}};w._$litElement$=!0,w.finalized=!0,At.litElementHydrateSupport?.({LitElement:w});const Ae=At.litElementPolyfillSupport;Ae?.({LitElement:w});(At.litElementVersions??=[]).push("4.2.1");const A=e=>(t,i)=>{i!==void 0?i.addInitializer((()=>{customElements.define(e,t)})):customElements.define(e,t)};const Ce={attribute:!0,type:String,converter:tt,reflect:!1,hasChanged:_t},Te=(e=Ce,t,i)=>{const{kind:s,metadata:o}=i;let n=globalThis.litPropertyMetadata.get(o);if(n===void 0&&globalThis.litPropertyMetadata.set(o,n=new Map),s==="setter"&&((e=Object.create(e)).wrapped=!0),n.set(i.name,e),s==="accessor"){const{name:a}=i;return{set(r){const l=t.get.call(this);t.set.call(this,r),this.requestUpdate(a,l,e)},init(r){return r!==void 0&&this.C(a,void 0,e,r),r}}}if(s==="setter"){const{name:a}=i;return function(r){const l=this[a];t.call(this,r),this.requestUpdate(a,l,e)}}throw Error("Unsupported decorator location: "+s)};function p(e){return(t,i)=>typeof i=="object"?Te(e,t,i):((s,o,n)=>{const a=o.hasOwnProperty(n);return o.constructor.createProperty(n,s),a?Object.getOwnPropertyDescriptor(o,n):void 0})(e,t,i)}function m(e){return p({...e,state:!0,attribute:!1})}const Qt=(e,t,i)=>(i.configurable=!0,i.enumerable=!0,Reflect.decorate&&typeof t!="object"&&Object.defineProperty(e,t,i),i);function $(e,t){return(i,s,o)=>{const n=a=>a.renderRoot?.querySelector(e)??null;return Qt(i,s,{get(){return n(this)}})}}let Ee;function te(e){return(t,i)=>Qt(t,i,{get(){return(this.renderRoot??(Ee??=document.createDocumentFragment())).querySelectorAll(e)}})}const V=T`
  :host {
    /*
    BASE STYLES
...
`;var Pe=Object.getOwnPropertyDescriptor,Ie=(e,t,i,s)=>{for(var o=s>1?void 0:s?Pe(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=a(o)||o);return o};let gt=class extends w{render(){return h`
      <button>
        <slot></slot>
      </button>
...
`;var Be=Object.defineProperty,De=Object.getOwnPropertyDescriptor,pt=(e,t,i,s)=>{for(var o=s>1?void 0:s?De(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(s?a(t,i,o):a(o))||o);return s&&o&&Be(t,i,o),o};let Y=class extends w{constructor(){super(...arguments),this.code="",this.language="auto",this.highlightedCode=""}willUpdate(e){(e.has("code")||e.has("language"))&&this.highlightCode()}render(){return h`
 ...
 `)}}))}static get styles(){return[V,T`
      ...
      `]}};Ct([p({type:Object})],ot.prototype,"styleInputData",2);Ct([te(".style-input")],ot.prototype,"styleInputs",2);ot=Ct([A("story-styles-settings")],ot);const ee=(e,t,i)=>{for(const s of t)if(s[0]===e)return(0,s[1])();return i?.()};var Ue=Object.defineProperty,Ve=Object.getOwnPropertyDescriptor,Tt=(e,t,i,s)=>{for(var o=s>1?void 0:s?Ve(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(s?a(t,i,o):a(o))||o);return s&&o&&Ue(t,i,o),o};let nt=class extends w{render(){return this.propInputData?h`
      <div class="settings-options">
        <table>
          ${this.propInputData.settings.map(e=>ee(e.inputType,[["radio",()=>this.createRadioPropInput(e)]],()=>this.createDefaultPropInput(e))??u)}
        </table>
...
`,appliedProps:t}}))}static get styles(){return[V,T`
      ...
      `]}};Tt([p({type:Object})],nt.prototype,"propInputData",2);Tt([te(".prop-input")],nt.prototype,"propInputs",2);nt=Tt([A("story-props-settings")],nt);var Fe=Object.defineProperty,He=Object.getOwnPropertyDescriptor,O=(e,t,i,s)=>{for(var o=s>1?void 0:s?He(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(s?a(t,i,o):a(o))||o);return s&&o&&Fe(t,i,o),o};let S=class extends w{constructor(){super(...arguments),this.elementTag="",this.elementClassName="",this.labs=!1,this.detailsVisible=!1,this.shouldHideSettingsSlot=!0,this.copiedKey=null}render(){return h`
      <div id="container">
        <h2>
        ...
        ${N(this.detailsVisible,()=>this.detailsTemplate)}
      </div>
    `}get detailsTemplate(){return h`
      <div id="details">
        ...
        <div class="two-col">
          <div class="left-col">
            <h3>Settings</h3>
            ${N(!!this.propInputData,()=>h`
                <story-props-settings
                  .propInputData=${this.propInputData}
                  @propsApplied=${this.handlePropsApplied}
                ></story-props-settings>
              `,()=>h`<p class="section-placeholder">No settings to adjust</p>`)}
            <div
...
${this.elementTag} {
 ${this.stringifiedStyles}
    ...
    `:""}get modulePath(){return this.labs?`@internetarchive/elements/labs/${this.elementTag}/${this.elementTag}`:`@internetarchive/elements/${this.elementTag}/${this.elementTag}`}handleSettingsSlotChange(e){const t=e.target.assignedElements();this.shouldHideSettingsSlot=t.length===0}handleDemoComponentSlotted(e){const t=e.target.assignedElements()[0];t&&(this.slottedDemoComponent=t)}handleStylesApplied(e){const t=e.detail.styles;t&&(this.stringifiedStyles=t)}handlePropsApplied(e){const t=e.detail.stringifiedProps,i=e.detail.appliedProps;!t||!i||(this.stringifiedProps=t,i.forEach(s=>{this.slottedDemoComponent[s.propName]=s.value}))}static get styles(){return[V,T`
      ...
      `]}};O([p({type:String})],S.prototype,"elementTag",2);O([p({type:String})],S.prototype,"elementClassName",2);O([p({type:String})],S.prototype,"customExampleUsage",2);O([p({type:String})],S.prototype,"defaultUsageProps",2);O([p({type:Object})],S.prototype,"styleInputData",2);O([p({type:Object})],S.prototype,"propInputData",2);O([p({type:Boolean})],S.prototype,"labs",2);O([m()],S.prototype,"detailsVisible",2);O([m()],S.prototype,"stringifiedStyles",2);O([m()],S.prototype,"stringifiedProps",2);O([m()],S.prototype,"shouldHideSettingsSlot",2);O([m()],S.prototype,"slottedDemoComponent",2);O([m()],S.prototype,"copiedKey",2);S=O([A("story-template")],S);var ze=Object.getOwnPropertyDescriptor,Ke=(e,t,i,s)=>{for(var o=s>1?void 0:s?ze(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=a(o)||o);return o};const qe=[{label:"Text Color (Primary)",cssVariable:"--ia-theme-primary-cta-text-color",defaultValue:"#ffffff",inputType:"color"},{label:"Background Color (Primary)",cssVariable:"--ia-theme-primary-cta-fill",defaultValue:"#194880",inputType:"color"}];let bt=class extends w{render(){return h`
      <story-template
    ...
    `;return[V,e]}};f.formAssociated=!0;f.shadowRootOptions={...w.shadowRootOptions,delegatesFocus:!0};v([p({type:Array})],f.prototype,"options",2);v([p({type:String})],f.prototype,"placeholder",2);v([p({type:String})],f.prototype,"behavior",2);v([p({type:Number,attribute:"max-autocomplete-entries"})],f.prototype,"maxAutocompleteEntries",2);v([p({type:String})],f.prototype,"filter",2);v([p({type:Boolean,reflect:!0,attribute:"case-sensitive"})],f.prototype,"caseSensitive",2);v([p({type:Boolean,reflect:!0})],f.prototype,"sort",2);v([p({type:Boolean,reflect:!0,attribute:"wrap-arrow-keys"})],f.prototype,"wrapArrowKeys",2);v([p({type:Boolean,reflect:!0,attribute:"stay-open"})],f.prototype,"stayOpen",2);v([p({type:Boolean,reflect:!0})],f.prototype,"clearable",2);v([p({type:Boolean,reflect:!0})],f.prototype,"open",2);v([p({type:Boolean,reflect:!0})],f.prototype,"disabled",2);v([p({type:Boolean,reflect:!0})],f.prototype,"required",2);v([p({type:String})],f.prototype,"value",2);v([m()],f.prototype,"hasFocus",2);v([m()],f.prototype,"highlightedOption",2);v([m()],f.prototype,"enteredText",2);v([m()],f.prototype,"filterText",2);v([$("#main-widget-row")],f.prototype,"mainWidgetRow",2);v([$("#text-input")],f.prototype,"textInput",2);v([$("#options-list")],f.prototype,"optionsList",2);f=v([A("ia-combo-box")],f);var fi=Object.defineProperty,mi=Object.getOwnPropertyDescriptor,b=(e,t,i,s)=>{for(var o=s>1?void 0:s?mi(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(s?a(t,i,o):a(o))||o);return s&&o&&fi(t,i,o),o};const bi=[{label:"Width",cssVariable:"--ia-theme-combo-box-width",defaultValue:"250px",inputType:"text"},{label:"Padding",cssVariable:"--ia-theme-padding-sm",defaultValue:"5px",inputType:"text"},{label:"Dropdown width",cssVariable:"--combo-box-list-width",defaultValue:"",inputType:"text"},{label:"Dropdown max height",cssVariable:"--combo-box-list-max-height",defaultValue:"250px",inputType:"text"}],se=[{id:"red",text:"Red"},{id:"orange",text:"Orange"},{id:"yellow",text:"Yellow"},{id:"green",text:"Green"},{id:"blue",text:"Blue"},{id:"indigo",text:"Indigo"},{id:"violet",text:"Violet"}],yi=se.map(e=>({...e,content:h` <span style="display: flex; align-items: center">
      <span style="flex: 1">${e.text}</span>
      <div style="width: 15px; height: 15px; background:${e.id}"></div>
    </span>`})),Ft=ie.map(e=>({id:e.name,text:e.name})),vi=ie.map(e=>({id:e.name,text:e.name,content:h`<span>${e.flag}</span>&nbsp;<span>${e.name}</span>`})),$i="list",wi="Choices",Ht="Select an option...",zt=50,xi="substring";let g=class extends w{constructor(){super(...arguments),this.options=Ft,this.behavior=$i,this.label=wi,this.placeholder=Ht,this.maxAutocompleteEntries=zt,this.filterFn=xi,this.caseSensitive=!1,this.shouldSort=!1,this.wrapArrowKeys=!0,this.clearable=!0,this.disabled=!1,this.announcerText=""}render(){return h`
      <story-template
        elementTag="ia-combo-box"
        elementClassName="IAComboBox"
        .customExampleUsage=${this.exampleUsage}
        .styleInputData=${{settings:bi}}
      >
        <div slot="demo">
          <ia-combo-box
...
`)}applySettings(e){e.preventDefault(),this.updateOptions(),this.behavior=this.behaviorSelect.value,this.label=this.labelInput.value,this.placeholder=this.placeholderInput.value,this.maxAutocompleteEntries=Number(this.maxAutocompleteInput.value),this.filterFn=this.filterFnSelect.value,this.caseSensitive=this.caseSensitiveCheck.checked,this.shouldSort=this.sortCheck.checked,this.wrapArrowKeys=this.wrapArrowKeysCheck.checked,this.clearable=this.clearableCheck.checked,this.disabled=this.disabledCheck.checked}updateOptions(){switch(this.optionSetSelect.value){case"colors":this.options=this.customContentCheck.checked?yi:se;break;case"countries":this.options=this.customContentCheck.checked?vi:Ft;break;default:this.options=[]}}handleComboBoxChange(e){this.announcerText=`New value is: ${e.detail}`}static get styles(){return T`
    ...
    `}};b([m()],g.prototype,"options",2);b([m()],g.prototype,"behavior",2);b([m()],g.prototype,"label",2);b([m()],g.prototype,"placeholder",2);b([m()],g.prototype,"maxAutocompleteEntries",2);b([m()],g.prototype,"filterFn",2);b([m()],g.prototype,"caseSensitive",2);b([m()],g.prototype,"shouldSort",2);b([m()],g.prototype,"wrapArrowKeys",2);b([m()],g.prototype,"clearable",2);b([m()],g.prototype,"disabled",2);b([m()],g.prototype,"announcerText",2);b([$("#settings__options")],g.prototype,"optionSetSelect",2);b([$("#settings__custom-content")],g.prototype,"customContentCheck",2);b([$("#settings__behavior")],g.prototype,"behaviorSelect",2);b([$("#settings__label")],g.prototype,"labelInput",2);b([$("#settings__placeholder")],g.prototype,"placeholderInput",2);b([$("#settings__max-entries")],g.prototype,"maxAutocompleteInput",2);b([$("#settings__filter-fn")],g.prototype,"filterFnSelect",2);b([$("#settings__case-sensitive")],g.prototype,"caseSensitiveCheck",2);b([$("#settings__sort")],g.prototype,"sortCheck",2);b([$("#settings__wrap")],g.prototype,"wrapArrowKeysCheck",2);b([$("#settings__clearable")],g.prototype,"clearableCheck",2);b([$("#settings__disabled")],g.prototype,"disabledCheck",2);g=b([A("ia-combo-box-story")],g);const _i=Object.freeze(Object.defineProperty({__proto__:null,get IAComboBoxStory(){return g}},Symbol.toStringTag,{value:"Module"}));var Si=Object.defineProperty,Oi=Object.getOwnPropertyDescriptor,F=(e,t,i,s)=>{for(var o=s>1?void 0:s?Oi(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(s?a(t,i,o):a(o))||o);return s&&o&&Si(t,i,o),o};let M=class extends w{constructor(){super(...arguments),this.loadingTitle=B("Loading..."),this.successTitle=B("Success"),this.errorTitle=B("Error"),this.loadingStyle="ring-dots",this.mode="loading"}render(){return h`${ee(this.mode,[["loading",()=>this.loadingIndicatorTemplate],["success",()=>this.successIndicatorTemplate],["error",()=>this.errorIndicatorTemplate]])}`}get loadingIndicatorTemplate(){return h`
      <svg
    ...
    `}get shouldShowLoadingDots(){return this.loadingStyle!=="ring"}static get styles(){return[V,T`
      ...
      `]}};F([p({type:String})],M.prototype,"loadingTitle",2);F([p({type:String})],M.prototype,"successTitle",2);F([p({type:String})],M.prototype,"errorTitle",2);F([p({type:String})],M.prototype,"loadingStyle",2);F([p({type:String})],M.prototype,"mode",2);M=F([A("ia-status-indicator")],M);var Ai=Object.getOwnPropertyDescriptor,Ci=(e,t,i,s)=>{for(var o=s>1?void 0:s?Ai(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=a(o)||o);return o};const Ti=[{label:"Width",cssVariable:"--ia-theme-icon-width",defaultValue:"1.25rem"},{label:"Color - loading",cssVariable:"--ia-theme-primary-text-color",defaultValue:"#2c2c2c",inputType:"color"},{label:"Color - success",cssVariable:"--ia-theme-color-success",defaultValue:"#31a481",inputType:"color"},{label:"Color - error",cssVariable:"--ia-theme-color-danger",defaultValue:"#e51c23",inputType:"color"}],Ei=[{label:"Mode",propertyName:"mode",defaultValue:"loading",inputType:"radio",radioOptions:["loading","success","error"]},{label:"Accessible title - loading",propertyName:"loadingTitle",defaultValue:"Loading..."},{label:"Loading style",propertyName:"loadingStyle",defaultValue:"ring-dots",inputType:"radio",radioOptions:["ring-dots","ring"]},{label:"Accessible title - success",propertyName:"successTitle",defaultValue:"Success"},{label:"Accessible title - error",propertyName:"errorTitle",defaultValue:"Error"}];let yt=class extends w{render(){return h`
      <story-template
    ...
    `}};Et([p({type:Object})],at.prototype,"snowConfig",2);Et([m()],at.prototype,"snowing",2);at=Et([A("ia-snow")],at);var Bi=Object.defineProperty,Di=Object.getOwnPropertyDescriptor,H=(e,t,i,s)=>{for(var o=s>1?void 0:s?Di(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(s?a(t,i,o):a(o))||o);return s&&o&&Bi(t,i,o),o};let k=class extends w{render(){return h`
      <story-template
        elementTag="ia-snow"
    ...
    `}firstUpdated(){const e=Vi.map(o=>o.id),t=Object.fromEntries(e.map(o=>[o,this.querySelector(`#ia-sidebar a[href="#${o}"]`)])),i=()=>e.map(o=>{const n=document.getElementById(o);return n?n.getBoundingClientRect().top+window.scrollY:null}),s=()=>{const o=i();let n=0;for(let a=0;a<o.length;a++)(o[a]??1/0)<=window.scrollY+40&&(n=a);e.forEach((a,r)=>{t[a]?.classList.toggle("active",r===n)})};e.forEach((o,n)=>{t[o]?.addEventListener("click",a=>{a.preventDefault();const r=i()[n];r!==null&&window.scrollTo({top:Math.max(0,r-16),behavior:"smooth"})})}),this._scrollHandler=s,window.addEventListener("scroll",s,{passive:!0}),s()}disconnectedCallback(){super.disconnectedCallback(),this._scrollHandler&&window.removeEventListener("scroll",this._scrollHandler)}};Wt=Ni([A("app-root")],Wt);
