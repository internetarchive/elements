...
`,appliedProps:t}}))}static get styles(){return[V,T`
      ...
      `]}};Tt([p({type:Object})],nt.prototype,"propInputData",2);Tt([te(".prop-input")],nt.prototype,"propInputs",2);nt=Tt([A("story-props-settings")],nt);var Fe=Object.defineProperty,He=Object.getOwnPropertyDescriptor,O=(e,t,i,s)=>{for(var o=s>1?void 0:s?He(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(s?a(t,i,o):a(o))||o);return s&&o&&Fe(t,i,o),o};let S=class extends w{constructor(){super(...arguments),this.elementTag="",this.elementClassName="",this.labs=!1,this.detailsVisible=!1,this.shouldShowPropertySettings=!1,this.copiedKey=null}render(){return h`
      <div id="container">
        <h2>
        ...
        ${j(this.detailsVisible,()=>this.detailsTemplate)}
      </div>
    `}get detailsTemplate(){return h`
      <div id="details">
        ...
        <div class="two-col">
          <div class="left-col">
            <h3>Settings</h3>
            ${j(!!this.propInputData,()=>h`
                <story-props-settings
                  .propInputData=${this.propInputData}
                  @propsApplied=${this.handlePropsApplied}
                ></story-props-settings>
              `)}
            ${j(!this.propInputData&&!this.shouldShowPropertySettings,()=>h`<p class="section-placeholder">No settings to adjust</p>`)}
            <div
 ...
 ${this.stringifiedStyles}
    ...
    `}get optionsListTemplate(){return h`
      ...
      >
        ...
        ${j(this.open,()=>this.optionTemplates)}
