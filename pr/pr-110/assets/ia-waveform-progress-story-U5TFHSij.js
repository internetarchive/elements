import{i as m,b as d,a as h,r as p,c as u}from"./index-CViPyoQM.js";import"./ia-waveform-progress-D_L1ed5N.js";import"./story-template-8YvJzhbu.js";import"./query-Cn3OgXYR.js";var g=Object.defineProperty,v=Object.getOwnPropertyDescriptor,l=(e,o,a,r)=>{for(var t=r>1?void 0:r?v(o,a):o,n=e.length-1,s;n>=0;n--)(s=e[n])&&(t=(r?s(o,a,t):s(t))||t);return r&&t&&g(o,a,t),t};function f(e=200){const o=Array.from({length:e},(r,t)=>{const n=Math.sin(t/3)*.3+Math.sin(t/11)*.4+Math.sin(t/29)*.3,s=Math.max(.06,Math.abs(n))*100,c=(100-s)/2;return`<rect x="${t*2}" y="${c.toFixed(2)}" width="1" height="${s.toFixed(2)}" />`}).join(""),a=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${e*2} 100" preserveAspectRatio="none"><g fill="#151515">${o}</g></svg>`;return`data:image/svg+xml,${encodeURIComponent(a)}`}const w=f(),b=[{startPercent:12,endPercent:18},{startPercent:44,endPercent:47},{startPercent:71,endPercent:79}],y=[{label:"Progress fill colour",cssVariable:"--ia-theme-waveform-fill-color",defaultValue:"#3272b6",inputType:"color"},{label:"Zone of silence colour",cssVariable:"--ia-theme-waveform-zone-of-silence-color",defaultValue:"#f6e652",inputType:"color"},{label:"Side margin",cssVariable:"--ia-theme-waveform-side-margin",defaultValue:10,inputType:"range",min:0,max:40,step:1,unit:"px"}],$=[{label:"Interactive",propertyName:"interactive",defaultValue:!0,inputType:"radio",radioOptions:[!0,!1]}];let i=class extends m{constructor(){super(...arguments),this.percentComplete=35,this.showZones=!0}render(){return d`
      <story-template
    ...
    `}};l([p()],i.prototype,"percentComplete",2);l([p()],i.prototype,"lastEmitted",2);l([p()],i.prototype,"showZones",2);i=l([u("ia-waveform-progress-story")],i);export{i as IAWaveformProgressStory};
