...
`,gs="data:image/svg+xml,%3csvg%20viewBox='0%200%2040%2040'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20fill='%23000'%20fill-rule='evenodd'%20d='m10.5%2017.5c1.3807119%200%202.5%201.1192881%202.5%202.5s-1.1192881%202.5-2.5%202.5c-1.38071187%200-2.5-1.1192881-2.5-2.5s1.11928813-2.5%202.5-2.5zm9.5%200c1.3807119%200%202.5%201.1192881%202.5%202.5s-1.1192881%202.5-2.5%202.5-2.5-1.1192881-2.5-2.5%201.1192881-2.5%202.5-2.5zm9.5%200c1.3807119%200%202.5%201.1192881%202.5%202.5s-1.1192881%202.5-2.5%202.5-2.5-1.1192881-2.5-2.5%201.1192881-2.5%202.5-2.5z'%20/%3e%3c/svg%3e",ms="data:image/svg+xml,%3csvg%20viewBox='0%200%2018%2018'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20fill='%23000'%20fill-rule='evenodd'%20d='m9%200c4.9705627%200%209%204.02943725%209%209%200%204.9705627-4.0294373%209-9%209-4.97056275%200-9-4.0294373-9-9%200-4.97056275%204.02943725-9%209-9zm1.6976167%205.28352881c-.365258-.3556459-.9328083-.37581056-1.32099801-.06558269l-.09308988.0844372-3%203.08108108-.08194436.09533317c-.27484337.36339327-.26799482.87009349.01656959%201.22592581l.084491.09308363%203%202.91891889.09533796.0818904c.3633964.2746544.8699472.2677153%201.2256839-.0167901l.093059-.0844712.0818904-.095338c.2746544-.3633964.2677153-.8699472-.0167901-1.2256839l-.0844712-.093059-2.283355-2.2222741%202.3024712-2.36338332.0819252-.09530804c.2997677-.39632298.2644782-.96313393-.1007797-1.31877983z'%20/%3e%3c/svg%3e",fs=F(gs),Ko=F(ms);var vs=Object.defineProperty,bs=Object.getOwnPropertyDescriptor,ve=(i,e,t,o)=>{for(var r=o>1?void 0:o?bs(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(r=(o?n(e,t,r):n(r))||r);return o&&r&&vs(e,t,r),r};let te=class extends x{constructor(){super(...arguments),this.icon="",this.href="",this.label="",this.menuDetails="",this.buttonId="",this.selected=!1,this.followable=!1}onClick(i){i.preventDefault(),this.dispatchMenuTypeSelectedEvent()}dispatchMenuTypeSelectedEvent(){this.dispatchEvent(new CustomEvent("menuTypeSelected",{bubbles:!0,composed:!0,detail:{id:this.buttonId}}))}get iconClass(){return this.selected?"active":""}get menuItem(){return d`
    ...
    `}openShortcut(i=""){this.openMenu=i,this.menuOpened=!0,this.moveFocusForDrawer()}get shortcuts(){const i=this.menuShortcuts.map(({icon:e,id:t,label:o})=>t==="fullscreen"?d`${e}`:d`
        <li>
          <button
            class="shortcut ${t}"
      ...
      ${i}
    </ul>`}get menuClass(){const i=this.menuContents?.length||this.menuShortcuts?.length,e=this.menuOpened&&i?"open":"",t=this.viewportInFullscreen?"fullscreen":"",o=this.shouldRenderMenu?"has-menu":"";return`${e} ${t} ${o} ${this.openMenuState}`}static get styles(){const i=_`var(--item-navigator-menu-width--)`,e=_`var(--item-navigator-animation-timing--)`,t=_`transform ${e} ease-out`,o=_`var(--item-navigator-menu-margin--)`,r=_`var(--item-navigator-theater-bg-color--)`,a=_`var(--item-navigator-icon-size--)`;return[V,_`
        :host {
          --item-navigator-menu-width--: var(
            --item-navigator-menu-width,
            320px
