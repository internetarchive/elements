import{n as l,t as g,i as T,b as u,r as m,A as R,a as C}from"./index-E5e4ypGT.js";import{m as I}from"./runtime-CCgtQBty.js";import{e as A}from"./query-UnbFREKW.js";import{o as k}from"./story-template-B_F4MHWx.js";class O{constructor(e,i,s,r,o,n){this.id=e,this.start=i,this.end=s,this.rawText=r,this.isMusic=o,this.searchMatchIndex=n}get displayText(){return this.isMusic?I("[Transcript unavailable]"):this.rawText}}class M{constructor(e){this.entries=[],this.entries=e}get searchResults(){return this.entries.filter(e=>e.searchMatchIndex!==void 0)}}function $(t){if(typeof t!="number"||!Number.isFinite(t))return"";const e=Math.max(0,Math.floor(t)),i=Math.floor(e/3600),s=Math.floor(e/60)%60,r=e%60,o=String(r).padStart(2,"0");if(i===0)return`${s}:${o}`;const n=String(s).padStart(2,"0");return`${i}:${n}:${o}`}var P=Object.defineProperty,_=Object.getOwnPropertyDescriptor,f=(t,e,i,s)=>{for(var r=s>1?void 0:s?_(e,i):e,o=t.length-1,n;o>=0;o--)(n=t[o])&&(r=(s?n(e,i,r):n(r))||r);return s&&r&&P(e,i,r),r};let p=class extends T{constructor(){super(...arguments),this.isActive=!1,this.isSelected=!1,this.isClickable=!1,this.isSearchResult=!1,this.isMusicEntry=!1}render(){return u`${this.entry?.displayText??""}`}};f([l({type:Object})],p.prototype,"entry",2);f([l({type:Boolean,reflect:!0})],p.prototype,"isActive",2);f([l({type:Boolean,reflect:!0})],p.prototype,"isSelected",2);f([l({type:Boolean,reflect:!0})],p.prototype,"isClickable",2);f([l({type:Boolean,reflect:!0})],p.prototype,"isSearchResult",2);f([l({type:Boolean,reflect:!0})],p.prototype,"isMusicEntry",2);p=f([g("ia-transcript-entry")],p);var D=Object.defineProperty,V=Object.getOwnPropertyDescriptor,c=(t,e,i,s)=>{for(var r=s>1?void 0:s?V(e,i):e,o=t.length-1,n;o>=0;o--)(n=t[o])&&(r=(s?n(e,i,r):n(r))||r);return s&&r&&D(e,i,r),r};const b={TranscriptEntrySelected:"transcriptEntrySelected",CurrentEntriesUpdated:"currentEntriesUpdated",AutoScrollChanged:"autoScrollChanged"},B=1;let a=class extends T{constructor(){super(...arguments),this.currentTime=0,this.topContextHeight=50,this.bottomContextHeight=50,this.autoScroll=!0,this.selectedSearchResultIndex=0,this.showContextZones=!1,this.scrollTimerDelay=15e3,this.timeScrollTop=0,this.currentEntries=[]}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this.scrollResumeTimerId),this.cancelScrollAnimation()}render(){return u`
      <div class="container">
    ...
    `}get timeDisplayTemplate(){return u`
      <div class="time-display" style="top: ${this.timeScrollTop}px">
        ${$(this.currentTime)}
      </div>
    `}transcriptEntryTemplate(t){const e=this.currentEntries.some(i=>i.id===t.id);return u`
      <ia-transcript-entry
        .entry=${t}
        ?isActive=${e}
      ...
      ></ia-transcript-entry>
    `}get contextZoneTemplates(){return u`
      <div
    ...
    `}};c([l({type:Object})],a.prototype,"config",2);c([l({type:Number})],a.prototype,"currentTime",2);c([l({type:Number})],a.prototype,"topContextHeight",2);c([l({type:Number})],a.prototype,"bottomContextHeight",2);c([l({type:Boolean})],a.prototype,"autoScroll",2);c([l({type:Number})],a.prototype,"selectedSearchResultIndex",2);c([l({type:Boolean})],a.prototype,"showContextZones",2);c([l({type:Number})],a.prototype,"scrollTimerDelay",2);c([m()],a.prototype,"timeScrollTop",2);c([m()],a.prototype,"currentEntries",2);c([A("#scroll-container")],a.prototype,"scrollView",2);a=c([g("ia-transcript-view")],a);var N=Object.defineProperty,z=Object.getOwnPropertyDescriptor,y=(t,e,i,s)=>{for(var r=s>1?void 0:s?z(e,i):e,o=t.length-1,n;o>=0;o--)(n=t[o])&&(r=(s?n(e,i,r):n(r))||r);return s&&r&&N(e,i,r),r};const E=[["Good evening, and welcome to the programme.",!1],["Tonight we are looking back at the early days of radio.",!1],["",!0],["Our first broadcast went out in nineteen twenty two.",!1],["It reached perhaps a few hundred listeners.",!1],["The transmitter sat in a shed behind the post office.",!1],["",!0],["By the end of the decade the audience was in the millions.",!1],["Whole families would gather around a single set.",!1],["The evening schedule became a fixed point in the week.",!1],["Announcers wore evening dress, though nobody could see them.",!1],["",!0],["We will hear from some of those early broadcasters after the break.",!1],["Stay with us.",!1],["And now, the news.",!1]],v=6;function w(t){let e=0;const i=E.map(([s,r],o)=>{const n=t!==""&&!r&&s.toLowerCase().includes(t.toLowerCase());let h;return n&&(h=e,e+=1),new O(o,o*v,o*v+v-1,s,r,h)});return new M(i)}const S=E.length*v,H=[{label:"Height",cssVariable:"--ia-theme-transcript-height",defaultValue:200,inputType:"range",min:80,max:400,step:10,unit:"px"},{label:"Text colour",cssVariable:"--ia-theme-transcript-normal-text-color",defaultValue:"#808080",inputType:"color"},{label:"Active text colour",cssVariable:"--ia-theme-transcript-active-text-color",defaultValue:"#ffffff",inputType:"color"},{label:"Selected result border",cssVariable:"--ia-theme-transcript-search-result-active-border-color",defaultValue:"#008000",inputType:"color"},{label:"Timestamp colour",cssVariable:"--ia-theme-transcript-time-color",defaultValue:"#ffffff",inputType:"color"}],j=[{label:"Show context zones",propertyName:"showContextZones",defaultValue:!1,inputType:"radio",radioOptions:[!0,!1]},{label:"Autoscroll",propertyName:"autoScroll",defaultValue:!0,inputType:"radio",radioOptions:[!0,!1]}];let d=class extends T{constructor(){super(...arguments),this.currentTime=0,this.searchTerm="",this.transcript=w(""),this.selectedSearchResultIndex=0,this.playing=!1}disconnectedCallback(){super.disconnectedCallback(),this.stopPlayback()}get resultCount(){return this.transcript.searchResults.length}render(){return u`
      ...
      >
        ...
        <div slot="demo" class="panel">
          ...
          ${this.searchTerm===""?u`<p class="hint">
