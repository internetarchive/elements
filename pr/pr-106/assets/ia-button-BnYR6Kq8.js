import{n as a,c as u,i as b,b as i,D as p,a as v}from"./index-BfLQ2-Wr.js";import{m}from"./runtime-CCgtQBty.js";import{t as g}from"./story-template-BXImRNk-.js";import"./ia-status-indicator-CxgfxRPT.js";import"./masked-icon-DmSajMtk.js";var h=Object.defineProperty,f=Object.getOwnPropertyDescriptor,r=(t,n,l,c)=>{for(var e=c>1?void 0:c?f(n,l):n,d=t.length-1,s;d>=0;d--)(s=t[d])&&(e=(c?s(n,l,e):s(e))||e);return c&&e&&h(n,l,e),e};let o=class extends b{constructor(){super(...arguments),this.mode="primary",this.loading=!1,this.disabled=!1,this.loadingText="",this.type="button",this.openLinksNewTab=!1}render(){return i`
      ${this.href?i`<a
            href=${this.href}
