...
`;class gn extends x{static get styles(){return B`
      :host {
    ...
    `}render(){return un}}customElements.define("ia-icon-close",gn);let H=class extends gt{constructor(){super(...arguments),this.value="",this.clearButtonScreenReaderLabel="Clear",this.focusOnClear=!0,this.forceClearButton=!1}render(){var t,e,o,s;const n=!this.value&&!this.forceClearButton;return Qs`
      <div id="container">
        <slot name="icon"></slot>
...
fill=""></path>
      ...
      <span ?hidden=${!this.open} class="caret-up">
        <slot name="caret-up">${In}</slot>
      </span>
    `}get caretDownTemplate(){return k`
      <span ?hidden=${this.open} class="caret-down">
        <slot name="caret-down">${Bn}</slot>
      </span>
  ...
  `;De=b([_o("ia-icon-label")],De);var Rn=Object.defineProperty,Dn=Object.getOwnPropertyDescriptor,xt=(i,t,e,o)=>{for(var s=o>1?void 0:o?Dn(t,e):t,n=i.length-1,r;n>=0;n--)(r=i[n])&&(s=(o?r(t,e,s):r(s))||s);return o&&s&&Rn(t,e,s),s};let rt=class extends x{constructor(){super(...arguments),this.loadingTitle=N("Loading..."),this.successTitle=N("Success"),this.errorTitle=N("Error"),this.loadingStyle="ring-dots",this.mode="loading"}render(){return p`${io(this.mode,[["loading",()=>this.loadingIndicatorTemplate],["success",()=>this.successIndicatorTemplate],["error",()=>this.errorIndicatorTemplate]])}`}get loadingIndicatorTemplate(){return p`
      <svg
    ...
    `}get shouldShowLoadingDots(){return this.loadingStyle!=="ring"}static get styles(){return[Y,B`
      ...
      `]}};xt([g({type:String})],rt.prototype,"loadingTitle",2);xt([g({type:String})],rt.prototype,"successTitle",2);xt([g({type:String})],rt.prototype,"errorTitle",2);xt([g({type:String})],rt.prototype,"loadingStyle",2);xt([g({type:String})],rt.prototype,"mode",2);rt=xt([O("ia-status-indicator")],rt);var Ln=Object.defineProperty,Un=Object.getOwnPropertyDescriptor,z=(i,t,e,o)=>{for(var s=o>1?void 0:o?Un(t,e):t,n=i.length-1,r;n>=0;n--)(r=i[n])&&(s=(o?r(t,e,s):r(s))||s);return o&&s&&Ln(t,e,s),s};const we={AdvancedSearchClicked:"advancedSearchClicked",CategoryChanged:"categoryChanged",SearchRequested:"searchRequested"};let I=class extends x{constructor(){super(...arguments),this.categories=[],this.selectedCategory="all",this.advancedSearchStyle="link",this.placeholder=N("Search"),this.useMobileView=!1,this.hideDropdown=!1,this.loading=!1}render(){return p`
    ...
    `}get searchButtonTemplate(){return p`
      ...
      >
        ${this.loading?p`<ia-status-indicator
            ...
            ></ia-status-indicator>`:p`<img src=${Fs} alt="" />`}
      </button>
