...
`:""}${e}${t}>${i??""}</${this.elementTag}>`}get cssCode(){return this.stringifiedStyles?`${this.elementTag} {
 ${this.stringifiedStyles}
    ...
    `;return[z,e]}};x.formAssociated=!0;x.shadowRootOptions={...v.shadowRootOptions,delegatesFocus:!0};C([h({type:Array})],x.prototype,"options",2);C([h({type:String})],x.prototype,"placeholder",2);C([h({type:String})],x.prototype,"behavior",2);C([h({type:Number,attribute:"max-autocomplete-entries"})],x.prototype,"maxAutocompleteEntries",2);C([h({type:String})],x.prototype,"filter",2);C([h({type:Boolean,reflect:!0,attribute:"case-sensitive"})],x.prototype,"caseSensitive",2);C([h({type:Boolean,reflect:!0})],x.prototype,"sort",2);C([h({type:Boolean,reflect:!0,attribute:"wrap-arrow-keys"})],x.prototype,"wrapArrowKeys",2);C([h({type:Boolean,reflect:!0,attribute:"stay-open"})],x.prototype,"stayOpen",2);C([h({type:Boolean,reflect:!0})],x.prototype,"clearable",2);C([h({type:Boolean,reflect:!0})],x.prototype,"open",2);C([h({type:Boolean,reflect:!0})],x.prototype,"disabled",2);C([h({type:Boolean,reflect:!0})],x.prototype,"required",2);C([h({type:String})],x.prototype,"value",2);C([f()],x.prototype,"hasFocus",2);C([f()],x.prototype,"highlightedOption",2);C([f()],x.prototype,"enteredText",2);C([f()],x.prototype,"filterText",2);C([$("#main-widget-row")],x.prototype,"mainWidgetRow",2);C([$("#text-input")],x.prototype,"textInput",2);C([$("#options-list")],x.prototype,"optionsList",2);x=C([O("ia-combo-box")],x);var Gi=Object.defineProperty,Zi=Object.getOwnPropertyDescriptor,_=(e,t,o,i)=>{for(var r=i>1?void 0:i?Zi(t,o):t,n=e.length-1,s;n>=0;n--)(s=e[n])&&(r=(i?s(t,o,r):s(r))||r);return i&&r&&Gi(t,o,r),r};const Yi=[{label:"Width",cssVariable:"--ia-theme-combo-box-width",defaultValue:"250px",inputType:"text"},{label:"Padding",cssVariable:"--ia-theme-padding-sm",defaultValue:"5px",inputType:"text"},{label:"Dropdown width",cssVariable:"--combo-box-list-width",defaultValue:"",inputType:"text"},{label:"Dropdown max height",cssVariable:"--combo-box-list-max-height",defaultValue:"250px",inputType:"text"},{label:"Dropdown fade duration",cssVariable:"--combo-box-list-fade-duration",defaultValue:125,inputType:"range",min:0,max:1e3,step:25,unit:"ms"}],So=[{id:"red",text:"Red"},{id:"orange",text:"Orange"},{id:"yellow",text:"Yellow"},{id:"green",text:"Green"},{id:"blue",text:"Blue"},{id:"indigo",text:"Indigo"},{id:"violet",text:"Violet"}],Ji=So.map(e=>({...e,content:d` <span style="display: flex; align-items: center">
      <span style="flex: 1">${e.text}</span>
      <div style="width: 15px; height: 15px; background:${e.id}"></div>
    </span>`})),He=_o.map(e=>({id:e.name,text:e.name})),Qi=_o.map(e=>({id:e.name,text:e.name,content:d`<span>${e.flag}</span>&nbsp;<span>${e.name}</span>`})),Xi="list",tr="Choices",Fe="Select an option...",qe=50,er="substring";let w=class extends v{constructor(){super(...arguments),this.options=He,this.behavior=Xi,this.label=tr,this.placeholder=Fe,this.maxAutocompleteEntries=qe,this.filterFn=er,this.caseSensitive=!1,this.shouldSort=!1,this.wrapArrowKeys=!0,this.clearable=!0,this.disabled=!1,this.announcerText=""}render(){return d`
      <story-template
