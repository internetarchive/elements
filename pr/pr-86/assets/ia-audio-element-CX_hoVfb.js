import{n as s,t as p,i as c,b as d}from"./index-BZFgLDMq.js";import{e as m}from"./query-BeeLIgst.js";var E=Object.defineProperty,y=Object.getOwnPropertyDescriptor,n=(e,t,l,o)=>{for(var a=o>1?void 0:o?y(t,l):t,u=e.length-1,h;u>=0;u--)(h=e[u])&&(a=(o?h(t,l,a):h(a))||a);return o&&a&&E(t,l,a),a};const i={TimeUpdate:"timeupdate",DurationChange:"durationchange",PlaybackStarted:"playbackStarted",PlaybackPaused:"playbackPaused",CanPlay:"canplay",Error:"error"};let r=class extends c{constructor(){super(...arguments),this.showControls=!1,this.playbackRate=1,this.volume=1,this.sources=[]}get duration(){return this.audioElement?.duration??0}get currentTime(){return this.audioElement?.currentTime??0}load(){this.audioElement&&(this.audioElement.load(),this.audioElement.playbackRate=this.playbackRate)}play(){this.audioElement?.play().catch(()=>{})}pause(){this.audioElement?.pause()}seekTo(e){this.audioElement&&(this.audioElement.currentTime=e)}seekBy(e){this.audioElement&&(this.audioElement.currentTime+=e)}render(){return d`
      <audio
