import{m as y}from"./runtime-CCgtQBty.js";import{n as a,t as f,i as b,b as p,r as T,A as g,a as x}from"./index-ClubkL1a.js";import{e as S}from"./query--hg7kYHG.js";import{o as w}from"./story-template-ZgmneDDF.js";class D{constructor(e,i,o,r,s,n){this.id=e,this.start=i,this.end=o,this.rawText=r,this.isMusic=s,this.searchMatchIndex=n}get displayText(){return this.isMusic?y("[Transcript unavailable]"):this.rawText}}class H{constructor(e){this.entries=[],this.entries=e}get searchResults(){return this.entries.filter(e=>e.searchMatchIndex!==void 0)}}function E(t){if(typeof t!="number"||!Number.isFinite(t))return"";const e=Math.max(0,Math.floor(t)),i=Math.floor(e/3600),o=Math.floor(e/60)%60,r=e%60,s=String(r).padStart(2,"0");if(i===0)return`${o}:${s}`;const n=String(o).padStart(2,"0");return`${i}:${n}:${s}`}var C=Object.defineProperty,I=Object.getOwnPropertyDescriptor,d=(t,e,i,o)=>{for(var r=o>1?void 0:o?I(e,i):e,s=t.length-1,n;s>=0;s--)(n=t[s])&&(r=(o?n(e,i,r):n(r))||r);return o&&r&&C(e,i,r),r};let u=class extends b{constructor(){super(...arguments),this.isActive=!1,this.isSelected=!1,this.isSearchResult=!1,this.isMusicEntry=!1}render(){return p`${this.entry?.displayText??""}`}};d([a({type:Object})],u.prototype,"entry",2);d([a({type:Boolean,reflect:!0})],u.prototype,"isActive",2);d([a({type:Boolean,reflect:!0})],u.prototype,"isSelected",2);d([a({type:Boolean,reflect:!0})],u.prototype,"isSearchResult",2);d([a({type:Boolean,reflect:!0})],u.prototype,"isMusicEntry",2);u=d([f("ia-transcript-entry")],u);var $=Object.defineProperty,R=Object.getOwnPropertyDescriptor,l=(t,e,i,o)=>{for(var r=o>1?void 0:o?R(e,i):e,s=t.length-1,n;s>=0;s--)(n=t[s])&&(r=(o?n(e,i,r):n(r))||r);return o&&r&&$(e,i,r),r};const m={TranscriptEntrySelected:"transcriptEntrySelected",CurrentEntriesUpdated:"currentEntriesUpdated",AutoScrollChanged:"autoScrollChanged"},A=1;let c=class extends b{constructor(){super(...arguments),this.currentTime=0,this.topContextHeight=50,this.bottomContextHeight=50,this.autoScroll=!0,this.selectedSearchResultIndex=0,this.showContextZones=!1,this.scrollTimerDelay=15e3,this.timeScrollTop=0,this.currentEntries=[]}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this.scrollResumeTimerId),this.cancelScrollAnimation()}render(){return p`
      <div class="container">
