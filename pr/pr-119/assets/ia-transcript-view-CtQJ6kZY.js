import{m as y}from"./runtime-CCgtQBty.js";import{n as a,c as f,i as b,b as d,r as T,A as g,a as x}from"./index-BTEdtX3V.js";import{e as S}from"./query-DnWYvIlM.js";import{o as E}from"./story-template-pIzzzXNc.js";class D{constructor(e,i,o,r,s,n){this.id=e,this.start=i,this.end=o,this.rawText=r,this.isMusic=s,this.searchMatchIndex=n}get displayText(){return this.isMusic?y("[Transcript unavailable]"):this.rawText}}class k{constructor(e){this.entries=[],this.entries=e}get searchResults(){return this.entries.filter(e=>e.searchMatchIndex!==void 0)}}function w(t){if(typeof t!="number"||!Number.isFinite(t))return"";const e=Math.max(0,Math.floor(t)),i=Math.floor(e/3600),o=Math.floor(e/60)%60,r=e%60,s=String(r).padStart(2,"0");if(i===0)return`${o}:${s}`;const n=String(o).padStart(2,"0");return`${i}:${n}:${s}`}var C=Object.defineProperty,I=Object.getOwnPropertyDescriptor,p=(t,e,i,o)=>{for(var r=o>1?void 0:o?I(e,i):e,s=t.length-1,n;s>=0;s--)(n=t[s])&&(r=(o?n(e,i,r):n(r))||r);return o&&r&&C(e,i,r),r};let h=class extends b{constructor(){super(...arguments),this.isActive=!1,this.isSelected=!1,this.isClickable=!1,this.isSearchResult=!1,this.isMusicEntry=!1}render(){return d`${this.entry?.displayText??""}`}};p([a({type:Object})],h.prototype,"entry",2);p([a({type:Boolean,reflect:!0})],h.prototype,"isActive",2);p([a({type:Boolean,reflect:!0})],h.prototype,"isSelected",2);p([a({type:Boolean,reflect:!0})],h.prototype,"isClickable",2);p([a({type:Boolean,reflect:!0})],h.prototype,"isSearchResult",2);p([a({type:Boolean,reflect:!0})],h.prototype,"isMusicEntry",2);h=p([f("ia-transcript-entry")],h);var $=Object.defineProperty,R=Object.getOwnPropertyDescriptor,l=(t,e,i,o)=>{for(var r=o>1?void 0:o?R(e,i):e,s=t.length-1,n;s>=0;s--)(n=t[s])&&(r=(o?n(e,i,r):n(r))||r);return o&&r&&$(e,i,r),r};const m={TranscriptEntrySelected:"transcriptEntrySelected",CurrentEntriesUpdated:"currentEntriesUpdated",AutoScrollChanged:"autoScrollChanged"},A=1;let c=class extends b{constructor(){super(...arguments),this.currentTime=0,this.topContextHeight=50,this.bottomContextHeight=50,this.autoScroll=!0,this.selectedSearchResultIndex=0,this.showContextZones=!1,this.scrollTimerDelay=15e3,this.timeScrollTop=0,this.currentEntries=[]}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this.scrollResumeTimerId),this.cancelScrollAnimation()}render(){return d`
      <div class="container">
        ${this.showContextZones?this.contextZoneTemplates:g}
    ...
    `}transcriptEntryTemplate(t){const e=this.currentEntries.some(i=>i.id===t.id);return d`
      <ia-transcript-entry
        ...
        isClickable
        data-search-result-index=${E(t.searchMatchIndex)}
