...
`;var Pe=Object.getOwnPropertyDescriptor,Ie=(e,t,i,s)=>{for(var o=s>1?void 0:s?Pe(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=a(o)||o);return o};let gt=class extends x{render(){return h`
      <button>
        <slot></slot>
      </button>
...
`;var Be=Object.defineProperty,De=Object.getOwnPropertyDescriptor,pt=(e,t,i,s)=>{for(var o=s>1?void 0:s?De(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(s?a(t,i,o):a(o))||o);return s&&o&&Be(t,i,o),o};let Y=class extends x{constructor(){super(...arguments),this.code="",this.language="auto",this.highlightedCode=""}willUpdate(e){(e.has("code")||e.has("language"))&&this.highlightCode()}render(){return h`
 ...
 `)}}))}static get styles(){return[V,T`
      ...
      `]}};Ct([p({type:Object})],ot.prototype,"styleInputData",2);Ct([te(".style-input")],ot.prototype,"styleInputs",2);ot=Ct([A("story-styles-settings")],ot);const ee=(e,t,i)=>{for(const s of t)if(s[0]===e)return(0,s[1])();return i?.()};var Ue=Object.defineProperty,Ve=Object.getOwnPropertyDescriptor,Tt=(e,t,i,s)=>{for(var o=s>1?void 0:s?Ve(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(s?a(t,i,o):a(o))||o);return s&&o&&Ue(t,i,o),o};let nt=class extends x{render(){return this.propInputData?h`
      <div class="settings-options">
        <table>
...
`,appliedProps:t}}))}static get styles(){return[V,T`
      ...
      `]}};Tt([p({type:Object})],nt.prototype,"propInputData",2);Tt([te(".prop-input")],nt.prototype,"propInputs",2);nt=Tt([A("story-props-settings")],nt);var Fe=Object.defineProperty,He=Object.getOwnPropertyDescriptor,O=(e,t,i,s)=>{for(var o=s>1?void 0:s?He(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(s?a(t,i,o):a(o))||o);return s&&o&&Fe(t,i,o),o};let S=class extends x{constructor(){super(...arguments),this.elementTag="",this.elementClassName="",this.labs=!1,this.detailsVisible=!1,this.shouldShowPropertySettings=!1,this.copiedKey=null}render(){return h`
      <div id="container">
        <h2>
...
`:"",t=this.stringifiedProps??"";return`<${this.elementTag}${e}${t}></${this.elementTag}>`}get cssCode(){return this.stringifiedStyles?`${this.elementTag} {
 ${this.stringifiedStyles}
    ...
    </span>`})),Ft=ie.map(e=>({id:e.name,text:e.name})),vi=ie.map(e=>({id:e.name,text:e.name,content:h`<span>${e.flag}</span>&nbsp;<span>${e.name}</span>`})),$i="list",xi="Choices",Ht="Select an option...",zt=50,wi="substring";let g=class extends x{constructor(){super(...arguments),this.options=Ft,this.behavior=$i,this.label=xi,this.placeholder=Ht,this.maxAutocompleteEntries=zt,this.filterFn=wi,this.caseSensitive=!1,this.shouldSort=!1,this.wrapArrowKeys=!0,this.clearable=!0,this.disabled=!1,this.announcerText=""}render(){return h`
      <story-template
...
`)}applySettings(e){e.preventDefault(),this.updateOptions(),this.behavior=this.behaviorSelect.value,this.label=this.labelInput.value,this.placeholder=this.placeholderInput.value,this.maxAutocompleteEntries=Number(this.maxAutocompleteInput.value),this.filterFn=this.filterFnSelect.value,this.caseSensitive=this.caseSensitiveCheck.checked,this.shouldSort=this.sortCheck.checked,this.wrapArrowKeys=this.wrapArrowKeysCheck.checked,this.clearable=this.clearableCheck.checked,this.disabled=this.disabledCheck.checked}updateOptions(){switch(this.optionSetSelect.value){case"colors":this.options=this.customContentCheck.checked?yi:se;break;case"countries":this.options=this.customContentCheck.checked?vi:Ft;break;default:this.options=[]}}handleComboBoxChange(e){this.announcerText=`New value is: ${e.detail}`}static get styles(){return T`
    ...
    `}};Et([p({type:Object})],at.prototype,"snowConfig",2);Et([m()],at.prototype,"snowing",2);at=Et([A("ia-snow")],at);var Bi=Object.defineProperty,Di=Object.getOwnPropertyDescriptor,H=(e,t,i,s)=>{for(var o=s>1?void 0:s?Di(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(s?a(t,i,o):a(o))||o);return s&&o&&Bi(t,i,o),o};let k=class extends x{render(){return h`
      <story-template
        elementTag="ia-snow"
