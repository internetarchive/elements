import{n as l,t as g,i as T,b as p,r as m,A as R,a as C}from"./index-Bpi7JUlY.js";import{m as I}from"./runtime-CCgtQBty.js";import{e as A}from"./query-BgUB2UxF.js";import{o as k}from"./story-template-CYWOjSQS.js";class O{constructor(e,s,i,r,o,n){this.id=e,this.start=s,this.end=i,this.rawText=r,this.isMusic=o,this.searchMatchIndex=n}get displayText(){return this.isMusic?I("[Transcript unavailable]"):this.rawText}}class M{constructor(e){this.entries=[],this.entries=e}get searchResults(){return this.entries.filter(e=>e.searchMatchIndex!==void 0)}}function $(t){if(typeof t!="number"||!Number.isFinite(t))return"";const e=Math.max(0,Math.floor(t)),s=Math.floor(e/3600),i=Math.floor(e/60)%60,r=e%60,o=String(r).padStart(2,"0");if(s===0)return`${i}:${o}`;const n=String(i).padStart(2,"0");return`${s}:${n}:${o}`}var P=Object.defineProperty,_=Object.getOwnPropertyDescriptor,f=(t,e,s,i)=>{for(var r=i>1?void 0:i?_(e,s):e,o=t.length-1,n;o>=0;o--)(n=t[o])&&(r=(i?n(e,s,r):n(r))||r);return i&&r&&P(e,s,r),r};let u=class extends T{constructor(){super(...arguments),this.isActive=!1,this.isSelected=!1,this.isClickable=!1,this.isSearchResult=!1,this.isMusicEntry=!1}render(){return p`${this.entry?.displayText??""}`}};f([l({type:Object})],u.prototype,"entry",2);f([l({type:Boolean,reflect:!0})],u.prototype,"isActive",2);f([l({type:Boolean,reflect:!0})],u.prototype,"isSelected",2);f([l({type:Boolean,reflect:!0})],u.prototype,"isClickable",2);f([l({type:Boolean,reflect:!0})],u.prototype,"isSearchResult",2);f([l({type:Boolean,reflect:!0})],u.prototype,"isMusicEntry",2);u=f([g("ia-transcript-entry")],u);var D=Object.defineProperty,N=Object.getOwnPropertyDescriptor,c=(t,e,s,i)=>{for(var r=i>1?void 0:i?N(e,s):e,o=t.length-1,n;o>=0;o--)(n=t[o])&&(r=(i?n(e,s,r):n(r))||r);return i&&r&&D(e,s,r),r};const b={TranscriptEntrySelected:"transcriptEntrySelected",CurrentEntriesUpdated:"currentEntriesUpdated",AutoScrollChanged:"autoScrollChanged"},V=1;let a=class extends T{constructor(){super(...arguments),this.currentTime=0,this.topContextHeight=50,this.bottomContextHeight=50,this.autoScroll=!0,this.selectedSearchResultIndex=0,this.showContextZones=!1,this.scrollTimerDelay=15e3,this.timeScrollTop=0,this.currentEntries=[]}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this.scrollResumeTimerId),this.cancelScrollAnimation()}render(){return p`
      <div class="container">
    ...
    `}scrollToSelectedSearchResult(){const{selectedSearchResult:t}=this;t&&(this.autoScroll=!1,this.scrollToElement(t))}entryIdentifierClosestToTime(t){const e=this.transcriptEntries;if(e.length===0)return null;let s=e[0],i=Math.abs(t-s.start);for(const r of e){const o=Math.abs(t-r.start);o<i&&(i=o,s=r)}return s.id}get autoScrollButtonTemplate(){return p`
      <button
        class="auto-scroll-button ${this.autoScroll?"hidden":""}"
        @click=${this.enableAutoScroll}
      >
        ${I("Scroll text with audio")}
      </button>
    `}get timeDisplayTemplate(){return p`
      <div class="time-display" style="top: ${this.timeScrollTop}px">
        ${$(this.currentTime)}
      </div>
    `}transcriptEntryTemplate(t){const e=this.currentEntries.some(s=>s.id===t.id);return p`
      <ia-transcript-entry
        .entry=${t}
        ?isActive=${e}
    ...
    `}handleSearchInput(t){this.searchTerm=t.target.value,this.transcript=w(this.searchTerm),this.selectedSearchResultIndex=0}stepResult(t){const e=this.resultCount;e!==0&&(this.selectedSearchResultIndex=(this.selectedSearchResultIndex+t+e)%e)}togglePlayback(){if(this.playing){this.stopPlayback();return}this.playing=!0,this.playbackTimer=setInterval(()=>{this.currentTime=(this.currentTime+1)%S},500)}stopPlayback(){clearInterval(this.playbackTimer),this.playbackTimer=void 0,this.playing=!1}static get styles(){return C`
      .transcript {
        display: block;
