(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))s(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const a of n.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function i(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(o){if(o.ep)return;o.ep=!0;const n=i(o);fetch(o.href,n)}})();const tt=globalThis,Ct=tt.ShadowRoot&&(tt.ShadyCSS===void 0||tt.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Ot=Symbol(),jt=new WeakMap;let Qt=class{constructor(t,i,s){if(this._$cssResult$=!0,s!==Ot)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=i}get styleSheet(){let t=this.o;const i=this.t;if(Ct&&t===void 0){const s=i!==void 0&&i.length===1;s&&(t=jt.get(i)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),s&&jt.set(i,t))}return t}toString(){return this.cssText}};const de=e=>new Qt(typeof e=="string"?e:e+"",void 0,Ot),A=(e,...t)=>{const i=e.length===1?e[0]:t.reduce(((s,o,n)=>s+(a=>{if(a._$cssResult$===!0)return a.cssText;if(typeof a=="number")return a;throw Error("Value passed to 'css' function must be a 'css' function result: "+a+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(o)+e[n+1]),e[0]);return new Qt(i,e,Ot)},ue=(e,t)=>{if(Ct)e.adoptedStyleSheets=t.map((i=>i instanceof CSSStyleSheet?i:i.styleSheet));else for(const i of t){const s=document.createElement("style"),o=tt.litNonce;o!==void 0&&s.setAttribute("nonce",o),s.textContent=i.cssText,e.appendChild(s)}},Mt=Ct?e=>e:e=>e instanceof CSSStyleSheet?(t=>{let i="";for(const s of t.cssRules)i+=s.cssText;return de(i)})(e):e;const{is:ge,defineProperty:fe,getOwnPropertyDescriptor:me,getOwnPropertyNames:be,getOwnPropertySymbols:ye,getPrototypeOf:ve}=Object,ht=globalThis,Bt=ht.trustedTypes,$e=Bt?Bt.emptyScript:"",we=ht.reactiveElementPolyfillSupport,W=(e,t)=>e,it={toAttribute(e,t){switch(t){case Boolean:e=e?$e:null;break;case Object:case Array:e=e==null?e:JSON.stringify(e)}return e},fromAttribute(e,t){let i=e;switch(t){case Boolean:i=e!==null;break;case Number:i=e===null?null:Number(e);break;case Object:case Array:try{i=JSON.parse(e)}catch{i=null}}return i}},Tt=(e,t)=>!ge(e,t),Vt={attribute:!0,type:String,converter:it,reflect:!1,useDefault:!1,hasChanged:Tt};Symbol.metadata??=Symbol("metadata"),ht.litPropertyMetadata??=new WeakMap;let R=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,i=Vt){if(i.state&&(i.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((i=Object.create(i)).wrapped=!0),this.elementProperties.set(t,i),!i.noAccessor){const s=Symbol(),o=this.getPropertyDescriptor(t,s,i);o!==void 0&&fe(this.prototype,t,o)}}static getPropertyDescriptor(t,i,s){const{get:o,set:n}=me(this.prototype,t)??{get(){return this[i]},set(a){this[i]=a}};return{get:o,set(a){const r=o?.call(this);n?.call(this,a),this.requestUpdate(t,r,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??Vt}static _$Ei(){if(this.hasOwnProperty(W("elementProperties")))return;const t=ve(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(W("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(W("properties"))){const i=this.properties,s=[...be(i),...ye(i)];for(const o of s)this.createProperty(o,i[o])}const t=this[Symbol.metadata];if(t!==null){const i=litPropertyMetadata.get(t);if(i!==void 0)for(const[s,o]of i)this.elementProperties.set(s,o)}this._$Eh=new Map;for(const[i,s]of this.elementProperties){const o=this._$Eu(i,s);o!==void 0&&this._$Eh.set(o,i)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const i=[];if(Array.isArray(t)){const s=new Set(t.flat(1/0).reverse());for(const o of s)i.unshift(Mt(o))}else t!==void 0&&i.push(Mt(t));return i}static _$Eu(t,i){const s=i.attribute;return s===!1?void 0:typeof s=="string"?s:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise((t=>this.enableUpdating=t)),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach((t=>t(this)))}addController(t){(this._$EO??=new Set).add(t),this.renderRoot!==void 0&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){const t=new Map,i=this.constructor.elementProperties;for(const s of i.keys())this.hasOwnProperty(s)&&(t.set(s,this[s]),delete this[s]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return ue(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach((t=>t.hostConnected?.()))}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach((t=>t.hostDisconnected?.()))}attributeChangedCallback(t,i,s){this._$AK(t,s)}_$ET(t,i){const s=this.constructor.elementProperties.get(t),o=this.constructor._$Eu(t,s);if(o!==void 0&&s.reflect===!0){const n=(s.converter?.toAttribute!==void 0?s.converter:it).toAttribute(i,s.type);this._$Em=t,n==null?this.removeAttribute(o):this.setAttribute(o,n),this._$Em=null}}_$AK(t,i){const s=this.constructor,o=s._$Eh.get(t);if(o!==void 0&&this._$Em!==o){const n=s.getPropertyOptions(o),a=typeof n.converter=="function"?{fromAttribute:n.converter}:n.converter?.fromAttribute!==void 0?n.converter:it;this._$Em=o;const r=a.fromAttribute(i,n.type);this[o]=r??this._$Ej?.get(o)??r,this._$Em=null}}requestUpdate(t,i,s){if(t!==void 0){const o=this.constructor,n=this[t];if(s??=o.getPropertyOptions(t),!((s.hasChanged??Tt)(n,i)||s.useDefault&&s.reflect&&n===this._$Ej?.get(t)&&!this.hasAttribute(o._$Eu(t,s))))return;this.C(t,i,s)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,i,{useDefault:s,reflect:o,wrapped:n},a){s&&!(this._$Ej??=new Map).has(t)&&(this._$Ej.set(t,a??i??this[t]),n!==!0||a!==void 0)||(this._$AL.has(t)||(this.hasUpdated||s||(i=void 0),this._$AL.set(t,i)),o===!0&&this._$Em!==t&&(this._$Eq??=new Set).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(i){Promise.reject(i)}const t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[o,n]of this._$Ep)this[o]=n;this._$Ep=void 0}const s=this.constructor.elementProperties;if(s.size>0)for(const[o,n]of s){const{wrapped:a}=n,r=this[o];a!==!0||this._$AL.has(o)||r===void 0||this.C(o,void 0,n,r)}}let t=!1;const i=this._$AL;try{t=this.shouldUpdate(i),t?(this.willUpdate(i),this._$EO?.forEach((s=>s.hostUpdate?.())),this.update(i)):this._$EM()}catch(s){throw t=!1,this._$EM(),s}t&&this._$AE(i)}willUpdate(t){}_$AE(t){this._$EO?.forEach((i=>i.hostUpdated?.())),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&=this._$Eq.forEach((i=>this._$ET(i,this[i]))),this._$EM()}updated(t){}firstUpdated(t){}};R.elementStyles=[],R.shadowRootOptions={mode:"open"},R[W("elementProperties")]=new Map,R[W("finalized")]=new Map,we?.({ReactiveElement:R}),(ht.reactiveElementVersions??=[]).push("2.1.1");const At=globalThis,st=At.trustedTypes,Dt=st?st.createPolicy("lit-html",{createHTML:e=>e}):void 0,Xt="$lit$",I=`lit$${Math.random().toFixed(9).slice(2)}$`,te="?"+I,xe=`<${te}>`,B=document,Z=()=>B.createComment(""),G=e=>e===null||typeof e!="object"&&typeof e!="function",Et=Array.isArray,_e=e=>Et(e)||typeof e?.[Symbol.iterator]=="function",ft=`[ 	
\f\r]`,q=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Rt=/-->/g,Nt=/>/g,L=RegExp(`>|${ft}(?:([^\\s"'>=/]+)(${ft}*=${ft}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ut=/'/g,zt=/"/g,ee=/^(?:script|style|textarea|title)$/i,ie=e=>(t,...i)=>({_$litType$:e,strings:t,values:i}),l=ie(1),se=ie(2),T=Symbol.for("lit-noChange"),g=Symbol.for("lit-nothing"),Ft=new WeakMap,j=B.createTreeWalker(B,129);function oe(e,t){if(!Et(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return Dt!==void 0?Dt.createHTML(t):t}const Se=(e,t)=>{const i=e.length-1,s=[];let o,n=t===2?"<svg>":t===3?"<math>":"",a=q;for(let r=0;r<i;r++){const c=e[r];let y,d,h=-1,x=0;for(;x<c.length&&(a.lastIndex=x,d=a.exec(c),d!==null);)x=a.lastIndex,a===q?d[1]==="!--"?a=Rt:d[1]!==void 0?a=Nt:d[2]!==void 0?(ee.test(d[2])&&(o=RegExp("</"+d[2],"g")),a=L):d[3]!==void 0&&(a=L):a===L?d[0]===">"?(a=o??q,h=-1):d[1]===void 0?h=-2:(h=a.lastIndex-d[2].length,y=d[1],a=d[3]===void 0?L:d[3]==='"'?zt:Ut):a===zt||a===Ut?a=L:a===Rt||a===Nt?a=q:(a=L,o=void 0);const _=a===L&&e[r+1].startsWith("/>")?" ":"";n+=a===q?c+xe:h>=0?(s.push(y),c.slice(0,h)+Xt+c.slice(h)+I+_):c+I+(h===-2?r:_)}return[oe(e,n+(e[i]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),s]};class Y{constructor({strings:t,_$litType$:i},s){let o;this.parts=[];let n=0,a=0;const r=t.length-1,c=this.parts,[y,d]=Se(t,i);if(this.el=Y.createElement(y,s),j.currentNode=this.el.content,i===2||i===3){const h=this.el.content.firstChild;h.replaceWith(...h.childNodes)}for(;(o=j.nextNode())!==null&&c.length<r;){if(o.nodeType===1){if(o.hasAttributes())for(const h of o.getAttributeNames())if(h.endsWith(Xt)){const x=d[a++],_=o.getAttribute(h).split(I),E=/([.?@])?(.*)/.exec(x);c.push({type:1,index:n,name:E[2],strings:_,ctor:E[1]==="."?Oe:E[1]==="?"?Te:E[1]==="@"?Ae:pt}),o.removeAttribute(h)}else h.startsWith(I)&&(c.push({type:6,index:n}),o.removeAttribute(h));if(ee.test(o.tagName)){const h=o.textContent.split(I),x=h.length-1;if(x>0){o.textContent=st?st.emptyScript:"";for(let _=0;_<x;_++)o.append(h[_],Z()),j.nextNode(),c.push({type:2,index:++n});o.append(h[x],Z())}}}else if(o.nodeType===8)if(o.data===te)c.push({type:2,index:n});else{let h=-1;for(;(h=o.data.indexOf(I,h+1))!==-1;)c.push({type:7,index:n}),h+=I.length-1}n++}}static createElement(t,i){const s=B.createElement("template");return s.innerHTML=t,s}}function U(e,t,i=e,s){if(t===T)return t;let o=s!==void 0?i._$Co?.[s]:i._$Cl;const n=G(t)?void 0:t._$litDirective$;return o?.constructor!==n&&(o?._$AO?.(!1),n===void 0?o=void 0:(o=new n(e),o._$AT(e,i,s)),s!==void 0?(i._$Co??=[])[s]=o:i._$Cl=o),o!==void 0&&(t=U(e,o._$AS(e,t.values),o,s)),t}class Ce{constructor(t,i){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=i}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:i},parts:s}=this._$AD,o=(t?.creationScope??B).importNode(i,!0);j.currentNode=o;let n=j.nextNode(),a=0,r=0,c=s[0];for(;c!==void 0;){if(a===c.index){let y;c.type===2?y=new Q(n,n.nextSibling,this,t):c.type===1?y=new c.ctor(n,c.name,c.strings,this,t):c.type===6&&(y=new Ee(n,this,t)),this._$AV.push(y),c=s[++r]}a!==c?.index&&(n=j.nextNode(),a++)}return j.currentNode=B,o}p(t){let i=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(t,s,i),i+=s.strings.length-2):s._$AI(t[i])),i++}}class Q{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,i,s,o){this.type=2,this._$AH=g,this._$AN=void 0,this._$AA=t,this._$AB=i,this._$AM=s,this.options=o,this._$Cv=o?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const i=this._$AM;return i!==void 0&&t?.nodeType===11&&(t=i.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,i=this){t=U(this,t,i),G(t)?t===g||t==null||t===""?(this._$AH!==g&&this._$AR(),this._$AH=g):t!==this._$AH&&t!==T&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):_e(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==g&&G(this._$AH)?this._$AA.nextSibling.data=t:this.T(B.createTextNode(t)),this._$AH=t}$(t){const{values:i,_$litType$:s}=t,o=typeof s=="number"?this._$AC(t):(s.el===void 0&&(s.el=Y.createElement(oe(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===o)this._$AH.p(i);else{const n=new Ce(o,this),a=n.u(this.options);n.p(i),this.T(a),this._$AH=n}}_$AC(t){let i=Ft.get(t.strings);return i===void 0&&Ft.set(t.strings,i=new Y(t)),i}k(t){Et(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let s,o=0;for(const n of t)o===i.length?i.push(s=new Q(this.O(Z()),this.O(Z()),this,this.options)):s=i[o],s._$AI(n),o++;o<i.length&&(this._$AR(s&&s._$AB.nextSibling,o),i.length=o)}_$AR(t=this._$AA.nextSibling,i){for(this._$AP?.(!1,!0,i);t!==this._$AB;){const s=t.nextSibling;t.remove(),t=s}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}}class pt{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,i,s,o,n){this.type=1,this._$AH=g,this._$AN=void 0,this.element=t,this.name=i,this._$AM=o,this.options=n,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=g}_$AI(t,i=this,s,o){const n=this.strings;let a=!1;if(n===void 0)t=U(this,t,i,0),a=!G(t)||t!==this._$AH&&t!==T,a&&(this._$AH=t);else{const r=t;let c,y;for(t=n[0],c=0;c<n.length-1;c++)y=U(this,r[s+c],i,c),y===T&&(y=this._$AH[c]),a||=!G(y)||y!==this._$AH[c],y===g?t=g:t!==g&&(t+=(y??"")+n[c+1]),this._$AH[c]=y}a&&!o&&this.j(t)}j(t){t===g?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class Oe extends pt{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===g?void 0:t}}class Te extends pt{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==g)}}class Ae extends pt{constructor(t,i,s,o,n){super(t,i,s,o,n),this.type=5}_$AI(t,i=this){if((t=U(this,t,i,0)??g)===T)return;const s=this._$AH,o=t===g&&s!==g||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,n=t!==g&&(s===g||o);o&&this.element.removeEventListener(this.name,this,s),n&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class Ee{constructor(t,i,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=i,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){U(this,t)}}const Pe=At.litHtmlPolyfillSupport;Pe?.(Y,Q),(At.litHtmlVersions??=[]).push("3.3.1");const Ie=(e,t,i)=>{const s=i?.renderBefore??t;let o=s._$litPart$;if(o===void 0){const n=i?.renderBefore??null;s._$litPart$=o=new Q(t.insertBefore(Z(),n),n,void 0,i??{})}return o._$AI(e),o};const Pt=globalThis;let $=class extends R{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const i=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Ie(i,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return T}};$._$litElement$=!0,$.finalized=!0,Pt.litElementHydrateSupport?.({LitElement:$});const ke=Pt.litElementPolyfillSupport;ke?.({LitElement:$});(Pt.litElementVersions??=[]).push("4.2.1");const C=e=>(t,i)=>{i!==void 0?i.addInitializer((()=>{customElements.define(e,t)})):customElements.define(e,t)};const Le={attribute:!0,type:String,converter:it,reflect:!1,hasChanged:Tt},je=(e=Le,t,i)=>{const{kind:s,metadata:o}=i;let n=globalThis.litPropertyMetadata.get(o);if(n===void 0&&globalThis.litPropertyMetadata.set(o,n=new Map),s==="setter"&&((e=Object.create(e)).wrapped=!0),n.set(i.name,e),s==="accessor"){const{name:a}=i;return{set(r){const c=t.get.call(this);t.set.call(this,r),this.requestUpdate(a,c,e)},init(r){return r!==void 0&&this.C(a,void 0,e,r),r}}}if(s==="setter"){const{name:a}=i;return function(r){const c=this[a];t.call(this,r),this.requestUpdate(a,c,e)}}throw Error("Unsupported decorator location: "+s)};function p(e){return(t,i)=>typeof i=="object"?je(e,t,i):((s,o,n)=>{const a=o.hasOwnProperty(n);return o.constructor.createProperty(n,s),a?Object.getOwnPropertyDescriptor(o,n):void 0})(e,t,i)}function u(e){return p({...e,state:!0,attribute:!1})}const ne=(e,t,i)=>(i.configurable=!0,i.enumerable=!0,Reflect.decorate&&typeof t!="object"&&Object.defineProperty(e,t,i),i);function w(e,t){return(i,s,o)=>{const n=a=>a.renderRoot?.querySelector(e)??null;return ne(i,s,{get(){return n(this)}})}}let Me;function ae(e){return(t,i)=>ne(t,i,{get(){return(this.renderRoot??(Me??=document.createDocumentFragment())).querySelectorAll(e)}})}const z=A`
  :host {
    /*
    BASE STYLES
...
`;var Be=Object.getOwnPropertyDescriptor,Ve=(e,t,i,s)=>{for(var o=s>1?void 0:s?Be(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=a(o)||o);return o};let bt=class extends ${render(){return l`
      <button>
        <slot></slot>
      </button>
    `}static get styles(){return[z,A`
        :host {
      ...
      `]}};bt=Ve([C("ia-button")],bt);const Ht=Object.freeze(Object.defineProperty({__proto__:null,get IAButton(){return bt}},Symbol.toStringTag,{value:"Module"}));function N(e,t,i){return e?t(e):i?.(e)}const ot=e=>e??g,De="modulepreload",Re=function(e,t){return new URL(e,t).href},Kt={},et=function(t,i,s){let o=Promise.resolve();if(i&&i.length>0){let y=function(d){return Promise.all(d.map(h=>Promise.resolve(h).then(x=>({status:"fulfilled",value:x}),x=>({status:"rejected",reason:x}))))};const a=document.getElementsByTagName("link"),r=document.querySelector("meta[property=csp-nonce]"),c=r?.nonce||r?.getAttribute("nonce");o=y(i.map(d=>{if(d=Re(d,s),d in Kt)return;Kt[d]=!0;const h=d.endsWith(".css"),x=h?'[rel="stylesheet"]':"";if(s)for(let E=a.length-1;E>=0;E--){const X=a[E];if(X.href===d&&(!h||X.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${d}"]${x}`))return;const _=document.createElement("link");if(_.rel=h?"stylesheet":De,h||(_.as="script"),_.crossOrigin="",_.href=d,c&&_.setAttribute("nonce",c),document.head.appendChild(_),h)return new Promise((E,X)=>{_.addEventListener("load",E),_.addEventListener("error",()=>X(new Error(`Unable to preload CSS for ${d}`)))})}))}function n(a){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=a,window.dispatchEvent(r),!r.defaultPrevented)throw a}return o.then(a=>{for(const r of a||[])r.status==="rejected"&&n(r.reason);return t().catch(n)})};const P={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4},dt=e=>(...t)=>({_$litDirective$:e,values:t});class ut{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,i,s){this._$Ct=t,this._$AM=i,this._$Ci=s}_$AS(t,i){return this.update(t,i)}update(t,i){return this.render(...i)}}let yt=class extends ut{constructor(t){if(super(t),this.it=g,t.type!==P.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===g||t==null)return this._t=void 0,this.it=t;if(t===T)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const i=[t];return i.raw=i,this._t={_$litType$:this.constructor.resultType,strings:i,values:[]}}};yt.directiveName="unsafeHTML",yt.resultType=1;const vt=dt(yt),Ne=A`
  pre {
...
`;var Ue=Object.defineProperty,ze=Object.getOwnPropertyDescriptor,gt=(e,t,i,s)=>{for(var o=s>1?void 0:s?ze(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(s?a(t,i,o):a(o))||o);return s&&o&&Ue(t,i,o),o};let J=class extends ${constructor(){super(...arguments),this.code="",this.language="auto",this.highlightedCode=""}willUpdate(e){(e.has("code")||e.has("language"))&&this.highlightCode()}render(){return l`
    ...
    `:g}applyStyles(){const e=[];this.styleInputs?.forEach(t=>{!t.dataset.variable||!t.value||e.push(`${t.dataset.variable}: ${t.value};`)}),this.dispatchEvent(new CustomEvent("stylesApplied",{detail:{styles:e.join(`
 `)}}))}static get styles(){return[z,A`
        .settings-options {
          background-color: var(--primary-background-color);
          padding: 1em;
        }
      `]}};It([p({type:Object})],at.prototype,"styleInputData",2);It([ae(".style-input")],at.prototype,"styleInputs",2);at=It([C("story-styles-settings")],at);const re=(e,t,i)=>{for(const s of t)if(s[0]===e)return(0,s[1])();return i?.()};var qe=Object.defineProperty,We=Object.getOwnPropertyDescriptor,kt=(e,t,i,s)=>{for(var o=s>1?void 0:s?We(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(s?a(t,i,o):a(o))||o);return s&&o&&qe(t,i,o),o};let rt=class extends ${render(){return this.propInputData?l`
      <div class="settings-options">
        <table>
          ${this.propInputData.settings.map(e=>re(e.inputType,[["radio",()=>this.createRadioPropInput(e)]],()=>this.createDefaultPropInput(e))??g)}
        </table>
        <button @click=${this.applyProps}>Apply</button>
      </div>
    `:g}createDefaultPropInput(e){const t=nt(e.label);return l`
      <tr>
    ...
    `}createRadioPropInput(e){if(e.inputType!=="radio"||!e.radioOptions)return g;const t=nt(e.label);return l`
      <tr>
  ...
  `+e.join(`
  `)+`
`,appliedProps:t}}))}static get styles(){return[z,A`
        .settings-options {
          background-color: var(--primary-background-color);
          padding: 1em;
        }
      `]}};kt([p({type:Object})],rt.prototype,"propInputData",2);kt([ae(".prop-input")],rt.prototype,"propInputs",2);rt=kt([C("story-props-settings")],rt);var Ze=Object.defineProperty,Ge=Object.getOwnPropertyDescriptor,O=(e,t,i,s)=>{for(var o=s>1?void 0:s?Ge(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(s?a(t,i,o):a(o))||o);return s&&o&&Ze(t,i,o),o};let S=class extends ${constructor(){super(...arguments),this.elementTag="",this.elementClassName="",this.labs=!1,this.detailsVisible=!1,this.shouldShowPropertySettings=!1,this.copiedKey=null}render(){return l`
      <div id="container">
        <h2>
...
`:"",t=this.stringifiedProps??"";return`<${this.elementTag}${e}${t}></${this.elementTag}>`}get cssCode(){return this.stringifiedStyles?`${this.elementTag} {
 ${this.stringifiedStyles}
}`:""}get modulePath(){return this.labs?`@internetarchive/elements/labs/${this.elementTag}/${this.elementTag}`:`@internetarchive/elements/${this.elementTag}/${this.elementTag}`}handleSettingsSlotChange(e){const t=e.target.assignedElements();this.shouldShowPropertySettings=t.length>0}handleDemoComponentSlotted(e){const t=e.target.assignedElements()[0];t&&(this.slottedDemoComponent=t)}handleStylesApplied(e){const t=e.detail.styles;t&&(this.stringifiedStyles=t)}handlePropsApplied(e){const t=e.detail.stringifiedProps,i=e.detail.appliedProps;!t||!i||(this.stringifiedProps=t,i.forEach(s=>{this.slottedDemoComponent[s.propName]=s.value}))}static get styles(){return[z,A`
        #container {
          background: #f0f0f0;
          padding: 0 10px 10px;
          margin-bottom: 1rem;
      ...
      `]}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this._copyTimeout)}};O([p({type:String})],S.prototype,"elementTag",2);O([p({type:String})],S.prototype,"elementClassName",2);O([p({type:String})],S.prototype,"customExampleUsage",2);O([p({type:String})],S.prototype,"defaultUsageProps",2);O([p({type:Object})],S.prototype,"styleInputData",2);O([p({type:Object})],S.prototype,"propInputData",2);O([p({type:Boolean})],S.prototype,"labs",2);O([u()],S.prototype,"detailsVisible",2);O([u()],S.prototype,"stringifiedStyles",2);O([u()],S.prototype,"stringifiedProps",2);O([u()],S.prototype,"shouldShowPropertySettings",2);O([u()],S.prototype,"slottedDemoComponent",2);O([u()],S.prototype,"copiedKey",2);S=O([C("story-template")],S);var Ye=Object.getOwnPropertyDescriptor,Je=(e,t,i,s)=>{for(var o=s>1?void 0:s?Ye(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=a(o)||o);return o};const Qe=[{label:"Text Color (Primary)",cssVariable:"--ia-theme-primary-cta-text-color",defaultValue:"#ffffff",inputType:"color"},{label:"Background Color (Primary)",cssVariable:"--ia-theme-primary-cta-fill",defaultValue:"#194880",inputType:"color"}];let $t=class extends ${render(){return l`
      <story-template
    ...
    `}get caretButtonTemplate(){return l`
      <button
        ...
        @blur=${this.handleBlur}
      >
        <span class="sr-only">${M("Toggle options")}</span>
        ${this.caretTemplate}
      </button>
    ...
    `;return[z,e]}};m.formAssociated=!0;m.shadowRootOptions={...$.shadowRootOptions,delegatesFocus:!0};v([p({type:Array})],m.prototype,"options",2);v([p({type:String})],m.prototype,"placeholder",2);v([p({type:String})],m.prototype,"behavior",2);v([p({type:Number,attribute:"max-autocomplete-entries"})],m.prototype,"maxAutocompleteEntries",2);v([p({type:String})],m.prototype,"filter",2);v([p({type:Boolean,reflect:!0,attribute:"case-sensitive"})],m.prototype,"caseSensitive",2);v([p({type:Boolean,reflect:!0})],m.prototype,"sort",2);v([p({type:Boolean,reflect:!0,attribute:"wrap-arrow-keys"})],m.prototype,"wrapArrowKeys",2);v([p({type:Boolean,reflect:!0,attribute:"stay-open"})],m.prototype,"stayOpen",2);v([p({type:Boolean,reflect:!0})],m.prototype,"clearable",2);v([p({type:Boolean,reflect:!0})],m.prototype,"open",2);v([p({type:Boolean,reflect:!0})],m.prototype,"disabled",2);v([p({type:Boolean,reflect:!0})],m.prototype,"required",2);v([p({type:String})],m.prototype,"value",2);v([u()],m.prototype,"hasFocus",2);v([u()],m.prototype,"highlightedOption",2);v([u()],m.prototype,"enteredText",2);v([u()],m.prototype,"filterText",2);v([w("#main-widget-row")],m.prototype,"mainWidgetRow",2);v([w("#text-input")],m.prototype,"textInput",2);v([w("#options-list")],m.prototype,"optionsList",2);m=v([C("ia-combo-box")],m);var wi=Object.defineProperty,xi=Object.getOwnPropertyDescriptor,b=(e,t,i,s)=>{for(var o=s>1?void 0:s?xi(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(s?a(t,i,o):a(o))||o);return s&&o&&wi(t,i,o),o};const _i=[{label:"Width",cssVariable:"--ia-theme-combo-box-width",defaultValue:"250px",inputType:"text"},{label:"Padding",cssVariable:"--ia-theme-padding-sm",defaultValue:"5px",inputType:"text"},{label:"Dropdown width",cssVariable:"--combo-box-list-width",defaultValue:"",inputType:"text"},{label:"Dropdown max height",cssVariable:"--combo-box-list-max-height",defaultValue:"250px",inputType:"text"}],ce=[{id:"red",text:"Red"},{id:"orange",text:"Orange"},{id:"yellow",text:"Yellow"},{id:"green",text:"Green"},{id:"blue",text:"Blue"},{id:"indigo",text:"Indigo"},{id:"violet",text:"Violet"}],Si=ce.map(e=>({...e,content:l` <span style="display: flex; align-items: center">
      <span style="flex: 1">${e.text}</span>
      <div style="width: 15px; height: 15px; background:${e.id}"></div>
    </span>`})),qt=le.map(e=>({id:e.name,text:e.name})),Ci=le.map(e=>({id:e.name,text:e.name,content:l`<span>${e.flag}</span>&nbsp;<span>${e.name}</span>`})),Oi="list",Ti="Choices",Wt="Select an option...",Zt=50,Ai="substring";let f=class extends ${constructor(){super(...arguments),this.options=qt,this.behavior=Oi,this.label=Ti,this.placeholder=Wt,this.maxAutocompleteEntries=Zt,this.filterFn=Ai,this.caseSensitive=!1,this.shouldSort=!1,this.wrapArrowKeys=!0,this.clearable=!0,this.disabled=!1,this.announcerText=""}render(){return l`
      <story-template
        elementTag="ia-combo-box"
        elementClassName="IAComboBox"
        .customExampleUsage=${this.exampleUsage}
        .styleInputData=${{settings:_i}}
      >
        <div slot="demo">
          <ia-combo-box
...
`)}applySettings(e){e.preventDefault(),this.updateOptions(),this.behavior=this.behaviorSelect.value,this.label=this.labelInput.value,this.placeholder=this.placeholderInput.value,this.maxAutocompleteEntries=Number(this.maxAutocompleteInput.value),this.filterFn=this.filterFnSelect.value,this.caseSensitive=this.caseSensitiveCheck.checked,this.shouldSort=this.sortCheck.checked,this.wrapArrowKeys=this.wrapArrowKeysCheck.checked,this.clearable=this.clearableCheck.checked,this.disabled=this.disabledCheck.checked}updateOptions(){switch(this.optionSetSelect.value){case"colors":this.options=this.customContentCheck.checked?Si:ce;break;case"countries":this.options=this.customContentCheck.checked?Ci:qt;break;default:this.options=[]}}handleComboBoxChange(e){this.announcerText=`New value is: ${e.detail}`}static get styles(){return A`
    ...
    `}};b([u()],f.prototype,"options",2);b([u()],f.prototype,"behavior",2);b([u()],f.prototype,"label",2);b([u()],f.prototype,"placeholder",2);b([u()],f.prototype,"maxAutocompleteEntries",2);b([u()],f.prototype,"filterFn",2);b([u()],f.prototype,"caseSensitive",2);b([u()],f.prototype,"shouldSort",2);b([u()],f.prototype,"wrapArrowKeys",2);b([u()],f.prototype,"clearable",2);b([u()],f.prototype,"disabled",2);b([u()],f.prototype,"announcerText",2);b([w("#settings__options")],f.prototype,"optionSetSelect",2);b([w("#settings__custom-content")],f.prototype,"customContentCheck",2);b([w("#settings__behavior")],f.prototype,"behaviorSelect",2);b([w("#settings__label")],f.prototype,"labelInput",2);b([w("#settings__placeholder")],f.prototype,"placeholderInput",2);b([w("#settings__max-entries")],f.prototype,"maxAutocompleteInput",2);b([w("#settings__filter-fn")],f.prototype,"filterFnSelect",2);b([w("#settings__case-sensitive")],f.prototype,"caseSensitiveCheck",2);b([w("#settings__sort")],f.prototype,"sortCheck",2);b([w("#settings__wrap")],f.prototype,"wrapArrowKeysCheck",2);b([w("#settings__clearable")],f.prototype,"clearableCheck",2);b([w("#settings__disabled")],f.prototype,"disabledCheck",2);f=b([C("ia-combo-box-story")],f);const Ei=Object.freeze(Object.defineProperty({__proto__:null,get IAComboBoxStory(){return f}},Symbol.toStringTag,{value:"Module"}));var Pi=Object.defineProperty,Ii=Object.getOwnPropertyDescriptor,F=(e,t,i,s)=>{for(var o=s>1?void 0:s?Ii(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(s?a(t,i,o):a(o))||o);return s&&o&&Pi(t,i,o),o};let V=class extends ${constructor(){super(...arguments),this.loadingTitle=M("Loading..."),this.successTitle=M("Success"),this.errorTitle=M("Error"),this.loadingStyle="ring-dots",this.mode="loading"}render(){return l`${re(this.mode,[["loading",()=>this.loadingIndicatorTemplate],["success",()=>this.successIndicatorTemplate],["error",()=>this.errorIndicatorTemplate]])}`}get loadingIndicatorTemplate(){return l`
      <svg
    ...
    `}get shouldShowLoadingDots(){return this.loadingStyle!=="ring"}static get styles(){return[z,A`
        :host {
      ...
      `]}};F([p({type:String})],V.prototype,"loadingTitle",2);F([p({type:String})],V.prototype,"successTitle",2);F([p({type:String})],V.prototype,"errorTitle",2);F([p({type:String})],V.prototype,"loadingStyle",2);F([p({type:String})],V.prototype,"mode",2);V=F([C("ia-status-indicator")],V);var ki=Object.getOwnPropertyDescriptor,Li=(e,t,i,s)=>{for(var o=s>1?void 0:s?ki(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=a(o)||o);return o};const ji=[{label:"Width",cssVariable:"--ia-theme-icon-width",defaultValue:"1.25rem"},{label:"Color - loading",cssVariable:"--ia-theme-primary-text-color",defaultValue:"#2c2c2c",inputType:"color"},{label:"Color - success",cssVariable:"--ia-theme-color-success",defaultValue:"#31a481",inputType:"color"},{label:"Color - error",cssVariable:"--ia-theme-color-danger",defaultValue:"#e51c23",inputType:"color"}],Mi=[{label:"Mode",propertyName:"mode",defaultValue:"loading",inputType:"radio",radioOptions:["loading","success","error"]},{label:"Accessible title - loading",propertyName:"loadingTitle",defaultValue:"Loading..."},{label:"Loading style",propertyName:"loadingStyle",defaultValue:"ring-dots",inputType:"radio",radioOptions:["ring-dots","ring"]},{label:"Accessible title - success",propertyName:"successTitle",defaultValue:"Success"},{label:"Accessible title - error",propertyName:"errorTitle",defaultValue:"Error"}];let wt=class extends ${render(){return l`
      <story-template
        elementTag="ia-status-indicator"
        elementClassName="IAStatusIndicator"
        .styleInputData=${{settings:ji}}
        .propInputData=${{settings:Mi}}
      >
        <ia-status-indicator slot="demo"></ia-status-indicator>
      </story-template>
    `}};wt=Li([C("ia-status-indicator-story")],wt);const Bi=Object.freeze(Object.defineProperty({__proto__:null,get IAStatusIndicatorStory(){return wt}},Symbol.toStringTag,{value:"Module"})),Vi=se`
  <svg
    class="icon-loader"
    height="20"
    viewBox="0 0 128 128"
...
`,Ri="https://static.zdassets.com/ekr/snippet.js";function Ni(e){return new Promise((t,i)=>{if(document.getElementById("ze-snippet")){t();return}const s=document.createElement("script");s.id="ze-snippet",s.src=`${Ri}?key=${e}`,s.onload=()=>t(),s.onerror=()=>i(new Error("Failed to load Zendesk script")),document.head.appendChild(s)})}function Ui(e=1e4){return new Promise((t,i)=>{const s=setInterval(()=>{window.zE&&(clearInterval(s),clearTimeout(o),t())},100),o=setTimeout(()=>{clearInterval(s),i(new Error("Zendesk API did not initialise in time"))},e)})}var zi=Object.defineProperty,Fi=Object.getOwnPropertyDescriptor,H=(e,t,i,s)=>{for(var o=s>1?void 0:s?Fi(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(s?a(t,i,o):a(o))||o);return s&&o&&zi(t,i,o),o};let D=class extends ${constructor(){super(...arguments),this.widgetKey="6fe87bd8-d4e3-4b42-8632-be6eb933d54d",this.breakpoint=767,this.buttonVisible=!0,this.isLoading=!1,this.isCompact=!1,this._onMqlChange=e=>{this.isCompact=e.matches},this.zendeskReady=!1}connectedCallback(){super.connectedCallback(),this._setupMediaQuery()}disconnectedCallback(){super.disconnectedCallback(),this._mql?.removeEventListener("change",this._onMqlChange)}updated(e){e.has("breakpoint")&&(this._mql?.removeEventListener("change",this._onMqlChange),this._setupMediaQuery())}_setupMediaQuery(){this._mql=window.matchMedia(`(max-width: ${this.breakpoint}px)`),this.isCompact=this._mql.matches,this._mql.addEventListener("change",this._onMqlChange)}async initiateZenDesk(){this.isLoading=!0,this.dispatchEvent(new Event("zendeskHelpButtonClicked"));try{if(!this.zendeskReady){if(await Ni(this.widgetKey),await Ui(),!window.zE){this.isLoading=!1;return}window.zE("messenger:on","open",()=>{this.buttonVisible=!1,this.isLoading=!1}),window.zE("messenger:on","close",()=>{setTimeout(()=>{this.buttonVisible=!0},500)}),this.zendeskReady=!0}window.zE&&window.zE("messenger","open")}catch(e){this.isLoading=!1,console.error("[ia-zendesk-widget]",e)}}get iconTemplate(){return this.isLoading?Vi:Di}render(){return l`
      <button
        class="help-widget ${this.buttonVisible?"":"hidden"}"
        @click=${this.initiateZenDesk}
      >
        ${this.iconTemplate}
        ${this.isCompact?g:l`<span class="label">Help</span>`}
      </button>
    ...
    `}};H([p({type:String})],D.prototype,"widgetKey",2);H([p({type:Number})],D.prototype,"breakpoint",2);H([u()],D.prototype,"buttonVisible",2);H([u()],D.prototype,"isLoading",2);H([u()],D.prototype,"isCompact",2);D=H([C("ia-zendesk-widget")],D);var Hi=Object.defineProperty,Ki=Object.getOwnPropertyDescriptor,he=(e,t,i,s)=>{for(var o=s>1?void 0:s?Ki(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(s?a(t,i,o):a(o))||o);return s&&o&&Hi(t,i,o),o};const xt="6fe87bd8-d4e3-4b42-8632-be6eb933d54d",qi=[{label:"Widget Key",propertyName:"widgetKey",defaultValue:xt},{label:"Breakpoint (px)",propertyName:"breakpoint",defaultValue:"767"}],Wi=[{label:"Background",cssVariable:"--button-background",defaultValue:"#194880",inputType:"color"},{label:"Text / Icon Color",cssVariable:"--button-color",defaultValue:"#ffffff",inputType:"color"},{label:"Icon Fill (independent)",cssVariable:"--icon-fill-color",defaultValue:"#ffffff",inputType:"color"},{label:"Width",cssVariable:"--button-width",defaultValue:"auto"},{label:"Padding",cssVariable:"--button-padding",defaultValue:"14px"},{label:"Margin",cssVariable:"--button-margin",defaultValue:"14px 20px"},{label:"Top",cssVariable:"--button-top",defaultValue:"auto"},{label:"Bottom",cssVariable:"--button-bottom",defaultValue:"0"},{label:"Left",cssVariable:"--button-left",defaultValue:"auto"},{label:"Right",cssVariable:"--button-right",defaultValue:"0"},{label:"Z-Index",cssVariable:"--button-z-index",defaultValue:"999998"},{label:"Border Radius",cssVariable:"--button-border-radius",defaultValue:"3rem"},{label:"Font Size",cssVariable:"--button-font-size",defaultValue:"14px"},{label:"Font Weight",cssVariable:"--button-font-weight",defaultValue:"700"}];let lt=class extends ${constructor(){super(...arguments),this.widgetMounted=!1}activateWidget(){this.widgetMounted=!0}get usageExample(){return`<ia-zendesk-widget
        .widgetKey="${xt}">
      </ia-zendesk-widget>,`}render(){return l`
      <story-template
    ...
    `:"<ia-snow></ia-snow>"}get configString(){return JSON.stringify(this.config,null,2)}get snowflakeConfig(){return{color:this.colorInput.value,count:Number(this.countInput.value),wind:this.windInput.checked,rotation:this.rotationInput.checked}}setupSnowflakes(){this.config=this.snowflakeConfig}static get styles(){return A`
      fieldset {
        margin-top: 16px;
      }
    `}};K([u()],k.prototype,"config",2);K([w("#count")],k.prototype,"countInput",2);K([w("#wind")],k.prototype,"windInput",2);K([w("#rotation")],k.prototype,"rotationInput",2);K([w("#color")],k.prototype,"colorInput",2);k=K([C("ia-snow-story")],k);const es=Object.freeze(Object.defineProperty({__proto__:null,get IASnowStory(){return k}},Symbol.toStringTag,{value:"Module"}));var is=Object.getOwnPropertyDescriptor,ss=(e,t,i,s)=>{for(var o=s>1?void 0:s?is(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=a(o)||o);return o};const os=Object.assign({"../src/elements/ia-button/ia-button-story.ts":Xe,"../src/elements/ia-combo-box/ia-combo-box-story.ts":Ei,"../src/elements/ia-status-indicator/ia-status-indicator-story.ts":Bi,"../src/elements/ia-zendesk-widget/ia-zendesk-widget-story.ts":Zi,"../src/labs/ia-snow/ia-snow-story.ts":es}),pe=Object.keys(os).map(e=>{const t=e.includes("/src/labs/"),i=e.split("/"),o=i[i.length-1].replace(/-story\.ts$/,"");return{tag:o,storyTag:`${o}-story`,id:`elem-${o}`,labs:t}}).sort((e,t)=>e.tag.localeCompare(t.tag)),_t=pe.filter(e=>!e.labs),St=pe.filter(e=>e.labs),ns=[..._t,...St];let Jt=class extends ${constructor(){super(...arguments),this._abortController=new AbortController}createRenderRoot(){return this}render(){return l`
      <nav id="ia-sidebar">
        <h2>Production-Ready</h2>
        ${_t.map(e=>l`<a href="#${e.id}">&lt;${e.tag}&gt;</a>`)}
        <h2>Labs 🧪</h2>
        ${St.map(e=>l`<a href="#${e.id}">&lt;${e.tag}&gt;</a>`)}
      </nav>
      <div id="ia-content">
