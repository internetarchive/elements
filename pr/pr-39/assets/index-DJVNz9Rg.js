(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))s(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const a of n.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function i(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(o){if(o.ep)return;o.ep=!0;const n=i(o);fetch(o.href,n)}})();const et=globalThis,Ct=et.ShadowRoot&&(et.ShadyCSS===void 0||et.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,At=Symbol(),Dt=new WeakMap;let Qt=class{constructor(t,i,s){if(this._$cssResult$=!0,s!==At)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=i}get styleSheet(){let t=this.o;const i=this.t;if(Ct&&t===void 0){const s=i!==void 0&&i.length===1;s&&(t=Dt.get(i)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),s&&Dt.set(i,t))}return t}toString(){return this.cssText}};const he=e=>new Qt(typeof e=="string"?e:e+"",void 0,At),T=(e,...t)=>{const i=e.length===1?e[0]:t.reduce(((s,o,n)=>s+(a=>{if(a._$cssResult$===!0)return a.cssText;if(typeof a=="number")return a;throw Error("Value passed to 'css' function must be a 'css' function result: "+a+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(o)+e[n+1]),e[0]);return new Qt(i,e,At)},pe=(e,t)=>{if(Ct)e.adoptedStyleSheets=t.map((i=>i instanceof CSSStyleSheet?i:i.styleSheet));else for(const i of t){const s=document.createElement("style"),o=et.litNonce;o!==void 0&&s.setAttribute("nonce",o),s.textContent=i.cssText,e.appendChild(s)}},Bt=Ct?e=>e:e=>e instanceof CSSStyleSheet?(t=>{let i="";for(const s of t.cssRules)i+=s.cssText;return he(i)})(e):e;const{is:de,defineProperty:ue,getOwnPropertyDescriptor:ge,getOwnPropertyNames:fe,getOwnPropertySymbols:me,getPrototypeOf:be}=Object,ht=globalThis,Mt=ht.trustedTypes,ye=Mt?Mt.emptyScript:"",ve=ht.reactiveElementPolyfillSupport,q=(e,t)=>e,st={toAttribute(e,t){switch(t){case Boolean:e=e?ye:null;break;case Object:case Array:e=e==null?e:JSON.stringify(e)}return e},fromAttribute(e,t){let i=e;switch(t){case Boolean:i=e!==null;break;case Number:i=e===null?null:Number(e);break;case Object:case Array:try{i=JSON.parse(e)}catch{i=null}}return i}},Tt=(e,t)=>!de(e,t),Rt={attribute:!0,type:String,converter:st,reflect:!1,useDefault:!1,hasChanged:Tt};Symbol.metadata??=Symbol("metadata"),ht.litPropertyMetadata??=new WeakMap;let R=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,i=Rt){if(i.state&&(i.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((i=Object.create(i)).wrapped=!0),this.elementProperties.set(t,i),!i.noAccessor){const s=Symbol(),o=this.getPropertyDescriptor(t,s,i);o!==void 0&&ue(this.prototype,t,o)}}static getPropertyDescriptor(t,i,s){const{get:o,set:n}=ge(this.prototype,t)??{get(){return this[i]},set(a){this[i]=a}};return{get:o,set(a){const r=o?.call(this);n?.call(this,a),this.requestUpdate(t,r,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??Rt}static _$Ei(){if(this.hasOwnProperty(q("elementProperties")))return;const t=be(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(q("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(q("properties"))){const i=this.properties,s=[...fe(i),...me(i)];for(const o of s)this.createProperty(o,i[o])}const t=this[Symbol.metadata];if(t!==null){const i=litPropertyMetadata.get(t);if(i!==void 0)for(const[s,o]of i)this.elementProperties.set(s,o)}this._$Eh=new Map;for(const[i,s]of this.elementProperties){const o=this._$Eu(i,s);o!==void 0&&this._$Eh.set(o,i)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const i=[];if(Array.isArray(t)){const s=new Set(t.flat(1/0).reverse());for(const o of s)i.unshift(Bt(o))}else t!==void 0&&i.push(Bt(t));return i}static _$Eu(t,i){const s=i.attribute;return s===!1?void 0:typeof s=="string"?s:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise((t=>this.enableUpdating=t)),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach((t=>t(this)))}addController(t){(this._$EO??=new Set).add(t),this.renderRoot!==void 0&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){const t=new Map,i=this.constructor.elementProperties;for(const s of i.keys())this.hasOwnProperty(s)&&(t.set(s,this[s]),delete this[s]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return pe(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach((t=>t.hostConnected?.()))}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach((t=>t.hostDisconnected?.()))}attributeChangedCallback(t,i,s){this._$AK(t,s)}_$ET(t,i){const s=this.constructor.elementProperties.get(t),o=this.constructor._$Eu(t,s);if(o!==void 0&&s.reflect===!0){const n=(s.converter?.toAttribute!==void 0?s.converter:st).toAttribute(i,s.type);this._$Em=t,n==null?this.removeAttribute(o):this.setAttribute(o,n),this._$Em=null}}_$AK(t,i){const s=this.constructor,o=s._$Eh.get(t);if(o!==void 0&&this._$Em!==o){const n=s.getPropertyOptions(o),a=typeof n.converter=="function"?{fromAttribute:n.converter}:n.converter?.fromAttribute!==void 0?n.converter:st;this._$Em=o;const r=a.fromAttribute(i,n.type);this[o]=r??this._$Ej?.get(o)??r,this._$Em=null}}requestUpdate(t,i,s){if(t!==void 0){const o=this.constructor,n=this[t];if(s??=o.getPropertyOptions(t),!((s.hasChanged??Tt)(n,i)||s.useDefault&&s.reflect&&n===this._$Ej?.get(t)&&!this.hasAttribute(o._$Eu(t,s))))return;this.C(t,i,s)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,i,{useDefault:s,reflect:o,wrapped:n},a){s&&!(this._$Ej??=new Map).has(t)&&(this._$Ej.set(t,a??i??this[t]),n!==!0||a!==void 0)||(this._$AL.has(t)||(this.hasUpdated||s||(i=void 0),this._$AL.set(t,i)),o===!0&&this._$Em!==t&&(this._$Eq??=new Set).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(i){Promise.reject(i)}const t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[o,n]of this._$Ep)this[o]=n;this._$Ep=void 0}const s=this.constructor.elementProperties;if(s.size>0)for(const[o,n]of s){const{wrapped:a}=n,r=this[o];a!==!0||this._$AL.has(o)||r===void 0||this.C(o,void 0,n,r)}}let t=!1;const i=this._$AL;try{t=this.shouldUpdate(i),t?(this.willUpdate(i),this._$EO?.forEach((s=>s.hostUpdate?.())),this.update(i)):this._$EM()}catch(s){throw t=!1,this._$EM(),s}t&&this._$AE(i)}willUpdate(t){}_$AE(t){this._$EO?.forEach((i=>i.hostUpdated?.())),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&=this._$Eq.forEach((i=>this._$ET(i,this[i]))),this._$EM()}updated(t){}firstUpdated(t){}};R.elementStyles=[],R.shadowRootOptions={mode:"open"},R[q("elementProperties")]=new Map,R[q("finalized")]=new Map,ve?.({ReactiveElement:R}),(ht.reactiveElementVersions??=[]).push("2.1.1");const Et=globalThis,ot=Et.trustedTypes,Nt=ot?ot.createPolicy("lit-html",{createHTML:e=>e}):void 0,te="$lit$",I=`lit$${Math.random().toFixed(9).slice(2)}$`,ee="?"+I,$e=`<${ee}>`,B=document,W=()=>B.createComment(""),Z=e=>e===null||typeof e!="object"&&typeof e!="function",Pt=Array.isArray,we=e=>Pt(e)||typeof e?.[Symbol.iterator]=="function",bt=`[ 	
\f\r]`,K=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Ut=/-->/g,Vt=/>/g,j=RegExp(`>|${bt}(?:([^\\s"'>=/]+)(${bt}*=${bt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ft=/'/g,zt=/"/g,ie=/^(?:script|style|textarea|title)$/i,xe=e=>(t,...i)=>({_$litType$:e,strings:t,values:i}),l=xe(1),A=Symbol.for("lit-noChange"),g=Symbol.for("lit-nothing"),Ht=new WeakMap,L=B.createTreeWalker(B,129);function se(e,t){if(!Pt(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return Nt!==void 0?Nt.createHTML(t):t}const _e=(e,t)=>{const i=e.length-1,s=[];let o,n=t===2?"<svg>":t===3?"<math>":"",a=K;for(let r=0;r<i;r++){const c=e[r];let y,u,h=-1,x=0;for(;x<c.length&&(a.lastIndex=x,u=a.exec(c),u!==null);)x=a.lastIndex,a===K?u[1]==="!--"?a=Ut:u[1]!==void 0?a=Vt:u[2]!==void 0?(ie.test(u[2])&&(o=RegExp("</"+u[2],"g")),a=j):u[3]!==void 0&&(a=j):a===j?u[0]===">"?(a=o??K,h=-1):u[1]===void 0?h=-2:(h=a.lastIndex-u[2].length,y=u[1],a=u[3]===void 0?j:u[3]==='"'?zt:Ft):a===zt||a===Ft?a=j:a===Ut||a===Vt?a=K:(a=j,o=void 0);const _=a===j&&e[r+1].startsWith("/>")?" ":"";n+=a===K?c+$e:h>=0?(s.push(y),c.slice(0,h)+te+c.slice(h)+I+_):c+I+(h===-2?r:_)}return[se(e,n+(e[i]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),s]};class G{constructor({strings:t,_$litType$:i},s){let o;this.parts=[];let n=0,a=0;const r=t.length-1,c=this.parts,[y,u]=_e(t,i);if(this.el=G.createElement(y,s),L.currentNode=this.el.content,i===2||i===3){const h=this.el.content.firstChild;h.replaceWith(...h.childNodes)}for(;(o=L.nextNode())!==null&&c.length<r;){if(o.nodeType===1){if(o.hasAttributes())for(const h of o.getAttributeNames())if(h.endsWith(te)){const x=u[a++],_=o.getAttribute(h).split(I),E=/([.?@])?(.*)/.exec(x);c.push({type:1,index:n,name:E[2],strings:_,ctor:E[1]==="."?Oe:E[1]==="?"?Ce:E[1]==="@"?Ae:pt}),o.removeAttribute(h)}else h.startsWith(I)&&(c.push({type:6,index:n}),o.removeAttribute(h));if(ie.test(o.tagName)){const h=o.textContent.split(I),x=h.length-1;if(x>0){o.textContent=ot?ot.emptyScript:"";for(let _=0;_<x;_++)o.append(h[_],W()),L.nextNode(),c.push({type:2,index:++n});o.append(h[x],W())}}}else if(o.nodeType===8)if(o.data===ee)c.push({type:2,index:n});else{let h=-1;for(;(h=o.data.indexOf(I,h+1))!==-1;)c.push({type:7,index:n}),h+=I.length-1}n++}}static createElement(t,i){const s=B.createElement("template");return s.innerHTML=t,s}}function U(e,t,i=e,s){if(t===A)return t;let o=s!==void 0?i._$Co?.[s]:i._$Cl;const n=Z(t)?void 0:t._$litDirective$;return o?.constructor!==n&&(o?._$AO?.(!1),n===void 0?o=void 0:(o=new n(e),o._$AT(e,i,s)),s!==void 0?(i._$Co??=[])[s]=o:i._$Cl=o),o!==void 0&&(t=U(e,o._$AS(e,t.values),o,s)),t}class Se{constructor(t,i){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=i}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:i},parts:s}=this._$AD,o=(t?.creationScope??B).importNode(i,!0);L.currentNode=o;let n=L.nextNode(),a=0,r=0,c=s[0];for(;c!==void 0;){if(a===c.index){let y;c.type===2?y=new Q(n,n.nextSibling,this,t):c.type===1?y=new c.ctor(n,c.name,c.strings,this,t):c.type===6&&(y=new Te(n,this,t)),this._$AV.push(y),c=s[++r]}a!==c?.index&&(n=L.nextNode(),a++)}return L.currentNode=B,o}p(t){let i=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(t,s,i),i+=s.strings.length-2):s._$AI(t[i])),i++}}class Q{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,i,s,o){this.type=2,this._$AH=g,this._$AN=void 0,this._$AA=t,this._$AB=i,this._$AM=s,this.options=o,this._$Cv=o?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const i=this._$AM;return i!==void 0&&t?.nodeType===11&&(t=i.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,i=this){t=U(this,t,i),Z(t)?t===g||t==null||t===""?(this._$AH!==g&&this._$AR(),this._$AH=g):t!==this._$AH&&t!==A&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):we(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==g&&Z(this._$AH)?this._$AA.nextSibling.data=t:this.T(B.createTextNode(t)),this._$AH=t}$(t){const{values:i,_$litType$:s}=t,o=typeof s=="number"?this._$AC(t):(s.el===void 0&&(s.el=G.createElement(se(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===o)this._$AH.p(i);else{const n=new Se(o,this),a=n.u(this.options);n.p(i),this.T(a),this._$AH=n}}_$AC(t){let i=Ht.get(t.strings);return i===void 0&&Ht.set(t.strings,i=new G(t)),i}k(t){Pt(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let s,o=0;for(const n of t)o===i.length?i.push(s=new Q(this.O(W()),this.O(W()),this,this.options)):s=i[o],s._$AI(n),o++;o<i.length&&(this._$AR(s&&s._$AB.nextSibling,o),i.length=o)}_$AR(t=this._$AA.nextSibling,i){for(this._$AP?.(!1,!0,i);t!==this._$AB;){const s=t.nextSibling;t.remove(),t=s}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}}class pt{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,i,s,o,n){this.type=1,this._$AH=g,this._$AN=void 0,this.element=t,this.name=i,this._$AM=o,this.options=n,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=g}_$AI(t,i=this,s,o){const n=this.strings;let a=!1;if(n===void 0)t=U(this,t,i,0),a=!Z(t)||t!==this._$AH&&t!==A,a&&(this._$AH=t);else{const r=t;let c,y;for(t=n[0],c=0;c<n.length-1;c++)y=U(this,r[s+c],i,c),y===A&&(y=this._$AH[c]),a||=!Z(y)||y!==this._$AH[c],y===g?t=g:t!==g&&(t+=(y??"")+n[c+1]),this._$AH[c]=y}a&&!o&&this.j(t)}j(t){t===g?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class Oe extends pt{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===g?void 0:t}}class Ce extends pt{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==g)}}class Ae extends pt{constructor(t,i,s,o,n){super(t,i,s,o,n),this.type=5}_$AI(t,i=this){if((t=U(this,t,i,0)??g)===A)return;const s=this._$AH,o=t===g&&s!==g||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,n=t!==g&&(s===g||o);o&&this.element.removeEventListener(this.name,this,s),n&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class Te{constructor(t,i,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=i,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){U(this,t)}}const Ee=Et.litHtmlPolyfillSupport;Ee?.(G,Q),(Et.litHtmlVersions??=[]).push("3.3.1");const Pe=(e,t,i)=>{const s=i?.renderBefore??t;let o=s._$litPart$;if(o===void 0){const n=i?.renderBefore??null;s._$litPart$=o=new Q(t.insertBefore(W(),n),n,void 0,i??{})}return o._$AI(e),o};const It=globalThis;let $=class extends R{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const i=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Pe(i,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return A}};$._$litElement$=!0,$.finalized=!0,It.litElementHydrateSupport?.({LitElement:$});const Ie=It.litElementPolyfillSupport;Ie?.({LitElement:$});(It.litElementVersions??=[]).push("4.2.1");const O=e=>(t,i)=>{i!==void 0?i.addInitializer((()=>{customElements.define(e,t)})):customElements.define(e,t)};const ke={attribute:!0,type:String,converter:st,reflect:!1,hasChanged:Tt},je=(e=ke,t,i)=>{const{kind:s,metadata:o}=i;let n=globalThis.litPropertyMetadata.get(o);if(n===void 0&&globalThis.litPropertyMetadata.set(o,n=new Map),s==="setter"&&((e=Object.create(e)).wrapped=!0),n.set(i.name,e),s==="accessor"){const{name:a}=i;return{set(r){const c=t.get.call(this);t.set.call(this,r),this.requestUpdate(a,c,e)},init(r){return r!==void 0&&this.C(a,void 0,e,r),r}}}if(s==="setter"){const{name:a}=i;return function(r){const c=this[a];t.call(this,r),this.requestUpdate(a,c,e)}}throw Error("Unsupported decorator location: "+s)};function p(e){return(t,i)=>typeof i=="object"?je(e,t,i):((s,o,n)=>{const a=o.hasOwnProperty(n);return o.constructor.createProperty(n,s),a?Object.getOwnPropertyDescriptor(o,n):void 0})(e,t,i)}function d(e){return p({...e,state:!0,attribute:!1})}const oe=(e,t,i)=>(i.configurable=!0,i.enumerable=!0,Reflect.decorate&&typeof t!="object"&&Object.defineProperty(e,t,i),i);function w(e,t){return(i,s,o)=>{const n=a=>a.renderRoot?.querySelector(e)??null;return oe(i,s,{get(){return n(this)}})}}let Le;function ne(e){return(t,i)=>oe(t,i,{get(){return(this.renderRoot??(Le??=document.createDocumentFragment())).querySelectorAll(e)}})}const F=T`
  :host {
    /*
    BASE STYLES
...
`;var De=Object.getOwnPropertyDescriptor,Be=(e,t,i,s)=>{for(var o=s>1?void 0:s?De(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=a(o)||o);return o};let vt=class extends ${render(){return l`
      <button>
        <slot></slot>
      </button>
    `}static get styles(){return[F,T`
      ...
      `]}};vt=Be([O("ia-button")],vt);const Kt=Object.freeze(Object.defineProperty({__proto__:null,get IAButton(){return vt}},Symbol.toStringTag,{value:"Module"}));function N(e,t,i){return e?t(e):i?.(e)}const nt=e=>e??g,Me="modulepreload",Re=function(e,t){return new URL(e,t).href},qt={},it=function(t,i,s){let o=Promise.resolve();if(i&&i.length>0){let y=function(u){return Promise.all(u.map(h=>Promise.resolve(h).then(x=>({status:"fulfilled",value:x}),x=>({status:"rejected",reason:x}))))};const a=document.getElementsByTagName("link"),r=document.querySelector("meta[property=csp-nonce]"),c=r?.nonce||r?.getAttribute("nonce");o=y(i.map(u=>{if(u=Re(u,s),u in qt)return;qt[u]=!0;const h=u.endsWith(".css"),x=h?'[rel="stylesheet"]':"";if(s)for(let E=a.length-1;E>=0;E--){const tt=a[E];if(tt.href===u&&(!h||tt.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${u}"]${x}`))return;const _=document.createElement("link");if(_.rel=h?"stylesheet":Me,h||(_.as="script"),_.crossOrigin="",_.href=u,c&&_.setAttribute("nonce",c),document.head.appendChild(_),h)return new Promise((E,tt)=>{_.addEventListener("load",E),_.addEventListener("error",()=>tt(new Error(`Unable to preload CSS for ${u}`)))})}))}function n(a){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=a,window.dispatchEvent(r),!r.defaultPrevented)throw a}return o.then(a=>{for(const r of a||[])r.status==="rejected"&&n(r.reason);return t().catch(n)})};const P={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4},dt=e=>(...t)=>({_$litDirective$:e,values:t});class ut{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,i,s){this._$Ct=t,this._$AM=i,this._$Ci=s}_$AS(t,i){return this.update(t,i)}update(t,i){return this.render(...i)}}let $t=class extends ut{constructor(t){if(super(t),this.it=g,t.type!==P.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===g||t==null)return this._t=void 0,this.it=t;if(t===A)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const i=[t];return i.raw=i,this._t={_$litType$:this.constructor.resultType,strings:i,values:[]}}};$t.directiveName="unsafeHTML",$t.resultType=1;const Y=dt($t),Ne=T`
  pre {
...
`;var Ue=Object.defineProperty,Ve=Object.getOwnPropertyDescriptor,gt=(e,t,i,s)=>{for(var o=s>1?void 0:s?Ve(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(s?a(t,i,o):a(o))||o);return s&&o&&Ue(t,i,o),o};let J=class extends ${constructor(){super(...arguments),this.code="",this.language="auto",this.highlightedCode=""}willUpdate(e){(e.has("code")||e.has("language"))&&this.highlightCode()}render(){return l`
 ...
 `)}}))}static get styles(){return[F,T`
      ...
      `]}};kt([p({type:Object})],rt.prototype,"styleInputData",2);kt([ne(".style-input")],rt.prototype,"styleInputs",2);rt=kt([O("story-styles-settings")],rt);const ae=(e,t,i)=>{for(const s of t)if(s[0]===e)return(0,s[1])();return i?.()};var Ke=Object.defineProperty,qe=Object.getOwnPropertyDescriptor,jt=(e,t,i,s)=>{for(var o=s>1?void 0:s?qe(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(s?a(t,i,o):a(o))||o);return s&&o&&Ke(t,i,o),o};let lt=class extends ${render(){return this.propInputData?l`
      <div class="settings-options">
        <table>
          ${this.propInputData.settings.map(e=>ae(e.inputType,[["radio",()=>this.createRadioPropInput(e)]],()=>this.createDefaultPropInput(e))??g)}
        </table>
        <button @click=${this.applyProps}>Apply</button>
      </div>
    `:g}createDefaultPropInput(e){const t=at(e.label);return l`
      <tr>
        ...
        <td>
          <input
            ...
            placeholder=${nt(e?.defaultValue)}
          />
        </td>
      </tr>
    `}createRadioPropInput(e){if(e.inputType!=="radio"||!e.radioOptions)return g;const t=at(e.label);return l`
      <tr>
...
`,appliedProps:t}}))}static get styles(){return[F,T`
      ...
      `]}};jt([p({type:Object})],lt.prototype,"propInputData",2);jt([ne(".prop-input")],lt.prototype,"propInputs",2);lt=jt([O("story-props-settings")],lt);var We=Object.defineProperty,Ze=Object.getOwnPropertyDescriptor,C=(e,t,i,s)=>{for(var o=s>1?void 0:s?Ze(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(s?a(t,i,o):a(o))||o);return s&&o&&We(t,i,o),o};let S=class extends ${constructor(){super(...arguments),this.elementTag="",this.elementClassName="",this.labs=!1,this.detailsVisible=!1,this.shouldShowPropertySettings=!1,this.copiedKey=null}render(){return l`
      <div id="container">
        <h2>
        ...
        <h3>Demo</h3>
        <div class="slot-container" style=${nt(this.stringifiedStyles)}>
          <slot
            name="demo"
...
`:"",t=this.stringifiedProps??"";return`<${this.elementTag}${e}${t}></${this.elementTag}>`}get cssCode(){return this.stringifiedStyles?`${this.elementTag} {
 ${this.stringifiedStyles}
}`:""}get modulePath(){return this.labs?`@internetarchive/elements/labs/${this.elementTag}/${this.elementTag}`:`@internetarchive/elements/${this.elementTag}/${this.elementTag}`}handleSettingsSlotChange(e){const t=e.target.assignedElements();this.shouldShowPropertySettings=t.length>0}handleDemoComponentSlotted(e){const t=e.target.assignedElements()[0];t&&(this.slottedDemoComponent=t)}handleStylesApplied(e){const t=e.detail.styles;t&&(this.stringifiedStyles=t)}handlePropsApplied(e){const t=e.detail.stringifiedProps,i=e.detail.appliedProps;!t||!i||(this.stringifiedProps=t,i.forEach(s=>{this.slottedDemoComponent[s.propName]=s.value}))}static get styles(){return[F,T`
        #container {
          background: #f0f0f0;
          padding: 0 10px 10px;
          margin-bottom: 1rem;
      ...
      `]}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this._copyTimeout)}};C([p({type:String})],S.prototype,"elementTag",2);C([p({type:String})],S.prototype,"elementClassName",2);C([p({type:String})],S.prototype,"customExampleUsage",2);C([p({type:String})],S.prototype,"defaultUsageProps",2);C([p({type:Object})],S.prototype,"styleInputData",2);C([p({type:Object})],S.prototype,"propInputData",2);C([p({type:Boolean})],S.prototype,"labs",2);C([d()],S.prototype,"detailsVisible",2);C([d()],S.prototype,"stringifiedStyles",2);C([d()],S.prototype,"stringifiedProps",2);C([d()],S.prototype,"shouldShowPropertySettings",2);C([d()],S.prototype,"slottedDemoComponent",2);C([d()],S.prototype,"copiedKey",2);S=C([O("story-template")],S);var Ge=Object.getOwnPropertyDescriptor,Ye=(e,t,i,s)=>{for(var o=s>1?void 0:s?Ge(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=a(o)||o);return o};const Je=[{label:"Text Color (Primary)",cssVariable:"--ia-theme-primary-cta-text-color",defaultValue:"#ffffff",inputType:"color"},{label:"Background Color (Primary)",cssVariable:"--ia-theme-primary-cta-fill",defaultValue:"#194880",inputType:"color"}];let wt=class extends ${render(){return l`
      <story-template
    ...
    `}get textInputTemplate(){const e=yt({"clear-padding":this.clearable&&!this.shouldShowClearButton});return l`
      <input
        type="text"
        id="text-input"
        class=${e}
        ...
        aria-activedescendant=${nt(this.highlightedOption?.id)}
    ...
    `}get optionTemplates(){return this.filteredOptions.length===0&&this.maxAutocompleteEntries>0?[this.emptyOptionsTemplate]:this.filteredOptions.map(e=>{const t=e===this.highlightedOption,i=yt({option:!0,highlight:t});return l`
        <li
          id=${e.id}
          class=${i}
    ...
    `;return[F,e]}};m.formAssociated=!0;m.shadowRootOptions={...$.shadowRootOptions,delegatesFocus:!0};v([p({type:Array})],m.prototype,"options",2);v([p({type:String})],m.prototype,"placeholder",2);v([p({type:String})],m.prototype,"behavior",2);v([p({type:Number,attribute:"max-autocomplete-entries"})],m.prototype,"maxAutocompleteEntries",2);v([p({type:String})],m.prototype,"filter",2);v([p({type:Boolean,reflect:!0,attribute:"case-sensitive"})],m.prototype,"caseSensitive",2);v([p({type:Boolean,reflect:!0})],m.prototype,"sort",2);v([p({type:Boolean,reflect:!0,attribute:"wrap-arrow-keys"})],m.prototype,"wrapArrowKeys",2);v([p({type:Boolean,reflect:!0,attribute:"stay-open"})],m.prototype,"stayOpen",2);v([p({type:Boolean,reflect:!0})],m.prototype,"clearable",2);v([p({type:Boolean,reflect:!0})],m.prototype,"open",2);v([p({type:Boolean,reflect:!0})],m.prototype,"disabled",2);v([p({type:Boolean,reflect:!0})],m.prototype,"required",2);v([p({type:String})],m.prototype,"value",2);v([d()],m.prototype,"hasFocus",2);v([d()],m.prototype,"highlightedOption",2);v([d()],m.prototype,"enteredText",2);v([d()],m.prototype,"filterText",2);v([w("#main-widget-row")],m.prototype,"mainWidgetRow",2);v([w("#text-input")],m.prototype,"textInput",2);v([w("#options-list")],m.prototype,"optionsList",2);m=v([O("ia-combo-box")],m);var $i=Object.defineProperty,wi=Object.getOwnPropertyDescriptor,b=(e,t,i,s)=>{for(var o=s>1?void 0:s?wi(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(s?a(t,i,o):a(o))||o);return s&&o&&$i(t,i,o),o};const xi=[{label:"Width",cssVariable:"--ia-theme-combo-box-width",defaultValue:"250px",inputType:"text"},{label:"Padding",cssVariable:"--ia-theme-padding-sm",defaultValue:"5px",inputType:"text"},{label:"Dropdown width",cssVariable:"--combo-box-list-width",defaultValue:"",inputType:"text"},{label:"Dropdown max height",cssVariable:"--combo-box-list-max-height",defaultValue:"250px",inputType:"text"}],le=[{id:"red",text:"Red"},{id:"orange",text:"Orange"},{id:"yellow",text:"Yellow"},{id:"green",text:"Green"},{id:"blue",text:"Blue"},{id:"indigo",text:"Indigo"},{id:"violet",text:"Violet"}],_i=le.map(e=>({...e,content:l` <span style="display: flex; align-items: center">
      <span style="flex: 1">${e.text}</span>
      <div style="width: 15px; height: 15px; background:${e.id}"></div>
    </span>`})),Wt=re.map(e=>({id:e.name,text:e.name})),Si=re.map(e=>({id:e.name,text:e.name,content:l`<span>${e.flag}</span>&nbsp;<span>${e.name}</span>`})),Oi="list",Ci="Choices",Zt="Select an option...",Gt=50,Ai="substring";let f=class extends ${constructor(){super(...arguments),this.options=Wt,this.behavior=Oi,this.label=Ci,this.placeholder=Zt,this.maxAutocompleteEntries=Gt,this.filterFn=Ai,this.caseSensitive=!1,this.shouldSort=!1,this.wrapArrowKeys=!0,this.clearable=!0,this.disabled=!1,this.announcerText=""}render(){return l`
      <story-template
...
`)}applySettings(e){e.preventDefault(),this.updateOptions(),this.behavior=this.behaviorSelect.value,this.label=this.labelInput.value,this.placeholder=this.placeholderInput.value,this.maxAutocompleteEntries=Number(this.maxAutocompleteInput.value),this.filterFn=this.filterFnSelect.value,this.caseSensitive=this.caseSensitiveCheck.checked,this.shouldSort=this.sortCheck.checked,this.wrapArrowKeys=this.wrapArrowKeysCheck.checked,this.clearable=this.clearableCheck.checked,this.disabled=this.disabledCheck.checked}updateOptions(){switch(this.optionSetSelect.value){case"colors":this.options=this.customContentCheck.checked?_i:le;break;case"countries":this.options=this.customContentCheck.checked?Si:Wt;break;default:this.options=[]}}handleComboBoxChange(e){this.announcerText=`New value is: ${e.detail}`}static get styles(){return T`
    ...
    `}};b([d()],f.prototype,"options",2);b([d()],f.prototype,"behavior",2);b([d()],f.prototype,"label",2);b([d()],f.prototype,"placeholder",2);b([d()],f.prototype,"maxAutocompleteEntries",2);b([d()],f.prototype,"filterFn",2);b([d()],f.prototype,"caseSensitive",2);b([d()],f.prototype,"shouldSort",2);b([d()],f.prototype,"wrapArrowKeys",2);b([d()],f.prototype,"clearable",2);b([d()],f.prototype,"disabled",2);b([d()],f.prototype,"announcerText",2);b([w("#settings__options")],f.prototype,"optionSetSelect",2);b([w("#settings__custom-content")],f.prototype,"customContentCheck",2);b([w("#settings__behavior")],f.prototype,"behaviorSelect",2);b([w("#settings__label")],f.prototype,"labelInput",2);b([w("#settings__placeholder")],f.prototype,"placeholderInput",2);b([w("#settings__max-entries")],f.prototype,"maxAutocompleteInput",2);b([w("#settings__filter-fn")],f.prototype,"filterFnSelect",2);b([w("#settings__case-sensitive")],f.prototype,"caseSensitiveCheck",2);b([w("#settings__sort")],f.prototype,"sortCheck",2);b([w("#settings__wrap")],f.prototype,"wrapArrowKeysCheck",2);b([w("#settings__clearable")],f.prototype,"clearableCheck",2);b([w("#settings__disabled")],f.prototype,"disabledCheck",2);f=b([O("ia-combo-box-story")],f);const Ti=Object.freeze(Object.defineProperty({__proto__:null,get IAComboBoxStory(){return f}},Symbol.toStringTag,{value:"Module"}));var Ei=Object.defineProperty,Pi=Object.getOwnPropertyDescriptor,z=(e,t,i,s)=>{for(var o=s>1?void 0:s?Pi(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(s?a(t,i,o):a(o))||o);return s&&o&&Ei(t,i,o),o};let M=class extends ${constructor(){super(...arguments),this.loadingTitle=D("Loading..."),this.successTitle=D("Success"),this.errorTitle=D("Error"),this.loadingStyle="ring-dots",this.mode="loading"}render(){return l`${ae(this.mode,[["loading",()=>this.loadingIndicatorTemplate],["success",()=>this.successIndicatorTemplate],["error",()=>this.errorIndicatorTemplate]])}`}get loadingIndicatorTemplate(){return l`
      <svg
    ...
    `}get shouldShowLoadingDots(){return this.loadingStyle!=="ring"}static get styles(){return[F,T`
      ...
      `]}};z([p({type:String})],M.prototype,"loadingTitle",2);z([p({type:String})],M.prototype,"successTitle",2);z([p({type:String})],M.prototype,"errorTitle",2);z([p({type:String})],M.prototype,"loadingStyle",2);z([p({type:String})],M.prototype,"mode",2);M=z([O("ia-status-indicator")],M);var Ii=Object.getOwnPropertyDescriptor,ki=(e,t,i,s)=>{for(var o=s>1?void 0:s?Ii(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=a(o)||o);return o};const ji=[{label:"Width",cssVariable:"--ia-theme-icon-width",defaultValue:"1.25rem"},{label:"Color - loading",cssVariable:"--ia-theme-primary-text-color",defaultValue:"#2c2c2c",inputType:"color"},{label:"Color - success",cssVariable:"--ia-theme-color-success",defaultValue:"#31a481",inputType:"color"},{label:"Color - error",cssVariable:"--ia-theme-color-danger",defaultValue:"#e51c23",inputType:"color"}],Li=[{label:"Mode",propertyName:"mode",defaultValue:"loading",inputType:"radio",radioOptions:["loading","success","error"]},{label:"Accessible title - loading",propertyName:"loadingTitle",defaultValue:"Loading..."},{label:"Loading style",propertyName:"loadingStyle",defaultValue:"ring-dots",inputType:"radio",radioOptions:["ring-dots","ring"]},{label:"Accessible title - success",propertyName:"successTitle",defaultValue:"Success"},{label:"Accessible title - error",propertyName:"errorTitle",defaultValue:"Error"}];let xt=class extends ${render(){return l`
      <story-template
    ...
    `}};xt=ki([O("ia-status-indicator-story")],xt);const Di=Object.freeze(Object.defineProperty({__proto__:null,get IAStatusIndicatorStory(){return xt}},Symbol.toStringTag,{value:"Module"})),Bi=`<svg
  class="icon-loader"
  height="20"
  viewBox="0 0 128 128"
  width="20"
...
`;var Ri=Object.defineProperty,Ni=Object.getOwnPropertyDescriptor,ft=(e,t,i,s)=>{for(var o=s>1?void 0:s?Ni(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(s?a(t,i,o):a(o))||o);return s&&o&&Ri(t,i,o),o};let X=class extends ${constructor(){super(...arguments),this.widgetSrc="",this.buttonVisible=!0,this.isLoading=!1,this.zendeskReady=!1}async initiateZenDesk(){this.isLoading=!0,this.dispatchEvent(new Event("zendeskHelpButtonClicked"));try{this.zendeskReady||(await this.loadZendeskScript(),await this.waitForZendesk(),window.zE("messenger:on","open",()=>{this.buttonVisible=!1,this.isLoading=!1}),window.zE("messenger:on","close",()=>{setTimeout(()=>{this.buttonVisible=!0},500)}),this.zendeskReady=!0),window.zE("messenger","open")}catch(e){this.isLoading=!1,console.error("[ia-zendesk-widget]",e)}}loadZendeskScript(){return new Promise((e,t)=>{if(document.getElementById("ze-snippet")){e();return}const i=document.createElement("script");i.id="ze-snippet",i.src=this.widgetSrc,i.onload=()=>e(),i.onerror=()=>t(new Error("Failed to load Zendesk script")),document.head.appendChild(i)})}waitForZendesk(e=1e4){return new Promise((t,i)=>{const s=setInterval(()=>{window.zE&&(clearInterval(s),clearTimeout(o),t())},100),o=setTimeout(()=>{clearInterval(s),i(new Error("Zendesk API did not initialise in time"))},e)})}get iconTemplate(){return this.isLoading?Y(Bi):Y(Mi)}render(){return l`
      <button
    ...
    `}};ft([p({type:String,attribute:"widget-src"})],X.prototype,"widgetSrc",2);ft([d()],X.prototype,"buttonVisible",2);ft([d()],X.prototype,"isLoading",2);X=ft([O("ia-zendesk-widget")],X);var Ui=Object.defineProperty,Vi=Object.getOwnPropertyDescriptor,mt=(e,t,i,s)=>{for(var o=s>1?void 0:s?Vi(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(s?a(t,i,o):a(o))||o);return s&&o&&Ui(t,i,o),o};const _t="https://static.zdassets.com/ekr/snippet.js?key=6fe87bd8-d4e3-4b42-8632-be6eb933d54d",Fi="https://static.zdassets.com/ekr/snippet.js?key=685f6dc4-48c5-411f-8463-cc6dd50abe2d",zi=[{label:"Test",src:_t},{label:"Production",src:Fi}];let V=class extends ${constructor(){super(...arguments),this.appliedSrc=_t,this.pendingSrc=_t,this.widgetMounted=!1}get usageExample(){return`<ia-zendesk-widget
  widget-src="${this.appliedSrc}"
></ia-zendesk-widget>`}applySelection(){this.appliedSrc=this.pendingSrc,this.widgetMounted=!0;const e=this.shadowRoot?.querySelector("ia-zendesk-widget");e&&(e.widgetSrc=this.appliedSrc)}render(){return l`
      <story-template
            ...
            ${zi.map(({label:e,src:t})=>l`
                <label>
                  <input
                    ...
                    name="widget-src"
                    value=${t}
                    ?checked=${this.pendingSrc===t}
                    @change=${()=>this.pendingSrc=t}
                  />
                  ${e}
                </label>
              `)}
    ...
    `}};H([d()],k.prototype,"config",2);H([w("#count")],k.prototype,"countInput",2);H([w("#wind")],k.prototype,"windInput",2);H([w("#rotation")],k.prototype,"rotationInput",2);H([w("#color")],k.prototype,"colorInput",2);k=H([O("ia-snow-story")],k);const Ji=Object.freeze(Object.defineProperty({__proto__:null,get IASnowStory(){return k}},Symbol.toStringTag,{value:"Module"}));var Xi=Object.getOwnPropertyDescriptor,Qi=(e,t,i,s)=>{for(var o=s>1?void 0:s?Xi(t,i):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=a(o)||o);return o};const ts=Object.assign({"../src/elements/ia-button/ia-button-story.ts":Xe,"../src/elements/ia-combo-box/ia-combo-box-story.ts":Ti,"../src/elements/ia-status-indicator/ia-status-indicator-story.ts":Di,"../src/elements/ia-zendesk-widget/ia-zendesk-widget-story.ts":Hi,"../src/labs/ia-snow/ia-snow-story.ts":Ji}),ce=Object.keys(ts).map(e=>{const t=e.includes("/src/labs/"),i=e.split("/"),o=i[i.length-1].replace(/-story\.ts$/,"");return{tag:o,storyTag:`${o}-story`,id:`elem-${o}`,labs:t}}).sort((e,t)=>e.tag.localeCompare(t.tag)),St=ce.filter(e=>!e.labs),Ot=ce.filter(e=>e.labs),es=[...St,...Ot];let Xt=class extends ${constructor(){super(...arguments),this._abortController=new AbortController}createRenderRoot(){return this}render(){return l`
      <nav id="ia-sidebar">
        <h2>Production-Ready</h2>
        ${St.map(e=>l`<a href="#${e.id}">&lt;${e.tag}&gt;</a>`)}
        <h2>Labs 🧪</h2>
        ${Ot.map(e=>l`<a href="#${e.id}">&lt;${e.tag}&gt;</a>`)}
      </nav>
      <div id="ia-content">
