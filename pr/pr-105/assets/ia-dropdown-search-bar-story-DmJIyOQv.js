...
fill=""></path>
      ...
      <span ?hidden=${!this.open} class="caret-up">
        <slot name="caret-up">${se}</slot>
      </span>
    `}get caretDownTemplate(){return f`
      <span ?hidden=${this.open} class="caret-down">
        <slot name="caret-down">${ae}</slot>
      </span>
  ...
  `;lt=p([ct("ia-icon-label")],lt);var le=Object.defineProperty,de=Object.getOwnPropertyDescriptor,C=(i,t,e,o)=>{for(var r=o>1?void 0:o?de(t,e):t,n=i.length-1,s;n>=0;n--)(s=i[n])&&(r=(o?s(t,e,r):s(r))||r);return o&&r&&le(t,e,r),r};const Ct={CategoryChanged:"categoryChanged",SearchRequested:"searchRequested"};let x=class extends Et{constructor(){super(...arguments),this.categories=[],this.placeholder=W("Search"),this.useMobileView=!1,this.hideDropdown=!1,this.loading=!1}get resolvedCategory(){return this.selectedCategory??this.categories?.[0]?.id??""}render(){return S`
    ...
    `;return[zt,i]}};C([O({type:String})],x.prototype,"query",2);C([O({type:Array})],x.prototype,"categories",2);C([O({type:String})],x.prototype,"selectedCategory",2);C([O({type:String})],x.prototype,"placeholder",2);C([O({type:Boolean})],x.prototype,"useMobileView",2);C([O({type:Boolean})],x.prototype,"hideDropdown",2);C([O({type:Boolean})],x.prototype,"loading",2);C([P("#search-input")],x.prototype,"searchInput",2);C([P("#category-dropdown")],x.prototype,"categoryDropdown",2);x=C([kt("ia-dropdown-search-bar")],x);var pe=Object.defineProperty,ce=Object.getOwnPropertyDescriptor,$=(i,t,e,o)=>{for(var r=o>1?void 0:o?ce(t,e):t,n=i.length-1,s;n>=0;n--)(s=i[n])&&(r=(o?s(t,e,r):s(r))||r);return o&&r&&pe(t,e,r),r};const he=[{label:"Bar height",cssVariable:"--ia-theme-search-bar-height",defaultValue:"30px",inputType:"text"},{label:"Bar width",cssVariable:"--ia-theme-search-bar-width",defaultValue:"300px",inputType:"text"},{label:"Internal padding",cssVariable:"--ia-theme-padding-sm",defaultValue:"5px",inputType:"text"},{label:"Dropdown z-index",cssVariable:"--dropdown-z-index",defaultValue:2,inputType:"number",min:0,step:1}],St=[{id:"all",label:"All"},{id:"texts",label:"Books/Documents"},{id:"fulltext",label:"Text Contents"},{id:"radio",label:"Radio"},{id:"tv",label:"TV"},{id:"movies",label:"Video"},{id:"audio",label:"Audio"},{id:"software",label:"Software"},{id:"image",label:"Images"},{id:"etree",label:"Live Music"},{id:"collection",label:"Collections"},{id:"data",label:"Data"},{id:"web",label:"Web Sites"}],ue="all",At="Search";let m=class extends Et{constructor(){super(...arguments),this.query="",this.selectedCategory=ue,this.placeholder=At,this.hideDropdown=!1,this.loading=!1,this.announcerText=""}render(){return S`
      <story-template
        elementTag="ia-dropdown-search-bar"
        elementClassName="IADropdownSearchBar"
        .customExampleUsage=${this.exampleUsage}
        .styleInputData=${{settings:he}}
      >
        <div slot="demo">
