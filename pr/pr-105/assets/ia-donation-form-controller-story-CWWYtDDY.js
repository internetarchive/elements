import{n as l,t as $,i as E,b as d,a as h,A as he,r as x}from"./index-56B-Iq-d.js";import{e as p}from"./query-BRD1yltV.js";import{_ as L,a as W}from"./icon-close-CFkUH5zF.js";import{C as We,D as M,c as pe,a as _,d as Ae,E as we,b as ue,e as Ue}from"./ia-donation-edit-donation-DbCeuAUR.js";import{m as s,s as Ce}from"./runtime-CCgtQBty.js";import{t as H,o as be}from"./story-template-DfCN2INx.js";import{m as ee}from"./masked-icon-BJu91dgm.js";import{D as Je}from"./ia-donation-section-WAikgXQp.js";class V{constructor(e){this.title=e?.title,this.subtitle=e?.subtitle,this.headline=e?.headline,this.message=e?.message,this.headerColor=e?.headerColor??"#55A183",this.bodyColor=e?.bodyColor??"#fbfbfd",this.showProcessingIndicator=e?.showProcessingIndicator??!1,this.processingImageMode=e?.processingImageMode??"complete",this.showCloseButton=e?.showCloseButton??!0,this.showLeftNavButton=e?.showLeftNavButton??!1,this.leftNavButtonText=e?.leftNavButtonText??"",this.showHeaderLogo=e?.showHeaderLogo??!0,this.closeOnBackdropClick=e?.closeOnBackdropClick??!0}}function*De(o=document.activeElement){o!=null&&(yield o,"shadowRoot"in o&&o.shadowRoot&&o.shadowRoot.mode!=="closed"&&(yield*De(o.shadowRoot.activeElement)))}function _e(){return[...De()].pop()}const ze=new WeakMap;function qe(o){let e=ze.get(o);return e||(e=window.getComputedStyle(o,null),ze.set(o,e)),e}function Xe(o){if("checkVisibility"in o&&typeof o.checkVisibility=="function")return o.checkVisibility({checkOpacity:!1,checkVisibilityCSS:!0});const e=qe(o);return e.visibility!=="hidden"&&e.display!=="none"}function Qe(o){const e=qe(o),{overflowY:t,overflowX:a}=e;return t==="scroll"||a==="scroll"?!0:t!=="auto"||a!=="auto"?!1:o.scrollHeight>o.clientHeight&&t==="auto"||o.scrollWidth>o.clientWidth&&a==="auto"}function et(o){const e=o.tagName.toLowerCase(),t=Number(o.getAttribute("tabindex"));return o.hasAttribute("tabindex")&&(isNaN(t)||t<=-1)||o.hasAttribute("disabled")||o.closest("[inert]")||e==="input"&&o.getAttribute("type")==="radio"&&!o.hasAttribute("checked")||!Xe(o)?!1:(e==="audio"||e==="video")&&o.hasAttribute("controls")||o.hasAttribute("tabindex")||o.hasAttribute("contenteditable")&&o.getAttribute("contenteditable")!=="false"||["button","input","select","textarea","a","audio","video","summary","iframe"].includes(e)?!0:Qe(o)}function tt(o,e){return o.getRootNode({composed:!0})?.host!==e}function Oe(o){const e=new WeakMap,t=[];function a(n){if(n instanceof Element){if(n.hasAttribute("inert")||n.closest("[inert]")||e.has(n))return;e.set(n,!0),!t.includes(n)&&et(n)&&t.push(n),n instanceof HTMLSlotElement&&tt(n,o)&&n.assignedElements({flatten:!0}).forEach(i=>{a(i)}),n.shadowRoot!==null&&n.shadowRoot.mode==="open"&&a(n.shadowRoot)}for(const i of Array.from(n.children))a(i)}return a(o),t.sort((n,i)=>{const r=Number(n.getAttribute("tabindex"))||0;return(Number(i.getAttribute("tabindex"))||0)-r})}let re=[];class ot{constructor(e){this.isExternalActivated=!1,this.tabDirection="forward",this.currentFocus=null,this.previousFocus=null,this.handleFocusIn=()=>{this.isActive()&&this.checkFocus()},this.handleKeyDown=t=>{if(t.key!=="Tab"||this.isExternalActivated||!this.isActive())return;const a=_e();if(this.previousFocus=a,this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus))return;t.shiftKey?this.tabDirection="backward":this.tabDirection="forward";const n=Oe(this.element);let i=n.findIndex(c=>c===a);this.previousFocus=this.currentFocus;const r=this.tabDirection==="forward"?1:-1;for(;;){i+r>=n.length?i=0:i+r<0?i=n.length-1:i+=r,this.previousFocus=this.currentFocus;const c=n[i];if(this.tabDirection==="backward"&&this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus)||c&&this.possiblyHasTabbableChildren(c))return;t.preventDefault(),this.currentFocus=c,this.currentFocus?.focus({preventScroll:!1});const u=[...De()];if(u.includes(this.currentFocus)||!u.includes(this.previousFocus))break}setTimeout(()=>this.checkFocus())},this.handleKeyUp=()=>{this.tabDirection="forward"},this.element=e,this.elementsWithTabbableControls=["iframe"]}activate(){re.push(this.element),document.addEventListener("focusin",this.handleFocusIn),document.addEventListener("keydown",this.handleKeyDown),document.addEventListener("keyup",this.handleKeyUp)}deactivate(){re=re.filter(e=>e!==this.element),this.currentFocus=null,document.removeEventListener("focusin",this.handleFocusIn),document.removeEventListener("keydown",this.handleKeyDown),document.removeEventListener("keyup",this.handleKeyUp)}isActive(){return re[re.length-1]===this.element}activateExternal(){this.isExternalActivated=!0}deactivateExternal(){this.isExternalActivated=!1}checkFocus(){if(this.isActive()&&!this.isExternalActivated){const e=Oe(this.element);if(!this.element.matches(":focus-within")){const t=e[0],a=e[e.length-1],n=this.tabDirection==="forward"?t:a;typeof n?.focus=="function"&&(this.currentFocus=n,n.focus({preventScroll:!1}))}}}possiblyHasTabbableChildren(e){return this.elementsWithTabbableControls.includes(e.tagName.toLowerCase())||e.hasAttribute("controls")}}var He;(function(o){o.processing="processing",o.complete="complete"})(He||(He={}));let $e=class extends E{constructor(){super(...arguments),this.mode="processing"}render(){return d`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
    ...
    `}static get styles(){const e=h`var(--activityIndicatorCheckmarkColor, #31A481)`,t=h`var(--activityIndicatorCompletedRingColor, #31A481)`,a=h`var(--activityIndicatorLoadingRingColor, #333333)`,n=h`var(--activityIndicatorLoadingDotColor, #333333)`;return h`
      #completed-ring {
        fill: ${t};
      }
    ...
    `}};L([l({type:String})],$e.prototype,"mode",void 0);$e=L([$("ia-activity-indicator")],$e);const nt=d`
  <svg
    class="ia-logo"
    viewBox="0 0 27 30"
    xmlns="http://www.w3.org/2000/svg"
...
`;let Ee=class extends E{constructor(){super(...arguments),this.config=new V}render(){return d`
      <div class="modal-wrapper">
        <div class="modal-container">
          <header style="background-color: ${this.config.headerColor}">
            ...
            ${this.config.showHeaderLogo?d`<div class="logo-icon">${nt}</div>`:he}
    ...
    >
      ${at} ${this.config.leftNavButtonText??""}
    </button> `}static get styles(){const e=h`var(--modalLogoSize, 6.5rem)`,t=h`var(--processingImageSize, 7.5rem)`,a=h`var(--modalCornerRadius, 1rem)`,n=h`var(--modalBorder, 2px solid black)`,i=h`var(--modalBottomMargin, 2.5rem)`,r=h`var(--modalTopMargin, 5rem)`,c=h`var(--modalHeaderBottomPadding, 0.5em)`,u=h`var(--modalBottomPadding, 2rem)`,f=h`var(--modalScrollOffset, 5px)`,y=h`var(--modalTitleFontSize, 1.8rem)`,v=h`var(--modalSubtitleFontSize, 1.4rem)`,F=h`var(--modalHeadlineFontSize, 1.6rem)`,A=h`var(--modalMessageFontSize, 1.4rem)`,ie=h`var(--modalTitleLineHeight, normal)`,fe=h`var(--modalSubtitleLineHeight, normal)`,Y=h`var(--modalHeadlineLineHeight, normal)`,Z=h`var(--modalMessageLineHeight, normal)`;return h`
      .processing-logo {
        margin: auto;
        width: ${t};
        height: ${t};
      ...
      header {
        ...
        color: white;
        border-radius: calc(${a}) calc(${a}) 0 0;
        border: ${n};
        border-bottom: 0;
        text-align: center;
        padding-bottom: ${c};
      ...
      .modal-body {
        ...
        border-radius: 0 0 calc(${a}) calc(${a});
        border: ${n};
        border-top: 0;
    ...
    `}get yesButton(){switch(this.yesButtonMode){case z.YesButton:return d`
      ...
      `]}};ye([l({type:String})],Q.prototype,"yesButtonMode",2);ye([l({type:Number})],Q.prototype,"amount",2);ye([l({type:Object})],Q.prototype,"error",2);ye([p("#amount-input")],Q.prototype,"amountInput",2);Q=ye([$("ia-donation-upsell-modal-content")],Q);let mt=()=>({events:{},emit(o,...e){(this.events[o]||[]).forEach(t=>t(...e))},on(o,e){return(this.events[o]=this.events[o]||[]).push(e),()=>this.events[o]=(this.events[o]||[]).filter(t=>t!==e)}});function gt(o){return new Promise(e=>setTimeout(e,o))}var T;(function(o){o.retryNumber="retryNumber",o.owner="owner",o.dynamicImportLoaded="dynamicImportLoaded",o.hasBeenRetried="hasBeenRetried"})(T||(T={}));const Ne="lazyLoaderService";class yt{constructor(e){var t,a,n;this.emitter=mt(),this.container=(t=e?.container)!==null&&t!==void 0?t:document.head,this.retryCount=(a=e?.retryCount)!==null&&a!==void 0?a:2,this.retryInterval=(n=e?.retryInterval)!==null&&n!==void 0?n:1}on(e,t){return this.emitter.on(e,t)}loadBundle(e){return W(this,void 0,void 0,function*(){let t,a;return e.module&&(t=this.loadScript({src:e.module,bundleType:"module"})),e.nomodule&&(a=this.loadScript({src:e.nomodule,bundleType:"nomodule"})),Promise.race([t,a])})}loadScript(e){return W(this,void 0,void 0,function*(){return this.doLoad(e)})}doLoad(e){var t;return W(this,void 0,void 0,function*(){const a=(t=e.retryNumber)!==null&&t!==void 0?t:0,n=`script[src='${e.src}'][async][${T.owner}='${Ne}'][${T.retryNumber}='${a}']`;let i=this.container.querySelector(n);return i||(i=this.getScriptTag(Object.assign(Object.assign({},e),{retryNumber:a})),this.container.appendChild(i)),new Promise((r,c)=>{if(i.getAttribute(T.dynamicImportLoaded)){r();return}const u=e.scriptBeingRetried,f=i.onload||u?.onload;i.onload=v=>{f?.(v),i.setAttribute(T.dynamicImportLoaded,"true"),r()};const y=i.onerror||u?.onerror;i.onerror=v=>W(this,void 0,void 0,function*(){const F=i.getAttribute(T.hasBeenRetried);if(a<this.retryCount&&!F){i.setAttribute(T.hasBeenRetried,"true"),yield gt(this.retryInterval*1e3);const A=a+1;this.emitter.emit("scriptLoadRetried",e.src,A),this.doLoad(Object.assign(Object.assign({},e),{retryNumber:A,scriptBeingRetried:i}))}else F||this.emitter.emit("scriptLoadFailed",e.src,v),y?.(v),c(v)})})})}getScriptTag(e){var t;const a=e.src.replace("'",'"'),n=document.createElement("script"),i=e.retryNumber;n.setAttribute(T.owner,Ne),n.setAttribute("src",a),n.setAttribute(T.retryNumber,i.toString()),n.async=!0;const r=(t=e.attributes)!==null&&t!==void 0?t:{};switch(Object.keys(r).forEach(c=>{n.setAttribute(c,r[c])}),e.bundleType){case"module":n.setAttribute("type",e.bundleType);break;case"nomodule":n.setAttribute(e.bundleType,"");break}return n}}class C{constructor(e){this.generator=e.generator}get(){return W(this,void 0,void 0,function*(){return this.cachedResponse?this.cachedResponse:this.previousPromise?(this.previousPromise=this.previousPromise.then(e=>e),this.previousPromise):(this.previousPromise=this.generateSingletonAndCache(),this.previousPromise)})}reset(){this.cachedResponse=void 0,this.previousPromise=void 0}generateSingletonAndCache(){return W(this,void 0,void 0,function*(){const e=yield this.generator();return this.cachedResponse=e,e})}}let te=()=>({emit(o,...e){for(let t=this.events[o]||[],a=0,n=t.length;a<n;a++)t[a](...e)},events:{},on(o,e){return(this.events[o]||=[]).push(e),()=>{this.events[o]=this.events[o]?.filter(t=>e!==t)}}});class Ge{constructor(e){this.logged_in_user=e?.logged_in_user,this.referrer=e?.referrer,this.fee_amount_covered=e?.fee_amount_covered,this.origin=e?.origin}}class ft{constructor(e){this.customFields=new Ge,this.paymentProvider=e.paymentProvider,this.paymentMethodNonce=e.paymentMethodNonce,this.recaptchaToken=e.recaptchaToken,this.customerId=e.customerId,this.deviceData=e.deviceData,this.upsellOnetimeTransactionId=e.upsellOnetimeTransactionId,this.bin=e.bin,this.binName=e.binName,this.amount=e.amount,this.donationType=e.donationType,this.customer=e.customer,this.billing=e.billing,e.customFields&&(this.customFields=e.customFields)}}const P={CreditCard:"Credit Card",PayPal:"PayPal",GooglePay:"Google Pay",Venmo:"Venmo",ApplePay:"Apple Pay"};class vt{constructor(e){this.session=e.session,this.donationInfo=e.donationInfo,this.applePayInstance=e.applePayInstance,this.braintreeManager=e.braintreeManager}async onvalidatemerchant(e){return new Promise((t,a)=>{this.applePayInstance.performValidation({validationURL:e.validationURL,displayName:"Internet Archive"},(n,i)=>{n?(this.delegate?.paymentFailed(n),this.session.abort(),a(`Merchant validation error: ${n}`)):(this.session.completeMerchantValidation(i),t())})})}async oncancel(){this.delegate?.paymentCancelled()}async onpaymentauthorized(e){let t;try{t=await this.applePayInstance.tokenize({token:e.payment.token})}catch(y){this.delegate?.paymentFailed(y),this.session.completePayment(ApplePaySession.STATUS_FAILURE);return}const a=e.payment,n=a.billingContact,i=a.shippingContact,[r,c]=n?.addressLines??[],u=new ge({streetAddress:r,extendedAddress:c,locality:n?.locality,region:n?.administrativeArea,postalCode:n?.postalCode,countryCodeAlpha2:n?.countryCode}),f=new me({email:i?.emailAddress,firstName:i?.givenName,lastName:i?.familyName});try{const y=await this.braintreeManager.submitDonation({nonce:t.nonce,paymentProvider:P.ApplePay,donationInfo:this.donationInfo,billingInfo:u,customerInfo:f});y.success?(this.delegate?.paymentComplete(y),this.session.completePayment(ApplePaySession.STATUS_SUCCESS)):(this.delegate?.paymentFailed("Failure submitting data"),this.session.completePayment(ApplePaySession.STATUS_FAILURE))}catch(y){this.delegate?.paymentFailed(y),this.session.completePayment(ApplePaySession.STATUS_FAILURE)}}}class bt{constructor(e){this.braintreeManager=e.braintreeManager,this.applePayClient=e.applePayClient,this.applePaySessionManager=e.applePaySessionManager,this.instance=e.instancePromisedSingleton??new C({generator:async()=>{if(!this.applePaySessionManager.canMakePayments())return;const t=await this.braintreeManager.instance.get();return this.applePayClient.create({client:t})}})}async isAvailable(){try{return!!await this.instance.get()}catch{return!1}}async createPaymentRequest(e,t){const a=await this.instance.get();if(!a)throw new Error("Apple Pay is not available in this browser");const n=t.donationType===M.OneTime?"Internet Archive":"Internet Archive Monthly",i=a.createPaymentRequest({total:{label:n,amount:`${t.total}`},requiredBillingContactFields:["postalAddress"],requiredShippingContactFields:["name","email"]}),r=this.applePaySessionManager.createNewPaymentSession(i),c=new vt({donationInfo:t,session:r,applePayInstance:a,braintreeManager:this.braintreeManager});return r.onvalidatemerchant=c.onvalidatemerchant.bind(c),r.onpaymentauthorized=c.onpaymentauthorized.bind(c),r.oncancel=c.oncancel.bind(c),r.begin(),c}}const ce=class ce{canMakePayments(){return"ApplePaySession"in window&&ApplePaySession.supportsVersion(ce.VERSION)&&ApplePaySession.canMakePayments()}createNewPaymentSession(e){return new ApplePaySession(ce.VERSION,e)}};ce.VERSION=3;let xe=ce;class wt extends Error{constructor(e){super(e),this.name="DonationFormError"}}const Ct=new Promise(()=>{});class Mt{constructor(e){this.instance=new C({generator:async()=>{const t=await this.braintreeManager.instance.get();return this.createHostedFields(t)}}),this.emitter=te(),this.braintreeManager=e.braintreeManager,this.hostedFieldClient=e.hostedFieldClient,this.hostedFieldConfig=e.hostedFieldConfig,this.maxRetryCount=e.maxRetryCount??2,this.loadTimeout=(e.loadTimeout??6)*1e3}on(e,t){return this.emitter.on(e,t)}async createHostedFields(e,t=0){this.hostedFieldConfig.hostedFieldContainer.resetHostedFields();let a;try{const n=new Promise((r,c)=>{a=window.setTimeout(()=>{c(new wt("Timeout loading Hosted Fields"))},this.loadTimeout)}),i=Promise.resolve().then(()=>this.hostedFieldClient.create({client:e,styles:this.hostedFieldConfig.hostedFieldStyle,fields:this.hostedFieldConfig.hostedFieldFieldOptions})).catch(r=>{if(r instanceof Error&&r.message.includes("Hosted Fields timed out"))return Ct;throw r});return i.catch(()=>{}),await Promise.race([n,i])}catch(n){if(t>=this.maxRetryCount)throw this.emitter.emit("hostedFieldsFailed",n),n;const i=t+1;return this.emitter.emit("hostedFieldsRetry",i),this.createHostedFields(e,i)}finally{window.clearTimeout(a)}}async tokenizeHostedFields(){return(await this.instance.get())?.tokenize()}markFieldErrors(e){this.hostedFieldConfig.hostedFieldContainer.markFieldErrors(e)}removeFieldErrors(e){this.hostedFieldConfig.hostedFieldContainer.removeFieldErrors(e)}showErrorMessage(e){this.hostedFieldConfig.hostedFieldContainer.showErrorMessage(e)}hideErrorMessage(){this.hostedFieldConfig.hostedFieldContainer.hideErrorMessage()}}class Pt{async isBrowserSupported(){return(await this.paymentsClient.isReadyToPay({apiVersion:2,apiVersionMinor:0,allowedPaymentMethods:[{type:"CARD",parameters:{allowedAuthMethods:["PAN_ONLY"],allowedCardNetworks:["AMEX","DISCOVER","INTERAC","JCB","MASTERCARD","VISA"]}}],existingPaymentMethodRequired:!1})).result}constructor(e){this.braintreeManager=e.braintreeManager,this.googlePayMerchantId=e.googlePayMerchantId,this.googlePayBraintreeClient=e.googlePayBraintreeClient,this.paymentsClient=e.googlePaymentsClient,this.instance=new C({generator:async()=>{const t=await this.braintreeManager.instance.get();return this.googlePayBraintreeClient.create({client:t,googlePayVersion:2,googleMerchantId:this.googlePayMerchantId})}})}}class St{constructor(e){this.donationInfo=e.donationInfo,this.paypalInstance=e.paypalInstance}async payment(){const t=this.donationInfo.donationType===M.OneTime?"checkout":"vault",a={flow:t,intent:"capture",enableShippingAddress:!0};return t==="checkout"?(a.amount=this.donationInfo.total,a.currency="USD"):a.billingAgreementDescription=`Subscribe to donate ${pe(this.donationInfo.total,{symbol:"$"}).format()} monthly`,this.delegate?.payPalPaymentStarted(this,a),this.paypalInstance.createPayment(a)}async onAuthorize(e){const t=await this.paypalInstance.tokenizePayment(e);return this.delegate?.payPalPaymentAuthorized(this,t),t}async onConfirm(e){const t=await this.paypalInstance.tokenizePayment(e);return this.delegate?.payPalPaymentConfirmed(this,t),t}onCancel(e){this.delegate?.payPalPaymentCancelled(this,e)}onError(e){console.error("PayPal error",e),this.delegate?.payPalPaymentError(this,e)}}class Ft{constructor(e){this.braintreeManager=e.braintreeManager,this.paypalClient=e.paypalClient,this.paypalButtonGenerator=e.paypalButton,this.hostingEnvironment=e.hostingEnvironment,this.instance=new C({generator:async()=>{const t=await this.braintreeManager.instance.get();return this.paypalClient.create({client:t})}})}async renderPayPalButton(e){const t=this.hostingEnvironment===J.Development?"sandbox":"production",a=await this.instance.get();if(!a)return;const n=new St({donationInfo:e.donationInfo,paypalInstance:a}),i=window.paypal?.FUNDING?.VENMO;return this.paypalButtonGenerator.render({env:t,style:e.style,payment:n.payment.bind(n),onAuthorize:n.onAuthorize.bind(n),onCancel:n.onCancel.bind(n),onError:n.onError.bind(n),funding:i?{disallowed:[i]}:void 0},e.selector),n}}class It{constructor(e){this.braintreeManager=e.braintreeManager,this.venmoClient=e.venmoClient,this.venmoProfileId=e.venmoProfileId,this.instance=e.instancePromisedSingleton??new C({generator:async()=>{const t=await this.braintreeManager.instance.get();return this.venmoClient.create({client:t,profileId:this.venmoProfileId})}})}async isBrowserSupported(){return this.isMobileFirefox()?!1:(await this.instance.get())?.isBrowserSupported()??!1}async startPayment(){return(await this.instance.get()).tokenize()}isMobileFirefox(){const e=navigator.userAgent.indexOf("FxiOS")!==-1,t=navigator.userAgent.indexOf("Firefox")!==-1,a=navigator.userAgent.indexOf("Mobile")!==-1;return(t||e)&&a}}class $t{constructor(e){this.creditCardHandler=new C({generator:async()=>{const t=await this.paymentClients.hostedFields.get(),a=new Mt({braintreeManager:this.braintreeManager,hostedFieldClient:t,hostedFieldConfig:this.hostedFieldConfig});return a.on("hostedFieldsRetry",n=>{this.emitter.emit("hostedFieldsRetry",n)}),a.on("hostedFieldsFailed",n=>{this.emitter.emit("hostedFieldsFailed",n)}),a}}),this.applePayHandler=new C({generator:async()=>{const t=await this.paymentClients.applePay.get();return new bt({braintreeManager:this.braintreeManager,applePayClient:t,applePaySessionManager:new xe})}}),this.venmoHandler=new C({generator:async()=>{const t=await this.paymentClients.venmo.get();if(this.venmoProfileId)return new It({braintreeManager:this.braintreeManager,venmoClient:t,venmoProfileId:this.venmoProfileId})}}),this.paypalHandler=new C({generator:async()=>{const[t,a]=await Promise.all([this.paymentClients.payPal.get(),this.paymentClients.paypalLibrary.get()]);return new Ft({braintreeManager:this.braintreeManager,paypalClient:t,paypalButton:a.Button,hostingEnvironment:this.hostingEnvironment})}}),this.googlePayHandler=new C({generator:async()=>{const[t,a]=await Promise.all([this.paymentClients.googlePayBraintreeClient.get(),this.paymentClients.googlePaymentsClient.get()]);return new Pt({braintreeManager:this.braintreeManager,googlePayMerchantId:this.googlePayMerchantId,googlePayBraintreeClient:t,googlePaymentsClient:a})}}),this.hostingEnvironment=J.Development,this.emitter=te(),this.braintreeManager=e.braintreeManager,this.venmoProfileId=e.venmoProfileId,this.googlePayMerchantId=e.googlePayMerchantId,this.paymentClients=e.paymentClients,this.hostingEnvironment=e.hostingEnvironment,this.hostedFieldConfig=e.hostedFieldConfig}on(e,t){return this.emitter.on(e,t)}}class Et{constructor(e){this.emitter=te(),this.instance=new C({generator:async()=>(await this.paymentClients.braintreeClient.get()).create({authorization:this.authorizationToken})}),this.deviceDataCollectionStarted=!1,this.authorizationToken=e.authorizationToken,this.endpointManager=e.endpointManager,this.paymentClients=e.paymentClients,this.referrer=e.referrer,this.loggedInUser=e.loggedInUser,this.origin=e.origin,this.paymentProviders=new $t({braintreeManager:this,paymentClients:this.paymentClients,venmoProfileId:e.venmoProfileId,googlePayMerchantId:e.googlePayMerchantId,hostingEnvironment:e.hostingEnvironment,hostedFieldConfig:e.hostedFieldConfig}),this.paymentProviders.on("hostedFieldsRetry",t=>{this.emitter.emit("paymentProvidersHostedFieldsRetry",t)}),this.paymentProviders.on("hostedFieldsFailed",t=>{this.emitter.emit("paymentProvidersHostedFieldsFailed",t)})}on(e,t){return this.emitter.on(e,t)}async startup(){return this.collectDeviceData()}async submitDonation(e){const{amount:t,coverFees:a}=e.donationInfo,n=_.calculateTotal(t,a),i=a?_.calculateFeeAmount(t):0,r=new Ge({fee_amount_covered:i,logged_in_user:this.loggedInUser,referrer:this.referrer,origin:this.origin}),c=new ft({deviceData:this.deviceData,paymentProvider:e.paymentProvider,paymentMethodNonce:e.nonce,amount:n,donationType:e.donationInfo.donationType,customer:e.customerInfo,billing:e.billingInfo,customFields:r,upsellOnetimeTransactionId:e.upsellOnetimeTransactionId,customerId:e.customerId,recaptchaToken:e.recaptchaToken,bin:e.bin,binName:e.binName}),u=await this.endpointManager.submitData(c);return new je(u)}async submitUpsellDonation(e){const t=e.oneTimeDonationResponse,a=new _({amount:e.amount,donationType:M.Upsell,coverFees:!1});return this.submitDonation({nonce:t.paymentMethodNonce,paymentProvider:t.paymentProvider,customerId:t.customer_id,donationInfo:a,customerInfo:t.customer,billingInfo:t.billing,upsellOnetimeTransactionId:t.transaction_id})}donationSuccessful(e){this.endpointManager.donationSuccessful(e)}async collectDeviceData(){if(this.deviceDataCollectionStarted)return;this.deviceDataCollectionStarted=!0;const e=await this.instance.get();if(!e)return;const a=await(await this.paymentClients.dataCollector.get()).create({client:e,kount:!1,paypal:!0});this.deviceData=a.deviceData}setReferrer(e){this.referrer=e}setLoggedInUser(e){this.loggedInUser=e}setOrigin(e){this.origin=e}}class xt{constructor(e,t){this.braintreeClient=new C({generator:async()=>(await this.loadBraintreeScript("client"),window.braintree.client)}),this.dataCollector=new C({generator:async()=>(await this.loadBraintreeScript("data-collector"),window.braintree.dataCollector)}),this.hostedFields=new C({generator:async()=>(await this.loadBraintreeScript("hosted-fields"),window.braintree.hostedFields)}),this.venmo=new C({generator:async()=>(await this.loadBraintreeScript("venmo"),window.braintree.venmo)}),this.payPal=new C({generator:async()=>(await this.loadBraintreeScript("paypal-checkout"),window.braintree.paypalCheckout)}),this.applePay=new C({generator:async()=>(await this.loadBraintreeScript("apple-pay"),window.braintree.applePay)}),this.googlePayBraintreeClient=new C({generator:async()=>(await this.loadBraintreeScript("google-payment"),window.braintree.googlePayment)}),this.googlePaymentsClient=new C({generator:async()=>(await this.lazyLoader.loadScript({src:"https://pay.google.com/gp/p/js/pay.js"}),new google.payments.api.PaymentsClient({environment:this.environment===J.Development?"TEST":"PRODUCTION"}))}),this.recaptchaLibrary=new C({generator:()=>new Promise(a=>{window.iaDonationFormGrecaptchaLoaded=()=>{setTimeout(()=>{delete window.iaDonationFormGrecaptchaLoaded},10),a(window.grecaptcha)},this.lazyLoader.loadScript({src:"https://www.google.com/recaptcha/api.js?onload=iaDonationFormGrecaptchaLoaded&render=explicit"})})}),this.paypalLibrary=new C({generator:async()=>(await this.lazyLoader.loadScript({src:"https://www.paypalobjects.com/api/checkout.js",attributes:{"data-version-4":"","log-level":"warn"}}),window.paypal)}),this.braintreeVersion="3.62.2",this.environment=J.Development,this.lazyLoader=e,this.environment=t}async loadBraintreeScript(e){const t=this.environment===J.Production?"min.js":"js",a=`https://js.braintreegateway.com/web/${this.braintreeVersion}/js/${e}.${t}`;await this.lazyLoader.loadScript({src:a})}}class kt{constructor(e){this.hostedFieldFieldOptions=e.hostedFieldFieldOptions,this.hostedFieldStyle=e.hostedFieldStyle,this.hostedFieldContainer=e.hostedFieldContainer}}const U={Number:"number",CVV:"cvv",ExpirationDate:"expirationDate"};class Tt{fieldFor(e){switch(e){case U.Number:return this.number;case U.CVV:return this.cvv;case U.ExpirationDate:return this.expirationDate}}markFieldErrors(e){e.forEach(t=>{const a=this.fieldFor(t);a.parentElement.error=!0})}removeFieldErrors(e){e.forEach(t=>{const a=this.fieldFor(t);a.parentElement.error=!1})}showErrorMessage(e){const t=e??"Some payment information below is missing or incorrect.";this.errorContainer.textContent=t,this.errorContainer.style.display="block"}hideErrorMessage(){this.errorContainer.style.display="none"}resetHostedFields(){[this.number,this.cvv,this.expirationDate].forEach(t=>{for(;t.firstChild;)t.firstChild.remove()})}constructor(e){this.number=e.number,this.cvv=e.cvv,this.expirationDate=e.expirationDate,this.errorContainer=e.errorContainer}}var At=Object.defineProperty,Dt=Object.getOwnPropertyDescriptor,oe=(o,e,t,a)=>{for(var n=a>1?void 0:a?Dt(e,t):e,i=o.length-1,r;i>=0;i--)(r=o[i])&&(n=(a?r(e,t,n):r(n))||n);return a&&n&&At(e,t,n),n};let q=class extends E{constructor(){super(...arguments),this.amount=5,this.currencyType="USD",this.donationType=M.OneTime,this.confirmDonation=()=>{},this.cancelDonation=()=>{}}get formattedAmount(){return pe(this.amount,{symbol:this.currencySymbol}).format()}get confirmationText(){return s(d`
      <p>
    ...
    `}static get styles(){return[H,h`
      ...
      `})}showConfirmationStepModal(e){const t=e.donationType===M.Upsell?s("Confirm monthly donation"):s("Complete donation"),a=new V({closeOnBackdropClick:!1,headerColor:se.Green,title:d`${t}`,message:d`
        ...
        ></ia-donation-confirm-modal>
      `});return this.modalManager.showModal({config:a,userClosedModalCallback:e.cancelDonationCB})}showUpsellModal(e){const t=new V({headerColor:se.Green,title:d`${s("Donation received")}`,processingImageMode:"complete",showProcessingIndicator:!0}),a=Me.getDefaultUpsellAmount(e.oneTimeAmount);e.amountChanged?.(a);const n=d`
    ...
    `}createRenderRoot(){return this}inputFocused(o){this.errorMessage.textContent="";const e=o.target,t=this.querySelector(`ia-donation-badged-input.${e.id}`);t&&(t.error=!1)}generateInput(o){const e=o.required??!0,t=o.fieldType??"text",a=o.iconSpaceOption??de.LeaveSpace;return d`
      <ia-donation-badged-input
        class=${o.id}
        .icon=${o.icon}
        .iconSpaceOption=${a}
    ...
    `}get displayTitle(){if(!this.donationInfo)return"";const o=this.donationInfo.amount,e=o===Math.round(o)?0:2,t=pe(o,{symbol:"$",precision:e}).format();return this.donationInfo.donationType===M.Monthly?s(Ce`${t} Monthly Donation`):s(Ce`${t} Donation`)}editClicked(){this.dispatchEvent(new Event("editClicked"))}static get styles(){return[H,h`
      ...
      `]}};Ye([l({type:Object})],ke.prototype,"donationInfo",2);ke=Ye([$("ia-donation-summary")],ke);var fo=Object.defineProperty,vo=Object.getOwnPropertyDescriptor,ae=(o,e,t,a)=>{for(var n=a>1?void 0:a?vo(e,t):e,i=o.length-1,r;i>=0;i--)(r=o[i])&&(n=(a?r(e,t,n):r(n))||n);return a&&n&&fo(e,t,n),n};const le={Summary:"summary",Edit:"edit"};let G=class extends E{constructor(){super(...arguments),this.mode=le.Edit,this.amountOptions=Ae,this.amountSelectionLayout=we.MultiLine,this.frequencySelectionMode=ue.Button}render(){switch(this.mode){case le.Summary:return this.donationSummaryTemplate;case le.Edit:return this.editDonationTemplate}}get editDonationTemplate(){return d`
    ...
    `}donationInfoChanged(o){this.donationInfo=o.detail.donationInfo,this.dispatchEvent(new CustomEvent("donationInfoChanged",{detail:{donationInfo:this.donationInfo}}))}editDonationError(o){this.dispatchEvent(new CustomEvent("editDonationError",{detail:o.detail}))}summaryEditClicked(){this.mode=le.Edit}showSummaryClicked(){this.mode=le.Summary}};ae([l({type:Object})],G.prototype,"donationInfo",2);ae([l({type:String})],G.prototype,"mode",2);ae([l({type:Array})],G.prototype,"amountOptions",2);ae([l({type:String})],G.prototype,"amountSelectionLayout",2);ae([l({type:String})],G.prototype,"frequencySelectionMode",2);G=ae([$("ia-donation-header")],G);var bo=Object.defineProperty,wo=Object.getOwnPropertyDescriptor,N=(o,e,t,a)=>{for(var n=a>1?void 0:a?wo(e,t):e,i=o.length-1,r;i>=0;i--)(r=o[i])&&(n=(a?r(e,t,n):r(n))||n);return a&&n&&bo(e,t,n),n};const k={Loading:"loading",Available:"available",Unavailable:"unavailable"};let D=class extends E{constructor(){super(...arguments),this.donationInfoValid=!0,this.applePayMode=k.Loading,this.googlePayMode=k.Loading,this.venmoMode=k.Loading,this.payPalMode=k.Loading}render(){const o=this.paymentModeSelected?"payment-selected":"";return d`
      <div
      ...
      >
        <div class="payment-provider-container">
          ...
          >
            <div class="payment-image">${no}</div>
          </button>
    ...
    `}firstUpdated(){this.dispatchEvent(new Event("firstUpdated"))}updated(o){o.has("paymentProviders")&&this.setButtonVisibility()}showPaypalButton(){this.payPalMode=k.Available}async setButtonVisibility(){const o=this.paymentProviders;if(!o)return;const e=t=>t?k.Available:k.Unavailable;o.venmoHandler.get().then(async t=>t?t.isBrowserSupported():!1).then(t=>{this.venmoMode=e(t)}).catch(t=>{console.error("venmo unavailable",t),this.venmoMode=k.Unavailable}),o.applePayHandler.get().then(t=>t.isAvailable()).then(t=>{this.applePayMode=e(t)}).catch(t=>{console.error("apple pay unavailable",t),this.applePayMode=k.Unavailable}),o.googlePayHandler.get().then(t=>t.isBrowserSupported()).then(t=>{this.googlePayMode=e(t)}).catch(t=>{console.error("google pay unavailable",t),this.googlePayMode=k.Unavailable})}googlePaySelected(){this.dispatchEvent(new Event("googlePaySelected"))}applePaySelected(o){this.dispatchEvent(new CustomEvent("applePaySelected",{detail:{originalEvent:o}}))}venmoSelected(){this.dispatchEvent(new Event("venmoSelected"))}creditCardSelected(){this.dispatchEvent(new Event("creditCardSelected"))}localPaypalButtonClicked(){this.dispatchEvent(new Event("paypalBlockerSelected"))}static get styles(){return[H,h`
      ...
      `]}};N([l({type:Boolean})],D.prototype,"donationInfoValid",2);N([l({type:Object})],D.prototype,"paymentProviders",2);N([x()],D.prototype,"applePayMode",2);N([x()],D.prototype,"googlePayMode",2);N([x()],D.prototype,"venmoMode",2);N([x()],D.prototype,"payPalMode",2);N([x()],D.prototype,"paymentModeSelected",2);D=N([$("ia-donation-payment-selector")],D);var Co=Object.defineProperty,Mo=Object.getOwnPropertyDescriptor,Ze=(o,e,t,a)=>{for(var n=a>1?void 0:a?Mo(e,t):e,i=o.length-1,r;i>=0;i--)(r=o[i])&&(n=(a?r(e,t,n):r(n))||n);return a&&n&&Co(e,t,n),n};let Te=class extends E{render(){return d`
    ...
    `}get totalLine(){if(!this.donationInfo)return"";const o=pe(this.donationInfo.total,{symbol:"$"}).format();return this.donationInfo.donationType===M.Monthly?s(Ce`Total: ${o}/month`):s(Ce`Total: ${o}`)}static get styles(){return[H,h`
      ...
      `]}};Ze([l({type:Object})],Te.prototype,"donationInfo",2);Te=Ze([$("ia-donation-total-amount")],Te);var Po=Object.defineProperty,So=Object.getOwnPropertyDescriptor,I=(o,e,t,a)=>{for(var n=a>1?void 0:a?So(e,t):e,i=o.length-1,r;i>=0;i--)(r=o[i])&&(n=(a?r(e,t,n):r(n))||n);return a&&n&&Po(e,t,n),n};let S=class extends E{constructor(){super(...arguments),this.donationInfo=Ue,this.amountOptions=Ae,this.amountSelectionLayout=we.MultiLine,this.frequencySelectionMode=ue.Button,this.creditCardVisible=!1,this.contactFormVisible=!1,this.donationInfoValid=!0,this.paypalButtonNeedsRender=!0,this.flowHandlersConfigured=!1}render(){return d`
      <ia-donation-header
        .amountOptions=${this.amountOptions}
        .amountSelectionLayout=${this.amountSelectionLayout}
        .frequencySelectionMode=${this.frequencySelectionMode}
