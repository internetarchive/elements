...
describe('IA Status Indicator', () => {
    test('renders a loading indicator by default', async () => {
        const el = await fixture(html `<ia-status-indicator></ia-status-indicator>`);
    ...
    test('uses a custom loading text for the indicator if desired', async () => {
        const el = await fixture(html `<ia-status-indicator
    ...
    test('can hide the loading dots if requested', async () => {
        const el = await fixture(html `<ia-status-indicator .loadingStyle=${'ring'}></ia-status-indicator>`);
        const loadingDots = el.shadowRoot?.querySelector('.loading-dots');
        expect(loadingDots.computedStyleMap().get('display')?.toString()).to.equal('none');
    });
    test('can render a success indicator instead if requested', async () => {
        const el = await fixture(html `<ia-status-indicator .mode=${'success'}></ia-status-indicator>`);
    ...
    test('can render an error indicator instead if requested', async () => {
        const el = await fixture(html `<ia-status-indicator .mode=${'error'}></ia-status-indicator>`);
...
//# sourceMappingURL=ia-status-indicator.test.js.map