import{w as U,n as m,c as I,i as $,b as l,a as P,r as f,A as k}from"./index-Dw4Pwfyl.js";import{T as j,a as A}from"./ia-transcript-view-Bxy0DK6O.js";import{e as C}from"./query-DTCVI47N.js";import{m as p,s as D}from"./runtime-CCgtQBty.js";import{P as M}from"./ia-playback-controls-COK05hqK.js";import"./ia-audio-element-s9zgRkzZ.js";import"./ia-expandable-search-bar-DLtnnim-.js";import"./ia-scrubber-bar-BG2ydij_.js";import"./ia-status-indicator-BYTe97u6.js";import"./ia-waveform-progress-DqgX1ab0.js";import"./story-template-C_BaAq0z.js";import"./masked-icon-CqkYdmw9.js";import"./directive-helpers-TlDvIFmu.js";class y{constructor(e,r){this.startIndex=e,this.endIndex=r}get length(){return Math.abs(this.endIndex-this.startIndex)}}class b{constructor(e){const{merged:r,ranges:a}=b.buildIndex(e);this.mergedTranscript=r,this.mergedTranscriptLowercased=r.toLowerCase(),this.transcriptEntryRanges=a}getTranscriptEntryAt(e){return this.transcriptEntryRanges.find(({range:r})=>r.startIndex<=e&&r.endIndex>e)}static buildIndex(e){const r=[];let a="";return e.entries.forEach(s=>{a!==""&&s.rawText!==""&&(a+=" ");const i=a.length;a+=s.rawText,r.push({entry:s,range:new y(i,a.length)})}),{merged:a,ranges:r}}}class Z{constructor(e){this.transcriptIndex=e}async getSearchRanges(e){if(e==="")return[];const r=this.transcriptIndex.mergedTranscriptLowercased,a=e.toLowerCase(),s=[];let i=r.indexOf(a);for(;i!==-1;)s.push(new y(i,i+a.length)),i=r.indexOf(a,i+1);return s}}function z(t,e){const r=t.startIndex<e.startIndex?t:e,a=r===t?e:t;if(!(r.endIndex<a.startIndex))return new y(a.startIndex,Math.min(r.endIndex,a.endIndex))}class S{constructor(e,r){this.searchBackend=e,this.transcriptIndex=r}async search(e){const r=await this.getSearchSeparatedTranscript(e),a=[];let s=0,i=1;return r.forEach(n=>{if(n.isSearchMatch){const o=this.entryForMatch(n,i);if(!o)return;o.searchMatchIndex=s,s+=1,i+=1,a.push(o);return}this.transcriptIndex.transcriptEntryRanges.forEach(o=>{const u=z(n.range,o.range);if(!u||u.length===0&&o.range.length>0)return;const g=S.blankEntryFrom(o.entry);g.rawText=this.transcriptIndex.mergedTranscript.substring(u.startIndex,u.endIndex).trim(),g.id=i,i+=1,a.push(g)})}),new j(a)}entryForMatch(e,r){const a=this.transcriptIndex.getTranscriptEntryAt(e.range.startIndex);if(!a)return;const s=Math.max(e.range.startIndex,e.range.endIndex-1),i=this.transcriptIndex.getTranscriptEntryAt(s)??a,n=S.blankEntryFrom(a.entry);return n.rawText=e.text,n.id=r,n.end=i.entry.end,n}async getSearchSeparatedTranscript(e){const r=await this.searchBackend.getSearchRanges(e),{mergedTranscript:a}=this.transcriptIndex;if(r.length===0)return[this.chunkFor(new y(0,a.length),!1)];const s=[...r].sort((o,u)=>o.startIndex-u.startIndex),i=[];let n=0;return s.forEach(o=>{o.startIndex<n||(i.push(this.chunkFor(new y(n,o.startIndex),!1)),i.push(this.chunkFor(o,!0)),n=o.endIndex)}),i.push(this.chunkFor(new y(n,a.length),!1)),i}chunkFor(e,r){return{range:e,text:this.transcriptIndex.mergedTranscript.substring(e.startIndex,e.endIndex),isSearchMatch:r}}static blankEntryFrom(e){return new A(e.id,e.start,e.end,"",e.isMusic)}}const K=U`
<svg
  height="13"
  viewBox="0 0 8 13"
  width="8"
...
`;var X=Object.defineProperty,Y=Object.getOwnPropertyDescriptor,B=(t,e,r,a)=>{for(var s=a>1?void 0:a?Y(e,r):e,i=t.length-1,n;i>=0;i--)(n=t[i])&&(s=(a?n(e,r,s):n(s))||s);return a&&s&&X(e,r,s),s};const ee={SearchResultIndexChanged:"searchResultIndexChanged"};let x=class extends ${constructor(){super(...arguments),this.numberOfResults=0,this.currentResultIndex=0}render(){return l`
      <div class="container">
        <button
          id="previous-button"
          type="button"
    ...
    `}};B([m({type:Number})],x.prototype,"numberOfResults",2);B([m({type:Number})],x.prototype,"currentResultIndex",2);x=B([I("ia-search-results-switcher")],x);var te=Object.defineProperty,re=Object.getOwnPropertyDescriptor,d=(t,e,r,a)=>{for(var s=a>1?void 0:a?re(e,r):e,i=t.length-1,n;i>=0;i--)(n=t[i])&&(s=(a?n(e,r,s):n(s))||s);return a&&s&&te(e,r,s),s};const h={CanPlay:"canplay",CurrentTimeChanged:"currentTimeChanged",HighlightedSearchResultChanged:"highlightedSearchResultChanged",JumpBackButtonPressed:"jumpBackButtonPressed",JumpForwardButtonPressed:"jumpForwardButtonPressed",NextSectionButtonPressed:"nextSectionButtonPressed",PlaybackPaused:"playbackPaused",PlaybackRateChanged:"playbackRateChanged",PlaybackStarted:"playbackStarted",PlayPauseButtonPressed:"playPauseButtonPressed",PrevSectionButtonPressed:"prevSectionButtonPressed",SearchCleared:"searchCleared",SearchExecuted:"searchExecuted",SearchFailed:"searchFailed",SearchTermChanged:"searchTermChanged",TimeChangedFromScrub:"timeChangedFromScrub",TranscriptEntrySelected:"transcriptEntrySelected"},N=10,ae=2,v=.1;let c=class extends ${constructor(){super(...arguments),this.currentTime=0,this.searchTerm="",this.skipMusicSections=!1,this.percentComplete=0,this.isPlaying=!1,this.duration=0,this.playbackRate=1,this.volume=1,this.isSearching=!1,this.latestSearchId=0}render(){return l`
    ...
    `}get collectionLogoTemplate(){const t=this.config?.logoUrl;return t?l`
      ...
      />
    `:k}get playbackControlsTemplate(){return l`
    ...
    `}get waveformProgressTemplate(){const t=this.config?.waveformUrl;return t?l`
      ...
      ></ia-waveform-progress>
    `:k}get scrubberBarTemplate(){return l`
      <ia-scrubber-bar
    ...
    `}get searchOutcomeTemplate(){if(this.searchTerm.length===0||!this.searchResultsTranscript)return k;const t=this.searchResults.length;return t===0?l`
    ...
    `}};d([m({type:Object})],c.prototype,"config",2);d([m({type:Object})],c.prototype,"searchHandler",2);d([m({type:Object})],c.prototype,"transcriptConfig",2);d([m({type:Object})],c.prototype,"searchResultsTranscript",2);d([m({type:Number})],c.prototype,"currentTime",2);d([m({type:String})],c.prototype,"searchTerm",2);d([m({type:Boolean})],c.prototype,"skipMusicSections",2);d([f()],c.prototype,"percentComplete",2);d([f()],c.prototype,"isPlaying",2);d([f()],c.prototype,"duration",2);d([f()],c.prototype,"playbackRate",2);d([f()],c.prototype,"volume",2);d([f()],c.prototype,"isSearching",2);d([C("ia-audio-element")],c.prototype,"audioElement",2);d([C("ia-transcript-view")],c.prototype,"transcriptView",2);d([C("ia-search-results-switcher")],c.prototype,"searchResultsSwitcher",2);c=d([I("ia-radio-player")],c);var se=Object.defineProperty,ie=Object.getOwnPropertyDescriptor,L=(t,e,r,a)=>{for(var s=a>1?void 0:a?ie(e,r):e,i=t.length-1,n;i>=0;i--)(n=t[i])&&(s=(a?n(e,r,s):n(s))||s);return a&&s&&se(e,r,s),s};const w=6,F=1.5,_=[0,3,5,7,10],V=[["Good evening, and welcome to the programme.",!1],["Tonight we look back at the early days of radio.",!1],["",!0],["The first broadcast went out in nineteen twenty two.",!1],["It reached perhaps a few hundred listeners.",!1],["The transmitter sat in a shed behind the post office.",!1],["",!0],["By the end of the decade the audience was in the millions.",!1],["Whole families gathered around a single radio set.",!1],["The evening schedule became a fixed point in the week.",!1],["",!0],["We hear from some of those early broadcasters after the break.",!1],["Stay with us.",!1],["And now, the news.",!1]],ne=V.length*w,E=new j(V.map(([t,e],r)=>new A(r,r*w,r*w+w-1,t,e)));function oe(t=ne){const r=8e3*t,a=44,s=new ArrayBuffer(a+r),i=new DataView(s),n=(o,u)=>{[...u].forEach((g,T)=>i.setUint8(o+T,g.charCodeAt(0)))};n(0,"RIFF"),i.setUint32(4,36+r,!0),n(8,"WAVE"),n(12,"fmt "),i.setUint32(16,16,!0),i.setUint16(20,1,!0),i.setUint16(22,1,!0),i.setUint32(24,8e3,!0),i.setUint32(28,8e3,!0),i.setUint16(32,1,!0),i.setUint16(34,8,!0),n(36,"data"),i.setUint32(40,r,!0);for(let o=0;o<r;o+=1){const u=o/8e3,g=Math.floor(u/F),T=u-g*F,H=_[g%_.length],q=Math.floor(u/w),O=220*2**((H-q)/12),G=Math.exp(-3.2*T),J=(Math.sin(2*Math.PI*O*u)+.35*Math.sin(4*Math.PI*O*u))/1.35,W=128+Math.round(J*G*14);i.setUint8(a+o,W)}return URL.createObjectURL(new Blob([s],{type:"audio/wav"}))}function ce(t=240){const e=Array.from({length:t},(a,s)=>{const i=Math.sin(s/4)*.3+Math.sin(s/13)*.4+Math.sin(s/31)*.3,n=Math.max(.06,Math.abs(i))*100;return`<rect x="${s*2}" y="${((100-n)/2).toFixed(2)}" width="1" height="${n.toFixed(2)}" />`}).join(""),r=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${t*2} 100" preserveAspectRatio="none"><g fill="#2b2b2b">${e}</g></svg>`;return`data:image/svg+xml,${encodeURIComponent(r)}`}const he=`data:image/svg+xml,${encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 160 160"><rect width="160" height="160" rx="12" fill="#2c2c2c"/><circle cx="80" cy="80" r="46" fill="none" stroke="#fff" stroke-width="6"/><circle cx="80" cy="80" r="12" fill="#fff"/><path d="M80 34 L80 12" stroke="#fff" stroke-width="6" stroke-linecap="round"/></svg>')}`,le={title:"The Early Days of Radio",date:"Broadcast 14 March 1958",logoUrl:he,waveformUrl:ce(),audioSources:[{url:oe(),mimetype:"audio/wav"}],quickSearches:["radio","listeners","broadcast"]},de=new S(new Z(new b(E)),new b(E)),ue=[{label:"Title colour",cssVariable:"--ia-theme-radio-player-title-color",defaultValue:"#ffffff",inputType:"color"},{label:"Waveform fill",cssVariable:"--ia-theme-waveform-fill-color",defaultValue:"#3272b6",inputType:"color"},{label:"Transcript active text",cssVariable:"--ia-theme-transcript-active-text-color",defaultValue:"#ffffff",inputType:"color"},{label:"Waveform height",cssVariable:"--ia-theme-radio-player-waveform-height",defaultValue:5,inputType:"range",min:2,max:10,step:.5,unit:"rem"}],pe=[{label:"Skip music sections",propertyName:"skipMusicSections",defaultValue:!1,inputType:"radio",radioOptions:[!0,!1]}],me=8;let R=class extends ${constructor(){super(...arguments),this.log=[]}render(){return l`
      <story-template
        elementTag="ia-radio-player"
        elementClassName="IARadioPlayer"
        .styleInputData=${{settings:ue}}
        .propInputData=${{settings:pe}}
    ...
    `}record(t){const{detail:e}=t,r=e?` ${JSON.stringify(e)}`:"";this.log=[`${t.type}${r}`,...this.log].slice(0,me)}static get styles(){return P`
      .player {
        display: block;
