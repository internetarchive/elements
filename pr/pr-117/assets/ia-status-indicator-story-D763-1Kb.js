import{i as u,b as c,a as p,r as d,c as m}from"./index-Dw4Pwfyl.js";import{e as f}from"./query-DTCVI47N.js";import"./ia-status-indicator-BYTe97u6.js";import"./story-template-C_BaAq0z.js";import"./masked-icon-CqkYdmw9.js";import"./directive-helpers-TlDvIFmu.js";import"./runtime-CCgtQBty.js";var b=Object.defineProperty,y=Object.getOwnPropertyDescriptor,n=(e,t,r,a)=>{for(var o=a>1?void 0:a?y(t,r):t,s=e.length-1,l;s>=0;s--)(l=e[s])&&(o=(a?l(t,r,o):l(o))||o);return a&&o&&b(t,r,o),o};const g=[{label:"Width",cssVariable:"--ia-theme-icon-width",defaultValue:"1.25rem",presets:[{label:"Default",value:"1.25rem",note:"--default-icon-width"},{label:"OTP form",value:"3rem",note:"font-size-lg x 1.33"},{label:"Page",value:"4rem",note:"home, details router"},{label:"Theater",value:"5rem",note:"theater, bookreader"},{label:"Account settings",value:"6rem",note:"account settings"}]},{section:"Color",label:"Loading",cssVariable:"--ia-theme-primary-text-color",defaultValue:"#2c2c2c",inputType:"color",presets:[{label:"White",value:"#ffffff",note:"theater, bookreader"}],presetsInline:!0},{section:"Color",label:"Success",cssVariable:"--ia-theme-color-success",defaultValue:"#31a481",inputType:"color"},{section:"Color",label:"Error",cssVariable:"--ia-theme-color-danger",defaultValue:"#e51c23",inputType:"color"}],h=[{label:"Mode",propertyName:"mode",defaultValue:"loading",inputType:"radio",radioOptions:["ready","loading","success","error"]},{label:"Mediatype icon",propertyName:"mediatype",defaultValue:"none",inputType:"radio",radioOptions:["none","audio","collection","etree","images","search","software","texts","tv","video","web"]},{label:"Hide dots (bare ring)",propertyName:"hideDots",defaultValue:!1,inputType:"radio",radioOptions:[!1,!0]},{section:"Accessible titles",label:"Loading",propertyName:"loadingTitle",defaultValue:"Loading..."},{section:"Accessible titles",label:"Success",propertyName:"successTitle",defaultValue:"Success"},{section:"Accessible titles",label:"Error",propertyName:"errorTitle",defaultValue:"Error"}],v=.75;function S(e){const t=e.trim().replace("#",""),r=t.length===3?t.split("").map(l=>l+l).join(""):t;if(!/^[0-9a-f]{6}$/i.test(r))return;const[a,o,s]=[0,2,4].map(l=>parseInt(r.slice(l,l+2),16)/255);return .299*a+.587*o+.114*s}let i=class extends u{constructor(){super(...arguments),this.darkSurface=!1}render(){return c`
      <story-template
        elementTag="ia-status-indicator"
        elementClassName="IAStatusIndicator"
        .styleInputData=${{settings:g,revertable:!0}}
