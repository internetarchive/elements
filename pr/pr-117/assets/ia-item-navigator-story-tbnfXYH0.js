import{i as f,n,b as s,a as c,c as $,A as u,r as w}from"./index-Dw4Pwfyl.js";import{e as _}from"./query-DTCVI47N.js";import{e as V}from"./class-map-Cy4pGB-J.js";import{o as U,t as C}from"./story-template-C_BaAq0z.js";import{m as h,c as R}from"./masked-icon-CqkYdmw9.js";import"./directive-helpers-TlDvIFmu.js";const H="data:image/svg+xml,%3csvg%20viewBox='0%200%2040%2040'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20fill='%23000'%20fill-rule='evenodd'%20d='m10.5%2017.5c1.3807119%200%202.5%201.1192881%202.5%202.5s-1.1192881%202.5-2.5%202.5c-1.38071187%200-2.5-1.1192881-2.5-2.5s1.11928813-2.5%202.5-2.5zm9.5%200c1.3807119%200%202.5%201.1192881%202.5%202.5s-1.1192881%202.5-2.5%202.5-2.5-1.1192881-2.5-2.5%201.1192881-2.5%202.5-2.5zm9.5%200c1.3807119%200%202.5%201.1192881%202.5%202.5s-1.1192881%202.5-2.5%202.5-2.5-1.1192881-2.5-2.5%201.1192881-2.5%202.5-2.5z'%20/%3e%3c/svg%3e",j="data:image/svg+xml,%3csvg%20viewBox='0%200%2018%2018'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20fill='%23000'%20fill-rule='evenodd'%20d='m9%200c4.9705627%200%209%204.02943725%209%209%200%204.9705627-4.0294373%209-9%209-4.97056275%200-9-4.0294373-9-9%200-4.97056275%204.02943725-9%209-9zm1.6976167%205.28352881c-.365258-.3556459-.9328083-.37581056-1.32099801-.06558269l-.09308988.0844372-3%203.08108108-.08194436.09533317c-.27484337.36339327-.26799482.87009349.01656959%201.22592581l.084491.09308363%203%202.91891889.09533796.0818904c.3633964.2746544.8699472.2677153%201.2256839-.0167901l.093059-.0844712.0818904-.095338c.2746544-.3633964.2677153-.8699472-.0167901-1.2256839l-.0844712-.093059-2.283355-2.2222741%202.3024712-2.36338332.0819252-.09530804c.2997677-.39632298.2644782-.96313393-.1007797-1.31877983z'%20/%3e%3c/svg%3e",N=h(H),L=h(j);var q=Object.defineProperty,W=Object.getOwnPropertyDescriptor,z=(e,t,i,a)=>{for(var o=a>1?void 0:a?W(t,i):t,r=e.length-1,l;r>=0;r--)(l=e[r])&&(o=(a?l(t,i,o):l(o))||o);return a&&o&&q(t,i,o),o};let p=class extends f{constructor(){super(...arguments),this.icon="",this.href="",this.label="",this.menuDetails="",this.buttonId="",this.selected=!1,this.followable=!1}onClick(e){e.preventDefault(),this.dispatchMenuTypeSelectedEvent()}dispatchMenuTypeSelectedEvent(){this.dispatchEvent(new CustomEvent("menuTypeSelected",{bubbles:!0,composed:!0,detail:{id:this.buttonId}}))}get iconClass(){return this.selected?"active":""}get menuItem(){return s`
    ...
    `}get linkButton(){return s`
      <a
        ...
        aria-expanded=${U(this.followable?void 0:this.selected)}
    ...
    `}render(){return this.href?this.linkButton:this.clickButton}static get styles(){return[C,c`
        :host {
      ...
      `]}};p.shadowRootOptions={...f.shadowRootOptions,delegatesFocus:!0};z([n({type:Object})],p.prototype,"icon",2);z([n({type:String})],p.prototype,"href",2);z([n({type:String})],p.prototype,"label",2);z([n({type:Object})],p.prototype,"menuDetails",2);z([n({type:String})],p.prototype,"buttonId",2);z([n({type:Boolean})],p.prototype,"selected",2);z([n({type:Boolean})],p.prototype,"followable",2);p=z([$("ia-itemnav-menu-button")],p);var X=Object.defineProperty,G=Object.getOwnPropertyDescriptor,k=(e,t,i,a)=>{for(var o=a>1?void 0:a?G(t,i):t,r=e.length-1,l;r>=0;r--)(l=e[r])&&(o=(a?l(t,i,o):l(o))||o);return a&&o&&X(t,i,o),o};const A={closeDrawer:"menuSliderClosed",closePanel:"menuPanelClosed"};let x=class extends f{constructor(){super(...arguments),this.menus=[],this.selectedMenu="",this.selectedMenuAction=u,this.isFirstRender=!0}updated(e){const t=this.selectedMenuDetails?.actionButton||u;t!==this.selectedMenuAction&&(this.selectedMenuAction=t),!this.isFirstRender&&e.has("selectedMenu")&&this.moveFocusForSelection(e.get("selectedMenu")),this.isFirstRender=!1}moveFocusForSelection(e){this.selectedMenu?this.panel?.focus():e&&this.menuButtonFor(e)?.focus()}menuButtonFor(e){return[...this.menuList?.querySelectorAll("ia-itemnav-menu-button")??[]].find(i=>i.buttonId===e)}focusDrawer(){if(this.selectedMenu){this.panel?.focus();return}(this.menuList?.querySelector("ia-itemnav-menu-button")??this.drawerCloseButton)?.focus()}closeMenu(){this.dispatchEvent(new CustomEvent(A.closeDrawer,{detail:this.selectedMenuDetails}))}closePanel(){this.dispatchEvent(new CustomEvent(A.closePanel,{detail:{id:this.selectedMenu}}))}handleKeyDown(e){e.key==="Escape"&&(e.preventDefault(),this.selectedMenu?this.closePanel():this.closeMenu())}get selectedMenuDetails(){return this.menus.find(e=>e.id===this.selectedMenu)}get selectedMenuClass(){return this.selectedMenu?"open":""}get menuItems(){return this.menus.map(e=>s`
        <li>
      ...
      `)}get renderMenuHeader(){const{label:e="",menuDetails:t=""}=this.selectedMenuDetails||{},i=this.selectedMenuAction!==u,a=i?"with-secondary-action":"",o=i?s`<span class="custom-action">${this.selectedMenuAction}</span>`:u,r=e?`Close ${e}`:"Close this panel";return s`
      <header class=${a}>
        <div class="details">
    ...
    `}render(){const e=!!this.selectedMenu;return s`
          ...
          >
            ...
            <section>
              <div class="selected-menu">
                ${this.selectedMenuDetails?.component||u}
              </div>
            </section>
          </div>
        </div>
      </div>
    `}static get styles(){const e=c`42px`,t=c`var(--item-navigator-menu-width--)`,i=c`var(--item-navigator-animation-timing--)`;return[C,c`
        :host {
      ...
      `]}};k([n({type:Array})],x.prototype,"menus",2);k([n({type:String})],x.prototype,"selectedMenu",2);k([n({type:Object})],x.prototype,"selectedMenuAction",2);k([_(".content")],x.prototype,"panel",2);k([_(".menu-list")],x.prototype,"menuList",2);k([_(".menu > button.close")],x.prototype,"drawerCloseButton",2);x=k([$("ia-itemnav-menu-slider")],x);var J=Object.defineProperty,K=Object.getOwnPropertyDescriptor,D=(e,t,i,a)=>{for(var o=a>1?void 0:a?K(t,i):t,r=e.length-1,l;r>=0;r--)(l=e[r])&&(o=(a?l(t,i,o):l(o))||o);return a&&o&&J(t,i,o),o};let T=class extends f{constructor(){super(...arguments),this.identifier=""}emitLoaded(){this.dispatchEvent(new CustomEvent("loadingStateUpdated",{detail:{loaded:!0}}))}updated(e){e.has("identifier")&&this.emitLoaded()}get downloadUrl(){return`/download/${this.identifier}`}render(){return s`
      <section>
    ...
    `}static get styles(){return[C,c`
      ...
      `]}};D([n({type:String})],T.prototype,"identifier",2);T=D([$("ia-itemnav-no-theater-available")],T);var Z=Object.defineProperty,Q=Object.getOwnPropertyDescriptor,m=(e,t,i,a)=>{for(var o=a>1?void 0:a?Q(t,i):t,r=e.length-1,l;r>=0;r--)(l=e[r])&&(o=(a?l(t,i,o):l(o))||o);return a&&o&&Z(t,i,o),o};let d=class extends f{constructor(){super(...arguments),this.viewAvailable=!0,this.baseHost="archive.org",this.signedIn=!1,this.menuContents=[],this.menuShortcuts=[],this.viewportInFullscreen=null,this.menuOpened=!1,this.loaded=!1,this.drawerEntering=!1}slotChange(e,t){const i=e.target.assignedNodes()?.[0];this.dispatchEvent(new CustomEvent("slotChange",{detail:{slot:i,type:t}})),this.requestUpdate()}render(){const e=this.loaded?"":"hidden";return s`
      <div id="frame" class=${this.menuClass}>
        ...
        <div class="menu-and-reader">
          ${this.shouldRenderMenu?this.renderSideMenu:u}
          <div id="reader" class=${e}>
            ${this.renderViewport}
          </div>
        </div>
      </div>
    `}get noTheaterView(){return s`<ia-itemnav-no-theater-available
      .identifier=${this.identifier}
      @loadingStateUpdated=${this.loadingStateUpdated}
    ></ia-itemnav-no-theater-available>`}get renderViewport(){if(!this.viewAvailable)return this.noTheaterView;const e=this.loaded?"opacity: 1;":"opacity: 0;";return s`
    ...
    `}loadingStateUpdated(e){const{loaded:t}=e.detail;this.loaded=t??!1}manageViewportFullscreen(e){const t=!!e.detail.isFullScreen;this.viewportInFullscreen=t||null;const i=new CustomEvent("fullscreenToggled",{detail:e.detail});this.dispatchEvent(i)}get shouldRenderMenu(){return!!this.menuContents?.length}toggleMenu(e=void 0){this.drawerEntering=!1,this.menuOpened=e!==void 0?e:!this.menuOpened,this.moveFocusForDrawer()}moveFocusForDrawer(){this.updateComplete.then(()=>{this.menuOpened?this.menuSlider?.focusDrawer():this.toggleMenuButton?.focus()})}closeMenu(){this.openMenu=void 0,this.toggleMenu(!1)}setOpenMenu(e){this.drawerEntering=!1;const{id:t}=e.detail;this.openMenu=t!==this.openMenu?t:void 0}closeSidePanel(){this.drawerEntering=!1,this.openMenu=void 0}setMenuContents(e){const t=[...e.detail];this.menuContents=t}setMenuShortcuts(e){this.menuShortcuts=[...e.detail]}manageSideMenuEvents(e){const{menuId:t,action:i}=e.detail;t&&(i==="open"?this.openShortcut(t):i==="toggle"&&(this.openMenu=t,this.toggleMenu()))}get menuToggleButton(){const e=this.menuOpened?"Close side panel":"Open side panel";return s`
      <button
        class="toggle-menu"
    ...
    `}get selectedMenuId(){return this.openMenu||""}get renderSideMenu(){return s`
      <nav aria-label="Item navigation">
        <div
          class="minimized ${V({hidden:this.menuOpened})}"
          part="minimized-menu"
        >
    ...
    `}openShortcut(e=""){this.drawerEntering=!this.menuOpened,this.openMenu=e,this.menuOpened=!0,this.moveFocusForDrawer()}get shortcuts(){const e=this.menuShortcuts.map(({icon:t,id:i,label:a})=>i==="fullscreen"?s`${t}`:s`
        <li>
          <button
            class="shortcut ${i}"
            @click=${()=>this.openShortcut(i)}
            title=${a}
            aria-label=${a}
            aria-expanded=${this.menuOpened&&this.openMenu===i}
          >
            ${t}
          </button>
        </li>
      `);return s`<ul class="shortcuts" role="list">
      ${e}
    </ul>`}get menuClass(){const e=this.menuContents?.length||this.menuShortcuts?.length,t=this.menuOpened&&e?"open":"",i=this.viewportInFullscreen?"fullscreen":"",a=this.shouldRenderMenu?"has-menu":"",o=this.drawerEntering?"drawer-entering":"";return`${t} ${i} ${a} ${o}`}static get styles(){const e=c`var(--item-navigator-menu-width--)`,t=c`var(--item-navigator-animation-timing--)`,i=c`transform ${t} ease-out`,a=c`var(--item-navigator-menu-margin--)`,o=c`var(--item-navigator-theater-bg-color--)`,r=c`var(--item-navigator-icon-size--)`;return[C,c`
        :host {
          --item-navigator-menu-width--: var(
            --item-navigator-menu-width,
            320px
    ...
    `}render(){return this.fileList.length?this.fileListTemplate:u}static get styles(){return[C,c`
      ...
      `]}};I([n({type:String})],O.prototype,"baseHost",2);I([n({type:String})],O.prototype,"sortOrderBy",2);I([n({type:String})],O.prototype,"subPrefix",2);I([n({type:Array})],O.prototype,"fileList",2);I([n({type:Boolean,reflect:!0})],O.prototype,"addSortToUrl",2);O=I([$("ia-itemnav-viewable-files-panel")],O);const ie="data:image/svg+xml,%3csvg%20viewBox='0%200%2018%2018'%20xmlns='http://www.w3.org/2000/svg'%3e%3cg%20fill='none'%20fill-rule='evenodd'%3e%3cpath%20d='m2.32514544%208.30769231.7756949-2.08468003h2.92824822l.75630252%202.08468003h1.01809955l-2.70523594-6.92307693h-1.01809955l-2.69553976%206.92307693zm3.41305753-2.86037492h-2.34647705l1.17323853-3.22883h.01939237z'%20fill='%23000'%20fill-rule='nonzero'%20/%3e%3cpath%20d='m7.1689722%2016.6153846v-.7756949h-4.4117647l4.29541047-5.3716871v-.77569491h-5.06140918v.77569491h3.97543633l-4.30510666%205.3716871v.7756949z'%20fill='%23000'%20fill-rule='nonzero'%20/%3e%3cpath%20d='m10.3846154%2011.0769231%202.7692308%205.5384615%202.7692307-5.5384615m-2.7692307%204.1538461v-13.15384612'%20stroke='%23000'%20stroke-linecap='round'%20stroke-linejoin='round'%20stroke-width='1.661538'%20transform='matrix(1%200%200%20-1%200%2018.692308)'%20/%3e%3c/g%3e%3c/svg%3e",oe="data:image/svg+xml,%3csvg%20viewBox='0%200%2018%2018'%20xmlns='http://www.w3.org/2000/svg'%3e%3cg%20fill='none'%20fill-rule='evenodd'%3e%3cpath%20d='m2.32514544%208.30769231.7756949-2.08468003h2.92824822l.75630252%202.08468003h1.01809955l-2.70523594-6.92307693h-1.01809955l-2.69553976%206.92307693zm3.41305753-2.86037492h-2.34647705l1.17323853-3.22883h.01939237z'%20fill='%23000'%20fill-rule='nonzero'%20/%3e%3cpath%20d='m7.1689722%2016.6153846v-.7756949h-4.4117647l4.29541047-5.3716871v-.77569491h-5.06140918v.77569491h3.97543633l-4.30510666%205.3716871v.7756949z'%20fill='%23000'%20fill-rule='nonzero'%20/%3e%3cpath%20d='m10.3846154%2011.0769231%202.7692308%205.5384615%202.7692307-5.5384615m-2.7692307%204.1538461v-13.15384612'%20stroke='%23000'%20stroke-linecap='round'%20stroke-linejoin='round'%20stroke-width='1.661538'%20/%3e%3c/g%3e%3c/svg%3e",ae="data:image/svg+xml,%3csvg%20viewBox='0%200%2018%2018'%20xmlns='http://www.w3.org/2000/svg'%3e%3cg%20fill='%23000'%20fill-rule='evenodd'%3e%3cpath%20d='m2.32514544%208.30769231.7756949-2.08468003h2.92824822l.75630252%202.08468003h1.01809955l-2.70523594-6.92307693h-1.01809955l-2.69553976%206.92307693zm3.41305753-2.86037492h-2.34647705l1.17323853-3.22883h.01939237z'%20fill-rule='nonzero'%20/%3e%3cpath%20d='m7.1689722%2016.6153846v-.7756949h-4.4117647l4.29541047-5.3716871v-.77569491h-5.06140918v.77569491h3.97543633l-4.30510666%205.3716871v.7756949z'%20fill-rule='nonzero'%20/%3e%3ccircle%20cx='13'%20cy='9'%20r='2'%20/%3e%3c/g%3e%3c/svg%3e";var re=Object.defineProperty,ne=Object.getOwnPropertyDescriptor,B=(e,t,i,a)=>{for(var o=a>1?void 0:a?ne(t,i):t,r=e.length-1,l;r>=0;r--)(l=e[r])&&(o=(a?l(t,i,o):l(o))||o);return a&&o&&re(t,i,o),o};const se=h(ie),le=h(oe),ce=h(ae);let P=class extends f{constructor(){super(...arguments),this.fileListRaw=[],this.fileListSorted=[],this.sortOrderBy="default"}render(){return s`<div class="sort-multi-file-list">${this.sortButton}</div>`}get sortButton(){return{default:s`
        <button
      ...
      `}[this.sortOrderBy]}sortVolumes(e){this.sortOrderBy=e;const t=[...this.fileListRaw].sort((i,a)=>e==="title_asc"?i.title.localeCompare(a.title):e==="title_desc"?a.title.localeCompare(i.title):(i.orig_sort??0)-(a.orig_sort??0));this.dispatchEvent(new CustomEvent("fileListSorted",{detail:{sortType:e,sortedFiles:t},bubbles:!0,composed:!0})),this.fileListSorted=t}static get styles(){return[C,c`
        :host {
    ...
    `}static get styles(){return[C,c`
      ...
      `]}};b([n({type:String})],v.prototype,"baseHost",2);b([n({type:String})],v.prototype,"creator",2);b([n({type:String})],v.prototype,"description",2);b([n({type:Boolean})],v.prototype,"embedOptionsVisible",2);b([n({type:String})],v.prototype,"identifier",2);b([n({type:Array})],v.prototype,"sharingOptions",2);b([n({type:String})],v.prototype,"type",2);b([n({type:Boolean})],v.prototype,"renderHeader",2);b([n({type:String})],v.prototype,"fileSubPrefix",2);v=b([$("ia-itemnav-share-panel")],v);const Oe="data:image/svg+xml,%3csvg%20viewBox='0%200%2024%2024'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20fill='%23000'%20d='M4%206h16v2H4V6zm0%205h16v2H4v-2zm0%205h16v2H4v-2z'%20/%3e%3c/svg%3e";var Ce=Object.defineProperty,ke=Object.getOwnPropertyDescriptor,y=(e,t,i,a)=>{for(var o=a>1?void 0:a?ke(t,i):t,r=e.length-1,l;r>=0;r--)(l=e[r])&&(o=(a?l(t,i,o):l(o))||o);return a&&o&&Ce(t,i,o),o};const Me=h(Oe),Ie=[{name:"Midnight",values:{"--item-navigator-theater-bg-color":"#0d1b2a","--item-navigator-share-embed-bg":"#12233a","--item-navigator-menu-slider-bg":"#1b263b","--item-navigator-active-button-bg":"#2c3e50","--item-navigator-text-color":"#e0e6ed","--item-navigator-icon-color":"#e0e6ed","--item-navigator-icon-active-color":"#7fd8ff","--item-navigator-icon-inactive-color":"#9fb3c8","--item-navigator-border-color":"#5c7799","--item-navigator-active-file-border-color":"#4cc9f0"}},{name:"Forest",values:{"--item-navigator-theater-bg-color":"#08160c","--item-navigator-share-embed-bg":"#0e2413","--item-navigator-menu-slider-bg":"#14301a","--item-navigator-active-button-bg":"#1f4a29","--item-navigator-text-color":"#e8f5e9","--item-navigator-icon-color":"#e8f5e9","--item-navigator-icon-active-color":"#7bd88f","--item-navigator-icon-inactive-color":"#9dbca4","--item-navigator-border-color":"#4d8259","--item-navigator-active-file-border-color":"#7bd88f"}},{name:"Plum",values:{"--item-navigator-theater-bg-color":"#150c1a","--item-navigator-share-embed-bg":"#1f1226","--item-navigator-menu-slider-bg":"#2b1733","--item-navigator-active-button-bg":"#3d2147","--item-navigator-text-color":"#f3e8f7","--item-navigator-icon-color":"#f3e8f7","--item-navigator-icon-active-color":"#d9a6ff","--item-navigator-icon-inactive-color":"#b39ec0","--item-navigator-border-color":"#8a6398","--item-navigator-active-file-border-color":"#d09bff"}},{name:"Solarized",values:{"--item-navigator-theater-bg-color":"#00212b","--item-navigator-share-embed-bg":"#002b36","--item-navigator-menu-slider-bg":"#073642","--item-navigator-active-button-bg":"#0b4553","--item-navigator-text-color":"#eee8d5","--item-navigator-icon-color":"#eee8d5","--item-navigator-icon-active-color":"#5fd3c8","--item-navigator-icon-inactive-color":"#93a1a1","--item-navigator-border-color":"#4d8fa1","--item-navigator-active-file-border-color":"#5fd3c8"}},{name:"High Contrast",values:{"--item-navigator-theater-bg-color":"#000000","--item-navigator-share-embed-bg":"#000000","--item-navigator-menu-slider-bg":"#000000","--item-navigator-active-button-bg":"#1a1a1a","--item-navigator-text-color":"#ffffff","--item-navigator-icon-color":"#ffffff","--item-navigator-icon-active-color":"#ffff00","--item-navigator-icon-inactive-color":"#c0c0c0","--item-navigator-border-color":"#ffffff","--item-navigator-active-file-border-color":"#ffff00"}}],Pe="https://archive.org/embed",_e="https://archive.org/download";function M(e,t,i,a,o){return{identifier:e,mediatype:i,pdfFile:o,title:t,file_prefix:e,file_subprefix:e,file_source:i==="pdf"?`${e}.pdf`:e,url_path:`/details/${e}`,image:"",author:"",orig_sort:a}}const S=[M("Dolly-Parton-Coat-Of-Many-Colors","Coat of Many Colors (album cover)","image",0),M("9to-5and-odd-jobs","9 to 5 and Odd Jobs","image",1),M("musikladen-77","Musikladen Concert, 1977","video",2),M("lp_rhinestone-original-soundtrack-record_various-dolly-parton-floyd-parton-kin-v","Rhinestone: Original Soundtrack Recording","audio",3),M("isbn_9780590899352","Coat of Many Colors","book",4),M("sounds-78-03","Sounds, 3/78","pdf",5,"sounds-78-03.pdf")];let g=class extends f{constructor(){super(...arguments),this.loaded=!0,this.viewAvailable=!0,this.headerOn=!0,this.fullscreen=!1,this.animationsOn=!0,this.sortOrderBy="default",this.sortedFiles=[...S],this.selectedSubPrefix=S[0].file_subprefix}handleFileListSorted(e){const{sortType:t,sortedFiles:i}=e.detail;this.sortOrderBy=t,this.sortedFiles=i}get selectedFile(){return S.find(e=>e.file_subprefix===this.selectedSubPrefix)??S[0]}get theaterSrc(){const e=this.selectedFile;return e.mediatype==="pdf"&&e.pdfFile?`${_e}/${e.identifier}/${encodeURIComponent(e.pdfFile)}`:`${Pe}/${e.identifier}`}handleFileClick(e){const t=e.composedPath().find(o=>o instanceof HTMLAnchorElement);if(!t)return;e.preventDefault();const i=t.getAttribute("href"),a=S.find(o=>`//archive.org${o.url_path}`===i);a&&(this.selectedSubPrefix=a.file_subprefix)}get demoIdentifier(){return this.selectedFile.identifier}get menuContents(){const e={identifier:this.demoIdentifier,baseHost:"archive.org",subPrefix:""};return[{...e,id:"viewable-files",label:`Viewable Files (${S.length})`,icon:F,actionButton:s`
        ...
        `,component:s`
          ...
          ></ia-itemnav-viewable-files-panel>
        `},{...e,id:"share",label:"Share this item",icon:E,component:s`
          ...
          ></ia-itemnav-share-panel>
        `},{...e,id:"about",label:"About This Item",icon:Me,component:s`
          <p>
      ...
      >
        <div slot="demo">
          <div class="frame-wrapper ${this.fullscreen?"fullscreen":""}">
            <ia-item-navigator
              baseHost="archive.org"
              style=${this.animationsOn?u:"--item-navigator-animation-timing: 0ms"}
      ...
      <tr>
        ...
        <td>
          <input
            type="checkbox"
            .checked=${this[t]}
            @change=${i=>{this[t]=i.target.checked}}
          />
        </td>
      </tr>
    `}get headerTemplate(){return!this.headerOn&&!this.fullscreen?u:s`
    ...
    `}get theaterTemplate(){const e=this.selectedFile;return s`
...
>
  ...
  <div slot="main">…your theater…</div>
</ia-item-navigator>`}static get styles(){return c`
      .frame-wrapper {
        height: 460px;
    ...
    `}};y([w()],g.prototype,"loaded",2);y([w()],g.prototype,"viewAvailable",2);y([w()],g.prototype,"headerOn",2);y([w()],g.prototype,"fullscreen",2);y([w()],g.prototype,"animationsOn",2);y([w()],g.prototype,"sortOrderBy",2);y([w()],g.prototype,"sortedFiles",2);y([w()],g.prototype,"selectedSubPrefix",2);g=y([$("ia-item-navigator-story")],g);export{g as IAItemNavigatorStory};
