...
`:""}${t}${e}>${o??""}</${this.elementTag}>`}get cssCode(){return this.stringifiedStyles?`${this.elementTag} {
 ${this.stringifiedStyles}
      ...
      `]}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this._copyTimeout)}};d([p({type:String})],l.prototype,"elementTag",2);d([p({type:String})],l.prototype,"elementClassName",2);d([p({type:String})],l.prototype,"customExampleUsage",2);d([p({type:String})],l.prototype,"defaultUsageProps",2);d([p({type:String})],l.prototype,"defaultSlottedContent",2);d([p({type:Object})],l.prototype,"styleInputData",2);d([p({type:Object})],l.prototype,"propInputData",2);d([p({type:Boolean})],l.prototype,"labs",2);d([h()],l.prototype,"focused",2);d([h()],l.prototype,"detailsVisible",2);d([h()],l.prototype,"stringifiedStyles",2);d([h()],l.prototype,"stringifiedProps",2);d([h()],l.prototype,"shouldShowPropertySettings",2);d([h()],l.prototype,"shouldShowUsageNotes",2);d([h()],l.prototype,"slottedDemoComponent",2);d([h()],l.prototype,"copiedKey",2);l=d([$("story-template")],l);export{z as e,c as n,g as o,P as r,C as t};
