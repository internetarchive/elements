(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))r(o);new MutationObserver(o=>{for(const a of o)if(a.type==="childList")for(const n of a.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&r(n)}).observe(document,{childList:!0,subtree:!0});function t(o){const a={};return o.integrity&&(a.integrity=o.integrity),o.referrerPolicy&&(a.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?a.credentials="include":o.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function r(o){if(o.ep)return;o.ep=!0;const a=t(o);fetch(o.href,a)}})();const vt=globalThis,Ei=vt.ShadowRoot&&(vt.ShadyCSS===void 0||vt.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,ki=Symbol(),Gi=new WeakMap;let Jr=class{constructor(e,t,r){if(this._$cssResult$=!0,r!==ki)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(Ei&&e===void 0){const r=t!==void 0&&t.length===1;r&&(e=Gi.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),r&&Gi.set(t,e))}return e}toString(){return this.cssText}};const Bo=i=>new Jr(typeof i=="string"?i:i+"",void 0,ki),_=(i,...e)=>{const t=i.length===1?i[0]:e.reduce(((r,o,a)=>r+(n=>{if(n._$cssResult$===!0)return n.cssText;if(typeof n=="number")return n;throw Error("Value passed to 'css' function must be a 'css' function result: "+n+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(o)+i[a+1]),i[0]);return new Jr(t,i,ki)},Vo=(i,e)=>{if(Ei)i.adoptedStyleSheets=e.map((t=>t instanceof CSSStyleSheet?t:t.styleSheet));else for(const t of e){const r=document.createElement("style"),o=vt.litNonce;o!==void 0&&r.setAttribute("nonce",o),r.textContent=t.cssText,i.appendChild(r)}},Zi=Ei?i=>i:i=>i instanceof CSSStyleSheet?(e=>{let t="";for(const r of e.cssRules)t+=r.cssText;return Bo(t)})(i):i;const{is:Do,defineProperty:Lo,getOwnPropertyDescriptor:zo,getOwnPropertyNames:Ro,getOwnPropertySymbols:No,getPrototypeOf:Uo}=Object,Bt=globalThis,Ji=Bt.trustedTypes,jo=Ji?Ji.emptyScript:"",Ho=Bt.reactiveElementPolyfillSupport,it=(i,e)=>i,$t={toAttribute(i,e){switch(e){case Boolean:i=i?jo:null;break;case Object:case Array:i=i==null?i:JSON.stringify(i)}return i},fromAttribute(i,e){let t=i;switch(e){case Boolean:t=i!==null;break;case Number:t=i===null?null:Number(i);break;case Object:case Array:try{t=JSON.parse(i)}catch{t=null}}return t}},Pi=(i,e)=>!Do(i,e),Yi={attribute:!0,type:String,converter:$t,reflect:!1,useDefault:!1,hasChanged:Pi};Symbol.metadata??=Symbol("metadata"),Bt.litPropertyMetadata??=new WeakMap;let Ve=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=Yi){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){const r=Symbol(),o=this.getPropertyDescriptor(e,r,t);o!==void 0&&Lo(this.prototype,e,o)}}static getPropertyDescriptor(e,t,r){const{get:o,set:a}=zo(this.prototype,e)??{get(){return this[t]},set(n){this[t]=n}};return{get:o,set(n){const l=o?.call(this);a?.call(this,n),this.requestUpdate(e,l,r)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??Yi}static _$Ei(){if(this.hasOwnProperty(it("elementProperties")))return;const e=Uo(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(it("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(it("properties"))){const t=this.properties,r=[...Ro(t),...No(t)];for(const o of r)this.createProperty(o,t[o])}const e=this[Symbol.metadata];if(e!==null){const t=litPropertyMetadata.get(e);if(t!==void 0)for(const[r,o]of t)this.elementProperties.set(r,o)}this._$Eh=new Map;for(const[t,r]of this.elementProperties){const o=this._$Eu(t,r);o!==void 0&&this._$Eh.set(o,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const r=new Set(e.flat(1/0).reverse());for(const o of r)t.unshift(Zi(o))}else e!==void 0&&t.push(Zi(e));return t}static _$Eu(e,t){const r=t.attribute;return r===!1?void 0:typeof r=="string"?r:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise((e=>this.enableUpdating=e)),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach((e=>e(this)))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){const e=new Map,t=this.constructor.elementProperties;for(const r of t.keys())this.hasOwnProperty(r)&&(e.set(r,this[r]),delete this[r]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Vo(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach((e=>e.hostConnected?.()))}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach((e=>e.hostDisconnected?.()))}attributeChangedCallback(e,t,r){this._$AK(e,r)}_$ET(e,t){const r=this.constructor.elementProperties.get(e),o=this.constructor._$Eu(e,r);if(o!==void 0&&r.reflect===!0){const a=(r.converter?.toAttribute!==void 0?r.converter:$t).toAttribute(t,r.type);this._$Em=e,a==null?this.removeAttribute(o):this.setAttribute(o,a),this._$Em=null}}_$AK(e,t){const r=this.constructor,o=r._$Eh.get(e);if(o!==void 0&&this._$Em!==o){const a=r.getPropertyOptions(o),n=typeof a.converter=="function"?{fromAttribute:a.converter}:a.converter?.fromAttribute!==void 0?a.converter:$t;this._$Em=o;const l=n.fromAttribute(t,a.type);this[o]=l??this._$Ej?.get(o)??l,this._$Em=null}}requestUpdate(e,t,r){if(e!==void 0){const o=this.constructor,a=this[e];if(r??=o.getPropertyOptions(e),!((r.hasChanged??Pi)(a,t)||r.useDefault&&r.reflect&&a===this._$Ej?.get(e)&&!this.hasAttribute(o._$Eu(e,r))))return;this.C(e,t,r)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,t,{useDefault:r,reflect:o,wrapped:a},n){r&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,n??t??this[e]),a!==!0||n!==void 0)||(this._$AL.has(e)||(this.hasUpdated||r||(t=void 0),this._$AL.set(e,t)),o===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[o,a]of this._$Ep)this[o]=a;this._$Ep=void 0}const r=this.constructor.elementProperties;if(r.size>0)for(const[o,a]of r){const{wrapped:n}=a,l=this[o];n!==!0||this._$AL.has(o)||l===void 0||this.C(o,void 0,a,l)}}let e=!1;const t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach((r=>r.hostUpdate?.())),this.update(t)):this._$EM()}catch(r){throw e=!1,this._$EM(),r}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach((t=>t.hostUpdated?.())),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach((t=>this._$ET(t,this[t]))),this._$EM()}updated(e){}firstUpdated(e){}};Ve.elementStyles=[],Ve.shadowRootOptions={mode:"open"},Ve[it("elementProperties")]=new Map,Ve[it("finalized")]=new Map,Ho?.({ReactiveElement:Ve}),(Bt.reactiveElementVersions??=[]).push("2.1.1");const Mi=globalThis,xt=Mi.trustedTypes,Xi=xt?xt.createPolicy("lit-html",{createHTML:i=>i}):void 0,Yr="$lit$",se=`lit$${Math.random().toFixed(9).slice(2)}$`,Xr="?"+se,Fo=`<${Xr}>`,Ce=document,ot=()=>Ce.createComment(""),at=i=>i===null||typeof i!="object"&&typeof i!="function",Ii=Array.isArray,qo=i=>Ii(i)||typeof i?.[Symbol.iterator]=="function",Ht=`[ 	
\f\r]`,Xe=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Qi=/-->/g,er=/>/g,me=RegExp(`>|${Ht}(?:([^\\s"'>=/]+)(${Ht}*=${Ht}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),tr=/'/g,ir=/"/g,Qr=/^(?:script|style|textarea|title)$/i,eo=i=>(e,...t)=>({_$litType$:i,strings:e,values:t}),d=eo(1),rr=eo(2),K=Symbol.for("lit-noChange"),y=Symbol.for("lit-nothing"),or=new WeakMap,we=Ce.createTreeWalker(Ce,129);function to(i,e){if(!Ii(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return Xi!==void 0?Xi.createHTML(e):e}const Ko=(i,e)=>{const t=i.length-1,r=[];let o,a=e===2?"<svg>":e===3?"<math>":"",n=Xe;for(let l=0;l<t;l++){const s=i[l];let p,g,h=-1,v=0;for(;v<s.length&&(n.lastIndex=v,g=n.exec(s),g!==null);)v=n.lastIndex,n===Xe?g[1]==="!--"?n=Qi:g[1]!==void 0?n=er:g[2]!==void 0?(Qr.test(g[2])&&(o=RegExp("</"+g[2],"g")),n=me):g[3]!==void 0&&(n=me):n===me?g[0]===">"?(n=o??Xe,h=-1):g[1]===void 0?h=-2:(h=n.lastIndex-g[2].length,p=g[1],n=g[3]===void 0?me:g[3]==='"'?ir:tr):n===ir||n===tr?n=me:n===Qi||n===er?n=Xe:(n=me,o=void 0);const b=n===me&&i[l+1].startsWith("/>")?" ":"";a+=n===Xe?s+Fo:h>=0?(r.push(p),s.slice(0,h)+Yr+s.slice(h)+se+b):s+se+(h===-2?l:b)}return[to(i,a+(i[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),r]};let si=class io{constructor({strings:e,_$litType$:t},r){let o;this.parts=[];let a=0,n=0;const l=e.length-1,s=this.parts,[p,g]=Ko(e,t);if(this.el=io.createElement(p,r),we.currentNode=this.el.content,t===2||t===3){const h=this.el.content.firstChild;h.replaceWith(...h.childNodes)}for(;(o=we.nextNode())!==null&&s.length<l;){if(o.nodeType===1){if(o.hasAttributes())for(const h of o.getAttributeNames())if(h.endsWith(Yr)){const v=g[n++],b=o.getAttribute(h).split(se),A=/([.?@])?(.*)/.exec(v);s.push({type:1,index:a,name:A[2],strings:b,ctor:A[1]==="."?Go:A[1]==="?"?Zo:A[1]==="@"?Jo:Dt}),o.removeAttribute(h)}else h.startsWith(se)&&(s.push({type:6,index:a}),o.removeAttribute(h));if(Qr.test(o.tagName)){const h=o.textContent.split(se),v=h.length-1;if(v>0){o.textContent=xt?xt.emptyScript:"";for(let b=0;b<v;b++)o.append(h[b],ot()),we.nextNode(),s.push({type:2,index:++a});o.append(h[v],ot())}}}else if(o.nodeType===8)if(o.data===Xr)s.push({type:2,index:a});else{let h=-1;for(;(h=o.data.indexOf(se,h+1))!==-1;)s.push({type:7,index:a}),h+=se.length-1}a++}}static createElement(e,t){const r=Ce.createElement("template");return r.innerHTML=e,r}};function Ne(i,e,t=i,r){if(e===K)return e;let o=r!==void 0?t._$Co?.[r]:t._$Cl;const a=at(e)?void 0:e._$litDirective$;return o?.constructor!==a&&(o?._$AO?.(!1),a===void 0?o=void 0:(o=new a(i),o._$AT(i,t,r)),r!==void 0?(t._$Co??=[])[r]=o:t._$Cl=o),o!==void 0&&(e=Ne(i,o._$AS(i,e.values),o,r)),e}let Wo=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:r}=this._$AD,o=(e?.creationScope??Ce).importNode(t,!0);we.currentNode=o;let a=we.nextNode(),n=0,l=0,s=r[0];for(;s!==void 0;){if(n===s.index){let p;s.type===2?p=new Vt(a,a.nextSibling,this,e):s.type===1?p=new s.ctor(a,s.name,s.strings,this,e):s.type===6&&(p=new Yo(a,this,e)),this._$AV.push(p),s=r[++l]}n!==s?.index&&(a=we.nextNode(),n++)}return we.currentNode=Ce,o}p(e){let t=0;for(const r of this._$AV)r!==void 0&&(r.strings!==void 0?(r._$AI(e,r,t),t+=r.strings.length-2):r._$AI(e[t])),t++}},Vt=class ro{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,r,o){this.type=2,this._$AH=y,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=r,this.options=o,this._$Cv=o?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Ne(this,e,t),at(e)?e===y||e==null||e===""?(this._$AH!==y&&this._$AR(),this._$AH=y):e!==this._$AH&&e!==K&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):qo(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==y&&at(this._$AH)?this._$AA.nextSibling.data=e:this.T(Ce.createTextNode(e)),this._$AH=e}$(e){const{values:t,_$litType$:r}=e,o=typeof r=="number"?this._$AC(e):(r.el===void 0&&(r.el=si.createElement(to(r.h,r.h[0]),this.options)),r);if(this._$AH?._$AD===o)this._$AH.p(t);else{const a=new Wo(o,this),n=a.u(this.options);a.p(t),this.T(n),this._$AH=a}}_$AC(e){let t=or.get(e.strings);return t===void 0&&or.set(e.strings,t=new si(e)),t}k(e){Ii(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let r,o=0;for(const a of e)o===t.length?t.push(r=new ro(this.O(ot()),this.O(ot()),this,this.options)):r=t[o],r._$AI(a),o++;o<t.length&&(this._$AR(r&&r._$AB.nextSibling,o),t.length=o)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){const r=e.nextSibling;e.remove(),e=r}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},Dt=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,r,o,a){this.type=1,this._$AH=y,this._$AN=void 0,this.element=e,this.name=t,this._$AM=o,this.options=a,r.length>2||r[0]!==""||r[1]!==""?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=y}_$AI(e,t=this,r,o){const a=this.strings;let n=!1;if(a===void 0)e=Ne(this,e,t,0),n=!at(e)||e!==this._$AH&&e!==K,n&&(this._$AH=e);else{const l=e;let s,p;for(e=a[0],s=0;s<a.length-1;s++)p=Ne(this,l[r+s],t,s),p===K&&(p=this._$AH[s]),n||=!at(p)||p!==this._$AH[s],p===y?e=y:e!==y&&(e+=(p??"")+a[s+1]),this._$AH[s]=p}n&&!o&&this.j(e)}j(e){e===y?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},Go=class extends Dt{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===y?void 0:e}},Zo=class extends Dt{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==y)}},Jo=class extends Dt{constructor(e,t,r,o,a){super(e,t,r,o,a),this.type=5}_$AI(e,t=this){if((e=Ne(this,e,t,0)??y)===K)return;const r=this._$AH,o=e===y&&r!==y||e.capture!==r.capture||e.once!==r.once||e.passive!==r.passive,a=e!==y&&(r===y||o);o&&this.element.removeEventListener(this.name,this,r),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Yo=class{constructor(e,t,r){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(e){Ne(this,e)}};const Xo={I:Vt},Qo=Mi.litHtmlPolyfillSupport;Qo?.(si,Vt),(Mi.litHtmlVersions??=[]).push("3.3.1");const oo=(i,e,t)=>{const r=t?.renderBefore??e;let o=r._$litPart$;if(o===void 0){const a=t?.renderBefore??null;r._$litPart$=o=new Vt(e.insertBefore(ot(),a),a,void 0,t??{})}return o._$AI(i),o};const Bi=globalThis;let x=class extends Ve{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=oo(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return K}};x._$litElement$=!0,x.finalized=!0,Bi.litElementHydrateSupport?.({LitElement:x});const ea=Bi.litElementPolyfillSupport;ea?.({LitElement:x});(Bi.litElementVersions??=[]).push("4.2.1");const C=i=>(e,t)=>{t!==void 0?t.addInitializer((()=>{customElements.define(i,e)})):customElements.define(i,e)};const ta={attribute:!0,type:String,converter:$t,reflect:!1,hasChanged:Pi},ia=(i=ta,e,t)=>{const{kind:r,metadata:o}=t;let a=globalThis.litPropertyMetadata.get(o);if(a===void 0&&globalThis.litPropertyMetadata.set(o,a=new Map),r==="setter"&&((i=Object.create(i)).wrapped=!0),a.set(t.name,i),r==="accessor"){const{name:n}=t;return{set(l){const s=e.get.call(this);e.set.call(this,l),this.requestUpdate(n,s,i)},init(l){return l!==void 0&&this.C(n,void 0,i,l),l}}}if(r==="setter"){const{name:n}=t;return function(l){const s=this[n];e.call(this,l),this.requestUpdate(n,s,i)}}throw Error("Unsupported decorator location: "+r)};function u(i){return(e,t)=>typeof t=="object"?ia(i,e,t):((r,o,a)=>{const n=o.hasOwnProperty(a);return o.constructor.createProperty(a,r),n?Object.getOwnPropertyDescriptor(o,a):void 0})(i,e,t)}function $(i){return u({...i,state:!0,attribute:!1})}const ao=(i,e,t)=>(t.configurable=!0,t.enumerable=!0,Reflect.decorate&&typeof e!="object"&&Object.defineProperty(i,e,t),t);function S(i,e){return(t,r,o)=>{const a=n=>n.renderRoot?.querySelector(i)??null;return ao(t,r,{get(){return a(this)}})}}let ra;function Vi(i){return(e,t)=>ao(e,t,{get(){return(this.renderRoot??(ra??=document.createDocumentFragment())).querySelectorAll(i)}})}function ye(i,e,t){return i?e(i):t?.(i)}const $e=i=>i??y,oa="modulepreload",aa=function(i,e){return new URL(i,e).href},ar={},bt=function(e,t,r){let o=Promise.resolve();if(t&&t.length>0){let p=function(g){return Promise.all(g.map(h=>Promise.resolve(h).then(v=>({status:"fulfilled",value:v}),v=>({status:"rejected",reason:v}))))};const n=document.getElementsByTagName("link"),l=document.querySelector("meta[property=csp-nonce]"),s=l?.nonce||l?.getAttribute("nonce");o=p(t.map(g=>{if(g=aa(g,r),g in ar)return;ar[g]=!0;const h=g.endsWith(".css"),v=h?'[rel="stylesheet"]':"";if(r)for(let A=n.length-1;A>=0;A--){const k=n[A];if(k.href===g&&(!h||k.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${g}"]${v}`))return;const b=document.createElement("link");if(b.rel=h?"stylesheet":oa,h||(b.as="script"),b.crossOrigin="",b.href=g,s&&b.setAttribute("nonce",s),document.head.appendChild(b),h)return new Promise((A,k)=>{b.addEventListener("load",A),b.addEventListener("error",()=>k(new Error(`Unable to preload CSS for ${g}`)))})}))}function a(n){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=n,window.dispatchEvent(l),!l.defaultPrevented)throw n}return o.then(n=>{for(const l of n||[])l.status==="rejected"&&a(l.reason);return e().catch(a)})};const re={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4},gt=i=>(...e)=>({_$litDirective$:i,values:e});let mt=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,r){this._$Ct=e,this._$AM=t,this._$Ci=r}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};let li=class extends mt{constructor(e){if(super(e),this.it=y,e.type!==re.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===y||e==null)return this._t=void 0,this.it=e;if(e===K)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;const t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}};li.directiveName="unsafeHTML",li.resultType=1;const di=gt(li),na=_`
  pre {
...
`;var sa=Object.defineProperty,la=Object.getOwnPropertyDescriptor,Lt=(i,e,t,r)=>{for(var o=r>1?void 0:r?la(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=(r?n(e,t,o):n(o))||o);return r&&o&&sa(e,t,o),o};let nt=class extends x{constructor(){super(...arguments),this.code="",this.language="auto",this.highlightedCode=""}willUpdate(i){(i.has("code")||i.has("language"))&&this.highlightCode()}render(){return d`
      <pre><code class="hljs">${di(this.highlightedCode)}</code></pre>
    `}async highlightCode(){const e=(await bt(()=>import("./index-BBc-AmEf.js"),[],import.meta.url)).default,t=this.code.trim();let r;this.language==="auto"?r=e.highlightAuto(t).value:r=e.highlight(t,{language:this.language}).value,this.highlightedCode=r}static get styles(){return[na]}};Lt([u({type:String})],nt.prototype,"code",2);Lt([u({type:String})],nt.prototype,"language",2);Lt([$()],nt.prototype,"highlightedCode",2);nt=Lt([C("syntax-highlighter")],nt);const D=_`
  :host {
    /*
    BASE STYLES
...
`,da="data:image/svg+xml,%3c?xml%20version='1.0'%20encoding='UTF-8'?%3e%3csvg%20xmlns='http://www.w3.org/2000/svg'%20xmlns:xlink='http://www.w3.org/1999/xlink'%20width='36pt'%20height='36pt'%20viewBox='0%200%2036%2036'%20version='1.1'%3e%3cg%20id='surface35'%3e%3cpath%20style='%20stroke:none;fill-rule:nonzero;fill:rgb(0%25,0%25,0%25);fill-opacity:1;'%20d='M%2013.5%206.1875%20C%2012.878906%206.1875%2012.375%206.691406%2012.375%207.3125%20C%2012.375%207.933594%2012.878906%208.4375%2013.5%208.4375%20L%2014.0625%208.4375%20L%2014.0625%2013.523438%20C%2014.0625%2014.453125%2013.78125%2015.34375%2013.246094%2016.105469%20L%206.84375%2025.238281%20C%206.140625%2026.238281%206.054688%2027.535156%206.621094%2028.617188%20C%207.183594%2029.703125%208.292969%2030.375%209.515625%2030.375%20L%2026.484375%2030.375%20C%2027.707031%2030.375%2028.816406%2029.703125%2029.378906%2028.617188%20C%2029.941406%2027.535156%2029.859375%2026.238281%2029.15625%2025.238281%20L%2022.753906%2016.105469%20C%2022.21875%2015.34375%2021.9375%2014.453125%2021.9375%2013.523438%20L%2021.9375%208.4375%20L%2022.5%208.4375%20C%2023.121094%208.4375%2023.625%207.933594%2023.625%207.3125%20C%2023.625%206.691406%2023.121094%206.1875%2022.5%206.1875%20Z%20M%2016.3125%208.4375%20L%2019.6875%208.4375%20L%2019.6875%2013.523438%20C%2019.6875%2014.914062%2020.109375%2016.257812%2020.910156%2017.398438%20L%2020.941406%2017.4375%20L%2015.0625%2017.4375%20L%2015.089844%2017.398438%20C%2015.890625%2016.257812%2016.3125%2014.914062%2016.3125%2013.523438%20Z%20M%2015.1875%2020.8125%20C%2015.808594%2020.8125%2016.3125%2021.316406%2016.3125%2021.9375%20C%2016.3125%2022.558594%2015.808594%2023.0625%2015.1875%2023.0625%20C%2014.566406%2023.0625%2014.0625%2022.558594%2014.0625%2021.9375%20C%2014.0625%2021.316406%2014.566406%2020.8125%2015.1875%2020.8125%20Z%20M%2020.53125%2023.0625%20C%2021.617188%2023.0625%2022.5%2023.945312%2022.5%2025.03125%20C%2022.5%2026.117188%2021.617188%2027%2020.53125%2027%20C%2019.445312%2027%2018.5625%2026.117188%2018.5625%2025.03125%20C%2018.5625%2023.945312%2019.445312%2023.0625%2020.53125%2023.0625%20Z%20M%2020.53125%2023.0625%20'/%3e%3c/g%3e%3c/svg%3e";function ci(i){return i.toLowerCase().split(" ").join("-")}var ca=Object.defineProperty,ha=Object.getOwnPropertyDescriptor,Di=(i,e,t,r)=>{for(var o=r>1?void 0:r?ha(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=(r?n(e,t,o):n(o))||o);return r&&o&&ca(e,t,o),o};let _t=class extends x{render(){return this.styleInputData?d`
    ...
    `:y}renderStyleRow(i){const e=ci(i.label),t=i.inputType==="number"||i.inputType==="range";return d`
      <tr>
        <td>
        ...
        <td class="style-input-cell">
          <input
            ...
            min=${$e(t?i.min:void 0)}
            max=${$e(t?i.max:void 0)}
            step=${$e(t?i.step:void 0)}
 ...
 `)}}))}static get styles(){return[D,_`
      ...
      `]}};Di([u({type:Object})],_t.prototype,"styleInputData",2);Di([Vi(".style-input")],_t.prototype,"styleInputs",2);_t=Di([C("story-styles-settings")],_t);const no=(i,e,t)=>{for(const r of e)if(r[0]===i)return(0,r[1])();return t?.()};var pa=Object.defineProperty,ua=Object.getOwnPropertyDescriptor,Li=(i,e,t,r)=>{for(var o=r>1?void 0:r?ua(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=(r?n(e,t,o):n(o))||o);return r&&o&&pa(e,t,o),o};let St=class extends x{render(){return this.propInputData?d`
      <div class="settings-options">
        <table>
          ${this.propInputData.settings.map(i=>no(i.inputType,[["radio",()=>this.createRadioPropInput(i)]],()=>this.createDefaultPropInput(i))??y)}
        </table>
        <button @click=${this.applyProps}>Apply</button>
      </div>
    `:y}createDefaultPropInput(i){const e=ci(i.label);return d`
      <tr>
    ...
    `}createRadioPropInput(i){if(i.inputType!=="radio"||!i.radioOptions)return y;const e=ci(i.label);return d`
      <tr>
  ...
  `),appliedProps:e}}))}static get styles(){return[D,_`
        .settings-options {
          background-color: var(--primary-background-color);
          padding: 1em;
        }
      `]}};Li([u({type:Object})],St.prototype,"propInputData",2);Li([Vi(".prop-input")],St.prototype,"propInputs",2);St=Li([C("story-props-settings")],St);var ga=Object.defineProperty,ma=Object.getOwnPropertyDescriptor,R=(i,e,t,r)=>{for(var o=r>1?void 0:r?ma(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=(r?n(e,t,o):n(o))||o);return r&&o&&ga(e,t,o),o};let z=class extends x{constructor(){super(...arguments),this.elementTag="",this.elementClassName="",this.labs=!1,this.detailsVisible=!1,this.shouldShowPropertySettings=!1,this.shouldShowUsageNotes=!1,this.copiedKey=null}render(){return d`
      <div id="container">
        <h2>
        ...
        <h3>Demo</h3>
        <div class="slot-container" style=${$e(this.stringifiedStyles)}>
          <slot
            name="demo"
    ...
    `}get detailsTemplate(){return d`
      ...
      <div class="two-col">
        <div class="left-col">
          <h3>Settings</h3>
          ${ye(!!this.propInputData,()=>d`
              <story-props-settings
                .propInputData=${this.propInputData}
                @propsApplied=${this.handlePropsApplied}
              ></story-props-settings>
            `)}
          ${ye(!this.propInputData&&!this.shouldShowPropertySettings,()=>d`<p class="section-placeholder">No settings to adjust</p>`)}
          <div
      ...
      ${ye(this.shouldShowUsageNotes,()=>d` <h3>Usage Notes</h3>`)}
...
`:""}${i}${e}>${r??""}</${this.elementTag}>`}get cssCode(){return this.stringifiedStyles?`${this.elementTag} {
 ${this.stringifiedStyles}
      ...
      `]}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this._copyTimeout)}};R([u({type:String})],z.prototype,"elementTag",2);R([u({type:String})],z.prototype,"elementClassName",2);R([u({type:String})],z.prototype,"customExampleUsage",2);R([u({type:String})],z.prototype,"defaultUsageProps",2);R([u({type:String})],z.prototype,"defaultSlottedContent",2);R([u({type:Object})],z.prototype,"styleInputData",2);R([u({type:Object})],z.prototype,"propInputData",2);R([u({type:Boolean})],z.prototype,"labs",2);R([$()],z.prototype,"detailsVisible",2);R([$()],z.prototype,"stringifiedStyles",2);R([$()],z.prototype,"stringifiedProps",2);R([$()],z.prototype,"shouldShowPropertySettings",2);R([$()],z.prototype,"shouldShowUsageNotes",2);R([$()],z.prototype,"slottedDemoComponent",2);R([$()],z.prototype,"copiedKey",2);z=R([C("story-template")],z);const fa=i=>typeof i!="string"&&"strTag"in i,va=(i,e,t)=>{let r=i[0];for(let o=1;o<i.length;o++)r+=e[o-1],r+=i[o];return r};const ba=(i=>fa(i)?va(i.strings,i.values):i);let U=ba;class ya{constructor(){this.settled=!1,this.promise=new Promise((e,t)=>{this._resolve=e,this._reject=t})}resolve(e){this.settled=!0,this._resolve(e)}reject(e){this.settled=!0,this._reject(e)}}for(let i=0;i<256;i++)(i>>4&15).toString(16)+(i&15).toString(16);let wa=new ya;wa.resolve();var $a=Object.defineProperty,xa=Object.getOwnPropertyDescriptor,We=(i,e,t,r)=>{for(var o=r>1?void 0:r?xa(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=(r?n(e,t,o):n(o))||o);return r&&o&&$a(e,t,o),o};let Ae=class extends x{constructor(){super(...arguments),this.loadingTitle=U("Loading..."),this.successTitle=U("Success"),this.errorTitle=U("Error"),this.loadingStyle="ring-dots",this.mode="loading"}render(){return d`${no(this.mode,[["ready",()=>this.placeholderTemplate],["loading",()=>this.loadingIndicatorTemplate],["success",()=>this.successIndicatorTemplate],["error",()=>this.errorIndicatorTemplate]])}`}get placeholderTemplate(){return d`<div class="placeholder"></div>`}get loadingIndicatorTemplate(){return d`
      <svg
    ...
    `}get shouldShowLoadingDots(){return this.loadingStyle!=="ring"}static get styles(){return[D,_`
        :host {
      ...
      `]}};We([u({type:String})],Ae.prototype,"loadingTitle",2);We([u({type:String})],Ae.prototype,"successTitle",2);We([u({type:String})],Ae.prototype,"errorTitle",2);We([u({type:String})],Ae.prototype,"loadingStyle",2);We([u({type:String})],Ae.prototype,"mode",2);Ae=We([C("ia-status-indicator")],Ae);var _a=Object.defineProperty,Sa=Object.getOwnPropertyDescriptor,ue=(i,e,t,r)=>{for(var o=r>1?void 0:r?Sa(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=(r?n(e,t,o):n(o))||o);return r&&o&&_a(e,t,o),o};let Y=class extends x{constructor(){super(...arguments),this.mode="primary",this.loading=!1,this.disabled=!1,this.loadingText="",this.type="button",this.openLinksNewTab=!1}render(){return d`
      ${this.href?d`<a
            href=${this.href}
    ...
    `}get textInputTemplate(){const i=rt({"clear-padding":this.clearable&&!this.shouldShowClearButton});return d`
      <input
        ...
        aria-activedescendant=${$e(this.highlightedOption?.id)}
    ...
    `}get optionsListTemplate(){return d`
      ...
      >
        ...
        ${ye(this.open,()=>this.optionTemplates)}
    ...
    `;return[D,i]}};T.formAssociated=!0;T.shadowRootOptions={...x.shadowRootOptions,delegatesFocus:!0};M([u({type:Array})],T.prototype,"options",2);M([u({type:String})],T.prototype,"placeholder",2);M([u({type:String})],T.prototype,"behavior",2);M([u({type:Number,attribute:"max-autocomplete-entries"})],T.prototype,"maxAutocompleteEntries",2);M([u({type:String})],T.prototype,"filter",2);M([u({type:Boolean,reflect:!0,attribute:"case-sensitive"})],T.prototype,"caseSensitive",2);M([u({type:Boolean,reflect:!0})],T.prototype,"sort",2);M([u({type:Boolean,reflect:!0,attribute:"wrap-arrow-keys"})],T.prototype,"wrapArrowKeys",2);M([u({type:Boolean,reflect:!0,attribute:"stay-open"})],T.prototype,"stayOpen",2);M([u({type:Boolean,reflect:!0})],T.prototype,"clearable",2);M([u({type:Boolean,reflect:!0})],T.prototype,"open",2);M([u({type:Boolean,reflect:!0})],T.prototype,"disabled",2);M([u({type:Boolean,reflect:!0})],T.prototype,"required",2);M([u({type:String})],T.prototype,"value",2);M([$()],T.prototype,"hasFocus",2);M([$()],T.prototype,"highlightedOption",2);M([$()],T.prototype,"enteredText",2);M([$()],T.prototype,"filterText",2);M([S("#main-widget-row")],T.prototype,"mainWidgetRow",2);M([S("#text-input")],T.prototype,"textInput",2);M([S("#options-list")],T.prototype,"optionsList",2);T=M([C("ia-combo-box")],T);var Wa=Object.defineProperty,Ga=Object.getOwnPropertyDescriptor,E=(i,e,t,r)=>{for(var o=r>1?void 0:r?Ga(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=(r?n(e,t,o):n(o))||o);return r&&o&&Wa(e,t,o),o};const Za=[{label:"Width",cssVariable:"--ia-theme-combo-box-width",defaultValue:"250px",inputType:"text"},{label:"Padding",cssVariable:"--ia-theme-padding-sm",defaultValue:"5px",inputType:"text"},{label:"Dropdown width",cssVariable:"--combo-box-list-width",defaultValue:"",inputType:"text"},{label:"Dropdown max height",cssVariable:"--combo-box-list-max-height",defaultValue:"250px",inputType:"text"},{label:"Dropdown fade duration",cssVariable:"--combo-box-list-fade-duration",defaultValue:125,inputType:"range",min:0,max:1e3,step:25,unit:"ms"}],co=[{id:"red",text:"Red"},{id:"orange",text:"Orange"},{id:"yellow",text:"Yellow"},{id:"green",text:"Green"},{id:"blue",text:"Blue"},{id:"indigo",text:"Indigo"},{id:"violet",text:"Violet"}],Ja=co.map(i=>({...i,content:d` <span style="display: flex; align-items: center">
      <span style="flex: 1">${i.text}</span>
      <div style="width: 15px; height: 15px; background:${i.id}"></div>
    </span>`})),lr=so.map(i=>({id:i.name,text:i.name})),Ya=so.map(i=>({id:i.name,text:i.name,content:d`<span>${i.flag}</span>&nbsp;<span>${i.name}</span>`})),Xa="list",Qa="Choices",dr="Select an option...",cr=50,en="substring";let O=class extends x{constructor(){super(...arguments),this.options=lr,this.behavior=Xa,this.label=Qa,this.placeholder=dr,this.maxAutocompleteEntries=cr,this.filterFn=en,this.caseSensitive=!1,this.shouldSort=!1,this.wrapArrowKeys=!0,this.clearable=!0,this.disabled=!1,this.announcerText=""}render(){return d`
      <story-template
...
`)}applySettings(i){i.preventDefault(),this.updateOptions(),this.behavior=this.behaviorSelect.value,this.label=this.labelInput.value,this.placeholder=this.placeholderInput.value,this.maxAutocompleteEntries=Number(this.maxAutocompleteInput.value),this.filterFn=this.filterFnSelect.value,this.caseSensitive=this.caseSensitiveCheck.checked,this.shouldSort=this.sortCheck.checked,this.wrapArrowKeys=this.wrapArrowKeysCheck.checked,this.clearable=this.clearableCheck.checked,this.disabled=this.disabledCheck.checked}updateOptions(){switch(this.optionSetSelect.value){case"colors":this.options=this.customContentCheck.checked?Ja:co;break;case"countries":this.options=this.customContentCheck.checked?Ya:lr;break;default:this.options=[]}}handleComboBoxChange(i){this.announcerText=`New value is: ${i.detail}`}static get styles(){return _`
    ...
    `}};E([$()],O.prototype,"options",2);E([$()],O.prototype,"behavior",2);E([$()],O.prototype,"label",2);E([$()],O.prototype,"placeholder",2);E([$()],O.prototype,"maxAutocompleteEntries",2);E([$()],O.prototype,"filterFn",2);E([$()],O.prototype,"caseSensitive",2);E([$()],O.prototype,"shouldSort",2);E([$()],O.prototype,"wrapArrowKeys",2);E([$()],O.prototype,"clearable",2);E([$()],O.prototype,"disabled",2);E([$()],O.prototype,"announcerText",2);E([S("#settings__options")],O.prototype,"optionSetSelect",2);E([S("#settings__custom-content")],O.prototype,"customContentCheck",2);E([S("#settings__behavior")],O.prototype,"behaviorSelect",2);E([S("#settings__label")],O.prototype,"labelInput",2);E([S("#settings__placeholder")],O.prototype,"placeholderInput",2);E([S("#settings__max-entries")],O.prototype,"maxAutocompleteInput",2);E([S("#settings__filter-fn")],O.prototype,"filterFnSelect",2);E([S("#settings__case-sensitive")],O.prototype,"caseSensitiveCheck",2);E([S("#settings__sort")],O.prototype,"sortCheck",2);E([S("#settings__wrap")],O.prototype,"wrapArrowKeysCheck",2);E([S("#settings__clearable")],O.prototype,"clearableCheck",2);E([S("#settings__disabled")],O.prototype,"disabledCheck",2);O=E([C("ia-combo-box-story")],O);const tn=Object.freeze(Object.defineProperty({__proto__:null,get IAComboBoxStory(){return O}},Symbol.toStringTag,{value:"Module"}));function*rn(i,e){if(i!==void 0){let t=0;for(const r of i)yield e(r,t++)}}const on="data:image/svg+xml,%3csvg%20viewBox='0%200%20100%20100'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20class='fill-color'%20d='m17.0555551%2041.3194459c0-12.7430552%2010.3541664-23.1027772%2023.0847216-23.1027772%2012.7166664%200%2023.0777773%2010.359722%2023.0777773%2023.1027772%200%2012.7361108-10.3611109%2023.0986106-23.0777773%2023.0986106-12.7305552%200-23.0847216-10.3624998-23.0847216-23.0986106zm-17.24305512%200c0%2022.2916661%2018.04583292%2040.3472213%2040.32777672%2040.3472213%208.9208332%200%2017.145833-2.9319449%2023.8194439-7.8527776l24.1513883%2024.0777771c1.2125%201.1402778%202.8430555%201.8430556%204.6374999%201.8430556%203.7444443%200%206.7805554-3.0361111%206.7805554-6.7791665%200-2.0652778-.9222222-3.9069444-2.3736111-5.1499999l-23.718055-23.7458328c4.4152777-6.4791665%207.0152776-14.3055552%207.0152776-22.7402772%200-22.2791661-18.0458328-40.34861006-40.312499-40.34861006-22.2819438%200-40.32777672%2018.06944396-40.32777672%2040.34861006z'%20fill='%232c2c2c'%20fill-rule='evenodd'%20/%3e%3c/svg%3e";function c(i,e,t,r){var o=arguments.length,a=o<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")a=Reflect.decorate(i,e,t,r);else for(var l=i.length-1;l>=0;l--)(n=i[l])&&(a=(o<3?n(a):o>3?n(e,t,a):n(e,t))||a);return o>3&&a&&Object.defineProperty(e,t,a),a}const yt=window,zi=yt.ShadowRoot&&(yt.ShadyCSS===void 0||yt.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Ri=Symbol(),hr=new WeakMap;let ho=class{constructor(e,t,r){if(this._$cssResult$=!0,r!==Ri)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(zi&&e===void 0){const r=t!==void 0&&t.length===1;r&&(e=hr.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),r&&hr.set(t,e))}return e}toString(){return this.cssText}};const an=i=>new ho(typeof i=="string"?i:i+"",void 0,Ri),nn=(i,...e)=>{const t=i.length===1?i[0]:e.reduce(((r,o,a)=>r+(n=>{if(n._$cssResult$===!0)return n.cssText;if(typeof n=="number")return n;throw Error("Value passed to 'css' function must be a 'css' function result: "+n+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(o)+i[a+1]),i[0]);return new ho(t,i,Ri)},sn=(i,e)=>{zi?i.adoptedStyleSheets=e.map((t=>t instanceof CSSStyleSheet?t:t.styleSheet)):e.forEach((t=>{const r=document.createElement("style"),o=yt.litNonce;o!==void 0&&r.setAttribute("nonce",o),r.textContent=t.cssText,i.appendChild(r)}))},pr=zi?i=>i:i=>i instanceof CSSStyleSheet?(e=>{let t="";for(const r of e.cssRules)t+=r.cssText;return an(t)})(i):i;var qt;const Ct=window,ur=Ct.trustedTypes,ln=ur?ur.emptyScript:"",gr=Ct.reactiveElementPolyfillSupport,pi={toAttribute(i,e){switch(e){case Boolean:i=i?ln:null;break;case Object:case Array:i=i==null?i:JSON.stringify(i)}return i},fromAttribute(i,e){let t=i;switch(e){case Boolean:t=i!==null;break;case Number:t=i===null?null:Number(i);break;case Object:case Array:try{t=JSON.parse(i)}catch{t=null}}return t}},po=(i,e)=>e!==i&&(e==e||i==i),Kt={attribute:!0,type:String,converter:pi,reflect:!1,hasChanged:po},ui="finalized";let De=class extends HTMLElement{constructor(){super(),this._$Ei=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$El=null,this._$Eu()}static addInitializer(e){var t;this.finalize(),((t=this.h)!==null&&t!==void 0?t:this.h=[]).push(e)}static get observedAttributes(){this.finalize();const e=[];return this.elementProperties.forEach(((t,r)=>{const o=this._$Ep(r,t);o!==void 0&&(this._$Ev.set(o,r),e.push(o))})),e}static createProperty(e,t=Kt){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){const r=typeof e=="symbol"?Symbol():"__"+e,o=this.getPropertyDescriptor(e,r,t);o!==void 0&&Object.defineProperty(this.prototype,e,o)}}static getPropertyDescriptor(e,t,r){return{get(){return this[t]},set(o){const a=this[e];this[t]=o,this.requestUpdate(e,a,r)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||Kt}static finalize(){if(this.hasOwnProperty(ui))return!1;this[ui]=!0;const e=Object.getPrototypeOf(this);if(e.finalize(),e.h!==void 0&&(this.h=[...e.h]),this.elementProperties=new Map(e.elementProperties),this._$Ev=new Map,this.hasOwnProperty("properties")){const t=this.properties,r=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const o of r)this.createProperty(o,t[o])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const r=new Set(e.flat(1/0).reverse());for(const o of r)t.unshift(pr(o))}else e!==void 0&&t.push(pr(e));return t}static _$Ep(e,t){const r=t.attribute;return r===!1?void 0:typeof r=="string"?r:typeof e=="string"?e.toLowerCase():void 0}_$Eu(){var e;this._$E_=new Promise((t=>this.enableUpdating=t)),this._$AL=new Map,this._$Eg(),this.requestUpdate(),(e=this.constructor.h)===null||e===void 0||e.forEach((t=>t(this)))}addController(e){var t,r;((t=this._$ES)!==null&&t!==void 0?t:this._$ES=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((r=e.hostConnected)===null||r===void 0||r.call(e))}removeController(e){var t;(t=this._$ES)===null||t===void 0||t.splice(this._$ES.indexOf(e)>>>0,1)}_$Eg(){this.constructor.elementProperties.forEach(((e,t)=>{this.hasOwnProperty(t)&&(this._$Ei.set(t,this[t]),delete this[t])}))}createRenderRoot(){var e;const t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return sn(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$ES)===null||e===void 0||e.forEach((t=>{var r;return(r=t.hostConnected)===null||r===void 0?void 0:r.call(t)}))}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$ES)===null||e===void 0||e.forEach((t=>{var r;return(r=t.hostDisconnected)===null||r===void 0?void 0:r.call(t)}))}attributeChangedCallback(e,t,r){this._$AK(e,r)}_$EO(e,t,r=Kt){var o;const a=this.constructor._$Ep(e,r);if(a!==void 0&&r.reflect===!0){const n=(((o=r.converter)===null||o===void 0?void 0:o.toAttribute)!==void 0?r.converter:pi).toAttribute(t,r.type);this._$El=e,n==null?this.removeAttribute(a):this.setAttribute(a,n),this._$El=null}}_$AK(e,t){var r;const o=this.constructor,a=o._$Ev.get(e);if(a!==void 0&&this._$El!==a){const n=o.getPropertyOptions(a),l=typeof n.converter=="function"?{fromAttribute:n.converter}:((r=n.converter)===null||r===void 0?void 0:r.fromAttribute)!==void 0?n.converter:pi;this._$El=a,this[a]=l.fromAttribute(t,n.type),this._$El=null}}requestUpdate(e,t,r){let o=!0;e!==void 0&&(((r=r||this.constructor.getPropertyOptions(e)).hasChanged||po)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),r.reflect===!0&&this._$El!==e&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(e,r))):o=!1),!this.isUpdatePending&&o&&(this._$E_=this._$Ej())}async _$Ej(){this.isUpdatePending=!0;try{await this._$E_}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Ei&&(this._$Ei.forEach(((o,a)=>this[a]=o)),this._$Ei=void 0);let t=!1;const r=this._$AL;try{t=this.shouldUpdate(r),t?(this.willUpdate(r),(e=this._$ES)===null||e===void 0||e.forEach((o=>{var a;return(a=o.hostUpdate)===null||a===void 0?void 0:a.call(o)})),this.update(r)):this._$Ek()}catch(o){throw t=!1,this._$Ek(),o}t&&this._$AE(r)}willUpdate(e){}_$AE(e){var t;(t=this._$ES)===null||t===void 0||t.forEach((r=>{var o;return(o=r.hostUpdated)===null||o===void 0?void 0:o.call(r)})),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$Ek(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$E_}shouldUpdate(e){return!0}update(e){this._$EC!==void 0&&(this._$EC.forEach(((t,r)=>this._$EO(r,this[r],t))),this._$EC=void 0),this._$Ek()}updated(e){}firstUpdated(e){}};De[ui]=!0,De.elementProperties=new Map,De.elementStyles=[],De.shadowRootOptions={mode:"open"},gr?.({ReactiveElement:De}),((qt=Ct.reactiveElementVersions)!==null&&qt!==void 0?qt:Ct.reactiveElementVersions=[]).push("1.6.3");var Wt;const At=window,Ue=At.trustedTypes,mr=Ue?Ue.createPolicy("lit-html",{createHTML:i=>i}):void 0,gi="$lit$",le=`lit$${(Math.random()+"").slice(9)}$`,uo="?"+le,dn=`<${uo}>`,Oe=document,st=()=>Oe.createComment(""),lt=i=>i===null||typeof i!="object"&&typeof i!="function",go=Array.isArray,cn=i=>go(i)||typeof i?.[Symbol.iterator]=="function",Gt=`[ 	
\f\r]`,et=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,fr=/-->/g,vr=/>/g,ve=RegExp(`>|${Gt}(?:([^\\s"'>=/]+)(${Gt}*=${Gt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),br=/'/g,yr=/"/g,mo=/^(?:script|style|textarea|title)$/i,hn=i=>(e,...t)=>({_$litType$:i,strings:e,values:t}),pn=hn(1),je=Symbol.for("lit-noChange"),P=Symbol.for("lit-nothing"),wr=new WeakMap,xe=Oe.createTreeWalker(Oe,129,null,!1);function fo(i,e){if(!Array.isArray(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return mr!==void 0?mr.createHTML(e):e}const un=(i,e)=>{const t=i.length-1,r=[];let o,a=e===2?"<svg>":"",n=et;for(let l=0;l<t;l++){const s=i[l];let p,g,h=-1,v=0;for(;v<s.length&&(n.lastIndex=v,g=n.exec(s),g!==null);)v=n.lastIndex,n===et?g[1]==="!--"?n=fr:g[1]!==void 0?n=vr:g[2]!==void 0?(mo.test(g[2])&&(o=RegExp("</"+g[2],"g")),n=ve):g[3]!==void 0&&(n=ve):n===ve?g[0]===">"?(n=o??et,h=-1):g[1]===void 0?h=-2:(h=n.lastIndex-g[2].length,p=g[1],n=g[3]===void 0?ve:g[3]==='"'?yr:br):n===yr||n===br?n=ve:n===fr||n===vr?n=et:(n=ve,o=void 0);const b=n===ve&&i[l+1].startsWith("/>")?" ":"";a+=n===et?s+dn:h>=0?(r.push(p),s.slice(0,h)+gi+s.slice(h)+le+b):s+le+(h===-2?(r.push(void 0),l):b)}return[fo(i,a+(i[t]||"<?>")+(e===2?"</svg>":"")),r]};let mi=class vo{constructor({strings:e,_$litType$:t},r){let o;this.parts=[];let a=0,n=0;const l=e.length-1,s=this.parts,[p,g]=un(e,t);if(this.el=vo.createElement(p,r),xe.currentNode=this.el.content,t===2){const h=this.el.content,v=h.firstChild;v.remove(),h.append(...v.childNodes)}for(;(o=xe.nextNode())!==null&&s.length<l;){if(o.nodeType===1){if(o.hasAttributes()){const h=[];for(const v of o.getAttributeNames())if(v.endsWith(gi)||v.startsWith(le)){const b=g[n++];if(h.push(v),b!==void 0){const A=o.getAttribute(b.toLowerCase()+gi).split(le),k=/([.?@])?(.*)/.exec(b);s.push({type:1,index:a,name:k[2],strings:A,ctor:k[1]==="."?mn:k[1]==="?"?vn:k[1]==="@"?bn:zt})}else s.push({type:6,index:a})}for(const v of h)o.removeAttribute(v)}if(mo.test(o.tagName)){const h=o.textContent.split(le),v=h.length-1;if(v>0){o.textContent=Ue?Ue.emptyScript:"";for(let b=0;b<v;b++)o.append(h[b],st()),xe.nextNode(),s.push({type:2,index:++a});o.append(h[v],st())}}}else if(o.nodeType===8)if(o.data===uo)s.push({type:2,index:a});else{let h=-1;for(;(h=o.data.indexOf(le,h+1))!==-1;)s.push({type:7,index:a}),h+=le.length-1}a++}}static createElement(e,t){const r=Oe.createElement("template");return r.innerHTML=e,r}};function He(i,e,t=i,r){var o,a,n,l;if(e===je)return e;let s=r!==void 0?(o=t._$Co)===null||o===void 0?void 0:o[r]:t._$Cl;const p=lt(e)?void 0:e._$litDirective$;return s?.constructor!==p&&((a=s?._$AO)===null||a===void 0||a.call(s,!1),p===void 0?s=void 0:(s=new p(i),s._$AT(i,t,r)),r!==void 0?((n=(l=t)._$Co)!==null&&n!==void 0?n:l._$Co=[])[r]=s:t._$Cl=s),s!==void 0&&(e=He(i,s._$AS(i,e.values),s,r)),e}let gn=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;const{el:{content:r},parts:o}=this._$AD,a=((t=e?.creationScope)!==null&&t!==void 0?t:Oe).importNode(r,!0);xe.currentNode=a;let n=xe.nextNode(),l=0,s=0,p=o[0];for(;p!==void 0;){if(l===p.index){let g;p.type===2?g=new Ni(n,n.nextSibling,this,e):p.type===1?g=new p.ctor(n,p.name,p.strings,this,e):p.type===6&&(g=new yn(n,this,e)),this._$AV.push(g),p=o[++s]}l!==p?.index&&(n=xe.nextNode(),l++)}return xe.currentNode=Oe,a}v(e){let t=0;for(const r of this._$AV)r!==void 0&&(r.strings!==void 0?(r._$AI(e,r,t),t+=r.strings.length-2):r._$AI(e[t])),t++}},Ni=class bo{constructor(e,t,r,o){var a;this.type=2,this._$AH=P,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=r,this.options=o,this._$Cp=(a=o?.isConnected)===null||a===void 0||a}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=He(this,e,t),lt(e)?e===P||e==null||e===""?(this._$AH!==P&&this._$AR(),this._$AH=P):e!==this._$AH&&e!==je&&this._(e):e._$litType$!==void 0?this.g(e):e.nodeType!==void 0?this.$(e):cn(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==P&&lt(this._$AH)?this._$AA.nextSibling.data=e:this.$(Oe.createTextNode(e)),this._$AH=e}g(e){var t;const{values:r,_$litType$:o}=e,a=typeof o=="number"?this._$AC(e):(o.el===void 0&&(o.el=mi.createElement(fo(o.h,o.h[0]),this.options)),o);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===a)this._$AH.v(r);else{const n=new gn(a,this),l=n.u(this.options);n.v(r),this.$(l),this._$AH=n}}_$AC(e){let t=wr.get(e.strings);return t===void 0&&wr.set(e.strings,t=new mi(e)),t}T(e){go(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let r,o=0;for(const a of e)o===t.length?t.push(r=new bo(this.k(st()),this.k(st()),this,this.options)):r=t[o],r._$AI(a),o++;o<t.length&&(this._$AR(r&&r._$AB.nextSibling,o),t.length=o)}_$AR(e=this._$AA.nextSibling,t){var r;for((r=this._$AP)===null||r===void 0||r.call(this,!1,!0,t);e&&e!==this._$AB;){const o=e.nextSibling;e.remove(),e=o}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}},zt=class{constructor(e,t,r,o,a){this.type=1,this._$AH=P,this._$AN=void 0,this.element=e,this.name=t,this._$AM=o,this.options=a,r.length>2||r[0]!==""||r[1]!==""?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=P}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,r,o){const a=this.strings;let n=!1;if(a===void 0)e=He(this,e,t,0),n=!lt(e)||e!==this._$AH&&e!==je,n&&(this._$AH=e);else{const l=e;let s,p;for(e=a[0],s=0;s<a.length-1;s++)p=He(this,l[r+s],t,s),p===je&&(p=this._$AH[s]),n||(n=!lt(p)||p!==this._$AH[s]),p===P?e=P:e!==P&&(e+=(p??"")+a[s+1]),this._$AH[s]=p}n&&!o&&this.j(e)}j(e){e===P?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},mn=class extends zt{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===P?void 0:e}};const fn=Ue?Ue.emptyScript:"";let vn=class extends zt{constructor(){super(...arguments),this.type=4}j(e){e&&e!==P?this.element.setAttribute(this.name,fn):this.element.removeAttribute(this.name)}},bn=class extends zt{constructor(e,t,r,o,a){super(e,t,r,o,a),this.type=5}_$AI(e,t=this){var r;if((e=(r=He(this,e,t,0))!==null&&r!==void 0?r:P)===je)return;const o=this._$AH,a=e===P&&o!==P||e.capture!==o.capture||e.once!==o.once||e.passive!==o.passive,n=e!==P&&(o===P||a);a&&this.element.removeEventListener(this.name,this,o),n&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,r;typeof this._$AH=="function"?this._$AH.call((r=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&r!==void 0?r:this.element,e):this._$AH.handleEvent(e)}},yn=class{constructor(e,t,r){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(e){He(this,e)}};const $r=At.litHtmlPolyfillSupport;$r?.(mi,Ni),((Wt=At.litHtmlVersions)!==null&&Wt!==void 0?Wt:At.litHtmlVersions=[]).push("2.8.0");const wn=(i,e,t)=>{var r,o;const a=(r=t?.renderBefore)!==null&&r!==void 0?r:e;let n=a._$litPart$;if(n===void 0){const l=(o=t?.renderBefore)!==null&&o!==void 0?o:null;a._$litPart$=n=new Ni(e.insertBefore(st(),l),l,void 0,t??{})}return n._$AI(i),n};var Zt,Jt;let ze=class extends De{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const r=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=r.firstChild),r}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=wn(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return je}};ze.finalized=!0,ze._$litElement$=!0,(Zt=globalThis.litElementHydrateSupport)===null||Zt===void 0||Zt.call(globalThis,{LitElement:ze});const xr=globalThis.litElementPolyfillSupport;xr?.({LitElement:ze});((Jt=globalThis.litElementVersions)!==null&&Jt!==void 0?Jt:globalThis.litElementVersions=[]).push("3.3.3");const $n=i=>e=>typeof e=="function"?((t,r)=>(customElements.define(t,r),r))(i,e):((t,r)=>{const{kind:o,elements:a}=r;return{kind:o,elements:a,finisher(n){customElements.define(t,n)}}})(i,e);const xn=(i,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?{...e,finisher(t){t.createProperty(e.key,i)}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,i)}},_n=(i,e,t)=>{e.constructor.createProperty(t,i)};function Pe(i){return(e,t)=>t!==void 0?_n(i,e,t):xn(i,e)}const Sn=({finisher:i,descriptor:e})=>(t,r)=>{var o;if(r===void 0){const a=(o=t.originalKey)!==null&&o!==void 0?o:t.key,n=e!=null?{kind:"method",placement:"prototype",key:a,descriptor:e(t.key)}:{...t,key:a};return i!=null&&(n.finisher=function(l){i(l,a)}),n}{const a=t.constructor;e!==void 0&&Object.defineProperty(t,r,e(r)),i?.(a,r)}};function Cn(i,e){return Sn({descriptor:t=>({get(){var o,a;return(a=(o=this.renderRoot)===null||o===void 0?void 0:o.querySelector(i))!==null&&a!==void 0?a:null},enumerable:!0,configurable:!0})})}var Yt;((Yt=window.HTMLSlotElement)===null||Yt===void 0?void 0:Yt.prototype.assignedElements)!=null;const An=d`
<svg
  viewBox="0 0 40 40"
  version="1.1"
  xmlns="http://www.w3.org/2000/svg"
...
`;class On extends x{static get styles(){return _`
      :host {
    ...
    `}render(){return An}}customElements.define("ia-icon-close",On);let W=class extends ze{constructor(){super(...arguments),this.value="",this.clearButtonScreenReaderLabel="Clear",this.focusOnClear=!0,this.forceClearButton=!1}render(){var e,t,r,o;const a=!this.value&&!this.forceClearButton;return pn`
      <div id="container">
        <slot name="icon"></slot>
  ...
  `;c([Pe({type:String})],W.prototype,"value",void 0);c([Pe({type:String})],W.prototype,"placeholder",void 0);c([Pe({type:String})],W.prototype,"screenReaderLabel",void 0);c([Pe({type:String})],W.prototype,"clearButtonScreenReaderLabel",void 0);c([Pe({type:String})],W.prototype,"ariaControls",void 0);c([Pe({type:Boolean})],W.prototype,"focusOnClear",void 0);c([Pe({type:Boolean,reflect:!0})],W.prototype,"forceClearButton",void 0);c([Cn("#text-input")],W.prototype,"textInput",void 0);W=c([$n("ia-clearable-text-input")],W);const wt=window,Ui=wt.ShadowRoot&&(wt.ShadyCSS===void 0||wt.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,ji=Symbol(),_r=new WeakMap;let yo=class{constructor(e,t,r){if(this._$cssResult$=!0,r!==ji)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(Ui&&e===void 0){const r=t!==void 0&&t.length===1;r&&(e=_r.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),r&&_r.set(t,e))}return e}toString(){return this.cssText}};const Tn=i=>new yo(typeof i=="string"?i:i+"",void 0,ji),q=(i,...e)=>{const t=i.length===1?i[0]:e.reduce(((r,o,a)=>r+(n=>{if(n._$cssResult$===!0)return n.cssText;if(typeof n=="number")return n;throw Error("Value passed to 'css' function must be a 'css' function result: "+n+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(o)+i[a+1]),i[0]);return new yo(t,i,ji)},En=(i,e)=>{Ui?i.adoptedStyleSheets=e.map((t=>t instanceof CSSStyleSheet?t:t.styleSheet)):e.forEach((t=>{const r=document.createElement("style"),o=wt.litNonce;o!==void 0&&r.setAttribute("nonce",o),r.textContent=t.cssText,i.appendChild(r)}))},Sr=Ui?i=>i:i=>i instanceof CSSStyleSheet?(e=>{let t="";for(const r of e.cssRules)t+=r.cssText;return Tn(t)})(i):i;var Xt;const Ot=window,Cr=Ot.trustedTypes,kn=Cr?Cr.emptyScript:"",Ar=Ot.reactiveElementPolyfillSupport,fi={toAttribute(i,e){switch(e){case Boolean:i=i?kn:null;break;case Object:case Array:i=i==null?i:JSON.stringify(i)}return i},fromAttribute(i,e){let t=i;switch(e){case Boolean:t=i!==null;break;case Number:t=i===null?null:Number(i);break;case Object:case Array:try{t=JSON.parse(i)}catch{t=null}}return t}},wo=(i,e)=>e!==i&&(e==e||i==i),Qt={attribute:!0,type:String,converter:fi,reflect:!1,hasChanged:wo},vi="finalized";let Le=class extends HTMLElement{constructor(){super(),this._$Ei=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$El=null,this._$Eu()}static addInitializer(e){var t;this.finalize(),((t=this.h)!==null&&t!==void 0?t:this.h=[]).push(e)}static get observedAttributes(){this.finalize();const e=[];return this.elementProperties.forEach(((t,r)=>{const o=this._$Ep(r,t);o!==void 0&&(this._$Ev.set(o,r),e.push(o))})),e}static createProperty(e,t=Qt){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){const r=typeof e=="symbol"?Symbol():"__"+e,o=this.getPropertyDescriptor(e,r,t);o!==void 0&&Object.defineProperty(this.prototype,e,o)}}static getPropertyDescriptor(e,t,r){return{get(){return this[t]},set(o){const a=this[e];this[t]=o,this.requestUpdate(e,a,r)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||Qt}static finalize(){if(this.hasOwnProperty(vi))return!1;this[vi]=!0;const e=Object.getPrototypeOf(this);if(e.finalize(),e.h!==void 0&&(this.h=[...e.h]),this.elementProperties=new Map(e.elementProperties),this._$Ev=new Map,this.hasOwnProperty("properties")){const t=this.properties,r=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const o of r)this.createProperty(o,t[o])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const r=new Set(e.flat(1/0).reverse());for(const o of r)t.unshift(Sr(o))}else e!==void 0&&t.push(Sr(e));return t}static _$Ep(e,t){const r=t.attribute;return r===!1?void 0:typeof r=="string"?r:typeof e=="string"?e.toLowerCase():void 0}_$Eu(){var e;this._$E_=new Promise((t=>this.enableUpdating=t)),this._$AL=new Map,this._$Eg(),this.requestUpdate(),(e=this.constructor.h)===null||e===void 0||e.forEach((t=>t(this)))}addController(e){var t,r;((t=this._$ES)!==null&&t!==void 0?t:this._$ES=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((r=e.hostConnected)===null||r===void 0||r.call(e))}removeController(e){var t;(t=this._$ES)===null||t===void 0||t.splice(this._$ES.indexOf(e)>>>0,1)}_$Eg(){this.constructor.elementProperties.forEach(((e,t)=>{this.hasOwnProperty(t)&&(this._$Ei.set(t,this[t]),delete this[t])}))}createRenderRoot(){var e;const t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return En(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$ES)===null||e===void 0||e.forEach((t=>{var r;return(r=t.hostConnected)===null||r===void 0?void 0:r.call(t)}))}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$ES)===null||e===void 0||e.forEach((t=>{var r;return(r=t.hostDisconnected)===null||r===void 0?void 0:r.call(t)}))}attributeChangedCallback(e,t,r){this._$AK(e,r)}_$EO(e,t,r=Qt){var o;const a=this.constructor._$Ep(e,r);if(a!==void 0&&r.reflect===!0){const n=(((o=r.converter)===null||o===void 0?void 0:o.toAttribute)!==void 0?r.converter:fi).toAttribute(t,r.type);this._$El=e,n==null?this.removeAttribute(a):this.setAttribute(a,n),this._$El=null}}_$AK(e,t){var r;const o=this.constructor,a=o._$Ev.get(e);if(a!==void 0&&this._$El!==a){const n=o.getPropertyOptions(a),l=typeof n.converter=="function"?{fromAttribute:n.converter}:((r=n.converter)===null||r===void 0?void 0:r.fromAttribute)!==void 0?n.converter:fi;this._$El=a,this[a]=l.fromAttribute(t,n.type),this._$El=null}}requestUpdate(e,t,r){let o=!0;e!==void 0&&(((r=r||this.constructor.getPropertyOptions(e)).hasChanged||wo)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),r.reflect===!0&&this._$El!==e&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(e,r))):o=!1),!this.isUpdatePending&&o&&(this._$E_=this._$Ej())}async _$Ej(){this.isUpdatePending=!0;try{await this._$E_}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Ei&&(this._$Ei.forEach(((o,a)=>this[a]=o)),this._$Ei=void 0);let t=!1;const r=this._$AL;try{t=this.shouldUpdate(r),t?(this.willUpdate(r),(e=this._$ES)===null||e===void 0||e.forEach((o=>{var a;return(a=o.hostUpdate)===null||a===void 0?void 0:a.call(o)})),this.update(r)):this._$Ek()}catch(o){throw t=!1,this._$Ek(),o}t&&this._$AE(r)}willUpdate(e){}_$AE(e){var t;(t=this._$ES)===null||t===void 0||t.forEach((r=>{var o;return(o=r.hostUpdated)===null||o===void 0?void 0:o.call(r)})),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$Ek(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$E_}shouldUpdate(e){return!0}update(e){this._$EC!==void 0&&(this._$EC.forEach(((t,r)=>this._$EO(r,this[r],t))),this._$EC=void 0),this._$Ek()}updated(e){}firstUpdated(e){}};Le[vi]=!0,Le.elementProperties=new Map,Le.elementStyles=[],Le.shadowRootOptions={mode:"open"},Ar?.({ReactiveElement:Le}),((Xt=Ot.reactiveElementVersions)!==null&&Xt!==void 0?Xt:Ot.reactiveElementVersions=[]).push("1.6.3");var ei;const Tt=window,Fe=Tt.trustedTypes,Or=Fe?Fe.createPolicy("lit-html",{createHTML:i=>i}):void 0,bi="$lit$",de=`lit$${(Math.random()+"").slice(9)}$`,$o="?"+de,Pn=`<${$o}>`,Te=document,dt=()=>Te.createComment(""),ct=i=>i===null||typeof i!="object"&&typeof i!="function",xo=Array.isArray,Mn=i=>xo(i)||typeof i?.[Symbol.iterator]=="function",ti=`[ 	
\f\r]`,tt=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Tr=/-->/g,Er=/>/g,be=RegExp(`>|${ti}(?:([^\\s"'>=/]+)(${ti}*=${ti}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),kr=/'/g,Pr=/"/g,_o=/^(?:script|style|textarea|title)$/i,So=i=>(e,...t)=>({_$litType$:i,strings:e,values:t}),N=So(1),Co=So(2),qe=Symbol.for("lit-noChange"),V=Symbol.for("lit-nothing"),Mr=new WeakMap,_e=Te.createTreeWalker(Te,129,null,!1);function Ao(i,e){if(!Array.isArray(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return Or!==void 0?Or.createHTML(e):e}const In=(i,e)=>{const t=i.length-1,r=[];let o,a=e===2?"<svg>":"",n=tt;for(let l=0;l<t;l++){const s=i[l];let p,g,h=-1,v=0;for(;v<s.length&&(n.lastIndex=v,g=n.exec(s),g!==null);)v=n.lastIndex,n===tt?g[1]==="!--"?n=Tr:g[1]!==void 0?n=Er:g[2]!==void 0?(_o.test(g[2])&&(o=RegExp("</"+g[2],"g")),n=be):g[3]!==void 0&&(n=be):n===be?g[0]===">"?(n=o??tt,h=-1):g[1]===void 0?h=-2:(h=n.lastIndex-g[2].length,p=g[1],n=g[3]===void 0?be:g[3]==='"'?Pr:kr):n===Pr||n===kr?n=be:n===Tr||n===Er?n=tt:(n=be,o=void 0);const b=n===be&&i[l+1].startsWith("/>")?" ":"";a+=n===tt?s+Pn:h>=0?(r.push(p),s.slice(0,h)+bi+s.slice(h)+de+b):s+de+(h===-2?(r.push(void 0),l):b)}return[Ao(i,a+(i[t]||"<?>")+(e===2?"</svg>":"")),r]};class ht{constructor({strings:e,_$litType$:t},r){let o;this.parts=[];let a=0,n=0;const l=e.length-1,s=this.parts,[p,g]=In(e,t);if(this.el=ht.createElement(p,r),_e.currentNode=this.el.content,t===2){const h=this.el.content,v=h.firstChild;v.remove(),h.append(...v.childNodes)}for(;(o=_e.nextNode())!==null&&s.length<l;){if(o.nodeType===1){if(o.hasAttributes()){const h=[];for(const v of o.getAttributeNames())if(v.endsWith(bi)||v.startsWith(de)){const b=g[n++];if(h.push(v),b!==void 0){const A=o.getAttribute(b.toLowerCase()+bi).split(de),k=/([.?@])?(.*)/.exec(b);s.push({type:1,index:a,name:k[2],strings:A,ctor:k[1]==="."?Vn:k[1]==="?"?Ln:k[1]==="@"?zn:Rt})}else s.push({type:6,index:a})}for(const v of h)o.removeAttribute(v)}if(_o.test(o.tagName)){const h=o.textContent.split(de),v=h.length-1;if(v>0){o.textContent=Fe?Fe.emptyScript:"";for(let b=0;b<v;b++)o.append(h[b],dt()),_e.nextNode(),s.push({type:2,index:++a});o.append(h[v],dt())}}}else if(o.nodeType===8)if(o.data===$o)s.push({type:2,index:a});else{let h=-1;for(;(h=o.data.indexOf(de,h+1))!==-1;)s.push({type:7,index:a}),h+=de.length-1}a++}}static createElement(e,t){const r=Te.createElement("template");return r.innerHTML=e,r}}function Ke(i,e,t=i,r){var o,a,n,l;if(e===qe)return e;let s=r!==void 0?(o=t._$Co)===null||o===void 0?void 0:o[r]:t._$Cl;const p=ct(e)?void 0:e._$litDirective$;return s?.constructor!==p&&((a=s?._$AO)===null||a===void 0||a.call(s,!1),p===void 0?s=void 0:(s=new p(i),s._$AT(i,t,r)),r!==void 0?((n=(l=t)._$Co)!==null&&n!==void 0?n:l._$Co=[])[r]=s:t._$Cl=s),s!==void 0&&(e=Ke(i,s._$AS(i,e.values),s,r)),e}class Bn{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;const{el:{content:r},parts:o}=this._$AD,a=((t=e?.creationScope)!==null&&t!==void 0?t:Te).importNode(r,!0);_e.currentNode=a;let n=_e.nextNode(),l=0,s=0,p=o[0];for(;p!==void 0;){if(l===p.index){let g;p.type===2?g=new ft(n,n.nextSibling,this,e):p.type===1?g=new p.ctor(n,p.name,p.strings,this,e):p.type===6&&(g=new Rn(n,this,e)),this._$AV.push(g),p=o[++s]}l!==p?.index&&(n=_e.nextNode(),l++)}return _e.currentNode=Te,a}v(e){let t=0;for(const r of this._$AV)r!==void 0&&(r.strings!==void 0?(r._$AI(e,r,t),t+=r.strings.length-2):r._$AI(e[t])),t++}}class ft{constructor(e,t,r,o){var a;this.type=2,this._$AH=V,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=r,this.options=o,this._$Cp=(a=o?.isConnected)===null||a===void 0||a}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Ke(this,e,t),ct(e)?e===V||e==null||e===""?(this._$AH!==V&&this._$AR(),this._$AH=V):e!==this._$AH&&e!==qe&&this._(e):e._$litType$!==void 0?this.g(e):e.nodeType!==void 0?this.$(e):Mn(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==V&&ct(this._$AH)?this._$AA.nextSibling.data=e:this.$(Te.createTextNode(e)),this._$AH=e}g(e){var t;const{values:r,_$litType$:o}=e,a=typeof o=="number"?this._$AC(e):(o.el===void 0&&(o.el=ht.createElement(Ao(o.h,o.h[0]),this.options)),o);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===a)this._$AH.v(r);else{const n=new Bn(a,this),l=n.u(this.options);n.v(r),this.$(l),this._$AH=n}}_$AC(e){let t=Mr.get(e.strings);return t===void 0&&Mr.set(e.strings,t=new ht(e)),t}T(e){xo(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let r,o=0;for(const a of e)o===t.length?t.push(r=new ft(this.k(dt()),this.k(dt()),this,this.options)):r=t[o],r._$AI(a),o++;o<t.length&&(this._$AR(r&&r._$AB.nextSibling,o),t.length=o)}_$AR(e=this._$AA.nextSibling,t){var r;for((r=this._$AP)===null||r===void 0||r.call(this,!1,!0,t);e&&e!==this._$AB;){const o=e.nextSibling;e.remove(),e=o}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class Rt{constructor(e,t,r,o,a){this.type=1,this._$AH=V,this._$AN=void 0,this.element=e,this.name=t,this._$AM=o,this.options=a,r.length>2||r[0]!==""||r[1]!==""?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=V}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,r,o){const a=this.strings;let n=!1;if(a===void 0)e=Ke(this,e,t,0),n=!ct(e)||e!==this._$AH&&e!==qe,n&&(this._$AH=e);else{const l=e;let s,p;for(e=a[0],s=0;s<a.length-1;s++)p=Ke(this,l[r+s],t,s),p===qe&&(p=this._$AH[s]),n||(n=!ct(p)||p!==this._$AH[s]),p===V?e=V:e!==V&&(e+=(p??"")+a[s+1]),this._$AH[s]=p}n&&!o&&this.j(e)}j(e){e===V?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class Vn extends Rt{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===V?void 0:e}}const Dn=Fe?Fe.emptyScript:"";class Ln extends Rt{constructor(){super(...arguments),this.type=4}j(e){e&&e!==V?this.element.setAttribute(this.name,Dn):this.element.removeAttribute(this.name)}}class zn extends Rt{constructor(e,t,r,o,a){super(e,t,r,o,a),this.type=5}_$AI(e,t=this){var r;if((e=(r=Ke(this,e,t,0))!==null&&r!==void 0?r:V)===qe)return;const o=this._$AH,a=e===V&&o!==V||e.capture!==o.capture||e.once!==o.once||e.passive!==o.passive,n=e!==V&&(o===V||a);a&&this.element.removeEventListener(this.name,this,o),n&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,r;typeof this._$AH=="function"?this._$AH.call((r=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&r!==void 0?r:this.element,e):this._$AH.handleEvent(e)}}class Rn{constructor(e,t,r){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(e){Ke(this,e)}}const Ir=Tt.litHtmlPolyfillSupport;Ir?.(ht,ft),((ei=Tt.litHtmlVersions)!==null&&ei!==void 0?ei:Tt.litHtmlVersions=[]).push("2.8.0");const Nn=(i,e,t)=>{var r,o;const a=(r=t?.renderBefore)!==null&&r!==void 0?r:e;let n=a._$litPart$;if(n===void 0){const l=(o=t?.renderBefore)!==null&&o!==void 0?o:null;a._$litPart$=n=new ft(e.insertBefore(dt(),l),l,void 0,t??{})}return n._$AI(i),n};var ii,ri;class Re extends Le{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const r=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=r.firstChild),r}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Nn(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return qe}}Re.finalized=!0,Re._$litElement$=!0,(ii=globalThis.litElementHydrateSupport)===null||ii===void 0||ii.call(globalThis,{LitElement:Re});const Br=globalThis.litElementPolyfillSupport;Br?.({LitElement:Re});((ri=globalThis.litElementVersions)!==null&&ri!==void 0?ri:globalThis.litElementVersions=[]).push("3.3.3");const Oo=i=>e=>typeof e=="function"?((t,r)=>(customElements.define(t,r),r))(i,e):((t,r)=>{const{kind:o,elements:a}=r;return{kind:o,elements:a,finisher(n){customElements.define(t,n)}}})(i,e);const Un=(i,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?{...e,finisher(t){t.createProperty(e.key,i)}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,i)}},jn=(i,e,t)=>{e.constructor.createProperty(t,i)};function j(i){return(e,t)=>t!==void 0?jn(i,e,t):Un(i,e)}const To=({finisher:i,descriptor:e})=>(t,r)=>{var o;if(r===void 0){const a=(o=t.originalKey)!==null&&o!==void 0?o:t.key,n=e!=null?{kind:"method",placement:"prototype",key:a,descriptor:e(t.key)}:{...t,key:a};return i!=null&&(n.finisher=function(l){i(l,a)}),n}{const a=t.constructor;e!==void 0&&Object.defineProperty(t,r,e(r)),i?.(a,r)}};function Hi(i,e){return To({descriptor:t=>({get(){var o,a;return(a=(o=this.renderRoot)===null||o===void 0?void 0:o.querySelector(i))!==null&&a!==void 0?a:null},enumerable:!0,configurable:!0})})}var oi;const Hn=((oi=window.HTMLSlotElement)===null||oi===void 0?void 0:oi.prototype.assignedElements)!=null?(i,e)=>i.assignedElements(e):(i,e)=>i.assignedNodes(e).filter((t=>t.nodeType===Node.ELEMENT_NODE));function Fn(i){const{slot:e,selector:t}=i??{};return To({descriptor:r=>({get(){var o;const a="slot"+(e?`[name=${e}]`:":not([name])"),n=(o=this.renderRoot)===null||o===void 0?void 0:o.querySelector(a),l=n!=null?Hn(n,i):[];return t?l.filter((s=>s.matches(t))):l},enumerable:!0,configurable:!0})})}function Be(i,e,t){return i?e():t?.()}const qn=Co`<svg class="caret-up-svg" viewBox="0 0 8 4" xmlns="http://www.w3.org/2000/svg">
<path d="m6.7226499 3.51689722c.22976435.15317623.54019902.0910893.69337525-.13867505.13615665-.20423497.10222882-.47220946-.06836249-.63681849l-.07031256-.05655675-3.2773501-2.18490007-3.2773501 2.18490007c-.22976434.15317623-.29185128.4636109-.13867505.69337524.13615665.20423498.39656688.27598409.61412572.18182636l.07924953-.04315131 2.7226499-1.81402514z"
  fill=""></path>
</svg>`,Kn=Co`<svg class="caret-down-svg" viewBox="0 0 8 4" xmlns="http://www.w3.org/2000/svg">
<path d="m6.7226499.58397485c.22976435-.15317623.54019902-.09108929.69337525.13867505.13615665.20423498.10222882.47220947-.06836249.63681849l-.07031256.05655676-3.2773501 2.18490006-3.2773501-2.18490006c-.22976434-.15317623-.29185128-.4636109-.13867505-.69337525.13615665-.20423497.39656688-.27598409.61412572-.18182636l.07924953.04315131 2.7226499 1.81402515z"
fill=""></path>
</svg>`;let I=class extends Re{constructor(){super(...arguments),this.open=!1,this.isDisabled=!1,this.displayCaret=!1,this.closeOnSelect=!1,this.openViaButton=!0,this.usePopover=!1,this.includeSelectedOption=!1,this.selectedOption="",this.options=[],this.optionGroup="options",this.optionSelected=()=>{},this.isCustomList=!1,this.hasCustomClickHandler=!1,this.closeOnEscape=!1,this.closeOnBackdropClick=!1,this.boundKeyboardListener=e=>{switch(e.key){case"Escape":case"Esc":this.closeOptions();break}},this.closeOptions=e=>{e&&e.type==="click"&&e.stopPropagation(),this.open=!1,this.updatePopoverState()}}async firstUpdated(){await new Promise(e=>{setTimeout(e,0)}),this.addEventListener("closeDropdown",this.closeOptions)}willUpdate(e){e.has("open")&&this.updatePopoverState()}disconnectedCallback(){var e;(e=super.disconnectedCallback)===null||e===void 0||e.call(this),this.removeKeyboardListener()}setupKeyboardListener(){this.closeOnEscape&&document.addEventListener("keydown",this.boundKeyboardListener)}removeKeyboardListener(){this.closeOnEscape&&document.removeEventListener("keydown",this.boundKeyboardListener)}get dropdownState(){return this.open?(this.setupKeyboardListener(),"open"):(this.removeKeyboardListener(),"closed")}toggleOptions(){this.open=!this.open,this.updatePopoverState()}updatePopoverState(){var e,t;this.usePopover&&((t=(e=this.dropdownMenu)===null||e===void 0?void 0:e.togglePopover)===null||t===void 0||t.call(e,this.open),this.open&&this.positionDropdownMenu())}positionDropdownMenu(){if(!this.dropdownMenu)return;const e=this.container.getBoundingClientRect();this.dropdownMenu.style.left=`${e.left}px`,this.dropdownMenu.style.top=`${e.bottom}px`,this.dropdownMenu.style.minWidth=`${e.width}px`}mainButtonClicked(){var e;this.openViaButton?this.toggleOptions():(e=this.mainButtonLabelSlotted[0])===null||e===void 0||e.click()}mainButtonKeyDown(e){(e.key==="Enter"||e.key===" ")&&(this.mainButtonClicked(),e.preventDefault())}caretKeyDown(e){(e.key==="Enter"||e.key===" ")&&(this.toggleOptions(),e.preventDefault())}renderOption(e){const{label:t,url:r=void 0,id:o}=e;let a;const n=this.selectedOption===o?"selected":"";return r?a=N`<a
        href=${r}
      ...
      <span ?hidden=${!this.open} class="caret-up">
        <slot name="caret-up">${qn}</slot>
      </span>
    `}get caretDownTemplate(){return N`
      <span ?hidden=${this.open} class="caret-down">
        <slot name="caret-down">${Kn}</slot>
      </span>
    `}get caretTemplate(){return this.displayCaret?this.openViaButton?N`
      ...
      <button
        ...
        aria-haspopup="true"
        aria-expanded=${this.open}
        @click=${Be(this.shouldAttachEventHandlers,()=>this.toggleOptions)}
        @keydown=${Be(this.shouldAttachEventHandlers,()=>this.caretKeyDown)}
      ...
      <div class="ia-dropdown-group ${this.open?"open":""}">
        <div class="button-row">
          <button
            ...
            aria-expanded=${this.open}
            @click=${Be(this.shouldAttachEventHandlers,()=>this.mainButtonClicked)}
            @keydown=${Be(this.shouldAttachEventHandlers,()=>this.mainButtonKeyDown)}
            ?disabled=${this.isDisabled}
          >
            ...
            ${Be(this.shouldNestCaretInButton,()=>this.caretTemplate)}
          </button>
          ${Be(!this.shouldNestCaretInButton,()=>this.caretTemplate)}
        </div>
  ...
  `;yi=c([Oo("ia-icon-label")],yi);var Wn=Object.defineProperty,Gn=Object.getOwnPropertyDescriptor,ee=(i,e,t,r)=>{for(var o=r>1?void 0:r?Gn(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=(r?n(e,t,o):n(o))||o);return r&&o&&Wn(e,t,o),o};const Vr={CategoryChanged:"categoryChanged",SearchRequested:"searchRequested"};let Z=class extends x{constructor(){super(...arguments),this.categories=[],this.placeholder=U("Search"),this.useMobileView=!1,this.hideDropdown=!1,this.loading=!1}get resolvedCategory(){return this.selectedCategory??this.categories?.[0]?.id??""}render(){return d`
    ...
    `}get searchButtonTemplate(){return d`
      ...
      >
        ${this.loading?d`<ia-status-indicator
            ...
            ></ia-status-indicator>`:d`<img src=${on} alt="" />`}
      </button>
    `}get selectedCategoryLabel(){return this.categories.find(e=>e.id===this.resolvedCategory)?.label??this.resolvedCategory}get spacedQuery(){return this.query?.replace(/\+/g," ")??""}searchFieldCleared(){this.query&&this.emitSearchRequested()}handleSubmit(){this.emitSearchRequested()}handleCategorySelected(i){const e=i.detail.option.id;e!==this.resolvedCategory&&(this.selectedCategory=e,setTimeout(()=>this.searchInput.focus()),this.dispatchEvent(new CustomEvent(Vr.CategoryChanged,{detail:e})))}emitSearchRequested(){this.dispatchEvent(new CustomEvent(Vr.SearchRequested,{detail:{query:this.searchInput.value,category:this.resolvedCategory}}))}static get styles(){const i=_`
      :host {
    ...
    `;return[D,i]}};ee([u({type:String})],Z.prototype,"query",2);ee([u({type:Array})],Z.prototype,"categories",2);ee([u({type:String})],Z.prototype,"selectedCategory",2);ee([u({type:String})],Z.prototype,"placeholder",2);ee([u({type:Boolean})],Z.prototype,"useMobileView",2);ee([u({type:Boolean})],Z.prototype,"hideDropdown",2);ee([u({type:Boolean})],Z.prototype,"loading",2);ee([S("#search-input")],Z.prototype,"searchInput",2);ee([S("#category-dropdown")],Z.prototype,"categoryDropdown",2);Z=ee([C("ia-dropdown-search-bar")],Z);var Zn=Object.defineProperty,Jn=Object.getOwnPropertyDescriptor,G=(i,e,t,r)=>{for(var o=r>1?void 0:r?Jn(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=(r?n(e,t,o):n(o))||o);return r&&o&&Zn(e,t,o),o};const Yn=[{label:"Bar height",cssVariable:"--ia-theme-search-bar-height",defaultValue:"30px",inputType:"text"},{label:"Bar width",cssVariable:"--ia-theme-search-bar-width",defaultValue:"300px",inputType:"text"},{label:"Internal padding",cssVariable:"--ia-theme-padding-sm",defaultValue:"5px",inputType:"text"},{label:"Dropdown z-index",cssVariable:"--dropdown-z-index",defaultValue:2,inputType:"number",min:0,step:1}],Dr=[{id:"all",label:"All"},{id:"texts",label:"Books/Documents"},{id:"fulltext",label:"Text Contents"},{id:"radio",label:"Radio"},{id:"tv",label:"TV"},{id:"movies",label:"Video"},{id:"audio",label:"Audio"},{id:"software",label:"Software"},{id:"image",label:"Images"},{id:"etree",label:"Live Music"},{id:"collection",label:"Collections"},{id:"data",label:"Data"},{id:"web",label:"Web Sites"}],Xn="all",Lr="Search";let H=class extends x{constructor(){super(...arguments),this.query="",this.selectedCategory=Xn,this.placeholder=Lr,this.hideDropdown=!1,this.loading=!1,this.announcerText=""}render(){return d`
      <story-template
        elementTag="ia-dropdown-search-bar"
        elementClassName="IADropdownSearchBar"
        .customExampleUsage=${this.exampleUsage}
        .styleInputData=${{settings:Yn}}
      >
        <div slot="demo">
...
`)}applySettings(i){i.preventDefault(),this.query=this.queryInput.value,this.selectedCategory=this.selectedCategorySelect.value,this.placeholder=this.placeholderInput.value,this.hideDropdown=this.hideDropdownCheck.checked,this.loading=this.loadingCheck.checked}handleSearchRequested(i){this.announcerText=`Category ID "${i.detail.category}" / Query "${i.detail.query}"`}static get styles(){return _`
    ...
    `}};G([$()],H.prototype,"query",2);G([$()],H.prototype,"selectedCategory",2);G([$()],H.prototype,"placeholder",2);G([$()],H.prototype,"hideDropdown",2);G([$()],H.prototype,"loading",2);G([$()],H.prototype,"announcerText",2);G([S("#settings__query")],H.prototype,"queryInput",2);G([S("#settings__selected-category")],H.prototype,"selectedCategorySelect",2);G([S("#settings__placeholder")],H.prototype,"placeholderInput",2);G([S("#settings__hide-dropdown")],H.prototype,"hideDropdownCheck",2);G([S("#settings__loading")],H.prototype,"loadingCheck",2);H=G([C("ia-dropdown-search-bar-story")],H);const Qn=Object.freeze(Object.defineProperty({__proto__:null,get IADropdownSearchBarStory(){return H}},Symbol.toStringTag,{value:"Module"}));function m(i){let e,t,r;return e=i,(o,a,n)=>{if(n.value!=null)n.value=zr(n.value,e,t,r);else if(n.get!=null)n.get=zr(n.get,e,t,r);else throw"Only put a Memoize() decorator on a method or get accessor."}}const ai=new Map;function zr(i,e,t=0,r){const o=Symbol("__memoized_map__");return function(...a){let n;this.hasOwnProperty(o)||Object.defineProperty(this,o,{configurable:!1,enumerable:!1,writable:!1,value:new Map});let l=this[o];if(Array.isArray(r))for(const s of r)ai.has(s)?ai.get(s).push(l):ai.set(s,[l]);if(e||a.length>0||t>0){let s;e===!0?s=a.map(h=>h.toString()).join("!"):e?s=e.apply(this,a):s=a[0];const p=`${s}__timestamp`;let g=!1;if(t>0)if(!l.has(p))g=!0;else{let h=l.get(p);g=Date.now()-h>t}l.has(s)&&!g?n=l.get(s):(n=i.apply(this,a),l.set(s,n),t>0&&l.set(p,Date.now()))}else{const s=this;l.has(s)?n=l.get(s):(n=i.apply(this,a),l.set(s,n))}return n}}class wi{parseValue(e){if(typeof e=="string"){const t=e.trim().toLowerCase();if(t==="false"||t==="0"||t==="no")return!1;if(t==="true"||t==="1"||t==="yes")return!0}return!!e}}wi.shared=new wi;class oe{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=parseFloat(e);if(!Number.isNaN(t))return t}}oe.shared=new oe;class Et{parseValue(e){return oe.shared.parseValue(e)}}Et.shared=new Et;class pt{parseValue(e){return this.parseJSDate(e)||this.parseBracketDate(e)}parseBracketDate(e){if(typeof e!="string")return;const t=e.match(/\[([0-9]{4})\]/);if(!(!t||t.length<2))return this.parseJSDate(t[1])}parseJSDate(e){if(typeof e!="string")return;let t=e;t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}\s{1}[0-9]{2}:[0-9]{2}:[0-9]{2}$/)&&(t=t.replace(" ","T"));const r=Date.parse(t);if(Number.isNaN(r))return;let o=new Date(t);return(t.match(/^[0-9]{4}$/)||t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/))&&(o=new Date(o.getTime()+o.getTimezoneOffset()*1e3*60)),o}}pt.shared=new pt;class kt{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=e.split(":");let r;return t.length===1?r=this.parseNumberFormat(t[0]):r=this.parseColonSeparatedFormat(t),r}parseNumberFormat(e){let t=parseFloat(e);return Number.isNaN(t)&&(t=void 0),t}parseColonSeparatedFormat(e){let t=!1;const r=e.map((o,a)=>{const n=parseFloat(o);if(Number.isNaN(n))return t=!0,0;const s=60**(e.length-1-a);return n*Math.floor(s)}).reduce((o,a)=>o+a,0);return t?void 0:r}}kt.shared=new kt;class es{constructor(e,t){this.separators=[";",","],this.parser=e,t&&t.separators&&(this.separators=t.separators)}parseValue(e){const t=String(e);let r=[];for(const o of this.separators)if(r=t.split(o),r.length>1)break;return this.parseListValues(r)}parseListValues(e){const r=e.map(a=>a.trim()).map(a=>this.parser.parseValue(a)),o=[];return r.forEach(a=>{a!==void 0&&o.push(a)}),o}}class Pt{parseValue(e){return String(e)}}Pt.shared=new Pt;class Me{get name(){return this.rawValue.name}get source(){return this.rawValue.source}get btih(){return this.rawValue.btih}get md5(){return this.rawValue.md5}get format(){return this.rawValue.format}get mtime(){if(this.rawValue.mtime==null)return;const e=oe.shared.parseValue(this.rawValue.mtime);if(e)return new Date(e*1e3)}get crc32(){return this.rawValue.crc32}get sha1(){return this.rawValue.sha1}get original(){return this.rawValue.original}get size(){return this.rawValue.size!=null?Et.shared.parseValue(this.rawValue.size):void 0}get title(){return this.rawValue.title}get length(){return this.rawValue.length!=null?kt.shared.parseValue(this.rawValue.length):void 0}get height(){return this.rawValue.height!=null?oe.shared.parseValue(this.rawValue.height):void 0}get width(){return this.rawValue.width!=null?oe.shared.parseValue(this.rawValue.width):void 0}get track(){return this.rawValue.track!=null?oe.shared.parseValue(this.rawValue.track):void 0}get external_identifier(){return this.rawValue.external_identifier}get creator(){return this.rawValue.creator}get album(){return this.rawValue.album}constructor(e={}){this.rawValue=e}}c([m()],Me.prototype,"mtime",null);c([m()],Me.prototype,"size",null);c([m()],Me.prototype,"length",null);c([m()],Me.prototype,"height",null);c([m()],Me.prototype,"width",null);c([m()],Me.prototype,"track",null);class te{get values(){return this.parseRawValue()}get value(){return this.values[0]}constructor(e,t){this.parser=e,this.rawValue=t}parseRawValue(){const e=Array.isArray(this.rawValue)?this.rawValue:[this.rawValue],t=[];return e.forEach(r=>{const o=this.parser.parseValue(r);Array.isArray(o)?t.push(...o):o!==void 0&&t.push(o)}),t}}c([m()],te.prototype,"values",null);c([m()],te.prototype,"value",null);class Rr extends te{constructor(e){super(wi.shared,e)}}class ne extends te{constructor(e){super(pt.shared,e)}}class ni extends te{constructor(e){super(kt.shared,e)}}class F extends te{constructor(e){super(oe.shared,e)}}class w extends te{constructor(e){super(Pt.shared,e)}}class Fi{constructor(e){this.allowed=e}parseValue(e){return typeof e=="string"&&this.allowed.includes(e)?e:void 0}}class qi extends te{constructor(e,t){super(t,e)}}const ts=new Fi(["rl","lr"]);class is extends qi{constructor(e){super(e,ts)}}class Nr extends te{constructor(e){super(Et.shared,e)}}const rs=new Fi(["account","audio","collection","data","etree","image","movies","search","software","texts","web"]);class os extends qi{constructor(e){super(e,rs)}}class as extends te{constructor(e,t){super(t,e)}}class ns extends as{constructor(e){const t=new es(Pt.shared);super(e,t)}}const ss=new Fi(["true","none","frozen"]);class f{get identifier(){return this.rawMetadata.identifier}get addeddate(){return this.rawMetadata.addeddate!=null?new ne(this.rawMetadata.addeddate):void 0}get audio_codec(){return this.rawMetadata.audio_codec!=null?new w(this.rawMetadata.audio_codec):void 0}get audio_sample_rate(){return this.rawMetadata.audio_sample_rate!=null?new F(this.rawMetadata.audio_sample_rate):void 0}get avg_rating(){return this.rawMetadata.avg_rating!=null?new F(this.rawMetadata.avg_rating):void 0}get collection(){return this.rawMetadata.collection!=null?new w(this.rawMetadata.collection):void 0}get collections_raw(){return this.rawMetadata.collections_raw!=null?new w(this.rawMetadata.collections_raw):void 0}get collection_size(){return this.rawMetadata.collection_size!=null?new Nr(this.rawMetadata.collection_size):void 0}get contact(){return this.rawMetadata.contact!=null?new w(this.rawMetadata.contact):void 0}get contributor(){return this.rawMetadata.contributor!=null?new w(this.rawMetadata.contributor):void 0}get coverage(){return this.rawMetadata.coverage!=null?new w(this.rawMetadata.coverage):void 0}get creator(){return this.rawMetadata.creator!=null?new w(this.rawMetadata.creator):void 0}get creator_alt_script(){return this.rawMetadata["creator-alt-script"]!=null?new w(this.rawMetadata["creator-alt-script"]):void 0}get credits(){return this.rawMetadata.credits!=null?new w(this.rawMetadata.credits):void 0}get collection_layout(){return this.rawMetadata.collection_layout!=null?new w(this.rawMetadata.collection_layout):void 0}get date(){return this.rawMetadata.date!=null?new ne(this.rawMetadata.date):void 0}get description(){return this.rawMetadata.description!=null?new w(this.rawMetadata.description):void 0}get downloads(){return this.rawMetadata.downloads!=null?new F(this.rawMetadata.downloads):void 0}get duration(){return this.rawMetadata.duration!=null?new ni(this.rawMetadata.duration):void 0}get external_identifier(){return this.rawMetadata["external-identifier"]!=null?new w(this.rawMetadata["external-identifier"]):void 0}get external_link(){return this.rawMetadata["external-link"]!=null?new w(this.rawMetadata["external-link"]):void 0}get files_count(){return this.rawMetadata.files_count!=null?new F(this.rawMetadata.files_count):void 0}get indexdate(){return this.rawMetadata.indexdate!=null?new ne(this.rawMetadata.indexdate):void 0}get isbn(){return this.rawMetadata.isbn!=null?new w(this.rawMetadata.isbn):void 0}get issue(){return this.rawMetadata.issue!=null?new w(this.rawMetadata.issue):void 0}get item_count(){return this.rawMetadata.item_count!=null?new F(this.rawMetadata.item_count):void 0}get item_size(){return this.rawMetadata.item_size!=null?new Nr(this.rawMetadata.item_size):void 0}get language(){return this.rawMetadata.language!=null?new w(this.rawMetadata.language):void 0}get length(){return this.rawMetadata.length!=null?new ni(this.rawMetadata.length):void 0}get licenseurl(){return this.rawMetadata.licenseurl!=null?new w(this.rawMetadata.licenseurl):void 0}get lineage(){return this.rawMetadata.lineage!=null?new w(this.rawMetadata.lineage):void 0}get month(){return this.rawMetadata.month!=null?new F(this.rawMetadata.month):void 0}get mediatype(){return this.rawMetadata.mediatype!=null?new os(this.rawMetadata.mediatype):void 0}get noindex(){return this.rawMetadata.noindex!=null?new Rr(this.rawMetadata.noindex):void 0}get notes(){return this.rawMetadata.notes!=null?new w(this.rawMetadata.notes):void 0}get num_favorites(){return this.rawMetadata.num_favorites!=null?new F(this.rawMetadata.num_favorites):void 0}get num_reviews(){return this.rawMetadata.num_reviews!=null?new F(this.rawMetadata.num_reviews):void 0}get openlibrary_edition(){return this.rawMetadata.openlibrary_edition!=null?new w(this.rawMetadata.openlibrary_edition):void 0}get openlibrary_work(){return this.rawMetadata.openlibrary_work!=null?new w(this.rawMetadata.openlibrary_work):void 0}get page_progression(){return this.rawMetadata.page_progression!=null?new is(this.rawMetadata.page_progression):void 0}get paginated(){return this.rawMetadata.paginated!=null?new Rr(this.rawMetadata.paginated):void 0}get partner(){return this.rawMetadata.partner!=null?new w(this.rawMetadata.partner):void 0}get post_text(){return this.rawMetadata.post_text!=null?new w(this.rawMetadata.post_text):void 0}get ppi(){return this.rawMetadata.ppi!=null?new F(this.rawMetadata.ppi):void 0}get publicdate(){return this.rawMetadata.publicdate!=null?new ne(this.rawMetadata.publicdate):void 0}get publisher(){return this.rawMetadata.publisher!=null?new w(this.rawMetadata.publisher):void 0}get reviewdate(){return this.rawMetadata.reviewdate!=null?new ne(this.rawMetadata.reviewdate):void 0}get reviews_allowed(){return this.rawMetadata["reviews-allowed"]!=null?new qi(this.rawMetadata["reviews-allowed"],ss):void 0}get rights(){return this.rawMetadata.rights!=null?new w(this.rawMetadata.rights):void 0}get rights_holder(){var e;const t=(e=this.rawMetadata["rights-holder"])!==null&&e!==void 0?e:this.rawMetadata.rights_holder;return t!=null?new w(t):void 0}get runtime(){return this.rawMetadata.runtime!=null?new ni(this.rawMetadata.runtime):void 0}get scanner(){return this.rawMetadata.scanner!=null?new w(this.rawMetadata.scanner):void 0}get segments(){return this.rawMetadata.segments!=null?new w(this.rawMetadata.segments):void 0}get shotlist(){return this.rawMetadata.shotlist!=null?new w(this.rawMetadata.shotlist):void 0}get source(){return this.rawMetadata.source!=null?new w(this.rawMetadata.source):void 0}get sponsor(){return this.rawMetadata.sponsor!=null?new w(this.rawMetadata.sponsor):void 0}get start_localtime(){return this.rawMetadata.start_localtime!=null?new ne(this.rawMetadata.start_localtime):void 0}get start_time(){return this.rawMetadata.start_time!=null?new ne(this.rawMetadata.start_time):void 0}get stop_time(){return this.rawMetadata.stop_time!=null?new ne(this.rawMetadata.stop_time):void 0}get subject(){return this.rawMetadata.subject!=null?new ns(this.rawMetadata.subject):void 0}get taper(){return this.rawMetadata.taper!=null?new w(this.rawMetadata.taper):void 0}get title(){return this.rawMetadata.title!=null?new w(this.rawMetadata.title):void 0}get title_alt_script(){return this.rawMetadata["title-alt-script"]!=null?new w(this.rawMetadata["title-alt-script"]):void 0}get transferer(){return this.rawMetadata.transferer!=null?new w(this.rawMetadata.transferer):void 0}get track(){return this.rawMetadata.track!=null?new F(this.rawMetadata.track):void 0}get type(){return this.rawMetadata.type!=null?new w(this.rawMetadata.type):void 0}get uploader(){return this.rawMetadata.uploader!=null?new w(this.rawMetadata.uploader):void 0}get utc_offset(){return this.rawMetadata.utc_offset!=null?new F(this.rawMetadata.utc_offset):void 0}get venue(){return this.rawMetadata.venue!=null?new w(this.rawMetadata.venue):void 0}get volume(){return this.rawMetadata.volume!=null?new w(this.rawMetadata.volume):void 0}get week(){return this.rawMetadata.week!=null?new F(this.rawMetadata.week):void 0}get year(){return this.rawMetadata.year!=null?new F(this.rawMetadata.year):void 0}constructor(e={}){this.rawMetadata=e}}c([m()],f.prototype,"addeddate",null);c([m()],f.prototype,"audio_codec",null);c([m()],f.prototype,"audio_sample_rate",null);c([m()],f.prototype,"avg_rating",null);c([m()],f.prototype,"collection",null);c([m()],f.prototype,"collections_raw",null);c([m()],f.prototype,"collection_size",null);c([m()],f.prototype,"contact",null);c([m()],f.prototype,"contributor",null);c([m()],f.prototype,"coverage",null);c([m()],f.prototype,"creator",null);c([m()],f.prototype,"creator_alt_script",null);c([m()],f.prototype,"credits",null);c([m()],f.prototype,"collection_layout",null);c([m()],f.prototype,"date",null);c([m()],f.prototype,"description",null);c([m()],f.prototype,"downloads",null);c([m()],f.prototype,"duration",null);c([m()],f.prototype,"external_identifier",null);c([m()],f.prototype,"external_link",null);c([m()],f.prototype,"files_count",null);c([m()],f.prototype,"indexdate",null);c([m()],f.prototype,"isbn",null);c([m()],f.prototype,"issue",null);c([m()],f.prototype,"item_count",null);c([m()],f.prototype,"item_size",null);c([m()],f.prototype,"language",null);c([m()],f.prototype,"length",null);c([m()],f.prototype,"licenseurl",null);c([m()],f.prototype,"lineage",null);c([m()],f.prototype,"month",null);c([m()],f.prototype,"mediatype",null);c([m()],f.prototype,"noindex",null);c([m()],f.prototype,"notes",null);c([m()],f.prototype,"num_favorites",null);c([m()],f.prototype,"num_reviews",null);c([m()],f.prototype,"openlibrary_edition",null);c([m()],f.prototype,"openlibrary_work",null);c([m()],f.prototype,"page_progression",null);c([m()],f.prototype,"paginated",null);c([m()],f.prototype,"partner",null);c([m()],f.prototype,"post_text",null);c([m()],f.prototype,"ppi",null);c([m()],f.prototype,"publicdate",null);c([m()],f.prototype,"publisher",null);c([m()],f.prototype,"reviewdate",null);c([m()],f.prototype,"reviews_allowed",null);c([m()],f.prototype,"rights",null);c([m()],f.prototype,"rights_holder",null);c([m()],f.prototype,"runtime",null);c([m()],f.prototype,"scanner",null);c([m()],f.prototype,"segments",null);c([m()],f.prototype,"shotlist",null);c([m()],f.prototype,"source",null);c([m()],f.prototype,"sponsor",null);c([m()],f.prototype,"start_localtime",null);c([m()],f.prototype,"start_time",null);c([m()],f.prototype,"stop_time",null);c([m()],f.prototype,"subject",null);c([m()],f.prototype,"taper",null);c([m()],f.prototype,"title",null);c([m()],f.prototype,"title_alt_script",null);c([m()],f.prototype,"transferer",null);c([m()],f.prototype,"track",null);c([m()],f.prototype,"type",null);c([m()],f.prototype,"uploader",null);c([m()],f.prototype,"utc_offset",null);c([m()],f.prototype,"venue",null);c([m()],f.prototype,"volume",null);c([m()],f.prototype,"week",null);c([m()],f.prototype,"year",null);class Nt{get reviewbody(){return this.rawValue.reviewbody}get reviewtitle(){return this.rawValue.reviewtitle}get reviewer(){return this.rawValue.reviewer}get reviewer_itemname(){return this.rawValue.reviewer_itemname}get reviewdate(){return this.rawValue.reviewdate!=null?pt.shared.parseValue(this.rawValue.reviewdate):void 0}get createdate(){return this.rawValue.createdate!=null?pt.shared.parseValue(this.rawValue.createdate):void 0}get stars(){return this.rawValue.stars!=null?oe.shared.parseValue(this.rawValue.stars):void 0}constructor(e={}){this.rawValue=e}}c([m()],Nt.prototype,"reviewdate",null);c([m()],Nt.prototype,"createdate",null);c([m()],Nt.prototype,"stars",null);class Eo{constructor(e){var t,r;this.rawResponse=e,this.created=e.created,this.d1=e.d1,this.d2=e.d2,this.dir=e.dir,this.files=(t=e.files)===null||t===void 0?void 0:t.map(o=>new Me(o)),this.files_count=e.files_count,this.item_last_updated=e.item_last_updated,this.item_size=e.item_size,this.metadata=new f(e.metadata),this.server=e.server,this.uniq=e.uniq,this.workable_servers=e.workable_servers,this.speech_vs_music_asr=e.speech_vs_music_asr,this.reviews=(r=e.reviews)===null||r===void 0?void 0:r.map(o=>new Nt(o))}}var Se;(function(i){i.networkError="MetadataService.NetworkError",i.itemNotFound="MetadataService.ItemNotFound",i.decodingError="MetadataService.DecodingError",i.searchEngineError="MetadataService.SearchEngineError"})(Se||(Se={}));class $i extends Error{constructor(e,t,r){super(t),this.name=e,this.type=e,this.details=r}}class ls{constructor(e){var t;if(this.baseUrl=(t=e?.baseUrl)!==null&&t!==void 0?t:"archive.org",e?.includeCredentials!==void 0?this.includeCredentials=e.includeCredentials:this.includeCredentials=window.location.href.match(/^https?:\/\/.*archive\.org(:[0-9]+)?/)!==null,e?.scope!==void 0)this.requestScope=e.scope;else{const o=new URL(window.location.href).searchParams.get("scope");o&&(this.requestScope=o)}}async fetchMetadata(e,t){const r=t?`/${t}`:"",o=`https://${this.baseUrl}/metadata/${e}${r}`;return this.fetchUrl(o)}async fetchUrl(e,t){var r;const o=new URL(e);this.requestScope&&o.searchParams.set("scope",this.requestScope);let a;try{const n=(r=t?.requestOptions)!==null&&r!==void 0?r:{credentials:this.includeCredentials?"include":"same-origin"};a=await fetch(o.href,n)}catch(n){const l=n instanceof Error?n.message:typeof n=="string"?n:"Unknown error";return this.getErrorResult(Se.networkError,l)}try{const n=await a.json(),l=n.error;if(l){const s=n.forensics;return this.getErrorResult(Se.searchEngineError,l,s)}else return{success:n}}catch(n){const l=n instanceof Error?n.message:typeof n=="string"?n:"Unknown error";return this.getErrorResult(Se.decodingError,l)}}getErrorResult(e,t,r){return{error:new $i(e,t,r)}}}class Ur{constructor(e){this.backend=e}async fetchMetadata(e){var t;const r=await this.backend.fetchMetadata(e);return r.error?r:((t=r.success)===null||t===void 0?void 0:t.metadata)===void 0?{error:new $i(Se.itemNotFound)}:{success:new Eo(r.success)}}async fetchMetadataValue(e,t){var r;const o=await this.backend.fetchMetadata(e,t);return o.error?o:((r=o.success)===null||r===void 0?void 0:r.result)===void 0?{error:new $i(Se.itemNotFound)}:{success:o.success.result}}}Ur.default=new Ur(new ls);const ds=d`
  <svg
    class="ia-icon"
    viewBox="0 0 40 40"
    xmlns="http://www.w3.org/2000/svg"
...
`;var cs=Object.defineProperty,hs=Object.getOwnPropertyDescriptor,ge=(i,e,t,r)=>{for(var o=r>1?void 0:r?hs(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=(r?n(e,t,o):n(o))||o);return r&&o&&cs(e,t,o),o};let X=class extends x{constructor(){super(...arguments),this.icon="",this.href="",this.label="",this.menuDetails="",this.buttonId="",this.selected=!1,this.followable=!1}onClick(i){i.preventDefault(),this.dispatchMenuTypeSelectedEvent()}dispatchMenuTypeSelectedEvent(){this.dispatchEvent(new CustomEvent("menuTypeSelected",{bubbles:!0,composed:!0,detail:{id:this.buttonId}}))}get iconClass(){return this.selected?"active":""}get menuItem(){return d`
    ...
    `}render(){return this.href?this.linkButton:this.clickButton}static get styles(){return[D,_`
        :host {
    ...
    `}static get styles(){const i=_`42px`,e=_`var(--item-navigator-menu-width--)`,t=_`var(--item-navigator-animation-timing--)`;return[D,_`
        :host {
      ...
      `]}};ae([u({type:Array})],Q.prototype,"menus",2);ae([u({type:Boolean})],Q.prototype,"open",2);ae([u({type:Boolean})],Q.prototype,"manuallyHandleClose",2);ae([u({type:String})],Q.prototype,"selectedMenu",2);ae([u({type:Object})],Q.prototype,"selectedMenuAction",2);ae([u({type:Boolean})],Q.prototype,"animateMenuOpen",2);ae([S(".content.open button.close")],Q.prototype,"contentCloseButton",2);ae([S(".menu-list")],Q.prototype,"menuList",2);Q=ae([C("ia-menu-slider")],Q);var ms=Object.defineProperty,fs=Object.getOwnPropertyDescriptor,ko=(i,e,t,r)=>{for(var o=r>1?void 0:r?fs(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=(r?n(e,t,o):n(o))||o);return r&&o&&ms(e,t,o),o};let xi=class extends x{constructor(){super(...arguments),this.loaderMessage=""}get bookIconSvg(){return rr`
    ...
    `}get icon(){return this.bookIconSvg}get loader(){return rr`
    <svg
      height="100"
      viewBox="0 0 100 100"
      width="100"
    ...
    `}static get styles(){return[D,_`
      ...
      `]}};ko([u({type:String})],xi.prototype,"loaderMessage",2);xi=ko([C("ia-itemnav-loader")],xi);var vs=Object.defineProperty,bs=Object.getOwnPropertyDescriptor,Po=(i,e,t,r)=>{for(var o=r>1?void 0:r?bs(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=(r?n(e,t,o):n(o))||o);return r&&o&&vs(e,t,o),o};let _i=class extends x{constructor(){super(...arguments),this.identifier=""}emitLoaded(){this.dispatchEvent(new CustomEvent("loadingStateUpdated",{detail:{loaded:!0}}))}updated(i){i.has("identifier")&&this.emitLoaded()}get downloadUrl(){return`/download/${this.identifier}`}render(){return d`
      <section>
    ...
    `}openShortcut(i=""){this.openMenu=i,this.menuOpened=!0}get shortcuts(){const i=this.menuShortcuts.map(({icon:e,id:t,label:r})=>t==="fullscreen"?d`${e}`:d`
      ...
      `);return d`<div class="shortcuts">${i}</div>`}get menuClass(){const i=this.menuContents?.length||this.menuShortcuts?.length,e=this.menuOpened&&i?"open":"",t=this.viewportInFullscreen?"fullscreen":"";return`${e} ${t} ${this.openMenuState}`}static get styles(){const i=_`var(--item-navigator-menu-width--)`,e=_`var(--item-navigator-animation-timing--)`,t=_`transform ${e} ease-out`,r=_`var(--item-navigator-menu-margin--)`,o=_`var(--item-navigator-theater-bg-color--)`,a=_`var(--item-navigator-icon-width--)`,n=_`var(--item-navigator-icon-height--)`;return[D,_`
        :host {
          --item-navigator-menu-width--: var(
            --item-navigator-menu-width,
            320px
      ...
      `]}};L([u({type:Object,converter:i=>i&&typeof i=="string"?new Eo(JSON.parse(atob(i))):i})],B.prototype,"item",2);L([u({type:Boolean,reflect:!0})],B.prototype,"viewAvailable",2);L([u({type:String})],B.prototype,"baseHost",2);L([u({type:Boolean})],B.prototype,"signedIn",2);L([u({type:Array})],B.prototype,"menuContents",2);L([u({type:Array})],B.prototype,"menuShortcuts",2);L([u({type:Boolean,reflect:!0,attribute:!0})],B.prototype,"viewportInFullscreen",2);L([u({type:Boolean,reflect:!0})],B.prototype,"menuOpened",2);L([u({type:String,reflect:!0})],B.prototype,"openMenu",2);L([u({attribute:!1})],B.prototype,"modal",2);L([u({attribute:!1})],B.prototype,"sharedObserver",2);L([u({type:Boolean,reflect:!0,attribute:!0})],B.prototype,"loaded",2);L([$()],B.prototype,"openMenuState",2);L([S("#frame")],B.prototype,"frame",2);L([S('slot[name="header"]')],B.prototype,"headerSlot",2);L([S("ia-menu-slider")],B.prototype,"menuSlider",2);L([S("button.toggle-menu")],B.prototype,"toggleMenuButton",2);B=L([C("ia-item-navigator")],B);const Hr=(i,e,t)=>{const r=new Map;for(let o=e;o<=t;o++)r.set(i[o],o);return r},$s=gt(class extends mt{constructor(i){if(super(i),i.type!==re.CHILD)throw Error("repeat() can only be used in text expressions")}dt(i,e,t){let r;t===void 0?t=e:e!==void 0&&(r=e);const o=[],a=[];let n=0;for(const l of i)o[n]=r?r(l,n):n,a[n]=t(l,n),n++;return{values:a,keys:o}}render(i,e,t){return this.dt(i,e,t).values}update(i,[e,t,r]){const o=Ia(i),{values:a,keys:n}=this.dt(e,t,r);if(!Array.isArray(o))return this.ut=n,a;const l=this.ut??=[],s=[];let p,g,h=0,v=o.length-1,b=0,A=a.length-1;for(;h<=v&&b<=A;)if(o[h]===null)h++;else if(o[v]===null)v--;else if(l[h]===n[b])s[b]=fe(o[h],a[b]),h++,b++;else if(l[v]===n[A])s[A]=fe(o[v],a[A]),v--,A--;else if(l[h]===n[A])s[A]=fe(o[h],a[A]),Qe(i,s[A+1],o[h]),h++,A--;else if(l[v]===n[b])s[b]=fe(o[v],a[b]),Qe(i,o[h],o[v]),v--,b++;else if(p===void 0&&(p=Hr(n,b,A),g=Hr(l,h,v)),p.has(l[h]))if(p.has(l[v])){const k=g.get(n[b]),jt=k!==void 0?o[k]:null;if(jt===null){const Wi=Qe(i,o[h]);fe(Wi,a[b]),s[b]=Wi}else s[b]=fe(jt,a[b]),Qe(i,o[h],jt),o[k]=null;b++}else Ft(o[v]),v--;else Ft(o[h]),h++;for(;b<=A;){const k=Qe(i,s[A+1]);fe(k,a[b]),s[b++]=k}for(;h<=v;){const k=o[h++];k!==null&&Ft(k)}return this.ut=n,lo(i,s),K}});var xs=Object.defineProperty,_s=Object.getOwnPropertyDescriptor,Ge=(i,e,t,r)=>{for(var o=r>1?void 0:r?_s(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=(r?n(e,t,o):n(o))||o);return r&&o&&xs(e,t,o),o};const Ss=d`
  <svg
    viewBox="0 0 24 24"
    xmlns="http://www.w3.org/2000/svg"
...
`;let Ee=class extends x{constructor(){super(...arguments),this.baseHost="archive.org",this.sortOrderBy="default",this.subPrefix="",this.fileList=[],this.addSortToUrl=!1}firstUpdated(){const i=this.shadowRoot?.querySelector(".content.active");setTimeout(()=>{const e=i;e?.scrollIntoViewIfNeeded?e.scrollIntoViewIfNeeded(!0):i?.scrollIntoView({behavior:"smooth",block:"nearest",inline:"nearest"})},350)}fileUrl(i){const e=`//${this.baseHost}${i.url_path}`;return this.addSortToUrl&&this.sortOrderBy!=="default"?`${e}?sort=${this.sortOrderBy}`:e}get pdfLabel(){return d`<span class="pdf-label"
    ...
    `}get fileListTemplate(){const i=$s(this.fileList,e=>e?.file_prefix,this.fileLi.bind(this));return d`
      <ul>
        ${i}
        <div class="separator"></div>
      </ul>
    `}render(){return d`${this.fileList.length?this.fileListTemplate:y}`}static get styles(){return[D,_`
        :host {
          --item-navigator-text-color--: var(
            --item-navigator-text-color,
            var(--true-white)
      ...
      `]}};Ge([u({type:String})],Ee.prototype,"baseHost",2);Ge([u({type:String})],Ee.prototype,"sortOrderBy",2);Ge([u({type:String})],Ee.prototype,"subPrefix",2);Ge([u({type:Array})],Ee.prototype,"fileList",2);Ge([u({type:Boolean,reflect:!0})],Ee.prototype,"addSortToUrl",2);Ee=Ge([C("ia-viewable-files-panel")],Ee);var Cs=Object.defineProperty,As=Object.getOwnPropertyDescriptor,Ut=(i,e,t,r)=>{for(var o=r>1?void 0:r?As(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=(r?n(e,t,o):n(o))||o);return r&&o&&Cs(e,t,o),o};const Os=d`
...
`;let ut=class extends x{constructor(){super(...arguments),this.fileListRaw=[],this.fileListSorted=[],this.sortOrderBy="default"}render(){return d`<div class="sort-multi-file-list">${this.sortButton}</div>`}get sortButton(){return{default:d`
      ...
      `}[this.sortOrderBy]}sortVolumes(i){this.sortOrderBy=i;const e=[...this.fileListRaw].sort((t,r)=>i==="title_asc"?t.title.localeCompare(r.title):i==="title_desc"?r.title.localeCompare(t.title):(t.orig_sort??0)-(r.orig_sort??0));this.dispatchEvent(new CustomEvent("fileListSorted",{detail:{sortType:i,sortedFiles:e},bubbles:!0,composed:!0})),this.fileListSorted=e}static get styles(){return[D,_`
        :host {
          --item-navigator-header-icon-width--: var(
            --item-navigator-header-icon-width,
            18px
      ...
      `]}};Ut([u({type:Array})],ut.prototype,"fileListRaw",2);Ut([u({type:Array})],ut.prototype,"fileListSorted",2);Ut([u({type:String,reflect:!0})],ut.prototype,"sortOrderBy",2);ut=Ut([C("ia-sort-files-button")],ut);const ks=d`
  <svg
    class="ia-icon"
    viewBox="0 0 100 100"
    xmlns="http://www.w3.org/2000/svg"
...
`;var Ls=Object.defineProperty,zs=Object.getOwnPropertyDescriptor,ie=(i,e,t,r)=>{for(var o=r>1?void 0:r?zs(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=(r?n(e,t,o):n(o))||o);return r&&o&&Ls(e,t,o),o};let J=class extends x{constructor(){super(...arguments),this.baseHost="archive.org",this.creator="",this.description="",this.embedOptionsVisible=!1,this.identifier="",this.sharingOptions=[],this.type="",this.renderHeader=!1,this.fileSubPrefix="",this.copyNoteTimeouts=new WeakMap}updated(i){i.has("sharingOptions")&&!this.sharingOptions.length&&this.loadProviders()}loadProviders(){let i=`https://${this.baseHost}/details/${this.identifier}`;this.fileSubPrefix&&(i+=`/${this.fileSubPrefix}`);const e=[this.description,this.creator,"Free Download, Borrow, and Streaming","Internet Archive"].filter(Boolean).join(" : ");this.sharingOptions=[{name:"Twitter",icon:Ps,url:`https://twitter.com/intent/tweet?${new URLSearchParams({url:i,text:e,via:"internetarchive"})}`},{name:"Facebook",icon:Ms,url:`https://www.facebook.com/sharer/sharer.php?${new URLSearchParams({u:i})}`},{name:"Tumblr",icon:Is,url:`https://www.tumblr.com/widgets/share/tool/preview?${new URLSearchParams({posttype:"link",canonicalUrl:i,title:e})}`},{name:"Pinterest",icon:Bs,url:`http://www.pinterest.com/pin/create/button/?${new URLSearchParams({url:i,description:e})}`},{name:"Email",icon:Vs,url:`mailto:?${new URLSearchParams({subject:e,body:i})}`}]}async copyToClipboard(i){const e=i.currentTarget,t=e.querySelector("textarea"),r=e.querySelector("small");if(!(!t||!r)){try{await navigator.clipboard.writeText(t.value)}catch{t.select(),document.execCommand("copy"),t.blur()}r.classList.add("visible"),clearTimeout(this.copyNoteTimeouts.get(r)),this.copyNoteTimeouts.set(r,setTimeout(()=>r.classList.remove("visible"),4e3))}}get iframeEmbed(){return`<iframe
    ...
    `}static get styles(){return[D,_`
      ...
      `]}};ie([u({type:String})],J.prototype,"baseHost",2);ie([u({type:String})],J.prototype,"creator",2);ie([u({type:String})],J.prototype,"description",2);ie([u({type:Boolean})],J.prototype,"embedOptionsVisible",2);ie([u({type:String})],J.prototype,"identifier",2);ie([u({type:Array})],J.prototype,"sharingOptions",2);ie([u({type:String})],J.prototype,"type",2);ie([u({type:Boolean})],J.prototype,"renderHeader",2);ie([u({type:String})],J.prototype,"fileSubPrefix",2);J=ie([C("ia-share-panel")],J);var Rs=Object.defineProperty,Ns=Object.getOwnPropertyDescriptor,Ze=(i,e,t,r)=>{for(var o=r>1?void 0:r?Ns(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=(r?n(e,t,o):n(o))||o);return r&&o&&Rs(e,t,o),o};class Us{constructor(){this.handlers=new Map,this.observer=new ResizeObserver(e=>{for(const t of e)this.handlers.get(t.target)?.handler.handleResize(t)})}addObserver(e){this.handlers.set(e.target,e),this.observer.observe(e.target)}removeObserver(e){this.handlers.delete(e.target),this.observer.unobserve(e.target)}}const Fr=d`
...
`;let ce=class extends x{constructor(){super(...arguments),this.loaded=!0,this.viewAvailable=!0,this.sharedObserver=new Us,this.sortOrderBy="default",this.demoFiles=[{title:"Volume 1",file_prefix:"v1",file_subprefix:"v1",url_path:"/details/demo-item/v1",file_source:"v1.pdf",image:"",author:"",orig_sort:0},{title:"Volume 3",file_prefix:"v3",file_subprefix:"v3",url_path:"/details/demo-item/v3",file_source:"v3.txt",image:"",author:"",orig_sort:2},{title:"Volume 2",file_prefix:"v2",file_subprefix:"v2",url_path:"/details/demo-item/v2",file_source:"v2.pdf",image:"",author:"",orig_sort:1}],this.sortedFiles=[...this.demoFiles]}handleFileListSorted(i){const{sortType:e,sortedFiles:t}=i.detail;this.sortOrderBy=e,this.sortedFiles=t}get demoItem(){return{metadata:{identifier:"demo-item",title:"A Demonstration Item"}}}get menuContents(){const i={item:this.demoItem,baseHost:"archive.org",subPrefix:""};return[{...i,id:"contents",label:"Table of Contents",icon:Fr,component:d`
          <ul>
            <li>Chapter 1 — Introduction</li>
            <li>Chapter 2 — Getting Started</li>
            <li>Chapter 3 — In Practice</li>
          </ul>
        `},{...i,id:"viewable-files",label:"Viewable Files",icon:Ss,actionButton:d`
        ...
        `,component:d`
          <ia-viewable-files-panel
            ...
            .sortOrderBy=${this.sortOrderBy}
          ></ia-viewable-files-panel>
        `},{...i,id:"share",label:"Share",icon:ks,component:d`
          <ia-share-panel
            ...
            <tr>
              ...
              <td>
                <input
                  ...
                  id="loaded"
                  ?checked=${this.loaded}
                  @change=${i=>this.loaded=i.target.checked}
                />
              </td>
            </tr>
            <tr>
              ...
              <td>
                <input
                  ...
                  @change=${i=>this.viewAvailable=i.target.checked}
                />
              </td>
            </tr>
          </table>
...
>
  ...
  <div slot="main">…your theater…</div>
    ...
    `}};Ze([$()],ce.prototype,"loaded",2);Ze([$()],ce.prototype,"viewAvailable",2);Ze([$()],ce.prototype,"sharedObserver",2);Ze([$()],ce.prototype,"sortOrderBy",2);Ze([$()],ce.prototype,"sortedFiles",2);ce=Ze([C("ia-item-navigator-story")],ce);const js=Object.freeze(Object.defineProperty({__proto__:null,get IAItemNavigatorStory(){return ce}},Symbol.toStringTag,{value:"Module"}));var Hs=Object.defineProperty,Fs=Object.getOwnPropertyDescriptor,Ie=(i,e,t,r)=>{for(var o=r>1?void 0:r?Fs(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=(r?n(e,t,o):n(o))||o);return r&&o&&Hs(e,t,o),o};const qs={CodeSubmitted:"codeSubmitted"},qr=/^[0-9]+$/,Ks=/^[a-zA-Z0-9]+$/;let he=class extends x{constructor(){super(...arguments),this.disabled=!1,this.numChars=6,this.numericOnly=!0,this.allowedChars=qr}render(){return d`
      ${[...Array(this.numChars).keys()].map(i=>d`<input
          ...
          />`)}
    `}firstUpdated(){this.inputs[0].focus()}willUpdate(i){i.has("numericOnly")&&(this.allowedChars=this.numericOnly?qr:Ks),i.has("prefillValue")&&this.prefillValue!==void 0&&(this.fillInputs(this.prefillValue),this.prefillValue=void 0)}handleInput(i){i.preventDefault();const e=i.target,t=i.data;if(!t)return;if(t.length>1){this.fillInputs(t);return}if(!this.allowedChars.test(t))return;e.value=t;const r=e.nextElementSibling;r&&r.focus(),this.submitIfInputsFilled()}handleKeydown(i){const e=i.target,t=i.key,r=e.previousElementSibling,o=e.nextElementSibling;switch(t){case"Backspace":case"Delete":if(i.preventDefault(),r&&r.focus(),e.value===""){r.value="";break}e.value="";break;case"Tab":e.select();break;case"ArrowRight":case"Right":i.preventDefault(),o&&o.focus();break;case"ArrowLeft":case"Left":i.preventDefault(),r&&r.focus();break}}handlePaste(i){i.preventDefault();const e=i.clipboardData?.getData("text");e&&this.fillInputs(e)}fillInputs(i){i===""&&this.clearInputs();const e=i.split("").filter(r=>this.allowedChars.test(r)).slice(0,this.numChars);if(!e||e.length===0)return;if(e.forEach((r,o)=>this.inputs[o].value=r),e.length===this.numChars){this.triggerSubmit(e.join("")),this.inputs[this.numChars-1].focus();return}this.inputs[e.length].focus()}clearInputs(){this.inputs.forEach(i=>i.value=""),this.inputs[0].focus()}submitIfInputsFilled(){const i=[];this.inputs.forEach(e=>{e.value&&i.push(e.value)}),i.length===this.numChars&&this.triggerSubmit(i.join(""))}triggerSubmit(i){this.dispatchEvent(new CustomEvent(qs.CodeSubmitted,{detail:this.numericOnly?i:i.toUpperCase(),bubbles:!0,composed:!0}))}static get styles(){return[D,_`
        :host {
      ...
      `]}};Ie([u({type:String})],he.prototype,"prefillValue",2);Ie([u({type:Boolean})],he.prototype,"disabled",2);Ie([u({type:Number})],he.prototype,"numChars",2);Ie([u({type:Boolean})],he.prototype,"numericOnly",2);Ie([u({type:Object})],he.prototype,"allowedChars",2);Ie([Vi("input")],he.prototype,"inputs",2);he=Ie([C("ia-otp-input")],he);var Ws=Object.defineProperty,Gs=Object.getOwnPropertyDescriptor,Je=(i,e,t,r)=>{for(var o=r>1?void 0:r?Gs(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=(r?n(e,t,o):n(o))||o);return r&&o&&Ws(e,t,o),o};const Zs={NewCodeRequested:"newCodeRequested"};let ke=class extends x{constructor(){super(...arguments),this.validationStatus="ready",this.newCodeSending=!1,this.numPasscodeChars=6,this.numericOnly=!0}render(){return d`
    ...
    `}willUpdate(i){i.has("validationStatus")&&this.OTPInput&&this.validationStatus==="error"&&(this.OTPInput.prefillValue=""),i.has("newCodeSending")&&this.newCodeSending&&this.OTPInput&&(this.OTPInput.prefillValue="")}get resendCodeButtonTemplate(){return this.newCodeSending?d`<span part="new-code-message" class="new-code-msg"
        ...
        `}async handleNewCodeRequested(){this.dispatchEvent(new CustomEvent(Zs.NewCodeRequested,{bubbles:!0,composed:!0})),this.OTPInput.prefillValue=""}static get styles(){return[D,_`
        :host {
          --font-size-standard--: var(--font-size-standard);
          --font-size-lg--: var(--font-size-lg);
      ...
      `]}};Je([u({type:String})],ke.prototype,"validationStatus",2);Je([u({type:Boolean})],ke.prototype,"newCodeSending",2);Je([u({type:Number})],ke.prototype,"numPasscodeChars",2);Je([u({type:Boolean})],ke.prototype,"numericOnly",2);Je([S("ia-otp-input")],ke.prototype,"OTPInput",2);ke=Je([C("ia-otp-form")],ke);var Js=Object.getOwnPropertyDescriptor,Ys=(i,e,t,r)=>{for(var o=r>1?void 0:r?Js(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=n(o)||o);return o};const Xs=[{label:"Text color",cssVariable:"--ia-theme-primary-text-color",defaultValue:"#2c2c2c",inputType:"color"},{label:"Input font size",cssVariable:"--ia-theme-font-size-lg",defaultValue:"2.25rem",inputType:"text"},{label:"Link and error font size",cssVariable:"--ia-theme-font-size-standard",defaultValue:"0.875rem",inputType:"text"},{label:"Link font color",cssVariable:"--ia-theme-link-color",defaultValue:"#4b64ff",inputType:"color"},{label:"Error message/indicator color",cssVariable:"--ia-theme-color-danger",defaultValue:"#e51c23",inputType:"color"},{label:"Success indicator color",cssVariable:"--ia-theme-color-success",defaultValue:"#31a481",inputType:"color"}],Qs=[{label:"Validation Status",propertyName:"validationStatus",defaultValue:"ready",inputType:"radio",radioOptions:["ready","loading","success","error"]},{label:"New code sending in progress",propertyName:"newCodeSending",defaultValue:!1,inputType:"radio",radioOptions:[!0,!1]},{label:"Numeric only",propertyName:"numericOnly",defaultValue:!0,inputType:"radio",radioOptions:[!0,!1]},{label:"Number of passcode characters",propertyName:"numPasscodeChars",defaultValue:6,inputType:"number"}];let Si=class extends x{render(){return d`
      <story-template
        ...
        .styleInputData=${{settings:Xs}}
        .propInputData=${{settings:Qs}}
      >
        <ia-otp-form
          slot="demo"
    ...
    `}};Si=Ys([C("ia-otp-form-story")],Si);const el=Object.freeze(Object.defineProperty({__proto__:null,get IAOTPFormStory(){return Si}},Symbol.toStringTag,{value:"Module"}));var tl=Object.getOwnPropertyDescriptor,il=(i,e,t,r)=>{for(var o=r>1?void 0:r?tl(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=n(o)||o);return o};const rl=[{label:"Text color",cssVariable:"--ia-theme-primary-text-color",defaultValue:"#2c2c2c",inputType:"color"},{label:"Font size",cssVariable:"--ia-theme-font-size-lg",defaultValue:"2.25rem",inputType:"text"}],ol=[{label:"Number of characters",propertyName:"numChars",defaultValue:6,inputType:"number"},{label:"Numeric only",propertyName:"numericOnly",defaultValue:!0,inputType:"radio",radioOptions:[!0,!1]},{label:"Prefill value",propertyName:"prefillValue",defaultValue:""},{label:"Disabled",propertyName:"disabled",defaultValue:!1,inputType:"radio",radioOptions:[!0,!1]}];let Ci=class extends x{render(){return d`
      <story-template
        elementTag="ia-otp-input"
        elementClassName="IAOTPInput"
        .defaultUsageProps=${"@codeSubmitted=${(e: CustomEvent) => {setTimeout(() => alert('Code submitted: ' + e.detail), 250);}}"}
        .styleInputData=${{settings:rl}}
        .propInputData=${{settings:ol}}
      >
        <ia-otp-input
          @codeSubmitted=${i=>{setTimeout(()=>alert("Code submitted: "+i.detail),250)}}
          slot="demo"
    ...
    `}};Ci=il([C("ia-otp-input-story")],Ci);const al=Object.freeze(Object.defineProperty({__proto__:null,get IAOTPInputStory(){return Ci}},Symbol.toStringTag,{value:"Module"}));var nl=Object.getOwnPropertyDescriptor,sl=(i,e,t,r)=>{for(var o=r>1?void 0:r?nl(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=n(o)||o);return o};let Kr=class extends x{render(){return d`
      <span class="sr-only">
        <slot></slot>
      </span>
    `}static get styles(){return[D,_`
      ...
      `]}};Kr=sl([C("ia-sr-only-text")],Kr);var ll=Object.defineProperty,dl=Object.getOwnPropertyDescriptor,Mo=(i,e,t,r)=>{for(var o=r>1?void 0:r?dl(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=(r?n(e,t,o):n(o))||o);return r&&o&&ll(e,t,o),o};let Mt=class extends x{constructor(){super(...arguments),this.textVisible=!1}render(){return d`
      <story-template
    ...
    `}};Ki([u({type:Object})],It.prototype,"snowConfig",2);Ki([$()],It.prototype,"snowing",2);It=Ki([C("ia-snow")],It);var wl=Object.defineProperty,$l=Object.getOwnPropertyDescriptor,Ye=(i,e,t,r)=>{for(var o=r>1?void 0:r?$l(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=(r?n(e,t,o):n(o))||o);return r&&o&&wl(e,t,o),o};let pe=class extends x{render(){return d`
      <story-template
        elementTag="ia-snow"
    ...
    `}};Ye([$()],pe.prototype,"config",2);Ye([S("#count")],pe.prototype,"countInput",2);Ye([S("#wind")],pe.prototype,"windInput",2);Ye([S("#rotation")],pe.prototype,"rotationInput",2);Ye([S("#color")],pe.prototype,"colorInput",2);pe=Ye([C("ia-snow-story")],pe);const xl=Object.freeze(Object.defineProperty({__proto__:null,get IASnowStory(){return pe}},Symbol.toStringTag,{value:"Module"}));var _l=Object.getOwnPropertyDescriptor,Sl=(i,e,t,r)=>{for(var o=r>1?void 0:r?_l(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=n(o)||o);return o};const Cl=Object.assign({"../src/elements/ia-button/ia-button-story.ts":Ea,"../src/elements/ia-combo-box/ia-combo-box-story.ts":tn,"../src/elements/ia-dropdown-search-bar/ia-dropdown-search-bar-story.ts":Qn,"../src/elements/ia-item-navigator/ia-item-navigator-story.ts":js,"../src/elements/ia-otp-form/ia-otp-form-story.ts":el,"../src/elements/ia-otp-input/ia-otp-input-story.ts":al,"../src/elements/ia-sr-only-text/ia-sr-only-text-story.ts":cl,"../src/elements/ia-status-indicator/ia-status-indicator-story.ts":ml,"../src/labs/ia-snow/ia-snow-story.ts":xl}),Io=Object.keys(Cl).map(i=>{const e=i.includes("/src/labs/"),t=i.split("/"),o=t[t.length-1].replace(/-story\.ts$/,"");return{tag:o,storyTag:`${o}-story`,id:`elem-${o}`,labs:e}}).sort((i,e)=>i.tag.localeCompare(e.tag)),Oi=Io.filter(i=>!i.labs),Ti=Io.filter(i=>i.labs),Al=[...Oi,...Ti];let Zr=class extends x{constructor(){super(...arguments),this._abortController=new AbortController}createRenderRoot(){return this}render(){return d`
      <nav id="ia-sidebar">
        <h2>Production-Ready</h2>
        ${Oi.map(i=>d`<a href="#${i.id}">&lt;${i.tag}&gt;</a>`)}
        <h2>Labs 🧪</h2>
    ...
    `}firstUpdated(){const i=Al.map(r=>r.id),e=Object.fromEntries(i.map(r=>[r,this.querySelector(`#ia-sidebar a[href="#${r}"]`)])),t=new Set;this._observer=new IntersectionObserver(r=>{for(const a of r)a.isIntersecting?t.add(a.target.id):t.delete(a.target.id);const o=i.find(a=>t.has(a))??i[0];i.forEach(a=>e[a]?.classList.toggle("active",a===o))},{rootMargin:"0px 0px -70% 0px"}),i.forEach(r=>{const o=document.getElementById(r);o&&this._observer.observe(o)}),i.forEach(r=>{e[r]?.addEventListener("click",o=>{o.preventDefault();const a=document.getElementById(r);if(a){const n=a.getBoundingClientRect().top+window.scrollY;window.scrollTo({top:Math.max(0,n-16),behavior:"smooth"})}},{signal:this._abortController.signal})})}disconnectedCallback(){super.disconnectedCallback(),this._observer?.disconnect(),this._abortController.abort()}};Zr=Sl([C("app-root")],Zr);
