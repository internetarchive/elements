(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))r(o);new MutationObserver(o=>{for(const a of o)if(a.type==="childList")for(const n of a.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&r(n)}).observe(document,{childList:!0,subtree:!0});function t(o){const a={};return o.integrity&&(a.integrity=o.integrity),o.referrerPolicy&&(a.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?a.credentials="include":o.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function r(o){if(o.ep)return;o.ep=!0;const a=t(o);fetch(o.href,a)}})();const bt=globalThis,Pi=bt.ShadowRoot&&(bt.ShadyCSS===void 0||bt.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Mi=Symbol(),Ji=new WeakMap;let eo=class{constructor(e,t,r){if(this._$cssResult$=!0,r!==Mi)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(Pi&&e===void 0){const r=t!==void 0&&t.length===1;r&&(e=Ji.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),r&&Ji.set(t,e))}return e}toString(){return this.cssText}};const Lo=i=>new eo(typeof i=="string"?i:i+"",void 0,Mi),_=(i,...e)=>{const t=i.length===1?i[0]:e.reduce(((r,o,a)=>r+(n=>{if(n._$cssResult$===!0)return n.cssText;if(typeof n=="number")return n;throw Error("Value passed to 'css' function must be a 'css' function result: "+n+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(o)+i[a+1]),i[0]);return new eo(t,i,Mi)},Ro=(i,e)=>{if(Pi)i.adoptedStyleSheets=e.map((t=>t instanceof CSSStyleSheet?t:t.styleSheet));else for(const t of e){const r=document.createElement("style"),o=bt.litNonce;o!==void 0&&r.setAttribute("nonce",o),r.textContent=t.cssText,i.appendChild(r)}},Yi=Pi?i=>i:i=>i instanceof CSSStyleSheet?(e=>{let t="";for(const r of e.cssRules)t+=r.cssText;return Lo(t)})(i):i;const{is:No,defineProperty:Uo,getOwnPropertyDescriptor:jo,getOwnPropertyNames:Ho,getOwnPropertySymbols:Fo,getPrototypeOf:qo}=Object,zt=globalThis,Xi=zt.trustedTypes,Ko=Xi?Xi.emptyScript:"",Wo=zt.reactiveElementPolyfillSupport,ot=(i,e)=>i,_t={toAttribute(i,e){switch(e){case Boolean:i=i?Ko:null;break;case Object:case Array:i=i==null?i:JSON.stringify(i)}return i},fromAttribute(i,e){let t=i;switch(e){case Boolean:t=i!==null;break;case Number:t=i===null?null:Number(i);break;case Object:case Array:try{t=JSON.parse(i)}catch{t=null}}return t}},Ii=(i,e)=>!No(i,e),Qi={attribute:!0,type:String,converter:_t,reflect:!1,useDefault:!1,hasChanged:Ii};Symbol.metadata??=Symbol("metadata"),zt.litPropertyMetadata??=new WeakMap;let Le=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=Qi){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){const r=Symbol(),o=this.getPropertyDescriptor(e,r,t);o!==void 0&&Uo(this.prototype,e,o)}}static getPropertyDescriptor(e,t,r){const{get:o,set:a}=jo(this.prototype,e)??{get(){return this[t]},set(n){this[t]=n}};return{get:o,set(n){const l=o?.call(this);a?.call(this,n),this.requestUpdate(e,l,r)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??Qi}static _$Ei(){if(this.hasOwnProperty(ot("elementProperties")))return;const e=qo(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(ot("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(ot("properties"))){const t=this.properties,r=[...Ho(t),...Fo(t)];for(const o of r)this.createProperty(o,t[o])}const e=this[Symbol.metadata];if(e!==null){const t=litPropertyMetadata.get(e);if(t!==void 0)for(const[r,o]of t)this.elementProperties.set(r,o)}this._$Eh=new Map;for(const[t,r]of this.elementProperties){const o=this._$Eu(t,r);o!==void 0&&this._$Eh.set(o,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const r=new Set(e.flat(1/0).reverse());for(const o of r)t.unshift(Yi(o))}else e!==void 0&&t.push(Yi(e));return t}static _$Eu(e,t){const r=t.attribute;return r===!1?void 0:typeof r=="string"?r:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise((e=>this.enableUpdating=e)),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach((e=>e(this)))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){const e=new Map,t=this.constructor.elementProperties;for(const r of t.keys())this.hasOwnProperty(r)&&(e.set(r,this[r]),delete this[r]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Ro(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach((e=>e.hostConnected?.()))}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach((e=>e.hostDisconnected?.()))}attributeChangedCallback(e,t,r){this._$AK(e,r)}_$ET(e,t){const r=this.constructor.elementProperties.get(e),o=this.constructor._$Eu(e,r);if(o!==void 0&&r.reflect===!0){const a=(r.converter?.toAttribute!==void 0?r.converter:_t).toAttribute(t,r.type);this._$Em=e,a==null?this.removeAttribute(o):this.setAttribute(o,a),this._$Em=null}}_$AK(e,t){const r=this.constructor,o=r._$Eh.get(e);if(o!==void 0&&this._$Em!==o){const a=r.getPropertyOptions(o),n=typeof a.converter=="function"?{fromAttribute:a.converter}:a.converter?.fromAttribute!==void 0?a.converter:_t;this._$Em=o;const l=n.fromAttribute(t,a.type);this[o]=l??this._$Ej?.get(o)??l,this._$Em=null}}requestUpdate(e,t,r){if(e!==void 0){const o=this.constructor,a=this[e];if(r??=o.getPropertyOptions(e),!((r.hasChanged??Ii)(a,t)||r.useDefault&&r.reflect&&a===this._$Ej?.get(e)&&!this.hasAttribute(o._$Eu(e,r))))return;this.C(e,t,r)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,t,{useDefault:r,reflect:o,wrapped:a},n){r&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,n??t??this[e]),a!==!0||n!==void 0)||(this._$AL.has(e)||(this.hasUpdated||r||(t=void 0),this._$AL.set(e,t)),o===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[o,a]of this._$Ep)this[o]=a;this._$Ep=void 0}const r=this.constructor.elementProperties;if(r.size>0)for(const[o,a]of r){const{wrapped:n}=a,l=this[o];n!==!0||this._$AL.has(o)||l===void 0||this.C(o,void 0,a,l)}}let e=!1;const t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach((r=>r.hostUpdate?.())),this.update(t)):this._$EM()}catch(r){throw e=!1,this._$EM(),r}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach((t=>t.hostUpdated?.())),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach((t=>this._$ET(t,this[t]))),this._$EM()}updated(e){}firstUpdated(e){}};Le.elementStyles=[],Le.shadowRootOptions={mode:"open"},Le[ot("elementProperties")]=new Map,Le[ot("finalized")]=new Map,Wo?.({ReactiveElement:Le}),(zt.reactiveElementVersions??=[]).push("2.1.1");const Bi=globalThis,St=Bi.trustedTypes,er=St?St.createPolicy("lit-html",{createHTML:i=>i}):void 0,to="$lit$",de=`lit$${Math.random().toFixed(9).slice(2)}$`,io="?"+de,Go=`<${io}>`,Te=document,at=()=>Te.createComment(""),nt=i=>i===null||typeof i!="object"&&typeof i!="function",Vi=Array.isArray,Zo=i=>Vi(i)||typeof i?.[Symbol.iterator]=="function",qt=`[ 	
\f\r]`,et=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,tr=/-->/g,ir=/>/g,fe=RegExp(`>|${qt}(?:([^\\s"'>=/]+)(${qt}*=${qt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),rr=/'/g,or=/"/g,ro=/^(?:script|style|textarea|title)$/i,oo=i=>(e,...t)=>({_$litType$:i,strings:e,values:t}),d=oo(1),ar=oo(2),K=Symbol.for("lit-noChange"),y=Symbol.for("lit-nothing"),nr=new WeakMap,_e=Te.createTreeWalker(Te,129);function ao(i,e){if(!Vi(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return er!==void 0?er.createHTML(e):e}const Jo=(i,e)=>{const t=i.length-1,r=[];let o,a=e===2?"<svg>":e===3?"<math>":"",n=et;for(let l=0;l<t;l++){const s=i[l];let p,g,h=-1,v=0;for(;v<s.length&&(n.lastIndex=v,g=n.exec(s),g!==null);)v=n.lastIndex,n===et?g[1]==="!--"?n=tr:g[1]!==void 0?n=ir:g[2]!==void 0?(ro.test(g[2])&&(o=RegExp("</"+g[2],"g")),n=fe):g[3]!==void 0&&(n=fe):n===fe?g[0]===">"?(n=o??et,h=-1):g[1]===void 0?h=-2:(h=n.lastIndex-g[2].length,p=g[1],n=g[3]===void 0?fe:g[3]==='"'?or:rr):n===or||n===rr?n=fe:n===tr||n===ir?n=et:(n=fe,o=void 0);const b=n===fe&&i[l+1].startsWith("/>")?" ":"";a+=n===et?s+Go:h>=0?(r.push(p),s.slice(0,h)+to+s.slice(h)+de+b):s+de+(h===-2?l:b)}return[ao(i,a+(i[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),r]};let di=class no{constructor({strings:e,_$litType$:t},r){let o;this.parts=[];let a=0,n=0;const l=e.length-1,s=this.parts,[p,g]=Jo(e,t);if(this.el=no.createElement(p,r),_e.currentNode=this.el.content,t===2||t===3){const h=this.el.content.firstChild;h.replaceWith(...h.childNodes)}for(;(o=_e.nextNode())!==null&&s.length<l;){if(o.nodeType===1){if(o.hasAttributes())for(const h of o.getAttributeNames())if(h.endsWith(to)){const v=g[n++],b=o.getAttribute(h).split(de),A=/([.?@])?(.*)/.exec(v);s.push({type:1,index:a,name:A[2],strings:b,ctor:A[1]==="."?Xo:A[1]==="?"?Qo:A[1]==="@"?ea:Lt}),o.removeAttribute(h)}else h.startsWith(de)&&(s.push({type:6,index:a}),o.removeAttribute(h));if(ro.test(o.tagName)){const h=o.textContent.split(de),v=h.length-1;if(v>0){o.textContent=St?St.emptyScript:"";for(let b=0;b<v;b++)o.append(h[b],at()),_e.nextNode(),s.push({type:2,index:++a});o.append(h[v],at())}}}else if(o.nodeType===8)if(o.data===io)s.push({type:2,index:a});else{let h=-1;for(;(h=o.data.indexOf(de,h+1))!==-1;)s.push({type:7,index:a}),h+=de.length-1}a++}}static createElement(e,t){const r=Te.createElement("template");return r.innerHTML=e,r}};function He(i,e,t=i,r){if(e===K)return e;let o=r!==void 0?t._$Co?.[r]:t._$Cl;const a=nt(e)?void 0:e._$litDirective$;return o?.constructor!==a&&(o?._$AO?.(!1),a===void 0?o=void 0:(o=new a(i),o._$AT(i,t,r)),r!==void 0?(t._$Co??=[])[r]=o:t._$Cl=o),o!==void 0&&(e=He(i,o._$AS(i,e.values),o,r)),e}let Yo=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:r}=this._$AD,o=(e?.creationScope??Te).importNode(t,!0);_e.currentNode=o;let a=_e.nextNode(),n=0,l=0,s=r[0];for(;s!==void 0;){if(n===s.index){let p;s.type===2?p=new Dt(a,a.nextSibling,this,e):s.type===1?p=new s.ctor(a,s.name,s.strings,this,e):s.type===6&&(p=new ta(a,this,e)),this._$AV.push(p),s=r[++l]}n!==s?.index&&(a=_e.nextNode(),n++)}return _e.currentNode=Te,o}p(e){let t=0;for(const r of this._$AV)r!==void 0&&(r.strings!==void 0?(r._$AI(e,r,t),t+=r.strings.length-2):r._$AI(e[t])),t++}},Dt=class so{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,r,o){this.type=2,this._$AH=y,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=r,this.options=o,this._$Cv=o?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=He(this,e,t),nt(e)?e===y||e==null||e===""?(this._$AH!==y&&this._$AR(),this._$AH=y):e!==this._$AH&&e!==K&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):Zo(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==y&&nt(this._$AH)?this._$AA.nextSibling.data=e:this.T(Te.createTextNode(e)),this._$AH=e}$(e){const{values:t,_$litType$:r}=e,o=typeof r=="number"?this._$AC(e):(r.el===void 0&&(r.el=di.createElement(ao(r.h,r.h[0]),this.options)),r);if(this._$AH?._$AD===o)this._$AH.p(t);else{const a=new Yo(o,this),n=a.u(this.options);a.p(t),this.T(n),this._$AH=a}}_$AC(e){let t=nr.get(e.strings);return t===void 0&&nr.set(e.strings,t=new di(e)),t}k(e){Vi(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let r,o=0;for(const a of e)o===t.length?t.push(r=new so(this.O(at()),this.O(at()),this,this.options)):r=t[o],r._$AI(a),o++;o<t.length&&(this._$AR(r&&r._$AB.nextSibling,o),t.length=o)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){const r=e.nextSibling;e.remove(),e=r}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},Lt=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,r,o,a){this.type=1,this._$AH=y,this._$AN=void 0,this.element=e,this.name=t,this._$AM=o,this.options=a,r.length>2||r[0]!==""||r[1]!==""?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=y}_$AI(e,t=this,r,o){const a=this.strings;let n=!1;if(a===void 0)e=He(this,e,t,0),n=!nt(e)||e!==this._$AH&&e!==K,n&&(this._$AH=e);else{const l=e;let s,p;for(e=a[0],s=0;s<a.length-1;s++)p=He(this,l[r+s],t,s),p===K&&(p=this._$AH[s]),n||=!nt(p)||p!==this._$AH[s],p===y?e=y:e!==y&&(e+=(p??"")+a[s+1]),this._$AH[s]=p}n&&!o&&this.j(e)}j(e){e===y?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},Xo=class extends Lt{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===y?void 0:e}},Qo=class extends Lt{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==y)}},ea=class extends Lt{constructor(e,t,r,o,a){super(e,t,r,o,a),this.type=5}_$AI(e,t=this){if((e=He(this,e,t,0)??y)===K)return;const r=this._$AH,o=e===y&&r!==y||e.capture!==r.capture||e.once!==r.once||e.passive!==r.passive,a=e!==y&&(r===y||o);o&&this.element.removeEventListener(this.name,this,r),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},ta=class{constructor(e,t,r){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(e){He(this,e)}};const ia={I:Dt},ra=Bi.litHtmlPolyfillSupport;ra?.(di,Dt),(Bi.litHtmlVersions??=[]).push("3.3.1");const lo=(i,e,t)=>{const r=t?.renderBefore??e;let o=r._$litPart$;if(o===void 0){const a=t?.renderBefore??null;r._$litPart$=o=new Dt(e.insertBefore(at(),a),a,void 0,t??{})}return o._$AI(i),o};const zi=globalThis;let x=class extends Le{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=lo(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return K}};x._$litElement$=!0,x.finalized=!0,zi.litElementHydrateSupport?.({LitElement:x});const oa=zi.litElementPolyfillSupport;oa?.({LitElement:x});(zi.litElementVersions??=[]).push("4.2.1");const C=i=>(e,t)=>{t!==void 0?t.addInitializer((()=>{customElements.define(i,e)})):customElements.define(i,e)};const aa={attribute:!0,type:String,converter:_t,reflect:!1,hasChanged:Ii},na=(i=aa,e,t)=>{const{kind:r,metadata:o}=t;let a=globalThis.litPropertyMetadata.get(o);if(a===void 0&&globalThis.litPropertyMetadata.set(o,a=new Map),r==="setter"&&((i=Object.create(i)).wrapped=!0),a.set(t.name,i),r==="accessor"){const{name:n}=t;return{set(l){const s=e.get.call(this);e.set.call(this,l),this.requestUpdate(n,s,i)},init(l){return l!==void 0&&this.C(n,void 0,i,l),l}}}if(r==="setter"){const{name:n}=t;return function(l){const s=this[n];e.call(this,l),this.requestUpdate(n,s,i)}}throw Error("Unsupported decorator location: "+r)};function u(i){return(e,t)=>typeof t=="object"?na(i,e,t):((r,o,a)=>{const n=o.hasOwnProperty(a);return o.constructor.createProperty(a,r),n?Object.getOwnPropertyDescriptor(o,a):void 0})(i,e,t)}function w(i){return u({...i,state:!0,attribute:!1})}const co=(i,e,t)=>(t.configurable=!0,t.enumerable=!0,Reflect.decorate&&typeof e!="object"&&Object.defineProperty(i,e,t),t);function S(i,e){return(t,r,o)=>{const a=n=>n.renderRoot?.querySelector(i)??null;return co(t,r,{get(){return a(this)}})}}let sa;function Di(i){return(e,t)=>co(e,t,{get(){return(this.renderRoot??(sa??=document.createDocumentFragment())).querySelectorAll(i)}})}function xe(i,e,t){return i?e(i):t?.(i)}const Se=i=>i??y,la="modulepreload",da=function(i,e){return new URL(i,e).href},sr={},yt=function(e,t,r){let o=Promise.resolve();if(t&&t.length>0){let p=function(g){return Promise.all(g.map(h=>Promise.resolve(h).then(v=>({status:"fulfilled",value:v}),v=>({status:"rejected",reason:v}))))};const n=document.getElementsByTagName("link"),l=document.querySelector("meta[property=csp-nonce]"),s=l?.nonce||l?.getAttribute("nonce");o=p(t.map(g=>{if(g=da(g,r),g in sr)return;sr[g]=!0;const h=g.endsWith(".css"),v=h?'[rel="stylesheet"]':"";if(r)for(let A=n.length-1;A>=0;A--){const k=n[A];if(k.href===g&&(!h||k.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${g}"]${v}`))return;const b=document.createElement("link");if(b.rel=h?"stylesheet":la,h||(b.as="script"),b.crossOrigin="",b.href=g,s&&b.setAttribute("nonce",s),document.head.appendChild(b),h)return new Promise((A,k)=>{b.addEventListener("load",A),b.addEventListener("error",()=>k(new Error(`Unable to preload CSS for ${g}`)))})}))}function a(n){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=n,window.dispatchEvent(l),!l.defaultPrevented)throw n}return o.then(n=>{for(const l of n||[])l.status==="rejected"&&a(l.reason);return e().catch(a)})};const ae={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4},mt=i=>(...e)=>({_$litDirective$:i,values:e});let ft=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,r){this._$Ct=e,this._$AM=t,this._$Ci=r}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};let ci=class extends ft{constructor(e){if(super(e),this.it=y,e.type!==ae.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===y||e==null)return this._t=void 0,this.it=e;if(e===K)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;const t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}};ci.directiveName="unsafeHTML",ci.resultType=1;const hi=mt(ci),ca=_`
  pre {
...
`;var ha=Object.defineProperty,pa=Object.getOwnPropertyDescriptor,Rt=(i,e,t,r)=>{for(var o=r>1?void 0:r?pa(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=(r?n(e,t,o):n(o))||o);return r&&o&&ha(e,t,o),o};let st=class extends x{constructor(){super(...arguments),this.code="",this.language="auto",this.highlightedCode=""}willUpdate(i){(i.has("code")||i.has("language"))&&this.highlightCode()}render(){return d`
      <pre><code class="hljs">${hi(this.highlightedCode)}</code></pre>
    `}async highlightCode(){const e=(await yt(()=>import("./index-BBc-AmEf.js"),[],import.meta.url)).default,t=this.code.trim();let r;this.language==="auto"?r=e.highlightAuto(t).value:r=e.highlight(t,{language:this.language}).value,this.highlightedCode=r}static get styles(){return[ca]}};Rt([u({type:String})],st.prototype,"code",2);Rt([u({type:String})],st.prototype,"language",2);Rt([w()],st.prototype,"highlightedCode",2);st=Rt([C("syntax-highlighter")],st);const z=_`
  :host {
    /*
    BASE STYLES
...
`,ua="data:image/svg+xml,%3c?xml%20version='1.0'%20encoding='UTF-8'?%3e%3csvg%20xmlns='http://www.w3.org/2000/svg'%20xmlns:xlink='http://www.w3.org/1999/xlink'%20width='36pt'%20height='36pt'%20viewBox='0%200%2036%2036'%20version='1.1'%3e%3cg%20id='surface35'%3e%3cpath%20style='%20stroke:none;fill-rule:nonzero;fill:rgb(0%25,0%25,0%25);fill-opacity:1;'%20d='M%2013.5%206.1875%20C%2012.878906%206.1875%2012.375%206.691406%2012.375%207.3125%20C%2012.375%207.933594%2012.878906%208.4375%2013.5%208.4375%20L%2014.0625%208.4375%20L%2014.0625%2013.523438%20C%2014.0625%2014.453125%2013.78125%2015.34375%2013.246094%2016.105469%20L%206.84375%2025.238281%20C%206.140625%2026.238281%206.054688%2027.535156%206.621094%2028.617188%20C%207.183594%2029.703125%208.292969%2030.375%209.515625%2030.375%20L%2026.484375%2030.375%20C%2027.707031%2030.375%2028.816406%2029.703125%2029.378906%2028.617188%20C%2029.941406%2027.535156%2029.859375%2026.238281%2029.15625%2025.238281%20L%2022.753906%2016.105469%20C%2022.21875%2015.34375%2021.9375%2014.453125%2021.9375%2013.523438%20L%2021.9375%208.4375%20L%2022.5%208.4375%20C%2023.121094%208.4375%2023.625%207.933594%2023.625%207.3125%20C%2023.625%206.691406%2023.121094%206.1875%2022.5%206.1875%20Z%20M%2016.3125%208.4375%20L%2019.6875%208.4375%20L%2019.6875%2013.523438%20C%2019.6875%2014.914062%2020.109375%2016.257812%2020.910156%2017.398438%20L%2020.941406%2017.4375%20L%2015.0625%2017.4375%20L%2015.089844%2017.398438%20C%2015.890625%2016.257812%2016.3125%2014.914062%2016.3125%2013.523438%20Z%20M%2015.1875%2020.8125%20C%2015.808594%2020.8125%2016.3125%2021.316406%2016.3125%2021.9375%20C%2016.3125%2022.558594%2015.808594%2023.0625%2015.1875%2023.0625%20C%2014.566406%2023.0625%2014.0625%2022.558594%2014.0625%2021.9375%20C%2014.0625%2021.316406%2014.566406%2020.8125%2015.1875%2020.8125%20Z%20M%2020.53125%2023.0625%20C%2021.617188%2023.0625%2022.5%2023.945312%2022.5%2025.03125%20C%2022.5%2026.117188%2021.617188%2027%2020.53125%2027%20C%2019.445312%2027%2018.5625%2026.117188%2018.5625%2025.03125%20C%2018.5625%2023.945312%2019.445312%2023.0625%2020.53125%2023.0625%20Z%20M%2020.53125%2023.0625%20'/%3e%3c/g%3e%3c/svg%3e";function pi(i){return i.toLowerCase().split(" ").join("-")}var ga=Object.defineProperty,ma=Object.getOwnPropertyDescriptor,Li=(i,e,t,r)=>{for(var o=r>1?void 0:r?ma(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=(r?n(e,t,o):n(o))||o);return r&&o&&ga(e,t,o),o};let Ct=class extends x{render(){return this.styleInputData?d`
    ...
    `:y}resetStyles(){const i=new Map((this.styleInputData?.settings??[]).map(e=>[e.cssVariable,e]));this.styleInputs?.forEach(e=>{const t=i.get(e.dataset.variable??"");if(!t)return;e.value=String(t.defaultValue);const r=this.renderRoot.querySelector(`output[for="${CSS.escape(e.id)}"]`);r&&(r.textContent=`${t.defaultValue}${t.unit??""}`)}),this.dispatchEvent(new CustomEvent("stylesApplied",{detail:{styles:""}}))}renderStyleRow(i){const e=pi(i.label),t=i.inputType==="number"||i.inputType==="range";return d`
      <tr>
        <td>
        ...
        <td class="style-input-cell">
          <input
            ...
            min=${Se(t?i.min:void 0)}
            max=${Se(t?i.max:void 0)}
            step=${Se(t?i.step:void 0)}
          ...
          ${i.inputType==="range"?d`<output class="style-readout" for=${e}
              ...
              >`:y}
          <code class="style-var" title=${i.cssVariable}
            >${i.cssVariable}</code
          >
        </td>
      </tr>
 ...
 `)}}))}static get styles(){return[z,_`
      ...
      `]}};Li([u({type:Object})],Ct.prototype,"styleInputData",2);Li([Di(".style-input")],Ct.prototype,"styleInputs",2);Ct=Li([C("story-styles-settings")],Ct);const ho=(i,e,t)=>{for(const r of e)if(r[0]===i)return(0,r[1])();return t?.()};var fa=Object.defineProperty,va=Object.getOwnPropertyDescriptor,Ri=(i,e,t,r)=>{for(var o=r>1?void 0:r?va(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=(r?n(e,t,o):n(o))||o);return r&&o&&fa(e,t,o),o};let At=class extends x{render(){return this.propInputData?d`
      <div class="settings-options">
        <table>
          ${this.propInputData.settings.map(i=>ho(i.inputType,[["radio",()=>this.createRadioPropInput(i)]],()=>this.createDefaultPropInput(i))??y)}
        </table>
        <button @click=${this.applyProps}>Apply</button>
      </div>
    `:y}createDefaultPropInput(i){const e=pi(i.label);return d`
      <tr>
    ...
    `}createRadioPropInput(i){if(i.inputType!=="radio"||!i.radioOptions)return y;const e=pi(i.label);return d`
      <tr>
  ...
  `),appliedProps:e}}))}static get styles(){return[z,_`
      ...
      `]}};Ri([u({type:Object})],At.prototype,"propInputData",2);Ri([Di(".prop-input")],At.prototype,"propInputs",2);At=Ri([C("story-props-settings")],At);var ba=Object.defineProperty,ya=Object.getOwnPropertyDescriptor,R=(i,e,t,r)=>{for(var o=r>1?void 0:r?ya(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=(r?n(e,t,o):n(o))||o);return r&&o&&ba(e,t,o),o};let L=class extends x{constructor(){super(...arguments),this.elementTag="",this.elementClassName="",this.labs=!1,this.detailsVisible=!1,this.shouldShowPropertySettings=!1,this.shouldShowUsageNotes=!1,this.copiedKey=null}render(){return d`
      <div id="container">
        <h2>
    ...
    `}get detailsTemplate(){return d`
      ...
      <div class="two-col">
        <div class="left-col">
          <h3>Settings</h3>
          ${xe(!!this.propInputData,()=>d`
              <story-props-settings
                .propInputData=${this.propInputData}
                @propsApplied=${this.handlePropsApplied}
              ></story-props-settings>
            `)}
          ${xe(!this.propInputData&&!this.shouldShowPropertySettings,()=>d`<p class="section-placeholder">No settings to adjust</p>`)}
          <div
      ...
      ${xe(this.shouldShowUsageNotes,()=>d` <h3>Usage Notes</h3>`)}
...
`:""}${i}${e}>${r??""}</${this.elementTag}>`}get cssCode(){return this.stringifiedStyles?`${this.elementTag} {
 ${this.stringifiedStyles}
      ...
      `]}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this._copyTimeout)}};R([u({type:String})],L.prototype,"elementTag",2);R([u({type:String})],L.prototype,"elementClassName",2);R([u({type:String})],L.prototype,"customExampleUsage",2);R([u({type:String})],L.prototype,"defaultUsageProps",2);R([u({type:String})],L.prototype,"defaultSlottedContent",2);R([u({type:Object})],L.prototype,"styleInputData",2);R([u({type:Object})],L.prototype,"propInputData",2);R([u({type:Boolean})],L.prototype,"labs",2);R([w()],L.prototype,"detailsVisible",2);R([w()],L.prototype,"stringifiedStyles",2);R([w()],L.prototype,"stringifiedProps",2);R([w()],L.prototype,"shouldShowPropertySettings",2);R([w()],L.prototype,"shouldShowUsageNotes",2);R([w()],L.prototype,"slottedDemoComponent",2);R([w()],L.prototype,"copiedKey",2);L=R([C("story-template")],L);const wa=i=>typeof i!="string"&&"strTag"in i,$a=(i,e,t)=>{let r=i[0];for(let o=1;o<i.length;o++)r+=e[o-1],r+=i[o];return r};const xa=(i=>wa(i)?$a(i.strings,i.values):i);let U=xa;class _a{constructor(){this.settled=!1,this.promise=new Promise((e,t)=>{this._resolve=e,this._reject=t})}resolve(e){this.settled=!0,this._resolve(e)}reject(e){this.settled=!0,this._reject(e)}}for(let i=0;i<256;i++)(i>>4&15).toString(16)+(i&15).toString(16);let Sa=new _a;Sa.resolve();var Ca=Object.defineProperty,Aa=Object.getOwnPropertyDescriptor,Je=(i,e,t,r)=>{for(var o=r>1?void 0:r?Aa(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=(r?n(e,t,o):n(o))||o);return r&&o&&Ca(e,t,o),o};let Ee=class extends x{constructor(){super(...arguments),this.loadingTitle=U("Loading..."),this.successTitle=U("Success"),this.errorTitle=U("Error"),this.loadingStyle="ring-dots",this.mode="loading"}render(){return d`${ho(this.mode,[["ready",()=>this.placeholderTemplate],["loading",()=>this.loadingIndicatorTemplate],["success",()=>this.successIndicatorTemplate],["error",()=>this.errorIndicatorTemplate]])}`}get placeholderTemplate(){return d`<div class="placeholder"></div>`}get loadingIndicatorTemplate(){return d`
      <svg
    ...
    `}get shouldShowLoadingDots(){return this.loadingStyle!=="ring"}static get styles(){return[z,_`
      ...
      `]}};Je([u({type:String})],Ee.prototype,"loadingTitle",2);Je([u({type:String})],Ee.prototype,"successTitle",2);Je([u({type:String})],Ee.prototype,"errorTitle",2);Je([u({type:String})],Ee.prototype,"loadingStyle",2);Je([u({type:String})],Ee.prototype,"mode",2);Ee=Je([C("ia-status-indicator")],Ee);var Oa=Object.defineProperty,Ta=Object.getOwnPropertyDescriptor,ge=(i,e,t,r)=>{for(var o=r>1?void 0:r?Ta(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=(r?n(e,t,o):n(o))||o);return r&&o&&Oa(e,t,o),o};let X=class extends x{constructor(){super(...arguments),this.mode="primary",this.loading=!1,this.disabled=!1,this.loadingText="",this.type="button",this.openLinksNewTab=!1}render(){return d`
      ${this.href?d`<a
            href=${this.href}
    ...
    `}get optionsListTemplate(){return d`
      ...
      >
        ...
        ${xe(this.open,()=>this.optionTemplates)}
        <slot name="options-list-bottom"></slot>
      </ul>
    `}get optionTemplates(){return this.filteredOptions.length===0&&this.maxAutocompleteEntries>0?[this.emptyOptionsTemplate]:this.filteredOptions.map(i=>{const e=i===this.highlightedOption,t=wt({option:!0,highlight:e});return d`
        <li
          id=${i.id}
          class=${t}
    ...
    `;return[z,i]}};T.formAssociated=!0;T.shadowRootOptions={...x.shadowRootOptions,delegatesFocus:!0};M([u({type:Array})],T.prototype,"options",2);M([u({type:String})],T.prototype,"placeholder",2);M([u({type:String})],T.prototype,"behavior",2);M([u({type:Number,attribute:"max-autocomplete-entries"})],T.prototype,"maxAutocompleteEntries",2);M([u({type:String})],T.prototype,"filter",2);M([u({type:Boolean,reflect:!0,attribute:"case-sensitive"})],T.prototype,"caseSensitive",2);M([u({type:Boolean,reflect:!0})],T.prototype,"sort",2);M([u({type:Boolean,reflect:!0,attribute:"wrap-arrow-keys"})],T.prototype,"wrapArrowKeys",2);M([u({type:Boolean,reflect:!0,attribute:"stay-open"})],T.prototype,"stayOpen",2);M([u({type:Boolean,reflect:!0})],T.prototype,"clearable",2);M([u({type:Boolean,reflect:!0})],T.prototype,"open",2);M([u({type:Boolean,reflect:!0})],T.prototype,"disabled",2);M([u({type:Boolean,reflect:!0})],T.prototype,"required",2);M([u({type:String})],T.prototype,"value",2);M([w()],T.prototype,"hasFocus",2);M([w()],T.prototype,"highlightedOption",2);M([w()],T.prototype,"enteredText",2);M([w()],T.prototype,"filterText",2);M([S("#main-widget-row")],T.prototype,"mainWidgetRow",2);M([S("#text-input")],T.prototype,"textInput",2);M([S("#options-list")],T.prototype,"optionsList",2);T=M([C("ia-combo-box")],T);var Ya=Object.defineProperty,Xa=Object.getOwnPropertyDescriptor,E=(i,e,t,r)=>{for(var o=r>1?void 0:r?Xa(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=(r?n(e,t,o):n(o))||o);return r&&o&&Ya(e,t,o),o};const Qa=[{label:"Width",cssVariable:"--ia-theme-combo-box-width",defaultValue:"250px",inputType:"text"},{label:"Padding",cssVariable:"--ia-theme-padding-sm",defaultValue:"5px",inputType:"text"},{label:"Dropdown width",cssVariable:"--combo-box-list-width",defaultValue:"",inputType:"text"},{label:"Dropdown max height",cssVariable:"--combo-box-list-max-height",defaultValue:"250px",inputType:"text"},{label:"Dropdown fade duration",cssVariable:"--combo-box-list-fade-duration",defaultValue:125,inputType:"range",min:0,max:1e3,step:25,unit:"ms"}],go=[{id:"red",text:"Red"},{id:"orange",text:"Orange"},{id:"yellow",text:"Yellow"},{id:"green",text:"Green"},{id:"blue",text:"Blue"},{id:"indigo",text:"Indigo"},{id:"violet",text:"Violet"}],en=go.map(i=>({...i,content:d` <span style="display: flex; align-items: center">
      <span style="flex: 1">${i.text}</span>
      <div style="width: 15px; height: 15px; background:${i.id}"></div>
    </span>`})),cr=po.map(i=>({id:i.name,text:i.name})),tn=po.map(i=>({id:i.name,text:i.name,content:d`<span>${i.flag}</span>&nbsp;<span>${i.name}</span>`})),rn="list",on="Choices",hr="Select an option...",pr=50,an="substring";let O=class extends x{constructor(){super(...arguments),this.options=cr,this.behavior=rn,this.label=on,this.placeholder=hr,this.maxAutocompleteEntries=pr,this.filterFn=an,this.caseSensitive=!1,this.shouldSort=!1,this.wrapArrowKeys=!0,this.clearable=!0,this.disabled=!1,this.announcerText=""}render(){return d`
      <story-template
        elementTag="ia-combo-box"
        elementClassName="IAComboBox"
        .customExampleUsage=${this.exampleUsage}
        .styleInputData=${{settings:Qa}}
      >
        <div slot="demo">
          <ia-combo-box
...
`)}applySettings(i){i.preventDefault(),this.updateOptions(),this.behavior=this.behaviorSelect.value,this.label=this.labelInput.value,this.placeholder=this.placeholderInput.value,this.maxAutocompleteEntries=Number(this.maxAutocompleteInput.value),this.filterFn=this.filterFnSelect.value,this.caseSensitive=this.caseSensitiveCheck.checked,this.shouldSort=this.sortCheck.checked,this.wrapArrowKeys=this.wrapArrowKeysCheck.checked,this.clearable=this.clearableCheck.checked,this.disabled=this.disabledCheck.checked}updateOptions(){switch(this.optionSetSelect.value){case"colors":this.options=this.customContentCheck.checked?en:go;break;case"countries":this.options=this.customContentCheck.checked?tn:cr;break;default:this.options=[]}}handleComboBoxChange(i){this.announcerText=`New value is: ${i.detail}`}static get styles(){return _`
    ...
    `}};E([w()],O.prototype,"options",2);E([w()],O.prototype,"behavior",2);E([w()],O.prototype,"label",2);E([w()],O.prototype,"placeholder",2);E([w()],O.prototype,"maxAutocompleteEntries",2);E([w()],O.prototype,"filterFn",2);E([w()],O.prototype,"caseSensitive",2);E([w()],O.prototype,"shouldSort",2);E([w()],O.prototype,"wrapArrowKeys",2);E([w()],O.prototype,"clearable",2);E([w()],O.prototype,"disabled",2);E([w()],O.prototype,"announcerText",2);E([S("#settings__options")],O.prototype,"optionSetSelect",2);E([S("#settings__custom-content")],O.prototype,"customContentCheck",2);E([S("#settings__behavior")],O.prototype,"behaviorSelect",2);E([S("#settings__label")],O.prototype,"labelInput",2);E([S("#settings__placeholder")],O.prototype,"placeholderInput",2);E([S("#settings__max-entries")],O.prototype,"maxAutocompleteInput",2);E([S("#settings__filter-fn")],O.prototype,"filterFnSelect",2);E([S("#settings__case-sensitive")],O.prototype,"caseSensitiveCheck",2);E([S("#settings__sort")],O.prototype,"sortCheck",2);E([S("#settings__wrap")],O.prototype,"wrapArrowKeysCheck",2);E([S("#settings__clearable")],O.prototype,"clearableCheck",2);E([S("#settings__disabled")],O.prototype,"disabledCheck",2);O=E([C("ia-combo-box-story")],O);const nn=Object.freeze(Object.defineProperty({__proto__:null,get IAComboBoxStory(){return O}},Symbol.toStringTag,{value:"Module"}));function*sn(i,e){if(i!==void 0){let t=0;for(const r of i)yield e(r,t++)}}const ln="data:image/svg+xml,%3csvg%20viewBox='0%200%20100%20100'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20class='fill-color'%20d='m17.0555551%2041.3194459c0-12.7430552%2010.3541664-23.1027772%2023.0847216-23.1027772%2012.7166664%200%2023.0777773%2010.359722%2023.0777773%2023.1027772%200%2012.7361108-10.3611109%2023.0986106-23.0777773%2023.0986106-12.7305552%200-23.0847216-10.3624998-23.0847216-23.0986106zm-17.24305512%200c0%2022.2916661%2018.04583292%2040.3472213%2040.32777672%2040.3472213%208.9208332%200%2017.145833-2.9319449%2023.8194439-7.8527776l24.1513883%2024.0777771c1.2125%201.1402778%202.8430555%201.8430556%204.6374999%201.8430556%203.7444443%200%206.7805554-3.0361111%206.7805554-6.7791665%200-2.0652778-.9222222-3.9069444-2.3736111-5.1499999l-23.718055-23.7458328c4.4152777-6.4791665%207.0152776-14.3055552%207.0152776-22.7402772%200-22.2791661-18.0458328-40.34861006-40.312499-40.34861006-22.2819438%200-40.32777672%2018.06944396-40.32777672%2040.34861006z'%20fill='%232c2c2c'%20fill-rule='evenodd'%20/%3e%3c/svg%3e";function c(i,e,t,r){var o=arguments.length,a=o<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")a=Reflect.decorate(i,e,t,r);else for(var l=i.length-1;l>=0;l--)(n=i[l])&&(a=(o<3?n(a):o>3?n(e,t,a):n(e,t))||a);return o>3&&a&&Object.defineProperty(e,t,a),a}const $t=window,Ni=$t.ShadowRoot&&($t.ShadyCSS===void 0||$t.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Ui=Symbol(),ur=new WeakMap;let mo=class{constructor(e,t,r){if(this._$cssResult$=!0,r!==Ui)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(Ni&&e===void 0){const r=t!==void 0&&t.length===1;r&&(e=ur.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),r&&ur.set(t,e))}return e}toString(){return this.cssText}};const dn=i=>new mo(typeof i=="string"?i:i+"",void 0,Ui),cn=(i,...e)=>{const t=i.length===1?i[0]:e.reduce(((r,o,a)=>r+(n=>{if(n._$cssResult$===!0)return n.cssText;if(typeof n=="number")return n;throw Error("Value passed to 'css' function must be a 'css' function result: "+n+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(o)+i[a+1]),i[0]);return new mo(t,i,Ui)},hn=(i,e)=>{Ni?i.adoptedStyleSheets=e.map((t=>t instanceof CSSStyleSheet?t:t.styleSheet)):e.forEach((t=>{const r=document.createElement("style"),o=$t.litNonce;o!==void 0&&r.setAttribute("nonce",o),r.textContent=t.cssText,i.appendChild(r)}))},gr=Ni?i=>i:i=>i instanceof CSSStyleSheet?(e=>{let t="";for(const r of e.cssRules)t+=r.cssText;return dn(t)})(i):i;var Wt;const Ot=window,mr=Ot.trustedTypes,pn=mr?mr.emptyScript:"",fr=Ot.reactiveElementPolyfillSupport,gi={toAttribute(i,e){switch(e){case Boolean:i=i?pn:null;break;case Object:case Array:i=i==null?i:JSON.stringify(i)}return i},fromAttribute(i,e){let t=i;switch(e){case Boolean:t=i!==null;break;case Number:t=i===null?null:Number(i);break;case Object:case Array:try{t=JSON.parse(i)}catch{t=null}}return t}},fo=(i,e)=>e!==i&&(e==e||i==i),Gt={attribute:!0,type:String,converter:gi,reflect:!1,hasChanged:fo},mi="finalized";let Re=class extends HTMLElement{constructor(){super(),this._$Ei=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$El=null,this._$Eu()}static addInitializer(e){var t;this.finalize(),((t=this.h)!==null&&t!==void 0?t:this.h=[]).push(e)}static get observedAttributes(){this.finalize();const e=[];return this.elementProperties.forEach(((t,r)=>{const o=this._$Ep(r,t);o!==void 0&&(this._$Ev.set(o,r),e.push(o))})),e}static createProperty(e,t=Gt){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){const r=typeof e=="symbol"?Symbol():"__"+e,o=this.getPropertyDescriptor(e,r,t);o!==void 0&&Object.defineProperty(this.prototype,e,o)}}static getPropertyDescriptor(e,t,r){return{get(){return this[t]},set(o){const a=this[e];this[t]=o,this.requestUpdate(e,a,r)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||Gt}static finalize(){if(this.hasOwnProperty(mi))return!1;this[mi]=!0;const e=Object.getPrototypeOf(this);if(e.finalize(),e.h!==void 0&&(this.h=[...e.h]),this.elementProperties=new Map(e.elementProperties),this._$Ev=new Map,this.hasOwnProperty("properties")){const t=this.properties,r=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const o of r)this.createProperty(o,t[o])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const r=new Set(e.flat(1/0).reverse());for(const o of r)t.unshift(gr(o))}else e!==void 0&&t.push(gr(e));return t}static _$Ep(e,t){const r=t.attribute;return r===!1?void 0:typeof r=="string"?r:typeof e=="string"?e.toLowerCase():void 0}_$Eu(){var e;this._$E_=new Promise((t=>this.enableUpdating=t)),this._$AL=new Map,this._$Eg(),this.requestUpdate(),(e=this.constructor.h)===null||e===void 0||e.forEach((t=>t(this)))}addController(e){var t,r;((t=this._$ES)!==null&&t!==void 0?t:this._$ES=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((r=e.hostConnected)===null||r===void 0||r.call(e))}removeController(e){var t;(t=this._$ES)===null||t===void 0||t.splice(this._$ES.indexOf(e)>>>0,1)}_$Eg(){this.constructor.elementProperties.forEach(((e,t)=>{this.hasOwnProperty(t)&&(this._$Ei.set(t,this[t]),delete this[t])}))}createRenderRoot(){var e;const t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return hn(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$ES)===null||e===void 0||e.forEach((t=>{var r;return(r=t.hostConnected)===null||r===void 0?void 0:r.call(t)}))}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$ES)===null||e===void 0||e.forEach((t=>{var r;return(r=t.hostDisconnected)===null||r===void 0?void 0:r.call(t)}))}attributeChangedCallback(e,t,r){this._$AK(e,r)}_$EO(e,t,r=Gt){var o;const a=this.constructor._$Ep(e,r);if(a!==void 0&&r.reflect===!0){const n=(((o=r.converter)===null||o===void 0?void 0:o.toAttribute)!==void 0?r.converter:gi).toAttribute(t,r.type);this._$El=e,n==null?this.removeAttribute(a):this.setAttribute(a,n),this._$El=null}}_$AK(e,t){var r;const o=this.constructor,a=o._$Ev.get(e);if(a!==void 0&&this._$El!==a){const n=o.getPropertyOptions(a),l=typeof n.converter=="function"?{fromAttribute:n.converter}:((r=n.converter)===null||r===void 0?void 0:r.fromAttribute)!==void 0?n.converter:gi;this._$El=a,this[a]=l.fromAttribute(t,n.type),this._$El=null}}requestUpdate(e,t,r){let o=!0;e!==void 0&&(((r=r||this.constructor.getPropertyOptions(e)).hasChanged||fo)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),r.reflect===!0&&this._$El!==e&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(e,r))):o=!1),!this.isUpdatePending&&o&&(this._$E_=this._$Ej())}async _$Ej(){this.isUpdatePending=!0;try{await this._$E_}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Ei&&(this._$Ei.forEach(((o,a)=>this[a]=o)),this._$Ei=void 0);let t=!1;const r=this._$AL;try{t=this.shouldUpdate(r),t?(this.willUpdate(r),(e=this._$ES)===null||e===void 0||e.forEach((o=>{var a;return(a=o.hostUpdate)===null||a===void 0?void 0:a.call(o)})),this.update(r)):this._$Ek()}catch(o){throw t=!1,this._$Ek(),o}t&&this._$AE(r)}willUpdate(e){}_$AE(e){var t;(t=this._$ES)===null||t===void 0||t.forEach((r=>{var o;return(o=r.hostUpdated)===null||o===void 0?void 0:o.call(r)})),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$Ek(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$E_}shouldUpdate(e){return!0}update(e){this._$EC!==void 0&&(this._$EC.forEach(((t,r)=>this._$EO(r,this[r],t))),this._$EC=void 0),this._$Ek()}updated(e){}firstUpdated(e){}};Re[mi]=!0,Re.elementProperties=new Map,Re.elementStyles=[],Re.shadowRootOptions={mode:"open"},fr?.({ReactiveElement:Re}),((Wt=Ot.reactiveElementVersions)!==null&&Wt!==void 0?Wt:Ot.reactiveElementVersions=[]).push("1.6.3");var Zt;const Tt=window,Fe=Tt.trustedTypes,vr=Fe?Fe.createPolicy("lit-html",{createHTML:i=>i}):void 0,fi="$lit$",ce=`lit$${(Math.random()+"").slice(9)}$`,vo="?"+ce,un=`<${vo}>`,ke=document,lt=()=>ke.createComment(""),dt=i=>i===null||typeof i!="object"&&typeof i!="function",bo=Array.isArray,gn=i=>bo(i)||typeof i?.[Symbol.iterator]=="function",Jt=`[ 	
\f\r]`,it=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,br=/-->/g,yr=/>/g,be=RegExp(`>|${Jt}(?:([^\\s"'>=/]+)(${Jt}*=${Jt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),wr=/'/g,$r=/"/g,yo=/^(?:script|style|textarea|title)$/i,mn=i=>(e,...t)=>({_$litType$:i,strings:e,values:t}),fn=mn(1),qe=Symbol.for("lit-noChange"),P=Symbol.for("lit-nothing"),xr=new WeakMap,Ce=ke.createTreeWalker(ke,129,null,!1);function wo(i,e){if(!Array.isArray(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return vr!==void 0?vr.createHTML(e):e}const vn=(i,e)=>{const t=i.length-1,r=[];let o,a=e===2?"<svg>":"",n=it;for(let l=0;l<t;l++){const s=i[l];let p,g,h=-1,v=0;for(;v<s.length&&(n.lastIndex=v,g=n.exec(s),g!==null);)v=n.lastIndex,n===it?g[1]==="!--"?n=br:g[1]!==void 0?n=yr:g[2]!==void 0?(yo.test(g[2])&&(o=RegExp("</"+g[2],"g")),n=be):g[3]!==void 0&&(n=be):n===be?g[0]===">"?(n=o??it,h=-1):g[1]===void 0?h=-2:(h=n.lastIndex-g[2].length,p=g[1],n=g[3]===void 0?be:g[3]==='"'?$r:wr):n===$r||n===wr?n=be:n===br||n===yr?n=it:(n=be,o=void 0);const b=n===be&&i[l+1].startsWith("/>")?" ":"";a+=n===it?s+un:h>=0?(r.push(p),s.slice(0,h)+fi+s.slice(h)+ce+b):s+ce+(h===-2?(r.push(void 0),l):b)}return[wo(i,a+(i[t]||"<?>")+(e===2?"</svg>":"")),r]};let vi=class $o{constructor({strings:e,_$litType$:t},r){let o;this.parts=[];let a=0,n=0;const l=e.length-1,s=this.parts,[p,g]=vn(e,t);if(this.el=$o.createElement(p,r),Ce.currentNode=this.el.content,t===2){const h=this.el.content,v=h.firstChild;v.remove(),h.append(...v.childNodes)}for(;(o=Ce.nextNode())!==null&&s.length<l;){if(o.nodeType===1){if(o.hasAttributes()){const h=[];for(const v of o.getAttributeNames())if(v.endsWith(fi)||v.startsWith(ce)){const b=g[n++];if(h.push(v),b!==void 0){const A=o.getAttribute(b.toLowerCase()+fi).split(ce),k=/([.?@])?(.*)/.exec(b);s.push({type:1,index:a,name:k[2],strings:A,ctor:k[1]==="."?yn:k[1]==="?"?$n:k[1]==="@"?xn:Nt})}else s.push({type:6,index:a})}for(const v of h)o.removeAttribute(v)}if(yo.test(o.tagName)){const h=o.textContent.split(ce),v=h.length-1;if(v>0){o.textContent=Fe?Fe.emptyScript:"";for(let b=0;b<v;b++)o.append(h[b],lt()),Ce.nextNode(),s.push({type:2,index:++a});o.append(h[v],lt())}}}else if(o.nodeType===8)if(o.data===vo)s.push({type:2,index:a});else{let h=-1;for(;(h=o.data.indexOf(ce,h+1))!==-1;)s.push({type:7,index:a}),h+=ce.length-1}a++}}static createElement(e,t){const r=ke.createElement("template");return r.innerHTML=e,r}};function Ke(i,e,t=i,r){var o,a,n,l;if(e===qe)return e;let s=r!==void 0?(o=t._$Co)===null||o===void 0?void 0:o[r]:t._$Cl;const p=dt(e)?void 0:e._$litDirective$;return s?.constructor!==p&&((a=s?._$AO)===null||a===void 0||a.call(s,!1),p===void 0?s=void 0:(s=new p(i),s._$AT(i,t,r)),r!==void 0?((n=(l=t)._$Co)!==null&&n!==void 0?n:l._$Co=[])[r]=s:t._$Cl=s),s!==void 0&&(e=Ke(i,s._$AS(i,e.values),s,r)),e}let bn=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;const{el:{content:r},parts:o}=this._$AD,a=((t=e?.creationScope)!==null&&t!==void 0?t:ke).importNode(r,!0);Ce.currentNode=a;let n=Ce.nextNode(),l=0,s=0,p=o[0];for(;p!==void 0;){if(l===p.index){let g;p.type===2?g=new ji(n,n.nextSibling,this,e):p.type===1?g=new p.ctor(n,p.name,p.strings,this,e):p.type===6&&(g=new _n(n,this,e)),this._$AV.push(g),p=o[++s]}l!==p?.index&&(n=Ce.nextNode(),l++)}return Ce.currentNode=ke,a}v(e){let t=0;for(const r of this._$AV)r!==void 0&&(r.strings!==void 0?(r._$AI(e,r,t),t+=r.strings.length-2):r._$AI(e[t])),t++}},ji=class xo{constructor(e,t,r,o){var a;this.type=2,this._$AH=P,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=r,this.options=o,this._$Cp=(a=o?.isConnected)===null||a===void 0||a}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Ke(this,e,t),dt(e)?e===P||e==null||e===""?(this._$AH!==P&&this._$AR(),this._$AH=P):e!==this._$AH&&e!==qe&&this._(e):e._$litType$!==void 0?this.g(e):e.nodeType!==void 0?this.$(e):gn(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==P&&dt(this._$AH)?this._$AA.nextSibling.data=e:this.$(ke.createTextNode(e)),this._$AH=e}g(e){var t;const{values:r,_$litType$:o}=e,a=typeof o=="number"?this._$AC(e):(o.el===void 0&&(o.el=vi.createElement(wo(o.h,o.h[0]),this.options)),o);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===a)this._$AH.v(r);else{const n=new bn(a,this),l=n.u(this.options);n.v(r),this.$(l),this._$AH=n}}_$AC(e){let t=xr.get(e.strings);return t===void 0&&xr.set(e.strings,t=new vi(e)),t}T(e){bo(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let r,o=0;for(const a of e)o===t.length?t.push(r=new xo(this.k(lt()),this.k(lt()),this,this.options)):r=t[o],r._$AI(a),o++;o<t.length&&(this._$AR(r&&r._$AB.nextSibling,o),t.length=o)}_$AR(e=this._$AA.nextSibling,t){var r;for((r=this._$AP)===null||r===void 0||r.call(this,!1,!0,t);e&&e!==this._$AB;){const o=e.nextSibling;e.remove(),e=o}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}},Nt=class{constructor(e,t,r,o,a){this.type=1,this._$AH=P,this._$AN=void 0,this.element=e,this.name=t,this._$AM=o,this.options=a,r.length>2||r[0]!==""||r[1]!==""?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=P}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,r,o){const a=this.strings;let n=!1;if(a===void 0)e=Ke(this,e,t,0),n=!dt(e)||e!==this._$AH&&e!==qe,n&&(this._$AH=e);else{const l=e;let s,p;for(e=a[0],s=0;s<a.length-1;s++)p=Ke(this,l[r+s],t,s),p===qe&&(p=this._$AH[s]),n||(n=!dt(p)||p!==this._$AH[s]),p===P?e=P:e!==P&&(e+=(p??"")+a[s+1]),this._$AH[s]=p}n&&!o&&this.j(e)}j(e){e===P?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},yn=class extends Nt{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===P?void 0:e}};const wn=Fe?Fe.emptyScript:"";let $n=class extends Nt{constructor(){super(...arguments),this.type=4}j(e){e&&e!==P?this.element.setAttribute(this.name,wn):this.element.removeAttribute(this.name)}},xn=class extends Nt{constructor(e,t,r,o,a){super(e,t,r,o,a),this.type=5}_$AI(e,t=this){var r;if((e=(r=Ke(this,e,t,0))!==null&&r!==void 0?r:P)===qe)return;const o=this._$AH,a=e===P&&o!==P||e.capture!==o.capture||e.once!==o.once||e.passive!==o.passive,n=e!==P&&(o===P||a);a&&this.element.removeEventListener(this.name,this,o),n&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,r;typeof this._$AH=="function"?this._$AH.call((r=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&r!==void 0?r:this.element,e):this._$AH.handleEvent(e)}},_n=class{constructor(e,t,r){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(e){Ke(this,e)}};const _r=Tt.litHtmlPolyfillSupport;_r?.(vi,ji),((Zt=Tt.litHtmlVersions)!==null&&Zt!==void 0?Zt:Tt.litHtmlVersions=[]).push("2.8.0");const Sn=(i,e,t)=>{var r,o;const a=(r=t?.renderBefore)!==null&&r!==void 0?r:e;let n=a._$litPart$;if(n===void 0){const l=(o=t?.renderBefore)!==null&&o!==void 0?o:null;a._$litPart$=n=new ji(e.insertBefore(lt(),l),l,void 0,t??{})}return n._$AI(i),n};var Yt,Xt;let Ue=class extends Re{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const r=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=r.firstChild),r}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Sn(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return qe}};Ue.finalized=!0,Ue._$litElement$=!0,(Yt=globalThis.litElementHydrateSupport)===null||Yt===void 0||Yt.call(globalThis,{LitElement:Ue});const Sr=globalThis.litElementPolyfillSupport;Sr?.({LitElement:Ue});((Xt=globalThis.litElementVersions)!==null&&Xt!==void 0?Xt:globalThis.litElementVersions=[]).push("3.3.3");const Cn=i=>e=>typeof e=="function"?((t,r)=>(customElements.define(t,r),r))(i,e):((t,r)=>{const{kind:o,elements:a}=r;return{kind:o,elements:a,finisher(n){customElements.define(t,n)}}})(i,e);const An=(i,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?{...e,finisher(t){t.createProperty(e.key,i)}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,i)}},On=(i,e,t)=>{e.constructor.createProperty(t,i)};function Be(i){return(e,t)=>t!==void 0?On(i,e,t):An(i,e)}const Tn=({finisher:i,descriptor:e})=>(t,r)=>{var o;if(r===void 0){const a=(o=t.originalKey)!==null&&o!==void 0?o:t.key,n=e!=null?{kind:"method",placement:"prototype",key:a,descriptor:e(t.key)}:{...t,key:a};return i!=null&&(n.finisher=function(l){i(l,a)}),n}{const a=t.constructor;e!==void 0&&Object.defineProperty(t,r,e(r)),i?.(a,r)}};function En(i,e){return Tn({descriptor:t=>({get(){var o,a;return(a=(o=this.renderRoot)===null||o===void 0?void 0:o.querySelector(i))!==null&&a!==void 0?a:null},enumerable:!0,configurable:!0})})}var Qt;((Qt=window.HTMLSlotElement)===null||Qt===void 0?void 0:Qt.prototype.assignedElements)!=null;const kn=d`
<svg
  viewBox="0 0 40 40"
  version="1.1"
  xmlns="http://www.w3.org/2000/svg"
...
`;class Pn extends x{static get styles(){return _`
      :host {
    ...
    `}render(){return kn}}customElements.define("ia-icon-close",Pn);let W=class extends Ue{constructor(){super(...arguments),this.value="",this.clearButtonScreenReaderLabel="Clear",this.focusOnClear=!0,this.forceClearButton=!1}render(){var e,t,r,o;const a=!this.value&&!this.forceClearButton;return fn`
      <div id="container">
        <slot name="icon"></slot>
  ...
  `;c([Be({type:String})],W.prototype,"value",void 0);c([Be({type:String})],W.prototype,"placeholder",void 0);c([Be({type:String})],W.prototype,"screenReaderLabel",void 0);c([Be({type:String})],W.prototype,"clearButtonScreenReaderLabel",void 0);c([Be({type:String})],W.prototype,"ariaControls",void 0);c([Be({type:Boolean})],W.prototype,"focusOnClear",void 0);c([Be({type:Boolean,reflect:!0})],W.prototype,"forceClearButton",void 0);c([En("#text-input")],W.prototype,"textInput",void 0);W=c([Cn("ia-clearable-text-input")],W);const xt=window,Hi=xt.ShadowRoot&&(xt.ShadyCSS===void 0||xt.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Fi=Symbol(),Cr=new WeakMap;let _o=class{constructor(e,t,r){if(this._$cssResult$=!0,r!==Fi)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(Hi&&e===void 0){const r=t!==void 0&&t.length===1;r&&(e=Cr.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),r&&Cr.set(t,e))}return e}toString(){return this.cssText}};const Mn=i=>new _o(typeof i=="string"?i:i+"",void 0,Fi),q=(i,...e)=>{const t=i.length===1?i[0]:e.reduce(((r,o,a)=>r+(n=>{if(n._$cssResult$===!0)return n.cssText;if(typeof n=="number")return n;throw Error("Value passed to 'css' function must be a 'css' function result: "+n+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(o)+i[a+1]),i[0]);return new _o(t,i,Fi)},In=(i,e)=>{Hi?i.adoptedStyleSheets=e.map((t=>t instanceof CSSStyleSheet?t:t.styleSheet)):e.forEach((t=>{const r=document.createElement("style"),o=xt.litNonce;o!==void 0&&r.setAttribute("nonce",o),r.textContent=t.cssText,i.appendChild(r)}))},Ar=Hi?i=>i:i=>i instanceof CSSStyleSheet?(e=>{let t="";for(const r of e.cssRules)t+=r.cssText;return Mn(t)})(i):i;var ei;const Et=window,Or=Et.trustedTypes,Bn=Or?Or.emptyScript:"",Tr=Et.reactiveElementPolyfillSupport,bi={toAttribute(i,e){switch(e){case Boolean:i=i?Bn:null;break;case Object:case Array:i=i==null?i:JSON.stringify(i)}return i},fromAttribute(i,e){let t=i;switch(e){case Boolean:t=i!==null;break;case Number:t=i===null?null:Number(i);break;case Object:case Array:try{t=JSON.parse(i)}catch{t=null}}return t}},So=(i,e)=>e!==i&&(e==e||i==i),ti={attribute:!0,type:String,converter:bi,reflect:!1,hasChanged:So},yi="finalized";let Ne=class extends HTMLElement{constructor(){super(),this._$Ei=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$El=null,this._$Eu()}static addInitializer(e){var t;this.finalize(),((t=this.h)!==null&&t!==void 0?t:this.h=[]).push(e)}static get observedAttributes(){this.finalize();const e=[];return this.elementProperties.forEach(((t,r)=>{const o=this._$Ep(r,t);o!==void 0&&(this._$Ev.set(o,r),e.push(o))})),e}static createProperty(e,t=ti){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){const r=typeof e=="symbol"?Symbol():"__"+e,o=this.getPropertyDescriptor(e,r,t);o!==void 0&&Object.defineProperty(this.prototype,e,o)}}static getPropertyDescriptor(e,t,r){return{get(){return this[t]},set(o){const a=this[e];this[t]=o,this.requestUpdate(e,a,r)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||ti}static finalize(){if(this.hasOwnProperty(yi))return!1;this[yi]=!0;const e=Object.getPrototypeOf(this);if(e.finalize(),e.h!==void 0&&(this.h=[...e.h]),this.elementProperties=new Map(e.elementProperties),this._$Ev=new Map,this.hasOwnProperty("properties")){const t=this.properties,r=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const o of r)this.createProperty(o,t[o])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const r=new Set(e.flat(1/0).reverse());for(const o of r)t.unshift(Ar(o))}else e!==void 0&&t.push(Ar(e));return t}static _$Ep(e,t){const r=t.attribute;return r===!1?void 0:typeof r=="string"?r:typeof e=="string"?e.toLowerCase():void 0}_$Eu(){var e;this._$E_=new Promise((t=>this.enableUpdating=t)),this._$AL=new Map,this._$Eg(),this.requestUpdate(),(e=this.constructor.h)===null||e===void 0||e.forEach((t=>t(this)))}addController(e){var t,r;((t=this._$ES)!==null&&t!==void 0?t:this._$ES=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((r=e.hostConnected)===null||r===void 0||r.call(e))}removeController(e){var t;(t=this._$ES)===null||t===void 0||t.splice(this._$ES.indexOf(e)>>>0,1)}_$Eg(){this.constructor.elementProperties.forEach(((e,t)=>{this.hasOwnProperty(t)&&(this._$Ei.set(t,this[t]),delete this[t])}))}createRenderRoot(){var e;const t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return In(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$ES)===null||e===void 0||e.forEach((t=>{var r;return(r=t.hostConnected)===null||r===void 0?void 0:r.call(t)}))}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$ES)===null||e===void 0||e.forEach((t=>{var r;return(r=t.hostDisconnected)===null||r===void 0?void 0:r.call(t)}))}attributeChangedCallback(e,t,r){this._$AK(e,r)}_$EO(e,t,r=ti){var o;const a=this.constructor._$Ep(e,r);if(a!==void 0&&r.reflect===!0){const n=(((o=r.converter)===null||o===void 0?void 0:o.toAttribute)!==void 0?r.converter:bi).toAttribute(t,r.type);this._$El=e,n==null?this.removeAttribute(a):this.setAttribute(a,n),this._$El=null}}_$AK(e,t){var r;const o=this.constructor,a=o._$Ev.get(e);if(a!==void 0&&this._$El!==a){const n=o.getPropertyOptions(a),l=typeof n.converter=="function"?{fromAttribute:n.converter}:((r=n.converter)===null||r===void 0?void 0:r.fromAttribute)!==void 0?n.converter:bi;this._$El=a,this[a]=l.fromAttribute(t,n.type),this._$El=null}}requestUpdate(e,t,r){let o=!0;e!==void 0&&(((r=r||this.constructor.getPropertyOptions(e)).hasChanged||So)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),r.reflect===!0&&this._$El!==e&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(e,r))):o=!1),!this.isUpdatePending&&o&&(this._$E_=this._$Ej())}async _$Ej(){this.isUpdatePending=!0;try{await this._$E_}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Ei&&(this._$Ei.forEach(((o,a)=>this[a]=o)),this._$Ei=void 0);let t=!1;const r=this._$AL;try{t=this.shouldUpdate(r),t?(this.willUpdate(r),(e=this._$ES)===null||e===void 0||e.forEach((o=>{var a;return(a=o.hostUpdate)===null||a===void 0?void 0:a.call(o)})),this.update(r)):this._$Ek()}catch(o){throw t=!1,this._$Ek(),o}t&&this._$AE(r)}willUpdate(e){}_$AE(e){var t;(t=this._$ES)===null||t===void 0||t.forEach((r=>{var o;return(o=r.hostUpdated)===null||o===void 0?void 0:o.call(r)})),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$Ek(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$E_}shouldUpdate(e){return!0}update(e){this._$EC!==void 0&&(this._$EC.forEach(((t,r)=>this._$EO(r,this[r],t))),this._$EC=void 0),this._$Ek()}updated(e){}firstUpdated(e){}};Ne[yi]=!0,Ne.elementProperties=new Map,Ne.elementStyles=[],Ne.shadowRootOptions={mode:"open"},Tr?.({ReactiveElement:Ne}),((ei=Et.reactiveElementVersions)!==null&&ei!==void 0?ei:Et.reactiveElementVersions=[]).push("1.6.3");var ii;const kt=window,We=kt.trustedTypes,Er=We?We.createPolicy("lit-html",{createHTML:i=>i}):void 0,wi="$lit$",he=`lit$${(Math.random()+"").slice(9)}$`,Co="?"+he,Vn=`<${Co}>`,Pe=document,ct=()=>Pe.createComment(""),ht=i=>i===null||typeof i!="object"&&typeof i!="function",Ao=Array.isArray,zn=i=>Ao(i)||typeof i?.[Symbol.iterator]=="function",ri=`[ 	
\f\r]`,rt=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,kr=/-->/g,Pr=/>/g,ye=RegExp(`>|${ri}(?:([^\\s"'>=/]+)(${ri}*=${ri}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Mr=/'/g,Ir=/"/g,Oo=/^(?:script|style|textarea|title)$/i,To=i=>(e,...t)=>({_$litType$:i,strings:e,values:t}),N=To(1),Eo=To(2),Ge=Symbol.for("lit-noChange"),V=Symbol.for("lit-nothing"),Br=new WeakMap,Ae=Pe.createTreeWalker(Pe,129,null,!1);function ko(i,e){if(!Array.isArray(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return Er!==void 0?Er.createHTML(e):e}const Dn=(i,e)=>{const t=i.length-1,r=[];let o,a=e===2?"<svg>":"",n=rt;for(let l=0;l<t;l++){const s=i[l];let p,g,h=-1,v=0;for(;v<s.length&&(n.lastIndex=v,g=n.exec(s),g!==null);)v=n.lastIndex,n===rt?g[1]==="!--"?n=kr:g[1]!==void 0?n=Pr:g[2]!==void 0?(Oo.test(g[2])&&(o=RegExp("</"+g[2],"g")),n=ye):g[3]!==void 0&&(n=ye):n===ye?g[0]===">"?(n=o??rt,h=-1):g[1]===void 0?h=-2:(h=n.lastIndex-g[2].length,p=g[1],n=g[3]===void 0?ye:g[3]==='"'?Ir:Mr):n===Ir||n===Mr?n=ye:n===kr||n===Pr?n=rt:(n=ye,o=void 0);const b=n===ye&&i[l+1].startsWith("/>")?" ":"";a+=n===rt?s+Vn:h>=0?(r.push(p),s.slice(0,h)+wi+s.slice(h)+he+b):s+he+(h===-2?(r.push(void 0),l):b)}return[ko(i,a+(i[t]||"<?>")+(e===2?"</svg>":"")),r]};class pt{constructor({strings:e,_$litType$:t},r){let o;this.parts=[];let a=0,n=0;const l=e.length-1,s=this.parts,[p,g]=Dn(e,t);if(this.el=pt.createElement(p,r),Ae.currentNode=this.el.content,t===2){const h=this.el.content,v=h.firstChild;v.remove(),h.append(...v.childNodes)}for(;(o=Ae.nextNode())!==null&&s.length<l;){if(o.nodeType===1){if(o.hasAttributes()){const h=[];for(const v of o.getAttributeNames())if(v.endsWith(wi)||v.startsWith(he)){const b=g[n++];if(h.push(v),b!==void 0){const A=o.getAttribute(b.toLowerCase()+wi).split(he),k=/([.?@])?(.*)/.exec(b);s.push({type:1,index:a,name:k[2],strings:A,ctor:k[1]==="."?Rn:k[1]==="?"?Un:k[1]==="@"?jn:Ut})}else s.push({type:6,index:a})}for(const v of h)o.removeAttribute(v)}if(Oo.test(o.tagName)){const h=o.textContent.split(he),v=h.length-1;if(v>0){o.textContent=We?We.emptyScript:"";for(let b=0;b<v;b++)o.append(h[b],ct()),Ae.nextNode(),s.push({type:2,index:++a});o.append(h[v],ct())}}}else if(o.nodeType===8)if(o.data===Co)s.push({type:2,index:a});else{let h=-1;for(;(h=o.data.indexOf(he,h+1))!==-1;)s.push({type:7,index:a}),h+=he.length-1}a++}}static createElement(e,t){const r=Pe.createElement("template");return r.innerHTML=e,r}}function Ze(i,e,t=i,r){var o,a,n,l;if(e===Ge)return e;let s=r!==void 0?(o=t._$Co)===null||o===void 0?void 0:o[r]:t._$Cl;const p=ht(e)?void 0:e._$litDirective$;return s?.constructor!==p&&((a=s?._$AO)===null||a===void 0||a.call(s,!1),p===void 0?s=void 0:(s=new p(i),s._$AT(i,t,r)),r!==void 0?((n=(l=t)._$Co)!==null&&n!==void 0?n:l._$Co=[])[r]=s:t._$Cl=s),s!==void 0&&(e=Ze(i,s._$AS(i,e.values),s,r)),e}class Ln{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;const{el:{content:r},parts:o}=this._$AD,a=((t=e?.creationScope)!==null&&t!==void 0?t:Pe).importNode(r,!0);Ae.currentNode=a;let n=Ae.nextNode(),l=0,s=0,p=o[0];for(;p!==void 0;){if(l===p.index){let g;p.type===2?g=new vt(n,n.nextSibling,this,e):p.type===1?g=new p.ctor(n,p.name,p.strings,this,e):p.type===6&&(g=new Hn(n,this,e)),this._$AV.push(g),p=o[++s]}l!==p?.index&&(n=Ae.nextNode(),l++)}return Ae.currentNode=Pe,a}v(e){let t=0;for(const r of this._$AV)r!==void 0&&(r.strings!==void 0?(r._$AI(e,r,t),t+=r.strings.length-2):r._$AI(e[t])),t++}}class vt{constructor(e,t,r,o){var a;this.type=2,this._$AH=V,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=r,this.options=o,this._$Cp=(a=o?.isConnected)===null||a===void 0||a}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Ze(this,e,t),ht(e)?e===V||e==null||e===""?(this._$AH!==V&&this._$AR(),this._$AH=V):e!==this._$AH&&e!==Ge&&this._(e):e._$litType$!==void 0?this.g(e):e.nodeType!==void 0?this.$(e):zn(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==V&&ht(this._$AH)?this._$AA.nextSibling.data=e:this.$(Pe.createTextNode(e)),this._$AH=e}g(e){var t;const{values:r,_$litType$:o}=e,a=typeof o=="number"?this._$AC(e):(o.el===void 0&&(o.el=pt.createElement(ko(o.h,o.h[0]),this.options)),o);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===a)this._$AH.v(r);else{const n=new Ln(a,this),l=n.u(this.options);n.v(r),this.$(l),this._$AH=n}}_$AC(e){let t=Br.get(e.strings);return t===void 0&&Br.set(e.strings,t=new pt(e)),t}T(e){Ao(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let r,o=0;for(const a of e)o===t.length?t.push(r=new vt(this.k(ct()),this.k(ct()),this,this.options)):r=t[o],r._$AI(a),o++;o<t.length&&(this._$AR(r&&r._$AB.nextSibling,o),t.length=o)}_$AR(e=this._$AA.nextSibling,t){var r;for((r=this._$AP)===null||r===void 0||r.call(this,!1,!0,t);e&&e!==this._$AB;){const o=e.nextSibling;e.remove(),e=o}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class Ut{constructor(e,t,r,o,a){this.type=1,this._$AH=V,this._$AN=void 0,this.element=e,this.name=t,this._$AM=o,this.options=a,r.length>2||r[0]!==""||r[1]!==""?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=V}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,r,o){const a=this.strings;let n=!1;if(a===void 0)e=Ze(this,e,t,0),n=!ht(e)||e!==this._$AH&&e!==Ge,n&&(this._$AH=e);else{const l=e;let s,p;for(e=a[0],s=0;s<a.length-1;s++)p=Ze(this,l[r+s],t,s),p===Ge&&(p=this._$AH[s]),n||(n=!ht(p)||p!==this._$AH[s]),p===V?e=V:e!==V&&(e+=(p??"")+a[s+1]),this._$AH[s]=p}n&&!o&&this.j(e)}j(e){e===V?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class Rn extends Ut{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===V?void 0:e}}const Nn=We?We.emptyScript:"";class Un extends Ut{constructor(){super(...arguments),this.type=4}j(e){e&&e!==V?this.element.setAttribute(this.name,Nn):this.element.removeAttribute(this.name)}}class jn extends Ut{constructor(e,t,r,o,a){super(e,t,r,o,a),this.type=5}_$AI(e,t=this){var r;if((e=(r=Ze(this,e,t,0))!==null&&r!==void 0?r:V)===Ge)return;const o=this._$AH,a=e===V&&o!==V||e.capture!==o.capture||e.once!==o.once||e.passive!==o.passive,n=e!==V&&(o===V||a);a&&this.element.removeEventListener(this.name,this,o),n&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,r;typeof this._$AH=="function"?this._$AH.call((r=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&r!==void 0?r:this.element,e):this._$AH.handleEvent(e)}}class Hn{constructor(e,t,r){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(e){Ze(this,e)}}const Vr=kt.litHtmlPolyfillSupport;Vr?.(pt,vt),((ii=kt.litHtmlVersions)!==null&&ii!==void 0?ii:kt.litHtmlVersions=[]).push("2.8.0");const Fn=(i,e,t)=>{var r,o;const a=(r=t?.renderBefore)!==null&&r!==void 0?r:e;let n=a._$litPart$;if(n===void 0){const l=(o=t?.renderBefore)!==null&&o!==void 0?o:null;a._$litPart$=n=new vt(e.insertBefore(ct(),l),l,void 0,t??{})}return n._$AI(i),n};var oi,ai;class je extends Ne{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const r=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=r.firstChild),r}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Fn(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return Ge}}je.finalized=!0,je._$litElement$=!0,(oi=globalThis.litElementHydrateSupport)===null||oi===void 0||oi.call(globalThis,{LitElement:je});const zr=globalThis.litElementPolyfillSupport;zr?.({LitElement:je});((ai=globalThis.litElementVersions)!==null&&ai!==void 0?ai:globalThis.litElementVersions=[]).push("3.3.3");const Po=i=>e=>typeof e=="function"?((t,r)=>(customElements.define(t,r),r))(i,e):((t,r)=>{const{kind:o,elements:a}=r;return{kind:o,elements:a,finisher(n){customElements.define(t,n)}}})(i,e);const qn=(i,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?{...e,finisher(t){t.createProperty(e.key,i)}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,i)}},Kn=(i,e,t)=>{e.constructor.createProperty(t,i)};function j(i){return(e,t)=>t!==void 0?Kn(i,e,t):qn(i,e)}const Mo=({finisher:i,descriptor:e})=>(t,r)=>{var o;if(r===void 0){const a=(o=t.originalKey)!==null&&o!==void 0?o:t.key,n=e!=null?{kind:"method",placement:"prototype",key:a,descriptor:e(t.key)}:{...t,key:a};return i!=null&&(n.finisher=function(l){i(l,a)}),n}{const a=t.constructor;e!==void 0&&Object.defineProperty(t,r,e(r)),i?.(a,r)}};function qi(i,e){return Mo({descriptor:t=>({get(){var o,a;return(a=(o=this.renderRoot)===null||o===void 0?void 0:o.querySelector(i))!==null&&a!==void 0?a:null},enumerable:!0,configurable:!0})})}var ni;const Wn=((ni=window.HTMLSlotElement)===null||ni===void 0?void 0:ni.prototype.assignedElements)!=null?(i,e)=>i.assignedElements(e):(i,e)=>i.assignedNodes(e).filter((t=>t.nodeType===Node.ELEMENT_NODE));function Gn(i){const{slot:e,selector:t}=i??{};return Mo({descriptor:r=>({get(){var o;const a="slot"+(e?`[name=${e}]`:":not([name])"),n=(o=this.renderRoot)===null||o===void 0?void 0:o.querySelector(a),l=n!=null?Wn(n,i):[];return t?l.filter((s=>s.matches(t))):l},enumerable:!0,configurable:!0})})}function De(i,e,t){return i?e():t?.()}const Zn=Eo`<svg class="caret-up-svg" viewBox="0 0 8 4" xmlns="http://www.w3.org/2000/svg">
<path d="m6.7226499 3.51689722c.22976435.15317623.54019902.0910893.69337525-.13867505.13615665-.20423497.10222882-.47220946-.06836249-.63681849l-.07031256-.05655675-3.2773501-2.18490007-3.2773501 2.18490007c-.22976434.15317623-.29185128.4636109-.13867505.69337524.13615665.20423498.39656688.27598409.61412572.18182636l.07924953-.04315131 2.7226499-1.81402514z"
  fill=""></path>
</svg>`,Jn=Eo`<svg class="caret-down-svg" viewBox="0 0 8 4" xmlns="http://www.w3.org/2000/svg">
<path d="m6.7226499.58397485c.22976435-.15317623.54019902-.09108929.69337525.13867505.13615665.20423498.10222882.47220947-.06836249.63681849l-.07031256.05655676-3.2773501 2.18490006-3.2773501-2.18490006c-.22976434-.15317623-.29185128-.4636109-.13867505-.69337525.13615665-.20423497.39656688-.27598409.61412572-.18182636l.07924953.04315131 2.7226499 1.81402515z"
fill=""></path>
</svg>`;let I=class extends je{constructor(){super(...arguments),this.open=!1,this.isDisabled=!1,this.displayCaret=!1,this.closeOnSelect=!1,this.openViaButton=!0,this.usePopover=!1,this.includeSelectedOption=!1,this.selectedOption="",this.options=[],this.optionGroup="options",this.optionSelected=()=>{},this.isCustomList=!1,this.hasCustomClickHandler=!1,this.closeOnEscape=!1,this.closeOnBackdropClick=!1,this.boundKeyboardListener=e=>{switch(e.key){case"Escape":case"Esc":this.closeOptions();break}},this.closeOptions=e=>{e&&e.type==="click"&&e.stopPropagation(),this.open=!1,this.updatePopoverState()}}async firstUpdated(){await new Promise(e=>{setTimeout(e,0)}),this.addEventListener("closeDropdown",this.closeOptions)}willUpdate(e){e.has("open")&&this.updatePopoverState()}disconnectedCallback(){var e;(e=super.disconnectedCallback)===null||e===void 0||e.call(this),this.removeKeyboardListener()}setupKeyboardListener(){this.closeOnEscape&&document.addEventListener("keydown",this.boundKeyboardListener)}removeKeyboardListener(){this.closeOnEscape&&document.removeEventListener("keydown",this.boundKeyboardListener)}get dropdownState(){return this.open?(this.setupKeyboardListener(),"open"):(this.removeKeyboardListener(),"closed")}toggleOptions(){this.open=!this.open,this.updatePopoverState()}updatePopoverState(){var e,t;this.usePopover&&((t=(e=this.dropdownMenu)===null||e===void 0?void 0:e.togglePopover)===null||t===void 0||t.call(e,this.open),this.open&&this.positionDropdownMenu())}positionDropdownMenu(){if(!this.dropdownMenu)return;const e=this.container.getBoundingClientRect();this.dropdownMenu.style.left=`${e.left}px`,this.dropdownMenu.style.top=`${e.bottom}px`,this.dropdownMenu.style.minWidth=`${e.width}px`}mainButtonClicked(){var e;this.openViaButton?this.toggleOptions():(e=this.mainButtonLabelSlotted[0])===null||e===void 0||e.click()}mainButtonKeyDown(e){(e.key==="Enter"||e.key===" ")&&(this.mainButtonClicked(),e.preventDefault())}caretKeyDown(e){(e.key==="Enter"||e.key===" ")&&(this.toggleOptions(),e.preventDefault())}renderOption(e){const{label:t,url:r=void 0,id:o}=e;let a;const n=this.selectedOption===o?"selected":"";return r?a=N`<a
        href=${r}
      ...
      <span ?hidden=${!this.open} class="caret-up">
        <slot name="caret-up">${Zn}</slot>
      </span>
    `}get caretDownTemplate(){return N`
      <span ?hidden=${this.open} class="caret-down">
        <slot name="caret-down">${Jn}</slot>
      </span>
    `}get caretTemplate(){return this.displayCaret?this.openViaButton?N`
      ...
      <button
        ...
        aria-haspopup="true"
        aria-expanded=${this.open}
        @click=${De(this.shouldAttachEventHandlers,()=>this.toggleOptions)}
        @keydown=${De(this.shouldAttachEventHandlers,()=>this.caretKeyDown)}
      ...
      <div class="ia-dropdown-group ${this.open?"open":""}">
        <div class="button-row">
          <button
            ...
            aria-expanded=${this.open}
            @click=${De(this.shouldAttachEventHandlers,()=>this.mainButtonClicked)}
            @keydown=${De(this.shouldAttachEventHandlers,()=>this.mainButtonKeyDown)}
            ?disabled=${this.isDisabled}
          >
            ...
            ${De(this.shouldNestCaretInButton,()=>this.caretTemplate)}
          </button>
          ${De(!this.shouldNestCaretInButton,()=>this.caretTemplate)}
        </div>
  ...
  `;$i=c([Po("ia-icon-label")],$i);var Yn=Object.defineProperty,Xn=Object.getOwnPropertyDescriptor,te=(i,e,t,r)=>{for(var o=r>1?void 0:r?Xn(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=(r?n(e,t,o):n(o))||o);return r&&o&&Yn(e,t,o),o};const Dr={CategoryChanged:"categoryChanged",SearchRequested:"searchRequested"};let J=class extends x{constructor(){super(...arguments),this.categories=[],this.placeholder=U("Search"),this.useMobileView=!1,this.hideDropdown=!1,this.loading=!1}get resolvedCategory(){return this.selectedCategory??this.categories?.[0]?.id??""}render(){return d`
    ...
    `}get searchButtonTemplate(){return d`
      ...
      >
        ${this.loading?d`<ia-status-indicator
            ...
            ></ia-status-indicator>`:d`<img src=${ln} alt="" />`}
      </button>
    `}get selectedCategoryLabel(){return this.categories.find(e=>e.id===this.resolvedCategory)?.label??this.resolvedCategory}get spacedQuery(){return this.query?.replace(/\+/g," ")??""}searchFieldCleared(){this.query&&this.emitSearchRequested()}handleSubmit(){this.emitSearchRequested()}handleCategorySelected(i){const e=i.detail.option.id;e!==this.resolvedCategory&&(this.selectedCategory=e,setTimeout(()=>this.searchInput.focus()),this.dispatchEvent(new CustomEvent(Dr.CategoryChanged,{detail:e})))}emitSearchRequested(){this.dispatchEvent(new CustomEvent(Dr.SearchRequested,{detail:{query:this.searchInput.value,category:this.resolvedCategory}}))}static get styles(){const i=_`
      :host {
    ...
    `;return[z,i]}};te([u({type:String})],J.prototype,"query",2);te([u({type:Array})],J.prototype,"categories",2);te([u({type:String})],J.prototype,"selectedCategory",2);te([u({type:String})],J.prototype,"placeholder",2);te([u({type:Boolean})],J.prototype,"useMobileView",2);te([u({type:Boolean})],J.prototype,"hideDropdown",2);te([u({type:Boolean})],J.prototype,"loading",2);te([S("#search-input")],J.prototype,"searchInput",2);te([S("#category-dropdown")],J.prototype,"categoryDropdown",2);J=te([C("ia-dropdown-search-bar")],J);var Qn=Object.defineProperty,es=Object.getOwnPropertyDescriptor,Z=(i,e,t,r)=>{for(var o=r>1?void 0:r?es(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=(r?n(e,t,o):n(o))||o);return r&&o&&Qn(e,t,o),o};const ts=[{label:"Bar height",cssVariable:"--ia-theme-search-bar-height",defaultValue:"30px",inputType:"text"},{label:"Bar width",cssVariable:"--ia-theme-search-bar-width",defaultValue:"300px",inputType:"text"},{label:"Internal padding",cssVariable:"--ia-theme-padding-sm",defaultValue:"5px",inputType:"text"},{label:"Dropdown z-index",cssVariable:"--dropdown-z-index",defaultValue:2,inputType:"number",min:0,step:1}],Lr=[{id:"all",label:"All"},{id:"texts",label:"Books/Documents"},{id:"fulltext",label:"Text Contents"},{id:"radio",label:"Radio"},{id:"tv",label:"TV"},{id:"movies",label:"Video"},{id:"audio",label:"Audio"},{id:"software",label:"Software"},{id:"image",label:"Images"},{id:"etree",label:"Live Music"},{id:"collection",label:"Collections"},{id:"data",label:"Data"},{id:"web",label:"Web Sites"}],is="all",Rr="Search";let H=class extends x{constructor(){super(...arguments),this.query="",this.selectedCategory=is,this.placeholder=Rr,this.hideDropdown=!1,this.loading=!1,this.announcerText=""}render(){return d`
      <story-template
...
`)}applySettings(i){i.preventDefault(),this.query=this.queryInput.value,this.selectedCategory=this.selectedCategorySelect.value,this.placeholder=this.placeholderInput.value,this.hideDropdown=this.hideDropdownCheck.checked,this.loading=this.loadingCheck.checked}handleSearchRequested(i){this.announcerText=`Category ID "${i.detail.category}" / Query "${i.detail.query}"`}static get styles(){return _`
    ...
    `}};Z([w()],H.prototype,"query",2);Z([w()],H.prototype,"selectedCategory",2);Z([w()],H.prototype,"placeholder",2);Z([w()],H.prototype,"hideDropdown",2);Z([w()],H.prototype,"loading",2);Z([w()],H.prototype,"announcerText",2);Z([S("#settings__query")],H.prototype,"queryInput",2);Z([S("#settings__selected-category")],H.prototype,"selectedCategorySelect",2);Z([S("#settings__placeholder")],H.prototype,"placeholderInput",2);Z([S("#settings__hide-dropdown")],H.prototype,"hideDropdownCheck",2);Z([S("#settings__loading")],H.prototype,"loadingCheck",2);H=Z([C("ia-dropdown-search-bar-story")],H);const rs=Object.freeze(Object.defineProperty({__proto__:null,get IADropdownSearchBarStory(){return H}},Symbol.toStringTag,{value:"Module"}));function m(i){let e,t,r;return e=i,(o,a,n)=>{if(n.value!=null)n.value=Nr(n.value,e,t,r);else if(n.get!=null)n.get=Nr(n.get,e,t,r);else throw"Only put a Memoize() decorator on a method or get accessor."}}const si=new Map;function Nr(i,e,t=0,r){const o=Symbol("__memoized_map__");return function(...a){let n;this.hasOwnProperty(o)||Object.defineProperty(this,o,{configurable:!1,enumerable:!1,writable:!1,value:new Map});let l=this[o];if(Array.isArray(r))for(const s of r)si.has(s)?si.get(s).push(l):si.set(s,[l]);if(e||a.length>0||t>0){let s;e===!0?s=a.map(h=>h.toString()).join("!"):e?s=e.apply(this,a):s=a[0];const p=`${s}__timestamp`;let g=!1;if(t>0)if(!l.has(p))g=!0;else{let h=l.get(p);g=Date.now()-h>t}l.has(s)&&!g?n=l.get(s):(n=i.apply(this,a),l.set(s,n),t>0&&l.set(p,Date.now()))}else{const s=this;l.has(s)?n=l.get(s):(n=i.apply(this,a),l.set(s,n))}return n}}class xi{parseValue(e){if(typeof e=="string"){const t=e.trim().toLowerCase();if(t==="false"||t==="0"||t==="no")return!1;if(t==="true"||t==="1"||t==="yes")return!0}return!!e}}xi.shared=new xi;class ne{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=parseFloat(e);if(!Number.isNaN(t))return t}}ne.shared=new ne;class Pt{parseValue(e){return ne.shared.parseValue(e)}}Pt.shared=new Pt;class ut{parseValue(e){return this.parseJSDate(e)||this.parseBracketDate(e)}parseBracketDate(e){if(typeof e!="string")return;const t=e.match(/\[([0-9]{4})\]/);if(!(!t||t.length<2))return this.parseJSDate(t[1])}parseJSDate(e){if(typeof e!="string")return;let t=e;t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}\s{1}[0-9]{2}:[0-9]{2}:[0-9]{2}$/)&&(t=t.replace(" ","T"));const r=Date.parse(t);if(Number.isNaN(r))return;let o=new Date(t);return(t.match(/^[0-9]{4}$/)||t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/))&&(o=new Date(o.getTime()+o.getTimezoneOffset()*1e3*60)),o}}ut.shared=new ut;class Mt{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=e.split(":");let r;return t.length===1?r=this.parseNumberFormat(t[0]):r=this.parseColonSeparatedFormat(t),r}parseNumberFormat(e){let t=parseFloat(e);return Number.isNaN(t)&&(t=void 0),t}parseColonSeparatedFormat(e){let t=!1;const r=e.map((o,a)=>{const n=parseFloat(o);if(Number.isNaN(n))return t=!0,0;const s=60**(e.length-1-a);return n*Math.floor(s)}).reduce((o,a)=>o+a,0);return t?void 0:r}}Mt.shared=new Mt;class os{constructor(e,t){this.separators=[";",","],this.parser=e,t&&t.separators&&(this.separators=t.separators)}parseValue(e){const t=String(e);let r=[];for(const o of this.separators)if(r=t.split(o),r.length>1)break;return this.parseListValues(r)}parseListValues(e){const r=e.map(a=>a.trim()).map(a=>this.parser.parseValue(a)),o=[];return r.forEach(a=>{a!==void 0&&o.push(a)}),o}}class It{parseValue(e){return String(e)}}It.shared=new It;class Ve{get name(){return this.rawValue.name}get source(){return this.rawValue.source}get btih(){return this.rawValue.btih}get md5(){return this.rawValue.md5}get format(){return this.rawValue.format}get mtime(){if(this.rawValue.mtime==null)return;const e=ne.shared.parseValue(this.rawValue.mtime);if(e)return new Date(e*1e3)}get crc32(){return this.rawValue.crc32}get sha1(){return this.rawValue.sha1}get original(){return this.rawValue.original}get size(){return this.rawValue.size!=null?Pt.shared.parseValue(this.rawValue.size):void 0}get title(){return this.rawValue.title}get length(){return this.rawValue.length!=null?Mt.shared.parseValue(this.rawValue.length):void 0}get height(){return this.rawValue.height!=null?ne.shared.parseValue(this.rawValue.height):void 0}get width(){return this.rawValue.width!=null?ne.shared.parseValue(this.rawValue.width):void 0}get track(){return this.rawValue.track!=null?ne.shared.parseValue(this.rawValue.track):void 0}get external_identifier(){return this.rawValue.external_identifier}get creator(){return this.rawValue.creator}get album(){return this.rawValue.album}constructor(e={}){this.rawValue=e}}c([m()],Ve.prototype,"mtime",null);c([m()],Ve.prototype,"size",null);c([m()],Ve.prototype,"length",null);c([m()],Ve.prototype,"height",null);c([m()],Ve.prototype,"width",null);c([m()],Ve.prototype,"track",null);class ie{get values(){return this.parseRawValue()}get value(){return this.values[0]}constructor(e,t){this.parser=e,this.rawValue=t}parseRawValue(){const e=Array.isArray(this.rawValue)?this.rawValue:[this.rawValue],t=[];return e.forEach(r=>{const o=this.parser.parseValue(r);Array.isArray(o)?t.push(...o):o!==void 0&&t.push(o)}),t}}c([m()],ie.prototype,"values",null);c([m()],ie.prototype,"value",null);class Ur extends ie{constructor(e){super(xi.shared,e)}}class le extends ie{constructor(e){super(ut.shared,e)}}class li extends ie{constructor(e){super(Mt.shared,e)}}class F extends ie{constructor(e){super(ne.shared,e)}}class $ extends ie{constructor(e){super(It.shared,e)}}class Ki{constructor(e){this.allowed=e}parseValue(e){return typeof e=="string"&&this.allowed.includes(e)?e:void 0}}class Wi extends ie{constructor(e,t){super(t,e)}}const as=new Ki(["rl","lr"]);class ns extends Wi{constructor(e){super(e,as)}}class jr extends ie{constructor(e){super(Pt.shared,e)}}const ss=new Ki(["account","audio","collection","data","etree","image","movies","search","software","texts","web"]);class ls extends Wi{constructor(e){super(e,ss)}}class ds extends ie{constructor(e,t){super(t,e)}}class cs extends ds{constructor(e){const t=new os(It.shared);super(e,t)}}const hs=new Ki(["true","none","frozen"]);class f{get identifier(){return this.rawMetadata.identifier}get addeddate(){return this.rawMetadata.addeddate!=null?new le(this.rawMetadata.addeddate):void 0}get audio_codec(){return this.rawMetadata.audio_codec!=null?new $(this.rawMetadata.audio_codec):void 0}get audio_sample_rate(){return this.rawMetadata.audio_sample_rate!=null?new F(this.rawMetadata.audio_sample_rate):void 0}get avg_rating(){return this.rawMetadata.avg_rating!=null?new F(this.rawMetadata.avg_rating):void 0}get collection(){return this.rawMetadata.collection!=null?new $(this.rawMetadata.collection):void 0}get collections_raw(){return this.rawMetadata.collections_raw!=null?new $(this.rawMetadata.collections_raw):void 0}get collection_size(){return this.rawMetadata.collection_size!=null?new jr(this.rawMetadata.collection_size):void 0}get contact(){return this.rawMetadata.contact!=null?new $(this.rawMetadata.contact):void 0}get contributor(){return this.rawMetadata.contributor!=null?new $(this.rawMetadata.contributor):void 0}get coverage(){return this.rawMetadata.coverage!=null?new $(this.rawMetadata.coverage):void 0}get creator(){return this.rawMetadata.creator!=null?new $(this.rawMetadata.creator):void 0}get creator_alt_script(){return this.rawMetadata["creator-alt-script"]!=null?new $(this.rawMetadata["creator-alt-script"]):void 0}get credits(){return this.rawMetadata.credits!=null?new $(this.rawMetadata.credits):void 0}get collection_layout(){return this.rawMetadata.collection_layout!=null?new $(this.rawMetadata.collection_layout):void 0}get date(){return this.rawMetadata.date!=null?new le(this.rawMetadata.date):void 0}get description(){return this.rawMetadata.description!=null?new $(this.rawMetadata.description):void 0}get downloads(){return this.rawMetadata.downloads!=null?new F(this.rawMetadata.downloads):void 0}get duration(){return this.rawMetadata.duration!=null?new li(this.rawMetadata.duration):void 0}get external_identifier(){return this.rawMetadata["external-identifier"]!=null?new $(this.rawMetadata["external-identifier"]):void 0}get external_link(){return this.rawMetadata["external-link"]!=null?new $(this.rawMetadata["external-link"]):void 0}get files_count(){return this.rawMetadata.files_count!=null?new F(this.rawMetadata.files_count):void 0}get indexdate(){return this.rawMetadata.indexdate!=null?new le(this.rawMetadata.indexdate):void 0}get isbn(){return this.rawMetadata.isbn!=null?new $(this.rawMetadata.isbn):void 0}get issue(){return this.rawMetadata.issue!=null?new $(this.rawMetadata.issue):void 0}get item_count(){return this.rawMetadata.item_count!=null?new F(this.rawMetadata.item_count):void 0}get item_size(){return this.rawMetadata.item_size!=null?new jr(this.rawMetadata.item_size):void 0}get language(){return this.rawMetadata.language!=null?new $(this.rawMetadata.language):void 0}get length(){return this.rawMetadata.length!=null?new li(this.rawMetadata.length):void 0}get licenseurl(){return this.rawMetadata.licenseurl!=null?new $(this.rawMetadata.licenseurl):void 0}get lineage(){return this.rawMetadata.lineage!=null?new $(this.rawMetadata.lineage):void 0}get month(){return this.rawMetadata.month!=null?new F(this.rawMetadata.month):void 0}get mediatype(){return this.rawMetadata.mediatype!=null?new ls(this.rawMetadata.mediatype):void 0}get noindex(){return this.rawMetadata.noindex!=null?new Ur(this.rawMetadata.noindex):void 0}get notes(){return this.rawMetadata.notes!=null?new $(this.rawMetadata.notes):void 0}get num_favorites(){return this.rawMetadata.num_favorites!=null?new F(this.rawMetadata.num_favorites):void 0}get num_reviews(){return this.rawMetadata.num_reviews!=null?new F(this.rawMetadata.num_reviews):void 0}get openlibrary_edition(){return this.rawMetadata.openlibrary_edition!=null?new $(this.rawMetadata.openlibrary_edition):void 0}get openlibrary_work(){return this.rawMetadata.openlibrary_work!=null?new $(this.rawMetadata.openlibrary_work):void 0}get page_progression(){return this.rawMetadata.page_progression!=null?new ns(this.rawMetadata.page_progression):void 0}get paginated(){return this.rawMetadata.paginated!=null?new Ur(this.rawMetadata.paginated):void 0}get partner(){return this.rawMetadata.partner!=null?new $(this.rawMetadata.partner):void 0}get post_text(){return this.rawMetadata.post_text!=null?new $(this.rawMetadata.post_text):void 0}get ppi(){return this.rawMetadata.ppi!=null?new F(this.rawMetadata.ppi):void 0}get publicdate(){return this.rawMetadata.publicdate!=null?new le(this.rawMetadata.publicdate):void 0}get publisher(){return this.rawMetadata.publisher!=null?new $(this.rawMetadata.publisher):void 0}get reviewdate(){return this.rawMetadata.reviewdate!=null?new le(this.rawMetadata.reviewdate):void 0}get reviews_allowed(){return this.rawMetadata["reviews-allowed"]!=null?new Wi(this.rawMetadata["reviews-allowed"],hs):void 0}get rights(){return this.rawMetadata.rights!=null?new $(this.rawMetadata.rights):void 0}get rights_holder(){var e;const t=(e=this.rawMetadata["rights-holder"])!==null&&e!==void 0?e:this.rawMetadata.rights_holder;return t!=null?new $(t):void 0}get runtime(){return this.rawMetadata.runtime!=null?new li(this.rawMetadata.runtime):void 0}get scanner(){return this.rawMetadata.scanner!=null?new $(this.rawMetadata.scanner):void 0}get segments(){return this.rawMetadata.segments!=null?new $(this.rawMetadata.segments):void 0}get shotlist(){return this.rawMetadata.shotlist!=null?new $(this.rawMetadata.shotlist):void 0}get source(){return this.rawMetadata.source!=null?new $(this.rawMetadata.source):void 0}get sponsor(){return this.rawMetadata.sponsor!=null?new $(this.rawMetadata.sponsor):void 0}get start_localtime(){return this.rawMetadata.start_localtime!=null?new le(this.rawMetadata.start_localtime):void 0}get start_time(){return this.rawMetadata.start_time!=null?new le(this.rawMetadata.start_time):void 0}get stop_time(){return this.rawMetadata.stop_time!=null?new le(this.rawMetadata.stop_time):void 0}get subject(){return this.rawMetadata.subject!=null?new cs(this.rawMetadata.subject):void 0}get taper(){return this.rawMetadata.taper!=null?new $(this.rawMetadata.taper):void 0}get title(){return this.rawMetadata.title!=null?new $(this.rawMetadata.title):void 0}get title_alt_script(){return this.rawMetadata["title-alt-script"]!=null?new $(this.rawMetadata["title-alt-script"]):void 0}get transferer(){return this.rawMetadata.transferer!=null?new $(this.rawMetadata.transferer):void 0}get track(){return this.rawMetadata.track!=null?new F(this.rawMetadata.track):void 0}get type(){return this.rawMetadata.type!=null?new $(this.rawMetadata.type):void 0}get uploader(){return this.rawMetadata.uploader!=null?new $(this.rawMetadata.uploader):void 0}get utc_offset(){return this.rawMetadata.utc_offset!=null?new F(this.rawMetadata.utc_offset):void 0}get venue(){return this.rawMetadata.venue!=null?new $(this.rawMetadata.venue):void 0}get volume(){return this.rawMetadata.volume!=null?new $(this.rawMetadata.volume):void 0}get week(){return this.rawMetadata.week!=null?new F(this.rawMetadata.week):void 0}get year(){return this.rawMetadata.year!=null?new F(this.rawMetadata.year):void 0}constructor(e={}){this.rawMetadata=e}}c([m()],f.prototype,"addeddate",null);c([m()],f.prototype,"audio_codec",null);c([m()],f.prototype,"audio_sample_rate",null);c([m()],f.prototype,"avg_rating",null);c([m()],f.prototype,"collection",null);c([m()],f.prototype,"collections_raw",null);c([m()],f.prototype,"collection_size",null);c([m()],f.prototype,"contact",null);c([m()],f.prototype,"contributor",null);c([m()],f.prototype,"coverage",null);c([m()],f.prototype,"creator",null);c([m()],f.prototype,"creator_alt_script",null);c([m()],f.prototype,"credits",null);c([m()],f.prototype,"collection_layout",null);c([m()],f.prototype,"date",null);c([m()],f.prototype,"description",null);c([m()],f.prototype,"downloads",null);c([m()],f.prototype,"duration",null);c([m()],f.prototype,"external_identifier",null);c([m()],f.prototype,"external_link",null);c([m()],f.prototype,"files_count",null);c([m()],f.prototype,"indexdate",null);c([m()],f.prototype,"isbn",null);c([m()],f.prototype,"issue",null);c([m()],f.prototype,"item_count",null);c([m()],f.prototype,"item_size",null);c([m()],f.prototype,"language",null);c([m()],f.prototype,"length",null);c([m()],f.prototype,"licenseurl",null);c([m()],f.prototype,"lineage",null);c([m()],f.prototype,"month",null);c([m()],f.prototype,"mediatype",null);c([m()],f.prototype,"noindex",null);c([m()],f.prototype,"notes",null);c([m()],f.prototype,"num_favorites",null);c([m()],f.prototype,"num_reviews",null);c([m()],f.prototype,"openlibrary_edition",null);c([m()],f.prototype,"openlibrary_work",null);c([m()],f.prototype,"page_progression",null);c([m()],f.prototype,"paginated",null);c([m()],f.prototype,"partner",null);c([m()],f.prototype,"post_text",null);c([m()],f.prototype,"ppi",null);c([m()],f.prototype,"publicdate",null);c([m()],f.prototype,"publisher",null);c([m()],f.prototype,"reviewdate",null);c([m()],f.prototype,"reviews_allowed",null);c([m()],f.prototype,"rights",null);c([m()],f.prototype,"rights_holder",null);c([m()],f.prototype,"runtime",null);c([m()],f.prototype,"scanner",null);c([m()],f.prototype,"segments",null);c([m()],f.prototype,"shotlist",null);c([m()],f.prototype,"source",null);c([m()],f.prototype,"sponsor",null);c([m()],f.prototype,"start_localtime",null);c([m()],f.prototype,"start_time",null);c([m()],f.prototype,"stop_time",null);c([m()],f.prototype,"subject",null);c([m()],f.prototype,"taper",null);c([m()],f.prototype,"title",null);c([m()],f.prototype,"title_alt_script",null);c([m()],f.prototype,"transferer",null);c([m()],f.prototype,"track",null);c([m()],f.prototype,"type",null);c([m()],f.prototype,"uploader",null);c([m()],f.prototype,"utc_offset",null);c([m()],f.prototype,"venue",null);c([m()],f.prototype,"volume",null);c([m()],f.prototype,"week",null);c([m()],f.prototype,"year",null);class jt{get reviewbody(){return this.rawValue.reviewbody}get reviewtitle(){return this.rawValue.reviewtitle}get reviewer(){return this.rawValue.reviewer}get reviewer_itemname(){return this.rawValue.reviewer_itemname}get reviewdate(){return this.rawValue.reviewdate!=null?ut.shared.parseValue(this.rawValue.reviewdate):void 0}get createdate(){return this.rawValue.createdate!=null?ut.shared.parseValue(this.rawValue.createdate):void 0}get stars(){return this.rawValue.stars!=null?ne.shared.parseValue(this.rawValue.stars):void 0}constructor(e={}){this.rawValue=e}}c([m()],jt.prototype,"reviewdate",null);c([m()],jt.prototype,"createdate",null);c([m()],jt.prototype,"stars",null);class Io{constructor(e){var t,r;this.rawResponse=e,this.created=e.created,this.d1=e.d1,this.d2=e.d2,this.dir=e.dir,this.files=(t=e.files)===null||t===void 0?void 0:t.map(o=>new Ve(o)),this.files_count=e.files_count,this.item_last_updated=e.item_last_updated,this.item_size=e.item_size,this.metadata=new f(e.metadata),this.server=e.server,this.uniq=e.uniq,this.workable_servers=e.workable_servers,this.speech_vs_music_asr=e.speech_vs_music_asr,this.reviews=(r=e.reviews)===null||r===void 0?void 0:r.map(o=>new jt(o))}}var Oe;(function(i){i.networkError="MetadataService.NetworkError",i.itemNotFound="MetadataService.ItemNotFound",i.decodingError="MetadataService.DecodingError",i.searchEngineError="MetadataService.SearchEngineError"})(Oe||(Oe={}));class _i extends Error{constructor(e,t,r){super(t),this.name=e,this.type=e,this.details=r}}class ps{constructor(e){var t;if(this.baseUrl=(t=e?.baseUrl)!==null&&t!==void 0?t:"archive.org",e?.includeCredentials!==void 0?this.includeCredentials=e.includeCredentials:this.includeCredentials=window.location.href.match(/^https?:\/\/.*archive\.org(:[0-9]+)?/)!==null,e?.scope!==void 0)this.requestScope=e.scope;else{const o=new URL(window.location.href).searchParams.get("scope");o&&(this.requestScope=o)}}async fetchMetadata(e,t){const r=t?`/${t}`:"",o=`https://${this.baseUrl}/metadata/${e}${r}`;return this.fetchUrl(o)}async fetchUrl(e,t){var r;const o=new URL(e);this.requestScope&&o.searchParams.set("scope",this.requestScope);let a;try{const n=(r=t?.requestOptions)!==null&&r!==void 0?r:{credentials:this.includeCredentials?"include":"same-origin"};a=await fetch(o.href,n)}catch(n){const l=n instanceof Error?n.message:typeof n=="string"?n:"Unknown error";return this.getErrorResult(Oe.networkError,l)}try{const n=await a.json(),l=n.error;if(l){const s=n.forensics;return this.getErrorResult(Oe.searchEngineError,l,s)}else return{success:n}}catch(n){const l=n instanceof Error?n.message:typeof n=="string"?n:"Unknown error";return this.getErrorResult(Oe.decodingError,l)}}getErrorResult(e,t,r){return{error:new _i(e,t,r)}}}class Hr{constructor(e){this.backend=e}async fetchMetadata(e){var t;const r=await this.backend.fetchMetadata(e);return r.error?r:((t=r.success)===null||t===void 0?void 0:t.metadata)===void 0?{error:new _i(Oe.itemNotFound)}:{success:new Io(r.success)}}async fetchMetadataValue(e,t){var r;const o=await this.backend.fetchMetadata(e,t);return o.error?o:((r=o.success)===null||r===void 0?void 0:r.result)===void 0?{error:new _i(Oe.itemNotFound)}:{success:o.success.result}}}Hr.default=new Hr(new ps);const us=d`
  <svg
    class="ia-icon"
    viewBox="0 0 40 40"
    xmlns="http://www.w3.org/2000/svg"
...
`;var gs=Object.defineProperty,ms=Object.getOwnPropertyDescriptor,me=(i,e,t,r)=>{for(var o=r>1?void 0:r?ms(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=(r?n(e,t,o):n(o))||o);return r&&o&&gs(e,t,o),o};let Q=class extends x{constructor(){super(...arguments),this.icon="",this.href="",this.label="",this.menuDetails="",this.buttonId="",this.selected=!1,this.followable=!1}onClick(i){i.preventDefault(),this.dispatchMenuTypeSelectedEvent()}dispatchMenuTypeSelectedEvent(){this.dispatchEvent(new CustomEvent("menuTypeSelected",{bubbles:!0,composed:!0,detail:{id:this.buttonId}}))}get iconClass(){return this.selected?"active":""}get menuItem(){return d`
    ...
    `}render(){return this.href?this.linkButton:this.clickButton}static get styles(){return[z,_`
      ...
      `)}get renderMenuHeader(){const{label:i="",menuDetails:e=""}=this.selectedMenuDetails||{},t=this.selectedMenuAction!==y,r=t?"with-secondary-action":"",o=t?d`<span class="custom-action">${this.selectedMenuAction}</span>`:y;return d`
      <header class=${r}>
        <div class="details">
          <h3>${i}</h3>
    ...
    `}static get styles(){const i=_`42px`,e=_`var(--item-navigator-menu-width--)`,t=_`var(--item-navigator-animation-timing--)`;return[z,_`
      ...
      `]}};se([u({type:Array})],ee.prototype,"menus",2);se([u({type:Boolean})],ee.prototype,"open",2);se([u({type:Boolean})],ee.prototype,"manuallyHandleClose",2);se([u({type:String})],ee.prototype,"selectedMenu",2);se([u({type:Object})],ee.prototype,"selectedMenuAction",2);se([u({type:Boolean})],ee.prototype,"animateMenuOpen",2);se([S(".content.open button.close")],ee.prototype,"contentCloseButton",2);se([S(".menu-list")],ee.prototype,"menuList",2);ee=se([C("ia-menu-slider")],ee);var bs=Object.defineProperty,ys=Object.getOwnPropertyDescriptor,Bo=(i,e,t,r)=>{for(var o=r>1?void 0:r?ys(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=(r?n(e,t,o):n(o))||o);return r&&o&&bs(e,t,o),o};let Si=class extends x{constructor(){super(...arguments),this.loaderMessage=""}get bookIconSvg(){return ar`
    ...
    `}get icon(){return this.bookIconSvg}get loader(){return ar`
    <svg
      height="100"
      viewBox="0 0 100 100"
      width="100"
    ...
    `}static get styles(){return[z,_`
      ...
      `]}};Bo([u({type:String})],Si.prototype,"loaderMessage",2);Si=Bo([C("ia-itemnav-loader")],Si);var ws=Object.defineProperty,$s=Object.getOwnPropertyDescriptor,Vo=(i,e,t,r)=>{for(var o=r>1?void 0:r?$s(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=(r?n(e,t,o):n(o))||o);return r&&o&&ws(e,t,o),o};let Ci=class extends x{constructor(){super(...arguments),this.identifier=""}emitLoaded(){this.dispatchEvent(new CustomEvent("loadingStateUpdated",{detail:{loaded:!0}}))}updated(i){i.has("identifier")&&this.emitLoaded()}get downloadUrl(){return`/download/${this.identifier}`}render(){return d`
      <section>
    ...
    `}get selectedMenuId(){return this.openMenu||""}get renderSideMenu(){return d`
      <nav>
        <div
          class="minimized ${wt({hidden:this.menuOpened})}"
          part="minimized-menu"
        >
    ...
    `}openShortcut(i=""){this.openMenu=i,this.menuOpened=!0}get shortcuts(){const i=this.menuShortcuts.map(({icon:e,id:t,label:r})=>t==="fullscreen"?d`${e}`:d`
      ...
      `);return d`<div class="shortcuts">${i}</div>`}get menuClass(){const i=this.menuContents?.length||this.menuShortcuts?.length,e=this.menuOpened&&i?"open":"",t=this.viewportInFullscreen?"fullscreen":"",r=this.shouldRenderMenu?"has-menu":"";return`${e} ${t} ${r} ${this.openMenuState}`}static get styles(){const i=_`var(--item-navigator-menu-width--)`,e=_`var(--item-navigator-animation-timing--)`,t=_`transform ${e} ease-out`,r=_`var(--item-navigator-menu-margin--)`,o=_`var(--item-navigator-theater-bg-color--)`,a=_`var(--item-navigator-icon-width--)`,n=_`var(--item-navigator-icon-height--)`;return[z,_`
        :host {
          --item-navigator-menu-width--: var(
            --item-navigator-menu-width,
            320px
      ...
      `]}};D([u({type:Object,converter:i=>i&&typeof i=="string"?new Io(JSON.parse(atob(i))):i})],B.prototype,"item",2);D([u({type:Boolean,reflect:!0})],B.prototype,"viewAvailable",2);D([u({type:String})],B.prototype,"baseHost",2);D([u({type:Boolean})],B.prototype,"signedIn",2);D([u({type:Array})],B.prototype,"menuContents",2);D([u({type:Array})],B.prototype,"menuShortcuts",2);D([u({type:Boolean,reflect:!0,attribute:!0})],B.prototype,"viewportInFullscreen",2);D([u({type:Boolean,reflect:!0})],B.prototype,"menuOpened",2);D([u({type:String,reflect:!0})],B.prototype,"openMenu",2);D([u({attribute:!1})],B.prototype,"modal",2);D([u({attribute:!1})],B.prototype,"sharedObserver",2);D([u({type:Boolean,reflect:!0,attribute:!0})],B.prototype,"loaded",2);D([w()],B.prototype,"openMenuState",2);D([S("#frame")],B.prototype,"frame",2);D([S('slot[name="header"]')],B.prototype,"headerSlot",2);D([S("ia-menu-slider")],B.prototype,"menuSlider",2);D([S("button.toggle-menu")],B.prototype,"toggleMenuButton",2);B=D([C("ia-item-navigator")],B);const Kr=(i,e,t)=>{const r=new Map;for(let o=e;o<=t;o++)r.set(i[o],o);return r},Ss=mt(class extends ft{constructor(i){if(super(i),i.type!==ae.CHILD)throw Error("repeat() can only be used in text expressions")}dt(i,e,t){let r;t===void 0?t=e:e!==void 0&&(r=e);const o=[],a=[];let n=0;for(const l of i)o[n]=r?r(l,n):n,a[n]=t(l,n),n++;return{values:a,keys:o}}render(i,e,t){return this.dt(i,e,t).values}update(i,[e,t,r]){const o=Da(i),{values:a,keys:n}=this.dt(e,t,r);if(!Array.isArray(o))return this.ut=n,a;const l=this.ut??=[],s=[];let p,g,h=0,v=o.length-1,b=0,A=a.length-1;for(;h<=v&&b<=A;)if(o[h]===null)h++;else if(o[v]===null)v--;else if(l[h]===n[b])s[b]=ve(o[h],a[b]),h++,b++;else if(l[v]===n[A])s[A]=ve(o[v],a[A]),v--,A--;else if(l[h]===n[A])s[A]=ve(o[h],a[A]),tt(i,s[A+1],o[h]),h++,A--;else if(l[v]===n[b])s[b]=ve(o[v],a[b]),tt(i,o[h],o[v]),v--,b++;else if(p===void 0&&(p=Kr(n,b,A),g=Kr(l,h,v)),p.has(l[h]))if(p.has(l[v])){const k=g.get(n[b]),Ft=k!==void 0?o[k]:null;if(Ft===null){const Zi=tt(i,o[h]);ve(Zi,a[b]),s[b]=Zi}else s[b]=ve(Ft,a[b]),tt(i,o[h],Ft),o[k]=null;b++}else Kt(o[v]),v--;else Kt(o[h]),h++;for(;b<=A;){const k=tt(i,s[A+1]);ve(k,a[b]),s[b++]=k}for(;h<=v;){const k=o[h++];k!==null&&Kt(k)}return this.ut=n,uo(i,s),K}});var Cs=Object.defineProperty,As=Object.getOwnPropertyDescriptor,Ye=(i,e,t,r)=>{for(var o=r>1?void 0:r?As(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=(r?n(e,t,o):n(o))||o);return r&&o&&Cs(e,t,o),o};const Wr=d`
  <svg
    class="ia-icon"
    viewBox="0 0 24 24"
    xmlns="http://www.w3.org/2000/svg"
...
`;let Me=class extends x{constructor(){super(...arguments),this.baseHost="archive.org",this.sortOrderBy="default",this.subPrefix="",this.fileList=[],this.addSortToUrl=!1}firstUpdated(){const i=this.shadowRoot?.querySelector(".content.active");setTimeout(()=>{const e=i;e?.scrollIntoViewIfNeeded?e.scrollIntoViewIfNeeded(!0):i?.scrollIntoView({behavior:"smooth",block:"nearest",inline:"nearest"})},350)}fileUrl(i){const e=`//${this.baseHost}${i.url_path}`;return this.addSortToUrl&&this.sortOrderBy!=="default"?`${e}?sort=${this.sortOrderBy}`:e}get pdfLabel(){return d`<span class="pdf-label"
    ...
    `}get fileListTemplate(){const i=Ss(this.fileList,e=>e?.file_prefix,this.fileLi.bind(this));return d`
      <ul>
        ${i}
        <div class="separator"></div>
      </ul>
    `}render(){return d`${this.fileList.length?this.fileListTemplate:y}`}static get styles(){return[z,_`
      ...
      `]}};Ye([u({type:String})],Me.prototype,"baseHost",2);Ye([u({type:String})],Me.prototype,"sortOrderBy",2);Ye([u({type:String})],Me.prototype,"subPrefix",2);Ye([u({type:Array})],Me.prototype,"fileList",2);Ye([u({type:Boolean,reflect:!0})],Me.prototype,"addSortToUrl",2);Me=Ye([C("ia-viewable-files-panel")],Me);var Os=Object.defineProperty,Ts=Object.getOwnPropertyDescriptor,Ht=(i,e,t,r)=>{for(var o=r>1?void 0:r?Ts(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=(r?n(e,t,o):n(o))||o);return r&&o&&Os(e,t,o),o};const Es=d`
...
`;let gt=class extends x{constructor(){super(...arguments),this.fileListRaw=[],this.fileListSorted=[],this.sortOrderBy="default"}render(){return d`<div class="sort-multi-file-list">${this.sortButton}</div>`}get sortButton(){return{default:d`
        <button
      ...
      `]}};Ht([u({type:Array})],gt.prototype,"fileListRaw",2);Ht([u({type:Array})],gt.prototype,"fileListSorted",2);Ht([u({type:String,reflect:!0})],gt.prototype,"sortOrderBy",2);gt=Ht([C("ia-sort-files-button")],gt);const Gr=d`
  <svg
    class="ia-icon"
    viewBox="0 0 100 100"
    xmlns="http://www.w3.org/2000/svg"
...
`;var Ls=Object.defineProperty,Rs=Object.getOwnPropertyDescriptor,re=(i,e,t,r)=>{for(var o=r>1?void 0:r?Rs(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=(r?n(e,t,o):n(o))||o);return r&&o&&Ls(e,t,o),o};let Y=class extends x{constructor(){super(...arguments),this.baseHost="archive.org",this.creator="",this.description="",this.embedOptionsVisible=!1,this.identifier="",this.sharingOptions=[],this.type="",this.renderHeader=!1,this.fileSubPrefix="",this.copyNoteTimeouts=new WeakMap}updated(i){i.has("sharingOptions")&&!this.sharingOptions.length&&this.loadProviders()}loadProviders(){let i=`https://${this.baseHost}/details/${this.identifier}`;this.fileSubPrefix&&(i+=`/${this.fileSubPrefix}`);const e=[this.description,this.creator,"Free Download, Borrow, and Streaming","Internet Archive"].filter(Boolean).join(" : ");this.sharingOptions=[{name:"Twitter",icon:Ms,url:`https://twitter.com/intent/tweet?${new URLSearchParams({url:i,text:e,via:"internetarchive"})}`},{name:"Facebook",icon:Is,url:`https://www.facebook.com/sharer/sharer.php?${new URLSearchParams({u:i})}`},{name:"Tumblr",icon:Bs,url:`https://www.tumblr.com/widgets/share/tool/preview?${new URLSearchParams({posttype:"link",canonicalUrl:i,title:e})}`},{name:"Pinterest",icon:Vs,url:`http://www.pinterest.com/pin/create/button/?${new URLSearchParams({url:i,description:e})}`},{name:"Email",icon:zs,url:`mailto:?${new URLSearchParams({subject:e,body:i})}`}]}async copyToClipboard(i){const e=i.currentTarget,t=e.querySelector("textarea"),r=e.querySelector("small");if(!(!t||!r)){try{await navigator.clipboard.writeText(t.value)}catch{t.select(),document.execCommand("copy"),t.blur()}r.classList.add("visible"),clearTimeout(this.copyNoteTimeouts.get(r)),this.copyNoteTimeouts.set(r,setTimeout(()=>r.classList.remove("visible"),4e3))}}get iframeEmbed(){return`<iframe
    ...
    `}static get styles(){return[z,_`
      ...
      `]}};re([u({type:String})],Y.prototype,"baseHost",2);re([u({type:String})],Y.prototype,"creator",2);re([u({type:String})],Y.prototype,"description",2);re([u({type:Boolean})],Y.prototype,"embedOptionsVisible",2);re([u({type:String})],Y.prototype,"identifier",2);re([u({type:Array})],Y.prototype,"sharingOptions",2);re([u({type:String})],Y.prototype,"type",2);re([u({type:Boolean})],Y.prototype,"renderHeader",2);re([u({type:String})],Y.prototype,"fileSubPrefix",2);Y=re([C("ia-share-panel")],Y);var Ns=Object.defineProperty,Us=Object.getOwnPropertyDescriptor,oe=(i,e,t,r)=>{for(var o=r>1?void 0:r?Us(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=(r?n(e,t,o):n(o))||o);return r&&o&&Ns(e,t,o),o};class js{constructor(){this.handlers=new Map,this.observer=new ResizeObserver(e=>{for(const t of e)this.handlers.get(t.target)?.handler.handleResize(t)})}addObserver(e){this.handlers.set(e.target,e),this.observer.observe(e.target)}removeObserver(e){this.handlers.delete(e.target),this.observer.unobserve(e.target)}}const Hs=d`
  <svg class="ia-icon" viewBox="0 0 24 24" aria-hidden="true">
    <path class="fill-color" d="M4 6h16v2H4V6zm0 5h16v2H4v-2zm0 5h16v2H4v-2z" />
  </svg>
`,Fs="https://archive.org/embed",qs="https://archive.org/download";function we(i,e,t,r,o){return{identifier:i,mediatype:t,pdfFile:o,title:e,file_prefix:i,file_subprefix:i,file_source:t==="pdf"?`${i}.pdf`:i,url_path:`/details/${i}`,image:"",author:"",orig_sort:r}}const $e=[we("0FK9vj7MBL","Monmon Japanese Cats Tattoo Designs","image",0),we("Catsintherain","Cats in the Rain","image",1),we("WithPriscillaTheCat1987","With Priscilla the Cat, 1987","image",2),we("TheBlackCat_339","The Black Cat","pdf",3,"TheBlackCatByEdgarAllanPoe.pdf"),we("catofbubastestal00hentiala","The Cat of Bubastes: A Tale of Ancient Egypt","pdf",4,"catofbubastestal00hentiala.pdf"),we("lettersfromcatpu00jackiala","Letters from a Cat","pdf",5,"lettersfromcatpu00jackiala.pdf"),we("PrivateL1947","Private Life of a Cat (1947)","video",6)];let G=class extends x{constructor(){super(...arguments),this.loaded=!0,this.viewAvailable=!0,this.headerOn=!0,this.fullscreen=!1,this.animationsOn=!0,this.sharedObserver=new js,this.sortOrderBy="default",this.sortedFiles=[...$e],this.selectedSubPrefix=$e[0].file_subprefix}handleFileListSorted(i){const{sortType:e,sortedFiles:t}=i.detail;this.sortOrderBy=e,this.sortedFiles=t}get selectedFile(){return $e.find(i=>i.file_subprefix===this.selectedSubPrefix)??$e[0]}get theaterSrc(){const i=this.selectedFile;return i.mediatype==="pdf"&&i.pdfFile?`${qs}/${i.identifier}/${encodeURIComponent(i.pdfFile)}`:`${Fs}/${i.identifier}`}handleFileClick(i){const e=i.composedPath().find(o=>o instanceof HTMLAnchorElement);if(!e)return;i.preventDefault();const t=e.getAttribute("href"),r=$e.find(o=>`//archive.org${o.url_path}`===t);r&&(this.selectedSubPrefix=r.file_subprefix)}get demoItem(){return{metadata:{identifier:this.selectedFile.identifier,title:this.selectedFile.title}}}get menuContents(){const i={item:this.demoItem,baseHost:"archive.org",subPrefix:""};return[{...i,id:"viewable-files",label:`Viewable Files (${$e.length})`,icon:Wr,actionButton:d`
        ...
        `,component:d`
          ...
          ></ia-viewable-files-panel>
        `},{...i,id:"share",label:"Share this item",icon:Gr,component:d`
          <ia-share-panel
          ...
          ></ia-share-panel>
        `},{...i,id:"about",label:"About This Item",icon:Hs,component:d`
          <p>
...
>
  ...
  <div slot="main">…your theater…</div>
    ...
    `}};oe([w()],G.prototype,"loaded",2);oe([w()],G.prototype,"viewAvailable",2);oe([w()],G.prototype,"headerOn",2);oe([w()],G.prototype,"fullscreen",2);oe([w()],G.prototype,"animationsOn",2);oe([w()],G.prototype,"sharedObserver",2);oe([w()],G.prototype,"sortOrderBy",2);oe([w()],G.prototype,"sortedFiles",2);oe([w()],G.prototype,"selectedSubPrefix",2);G=oe([C("ia-item-navigator-story")],G);const Ks=Object.freeze(Object.defineProperty({__proto__:null,get IAItemNavigatorStory(){return G}},Symbol.toStringTag,{value:"Module"}));var Ws=Object.defineProperty,Gs=Object.getOwnPropertyDescriptor,ze=(i,e,t,r)=>{for(var o=r>1?void 0:r?Gs(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=(r?n(e,t,o):n(o))||o);return r&&o&&Ws(e,t,o),o};const Zs={CodeSubmitted:"codeSubmitted"},Zr=/^[0-9]+$/,Js=/^[a-zA-Z0-9]+$/;let pe=class extends x{constructor(){super(...arguments),this.disabled=!1,this.numChars=6,this.numericOnly=!0,this.allowedChars=Zr}render(){return d`
      ${[...Array(this.numChars).keys()].map(i=>d`<input
          ...
          />`)}
    `}firstUpdated(){this.inputs[0].focus()}willUpdate(i){i.has("numericOnly")&&(this.allowedChars=this.numericOnly?Zr:Js),i.has("prefillValue")&&this.prefillValue!==void 0&&(this.fillInputs(this.prefillValue),this.prefillValue=void 0)}handleInput(i){i.preventDefault();const e=i.target,t=i.data;if(!t)return;if(t.length>1){this.fillInputs(t);return}if(!this.allowedChars.test(t))return;e.value=t;const r=e.nextElementSibling;r&&r.focus(),this.submitIfInputsFilled()}handleKeydown(i){const e=i.target,t=i.key,r=e.previousElementSibling,o=e.nextElementSibling;switch(t){case"Backspace":case"Delete":if(i.preventDefault(),r&&r.focus(),e.value===""){r.value="";break}e.value="";break;case"Tab":e.select();break;case"ArrowRight":case"Right":i.preventDefault(),o&&o.focus();break;case"ArrowLeft":case"Left":i.preventDefault(),r&&r.focus();break}}handlePaste(i){i.preventDefault();const e=i.clipboardData?.getData("text");e&&this.fillInputs(e)}fillInputs(i){i===""&&this.clearInputs();const e=i.split("").filter(r=>this.allowedChars.test(r)).slice(0,this.numChars);if(!e||e.length===0)return;if(e.forEach((r,o)=>this.inputs[o].value=r),e.length===this.numChars){this.triggerSubmit(e.join("")),this.inputs[this.numChars-1].focus();return}this.inputs[e.length].focus()}clearInputs(){this.inputs.forEach(i=>i.value=""),this.inputs[0].focus()}submitIfInputsFilled(){const i=[];this.inputs.forEach(e=>{e.value&&i.push(e.value)}),i.length===this.numChars&&this.triggerSubmit(i.join(""))}triggerSubmit(i){this.dispatchEvent(new CustomEvent(Zs.CodeSubmitted,{detail:this.numericOnly?i:i.toUpperCase(),bubbles:!0,composed:!0}))}static get styles(){return[z,_`
        :host {
      ...
      `]}};ze([u({type:String})],pe.prototype,"prefillValue",2);ze([u({type:Boolean})],pe.prototype,"disabled",2);ze([u({type:Number})],pe.prototype,"numChars",2);ze([u({type:Boolean})],pe.prototype,"numericOnly",2);ze([u({type:Object})],pe.prototype,"allowedChars",2);ze([Di("input")],pe.prototype,"inputs",2);pe=ze([C("ia-otp-input")],pe);var Ys=Object.defineProperty,Xs=Object.getOwnPropertyDescriptor,Xe=(i,e,t,r)=>{for(var o=r>1?void 0:r?Xs(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=(r?n(e,t,o):n(o))||o);return r&&o&&Ys(e,t,o),o};const Qs={NewCodeRequested:"newCodeRequested"};let Ie=class extends x{constructor(){super(...arguments),this.validationStatus="ready",this.newCodeSending=!1,this.numPasscodeChars=6,this.numericOnly=!0}render(){return d`
    ...
    `}willUpdate(i){i.has("validationStatus")&&this.OTPInput&&this.validationStatus==="error"&&(this.OTPInput.prefillValue=""),i.has("newCodeSending")&&this.newCodeSending&&this.OTPInput&&(this.OTPInput.prefillValue="")}get resendCodeButtonTemplate(){return this.newCodeSending?d`<span part="new-code-message" class="new-code-msg"
        ...
        `}async handleNewCodeRequested(){this.dispatchEvent(new CustomEvent(Qs.NewCodeRequested,{bubbles:!0,composed:!0})),this.OTPInput.prefillValue=""}static get styles(){return[z,_`
        :host {
          --font-size-standard--: var(--font-size-standard);
          --font-size-lg--: var(--font-size-lg);
      ...
      `]}};Xe([u({type:String})],Ie.prototype,"validationStatus",2);Xe([u({type:Boolean})],Ie.prototype,"newCodeSending",2);Xe([u({type:Number})],Ie.prototype,"numPasscodeChars",2);Xe([u({type:Boolean})],Ie.prototype,"numericOnly",2);Xe([S("ia-otp-input")],Ie.prototype,"OTPInput",2);Ie=Xe([C("ia-otp-form")],Ie);var el=Object.getOwnPropertyDescriptor,tl=(i,e,t,r)=>{for(var o=r>1?void 0:r?el(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=n(o)||o);return o};const il=[{label:"Text color",cssVariable:"--ia-theme-primary-text-color",defaultValue:"#2c2c2c",inputType:"color"},{label:"Input font size",cssVariable:"--ia-theme-font-size-lg",defaultValue:"2.25rem",inputType:"text"},{label:"Link and error font size",cssVariable:"--ia-theme-font-size-standard",defaultValue:"0.875rem",inputType:"text"},{label:"Link font color",cssVariable:"--ia-theme-link-color",defaultValue:"#4b64ff",inputType:"color"},{label:"Error message/indicator color",cssVariable:"--ia-theme-color-danger",defaultValue:"#e51c23",inputType:"color"},{label:"Success indicator color",cssVariable:"--ia-theme-color-success",defaultValue:"#31a481",inputType:"color"}],rl=[{label:"Validation Status",propertyName:"validationStatus",defaultValue:"ready",inputType:"radio",radioOptions:["ready","loading","success","error"]},{label:"New code sending in progress",propertyName:"newCodeSending",defaultValue:!1,inputType:"radio",radioOptions:[!0,!1]},{label:"Numeric only",propertyName:"numericOnly",defaultValue:!0,inputType:"radio",radioOptions:[!0,!1]},{label:"Number of passcode characters",propertyName:"numPasscodeChars",defaultValue:6,inputType:"number"}];let Ai=class extends x{render(){return d`
      <story-template
    ...
    `}};Ai=tl([C("ia-otp-form-story")],Ai);const ol=Object.freeze(Object.defineProperty({__proto__:null,get IAOTPFormStory(){return Ai}},Symbol.toStringTag,{value:"Module"}));var al=Object.getOwnPropertyDescriptor,nl=(i,e,t,r)=>{for(var o=r>1?void 0:r?al(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=n(o)||o);return o};const sl=[{label:"Text color",cssVariable:"--ia-theme-primary-text-color",defaultValue:"#2c2c2c",inputType:"color"},{label:"Font size",cssVariable:"--ia-theme-font-size-lg",defaultValue:"2.25rem",inputType:"text"}],ll=[{label:"Number of characters",propertyName:"numChars",defaultValue:6,inputType:"number"},{label:"Numeric only",propertyName:"numericOnly",defaultValue:!0,inputType:"radio",radioOptions:[!0,!1]},{label:"Prefill value",propertyName:"prefillValue",defaultValue:""},{label:"Disabled",propertyName:"disabled",defaultValue:!1,inputType:"radio",radioOptions:[!0,!1]}];let Oi=class extends x{render(){return d`
      <story-template
        elementTag="ia-otp-input"
        elementClassName="IAOTPInput"
        .defaultUsageProps=${"@codeSubmitted=${(e: CustomEvent) => {setTimeout(() => alert('Code submitted: ' + e.detail), 250);}}"}
        .styleInputData=${{settings:sl}}
        .propInputData=${{settings:ll}}
      >
        <ia-otp-input
          @codeSubmitted=${i=>{setTimeout(()=>alert("Code submitted: "+i.detail),250)}}
          slot="demo"
    ...
    `}};Oi=nl([C("ia-otp-input-story")],Oi);const dl=Object.freeze(Object.defineProperty({__proto__:null,get IAOTPInputStory(){return Oi}},Symbol.toStringTag,{value:"Module"}));var cl=Object.getOwnPropertyDescriptor,hl=(i,e,t,r)=>{for(var o=r>1?void 0:r?cl(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=n(o)||o);return o};let Jr=class extends x{render(){return d`
      <span class="sr-only">
        <slot></slot>
      </span>
    `}static get styles(){return[z,_`
      ...
      `]}};Jr=hl([C("ia-sr-only-text")],Jr);var pl=Object.defineProperty,ul=Object.getOwnPropertyDescriptor,zo=(i,e,t,r)=>{for(var o=r>1?void 0:r?ul(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=(r?n(e,t,o):n(o))||o);return r&&o&&pl(e,t,o),o};let Bt=class extends x{constructor(){super(...arguments),this.textVisible=!1}render(){return d`
      <story-template
    ...
    `}};Qe([w()],ue.prototype,"config",2);Qe([S("#count")],ue.prototype,"countInput",2);Qe([S("#wind")],ue.prototype,"windInput",2);Qe([S("#rotation")],ue.prototype,"rotationInput",2);Qe([S("#color")],ue.prototype,"colorInput",2);ue=Qe([C("ia-snow-story")],ue);const Al=Object.freeze(Object.defineProperty({__proto__:null,get IASnowStory(){return ue}},Symbol.toStringTag,{value:"Module"}));var Ol=Object.getOwnPropertyDescriptor,Tl=(i,e,t,r)=>{for(var o=r>1?void 0:r?Ol(e,t):e,a=i.length-1,n;a>=0;a--)(n=i[a])&&(o=n(o)||o);return o};const El=Object.assign({"../src/elements/ia-button/ia-button-story.ts":Ia,"../src/elements/ia-combo-box/ia-combo-box-story.ts":nn,"../src/elements/ia-dropdown-search-bar/ia-dropdown-search-bar-story.ts":rs,"../src/elements/ia-item-navigator/ia-item-navigator-story.ts":Ks,"../src/elements/ia-otp-form/ia-otp-form-story.ts":ol,"../src/elements/ia-otp-input/ia-otp-input-story.ts":dl,"../src/elements/ia-sr-only-text/ia-sr-only-text-story.ts":gl,"../src/elements/ia-status-indicator/ia-status-indicator-story.ts":yl,"../src/labs/ia-snow/ia-snow-story.ts":Al}),Do=Object.keys(El).map(i=>{const e=i.includes("/src/labs/"),t=i.split("/"),o=t[t.length-1].replace(/-story\.ts$/,"");return{tag:o,storyTag:`${o}-story`,id:`elem-${o}`,labs:e}}).sort((i,e)=>i.tag.localeCompare(e.tag)),Ei=Do.filter(i=>!i.labs),ki=Do.filter(i=>i.labs),kl=[...Ei,...ki];let Qr=class extends x{constructor(){super(...arguments),this._abortController=new AbortController}createRenderRoot(){return this}render(){return d`
      <nav id="ia-sidebar">
    ...
    `}firstUpdated(){const i=kl.map(r=>r.id),e=Object.fromEntries(i.map(r=>[r,this.querySelector(`#ia-sidebar a[href="#${r}"]`)])),t=new Set;this._observer=new IntersectionObserver(r=>{for(const a of r)a.isIntersecting?t.add(a.target.id):t.delete(a.target.id);const o=i.find(a=>t.has(a))??i[0];i.forEach(a=>e[a]?.classList.toggle("active",a===o))},{rootMargin:"0px 0px -70% 0px"}),i.forEach(r=>{const o=document.getElementById(r);o&&this._observer.observe(o)}),i.forEach(r=>{e[r]?.addEventListener("click",o=>{o.preventDefault();const a=document.getElementById(r);if(a){const n=a.getBoundingClientRect().top+window.scrollY;window.scrollTo({top:Math.max(0,n-16),behavior:"smooth"})}},{signal:this._abortController.signal})})}disconnectedCallback(){super.disconnectedCallback(),this._observer?.disconnect(),this._abortController.abort()}};Qr=Tl([C("app-root")],Qr);
